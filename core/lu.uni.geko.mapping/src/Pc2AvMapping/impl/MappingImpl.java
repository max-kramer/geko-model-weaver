 ...
 * <ul>
 *   <li>{@link Pc2AvMapping.impl.MappingImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingImpl extends EObjectImpl implements Mapping {
	...
	protected EClass eStaticClass() {
		return Pc2AvMappingPackage.Literals.MAPPING;
	}
	...
	public EList<MappingEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<MappingEntry>(MappingEntry.class, this, Pc2AvMappingPackage.MAPPING__ENTRIES);
		}
		return entries;
	}
