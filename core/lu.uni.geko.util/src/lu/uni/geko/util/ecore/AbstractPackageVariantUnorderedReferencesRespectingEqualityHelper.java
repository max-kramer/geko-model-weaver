      ...
      if (featureName.equals("instanceClassName") || featureName.equals("instanceTypeName") || featureName.equals("ePackage")) {
         ...
         if (value instanceof String && variantValue instanceof String) {
            ...
            if (packageName.endsWith(getMMPkgNameAppendage())) {
               variantValueString = JavaPkgNameBridge.removePkgSuffixFromCanonicalClassName(variantValueString, getMMPkgNameAppendage());
            }
            ...
            String variantNsPrefix = JavaPkgNameBridge.removeSuffixFromPkgName(variantEPackage.getNsPrefix(), getMMPkgNsPrefixAppendage());
