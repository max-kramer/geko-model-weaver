 ...
 * @author Max E. Kramer
 */
public class WeaveSeveralModelsInferringPc2AvMappingHandlerInPlace extends AbstractFileHandler {
   ...
   protected Runnable getRunnable(final List<URI> baseMURIs, final URI pointcutMURI, final URI adviceMURI, final List<List<URI>> uris) {
      return new Runnable() {
         @Override
         public void run() {
            ActionsFacade.weaveSeveralModelsInferringPc2AvMapping(baseMURIs, pointcutMURI, adviceMURI, true);
         }
      };
   }
}
