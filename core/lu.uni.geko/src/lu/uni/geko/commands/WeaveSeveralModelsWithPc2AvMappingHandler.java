 ...
 * @author Max E. Kramer
 */
public class WeaveSeveralModelsWithPc2AvMappingHandler extends WeaveSeveralModelsInferringPc2AvMappingHandler {
   ...
   protected Runnable getRunnable(final List<URI> baseMURIs, final URI pointcutMURI, final URI adviceMURI, final List<List<URI>> uris) {
      ...
      return new Runnable() {
         @Override
         public void run() {
            ActionsFacade.weaveSeveralModelsWithPc2AvMappingModel(baseMURIs, pointcutMURI, adviceMURI, pc2AvMappingMURI, false);
         }
      };
   }
}
