 ...
 * <ul>
 *   <li>{@link bsd.impl.PrecedenceTupleImpl#getPrecedingEvent <em>Preceding Event</em>}</li>
 *   <li>{@link bsd.impl.PrecedenceTupleImpl#getSubsequentEvent <em>Subsequent Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrecedenceTupleImpl extends EObjectImpl implements PrecedenceTuple {
	...
	protected EClass eStaticClass() {
		return BsdPackage.Literals.PRECEDENCE_TUPLE;
	}
		...
		if (precedingEvent != null && precedingEvent.eIsProxy()) {
			...
			if (precedingEvent != oldPrecedingEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BsdPackage.PRECEDENCE_TUPLE__PRECEDING_EVENT, oldPrecedingEvent, precedingEvent));
			}
		}
	...
	public void setPrecedingEvent(Event newPrecedingEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BsdPackage.PRECEDENCE_TUPLE__PRECEDING_EVENT, oldPrecedingEvent, precedingEvent));
	}
	...
	public Event getSubsequentEvent() {
		if (subsequentEvent != null && subsequentEvent.eIsProxy()) {
			...
			if (subsequentEvent != oldSubsequentEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BsdPackage.PRECEDENCE_TUPLE__SUBSEQUENT_EVENT, oldSubsequentEvent, subsequentEvent));
			}
		}
	...
	public void setSubsequentEvent(Event newSubsequentEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BsdPackage.PRECEDENCE_TUPLE__SUBSEQUENT_EVENT, oldSubsequentEvent, subsequentEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BsdPackage.PRECEDENCE_TUPLE__PRECEDING_EVENT:
				if (resolve) return getPrecedingEvent();
				return basicGetPrecedingEvent();
			case BsdPackage.PRECEDENCE_TUPLE__SUBSEQUENT_EVENT:
