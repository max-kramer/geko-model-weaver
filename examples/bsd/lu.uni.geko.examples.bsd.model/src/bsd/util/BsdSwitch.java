 ...
 * @generated
 */
public class BsdSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BsdPackage.BSD: {
				BSD bsd = (BSD)theEObject;
				T result = caseBSD(bsd);
				if (result == null) result = caseNamedElement(bsd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BsdPackage.LIFELINE: {
			...
			case BsdPackage.SEND_EVENT: {
				SendEvent sendEvent = (SendEvent)theEObject;
				T result = caseSendEvent(sendEvent);
				if (result == null) result = caseEvent(sendEvent);
				if (result == null) result = caseNamedElement(sendEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BsdPackage.RECEIVE_EVENT: {
				ReceiveEvent receiveEvent = (ReceiveEvent)theEObject;
				T result = caseReceiveEvent(receiveEvent);
				if (result == null) result = caseEvent(receiveEvent);
				if (result == null) result = caseNamedElement(receiveEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BsdPackage.PRECEDENCE_TUPLE: {
				PrecedenceTuple precedenceTuple = (PrecedenceTuple)theEObject;
				T result = casePrecedenceTuple(precedenceTuple);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BsdPackage.MESSAGE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>BSD</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>BSD</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBSD(BSD object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Precedence Tuple</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Precedence Tuple</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePrecedenceTuple(PrecedenceTuple object) {
		return null;
	}
