 ...
 * <ul>
 *   <li>{@link bsd_av.impl.BSDImpl#getPrecendenceTuples <em>Precendence Tuples</em>}</li>
 *   <li>{@link bsd_av.impl.BSDImpl#getLifelines <em>Lifelines</em>}</li>
 *   <li>{@link bsd_av.impl.BSDImpl#getMessages <em>Messages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BSDImpl extends NamedElementImpl implements BSD {
	...
	protected EClass eStaticClass() {
		return Bsd_avPackage.Literals.BSD;
	}
	...
	public EList<PrecedenceTuple> getPrecendenceTuples() {
		if (precendenceTuples == null) {
			precendenceTuples = new EObjectContainmentEList<PrecedenceTuple>(PrecedenceTuple.class, this, Bsd_avPackage.BSD__PRECENDENCE_TUPLES);
		}
	...
	public EList<Lifeline> getLifelines() {
		if (lifelines == null) {
			lifelines = new EObjectContainmentEList<Lifeline>(Lifeline.class, this, Bsd_avPackage.BSD__LIFELINES);
		}
		return lifelines;
	}
	...
	public EList<Message> getMessages() {
		if (messages == null) {
			messages = new EObjectContainmentEList<Message>(Message.class, this, Bsd_avPackage.BSD__MESSAGES);
		}
		return messages;
	}
