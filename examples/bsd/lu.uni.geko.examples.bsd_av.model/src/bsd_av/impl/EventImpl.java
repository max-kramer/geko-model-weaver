 ...
 * <ul>
 *   <li>{@link bsd_av.impl.EventImpl#getOwningLifeline <em>Owning Lifeline</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventImpl extends NamedElementImpl implements Event {
	...
	protected EClass eStaticClass() {
		return Bsd_avPackage.Literals.EVENT;
	}
		...
		if (owningLifeline != null && owningLifeline.eIsProxy()) {
			...
			if (owningLifeline != oldOwningLifeline) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bsd_avPackage.EVENT__OWNING_LIFELINE, oldOwningLifeline, owningLifeline));
			}
		}
	...
	public void setOwningLifeline(Lifeline newOwningLifeline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bsd_avPackage.EVENT__OWNING_LIFELINE, oldOwningLifeline, owningLifeline));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bsd_avPackage.EVENT__OWNING_LIFELINE:
