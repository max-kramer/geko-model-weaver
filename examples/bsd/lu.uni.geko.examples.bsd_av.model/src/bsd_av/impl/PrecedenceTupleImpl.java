 ...
 * <ul>
 *   <li>{@link bsd_av.impl.PrecedenceTupleImpl#getPrecedingEvent <em>Preceding Event</em>}</li>
 *   <li>{@link bsd_av.impl.PrecedenceTupleImpl#getSubsequentEvent <em>Subsequent Event</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrecedenceTupleImpl extends EObjectImpl implements PrecedenceTuple {
	...
	protected EClass eStaticClass() {
		return Bsd_avPackage.Literals.PRECEDENCE_TUPLE;
	}
		...
		if (precedingEvent != null && precedingEvent.eIsProxy()) {
			...
			if (precedingEvent != oldPrecedingEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bsd_avPackage.PRECEDENCE_TUPLE__PRECEDING_EVENT, oldPrecedingEvent, precedingEvent));
			}
		}
	...
	public void setPrecedingEvent(Event newPrecedingEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bsd_avPackage.PRECEDENCE_TUPLE__PRECEDING_EVENT, oldPrecedingEvent, precedingEvent));
	}
	...
	public Event getSubsequentEvent() {
		if (subsequentEvent != null && subsequentEvent.eIsProxy()) {
			...
			if (subsequentEvent != oldSubsequentEvent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bsd_avPackage.PRECEDENCE_TUPLE__SUBSEQUENT_EVENT, oldSubsequentEvent, subsequentEvent));
			}
		}
	...
	public void setSubsequentEvent(Event newSubsequentEvent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bsd_avPackage.PRECEDENCE_TUPLE__SUBSEQUENT_EVENT, oldSubsequentEvent, subsequentEvent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bsd_avPackage.PRECEDENCE_TUPLE__PRECEDING_EVENT:
				if (resolve) return getPrecedingEvent();
				return basicGetPrecedingEvent();
			case Bsd_avPackage.PRECEDENCE_TUPLE__SUBSEQUENT_EVENT:
