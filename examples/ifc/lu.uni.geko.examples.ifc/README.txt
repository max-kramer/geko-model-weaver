If you want to use the IFC examples for GeKo you also need the lu.uni.geko.ext.ifc plugin and the IFC-Ecore bridge that is described in this article:
...
If you do not want to use the IFC examples simply close or delete the plugin lu.uni.geko.ext.ifc after checkout.