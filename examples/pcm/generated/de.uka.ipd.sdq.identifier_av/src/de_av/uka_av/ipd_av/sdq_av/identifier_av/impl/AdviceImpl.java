...
import de_av.uka_av.ipd_av.sdq_av.identifier_av.Advice;
 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.identifier_av.impl.AdviceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdviceImpl extends EObjectImpl implements Advice {
   ...
   protected EClass eStaticClass() {
      return Identifier_avPackage.Literals.ADVICE;
   }
   ...
   public EList<EObject> getChildren() {
      if (children == null) {
         children = new EObjectContainmentEList<EObject>(EObject.class, this, Identifier_avPackage.ADVICE__CHILDREN);
      }
      return children;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Identifier_avPackage.ADVICE__CHILDREN:
