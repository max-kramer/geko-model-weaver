...
import de_av.uka_av.ipd_av.sdq_av.identifier_av.GlobalScope;
 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.identifier_av.impl.GlobalScopeImpl#getScopedObject <em>Scoped Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalScopeImpl extends EObjectImpl implements GlobalScope {
   ...
   protected EClass eStaticClass() {
      return Identifier_avPackage.Literals.GLOBAL_SCOPE;
   }
      ...
      if (scopedObject != null && scopedObject.eIsProxy()) {
         ...
         if (scopedObject != oldScopedObject) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Identifier_avPackage.GLOBAL_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
         }
      }
      return scopedObject;
   }
   ...
   public void setScopedObject(EObject newScopedObject) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Identifier_avPackage.GLOBAL_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Identifier_avPackage.GLOBAL_SCOPE__SCOPED_OBJECT:
