 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.identifier_av_av.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifierImpl extends EObjectImpl implements Identifier {
   ...
   protected EClass eStaticClass() {
      return Identifier_av_avPackage.Literals.IDENTIFIER;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Identifier_av_avPackage.IDENTIFIER__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Identifier_av_avPackage.IDENTIFIER__ID:
            return getId();
      }
