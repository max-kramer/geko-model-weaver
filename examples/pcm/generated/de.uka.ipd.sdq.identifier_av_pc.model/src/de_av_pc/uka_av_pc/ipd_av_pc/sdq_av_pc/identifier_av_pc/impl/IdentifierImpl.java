 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.identifier_av_pc.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifierImpl extends EObjectImpl implements Identifier {
   ...
   protected EClass eStaticClass() {
      return Identifier_av_pcPackage.Literals.IDENTIFIER;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Identifier_av_pcPackage.IDENTIFIER__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Identifier_av_pcPackage.IDENTIFIER__ID:
            return getId();
      }
