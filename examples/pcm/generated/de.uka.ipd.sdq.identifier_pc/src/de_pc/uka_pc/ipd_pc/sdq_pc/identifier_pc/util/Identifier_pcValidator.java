 ...
 * @generated
 */
public class Identifier_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Identifier_pcValidator INSTANCE = new Identifier_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc.uka_pc.ipd_pc.sdq_pc.identifier_pc";
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Identifier_pcPackage.IDENTIFIER:
            return validateIdentifier((Identifier)value, diagnostics, context);
         case Identifier_pcPackage.POINTCUT:
