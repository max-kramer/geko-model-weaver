 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.identifier_pc_av.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifierImpl extends EObjectImpl implements Identifier {
   ...
   protected EClass eStaticClass() {
      return Identifier_pc_avPackage.Literals.IDENTIFIER;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Identifier_pc_avPackage.IDENTIFIER__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Identifier_pc_avPackage.IDENTIFIER__ID:
            return getId();
      }
