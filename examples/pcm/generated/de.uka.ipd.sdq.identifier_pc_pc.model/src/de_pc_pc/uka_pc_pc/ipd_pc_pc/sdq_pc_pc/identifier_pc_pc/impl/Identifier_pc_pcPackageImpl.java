...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.Identifier_pc_pcFactory;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.Identifier_pc_pcPackage;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.Pointcut;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.PointcutPointcut;
 ...
 * @generated
 */
public class Identifier_pc_pcPackageImpl extends EPackageImpl implements Identifier_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.Identifier_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Identifier_pc_pcPackageImpl() {
      super(eNS_URI, Identifier_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Identifier_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Identifier_pc_pcPackage init() {
      if (isInited) return (Identifier_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Identifier_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      Identifier_pc_pcPackageImpl theIdentifier_pc_pcPackage = (Identifier_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Identifier_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Identifier_pc_pcPackageImpl());

      isInited = true;

      // Create package meta-data objects
      theIdentifier_pc_pcPackage.createPackageContents();

      // Initialize created meta-data
      theIdentifier_pc_pcPackage.initializePackageContents();

      // Register package validator
      EValidator.Registry.INSTANCE.put
         (theIdentifier_pc_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Identifier_pc_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theIdentifier_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Identifier_pc_pcPackage.eNS_URI, theIdentifier_pc_pcPackage);
      return theIdentifier_pc_pcPackage;
   }
    ...
    * @generated
    */
   public Identifier_pc_pcFactory getIdentifier_pc_pcFactory() {
      return (Identifier_pc_pcFactory)getEFactoryInstance();
   }
