 ...
 * @generated
 */
public class Identifier_pc_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Identifier_pc_pcPackage modelPackage;
    ...
    * @generated
    */
   public Identifier_pc_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Identifier_pc_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Identifier_pc_pcSwitch<Adapter> modelSwitch =
      new Identifier_pc_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.PointcutPointcut <em>Pointcut Pointcut</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.Pointcut <em>Pointcut</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Identifier_pc_pcAdapterFactory
