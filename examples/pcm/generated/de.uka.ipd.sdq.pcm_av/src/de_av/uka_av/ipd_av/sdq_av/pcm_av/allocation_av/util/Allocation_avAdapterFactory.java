 ...
 * @generated
 */
public class Allocation_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Allocation_avPackage modelPackage;
    ...
    * @generated
    */
   public Allocation_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Allocation_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Allocation_avSwitch<Adapter> modelSwitch =
      new Allocation_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.allocation_av.AllocationContext <em>Allocation Context</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.allocation_av.Allocation <em>Allocation</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
