 ...
 * @generated
 */
public class Completions_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Completions_avPackage.COMPLETION: {
         ...
         case Completions_avPackage.COMPLETION_REPOSITORY: {
         ...
         case Completions_avPackage.DELEGATING_EXTERNAL_CALL_ACTION: {
         ...
         case Completions_avPackage.NETWORK_DEMAND_PARAMETRIC_RESOURCE_DEMAND: {
