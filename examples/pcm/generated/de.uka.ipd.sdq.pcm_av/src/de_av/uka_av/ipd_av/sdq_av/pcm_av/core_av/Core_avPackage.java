 ...
 * <!-- end-model-doc -->
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.Core_avFactory
 * @model kind="package"
 * @generated
 */
public interface Core_avPackage extends EPackage {
   /**
    * The package name.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   String eNS_URI = "http://sdq.ipd.uka.de/PalladioComponentModel/Core/5.0_advice";
    ...
    * @generated
    */
   Core_avPackage eINSTANCE = de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.Core_avPackageImpl.init();

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.PCMRandomVariableImpl <em>PCM Random Variable</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.PCMRandomVariableImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.Core_avPackageImpl#getPCMRandomVariable()
    * @generated
    */
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__SPECIFICATION = Stoex_avPackage.RANDOM_VARIABLE__SPECIFICATION;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__EXPRESSION = Stoex_avPackage.RANDOM_VARIABLE__EXPRESSION;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__CLOSED_WORKLOAD_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__PASSIVE_RESOURCE_CAPACITY_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__VARIABLE_CHARACTERISATION_SPECIFICATION = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__INFRASTRUCTURE_CALL_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 3;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__RESOURCE_CALL_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 4;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__PARAMETRIC_RESOURCE_DEMAND_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 5;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 6;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__GUARDED_BRANCH_TRANSITION_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 7;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__SPECIFIED_EXECUTION_TIME_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 8;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__EVENT_CHANNEL_SINK_CONNECTOR_FILTER_CONDITION = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 9;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 10;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__LOOP_LOOP_ITERATION = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 11;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__OPEN_WORKLOAD_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 12;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 13;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__COMMUNICATION_LINK_RESOURCE_SPECIFCATION_THROUGHPUT_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 14;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__PROCESSING_RESOURCE_SPECIFICATION_PROCESSING_RATE_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 15;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE__COMMUNICATION_LINK_RESOURCE_SPECIFICATION_LATENCY_PCM_RANDOM_VARIABLE = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 16;
    ...
    * @ordered
    */
   int PCM_RANDOM_VARIABLE_FEATURE_COUNT = Stoex_avPackage.RANDOM_VARIABLE_FEATURE_COUNT + 17;


   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable <em>PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable
    * @generated
    */
   EClass getPCMRandomVariable();

   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getClosedWorkload_PCMRandomVariable <em>Closed Workload PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Closed Workload PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getClosedWorkload_PCMRandomVariable()
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getPassiveResource_capacity_PCMRandomVariable <em>Passive Resource capacity PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Passive Resource capacity PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getPassiveResource_capacity_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getVariableCharacterisation_Specification <em>Variable Characterisation Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Variable Characterisation Specification</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getVariableCharacterisation_Specification()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getInfrastructureCall__PCMRandomVariable <em>Infrastructure Call PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getResourceCall__PCMRandomVariable <em>Resource Call PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Resource Call PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getResourceCall__PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getParametricResourceDemand_PCMRandomVariable <em>Parametric Resource Demand PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Parametric Resource Demand PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getParametricResourceDemand_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getLoopAction_PCMRandomVariable <em>Loop Action PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Loop Action PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getLoopAction_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getGuardedBranchTransition_PCMRandomVariable <em>Guarded Branch Transition PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Guarded Branch Transition PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getGuardedBranchTransition_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getSpecifiedExecutionTime_PCMRandomVariable <em>Specified Execution Time PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Specified Execution Time PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getSpecifiedExecutionTime_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getEventChannelSinkConnector__FilterCondition <em>Event Channel Sink Connector Filter Condition</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Event Channel Sink Connector Filter Condition</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getEventChannelSinkConnector__FilterCondition()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getAssemblyEventConnector__FilterCondition <em>Assembly Event Connector Filter Condition</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Assembly Event Connector Filter Condition</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getAssemblyEventConnector__FilterCondition()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getLoop_LoopIteration <em>Loop Loop Iteration</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getOpenWorkload_PCMRandomVariable <em>Open Workload PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Open Workload PCM Random Variable</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getOpenWorkload_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getDelay_TimeSpecification <em>Delay Time Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getCommunicationLinkResourceSpecifcation_throughput_PCMRandomVariable <em>Communication Link Resource Specifcation throughput PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getProcessingResourceSpecification_processingRate_PCMRandomVariable <em>Processing Resource Specification processing Rate PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getProcessingResourceSpecification_processingRate_PCMRandomVariable()
    * @see #getPCMRandomVariable()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable#getCommunicationLinkResourceSpecification_latency_PCMRandomVariable <em>Communication Link Resource Specification latency PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   Core_avFactory getCore_avFactory();
   ...
   interface Literals {
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.PCMRandomVariableImpl <em>PCM Random Variable</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.PCMRandomVariableImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.impl.Core_avPackageImpl#getPCMRandomVariable()
