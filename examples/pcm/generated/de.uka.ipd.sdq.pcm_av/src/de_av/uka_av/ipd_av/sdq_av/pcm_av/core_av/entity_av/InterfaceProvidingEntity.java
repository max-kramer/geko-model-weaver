 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.InterfaceProvidingEntity#getProvidedRoles_InterfaceProvidingEntity <em>Provided Roles Interface Providing Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.Entity_avPackage#getInterfaceProvidingEntity()
 * @model
 * @generated
 */
public interface InterfaceProvidingEntity extends Entity {
    ...
    * The list contents are of type {@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.ProvidedRole}.
    * It is bidirectional and its opposite is '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.ProvidedRole#getProvidingEntity_ProvidedRole <em>Providing Entity Provided Role</em>}'.
    * <!-- begin-user-doc -->
    * <p>
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.Entity_avPackage#getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity()
