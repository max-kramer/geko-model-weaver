 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.InterfaceRequiringEntity#getRequiredRoles_InterfaceRequiringEntity <em>Required Roles Interface Requiring Entity</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.Entity_avPackage#getInterfaceRequiringEntity()
 * @model
 * @generated
 */
public interface InterfaceRequiringEntity extends Entity, ResourceInterfaceRequiringEntity {
    ...
    * The list contents are of type {@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.RequiredRole}.
    * It is bidirectional and its opposite is '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.RequiredRole#getRequiringEntity_RequiredRole <em>Requiring Entity Required Role</em>}'.
    * <!-- begin-user-doc -->
    * <p>
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.Entity_avPackage#getInterfaceRequiringEntity_RequiredRoles_InterfaceRequiringEntity()
