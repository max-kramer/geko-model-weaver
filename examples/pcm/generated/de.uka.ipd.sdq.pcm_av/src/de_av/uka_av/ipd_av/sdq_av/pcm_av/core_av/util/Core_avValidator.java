 ...
 * @generated
 */
public class Core_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Core_avValidator INSTANCE = new Core_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av";
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Core_avPackage.PCM_RANDOM_VARIABLE:
