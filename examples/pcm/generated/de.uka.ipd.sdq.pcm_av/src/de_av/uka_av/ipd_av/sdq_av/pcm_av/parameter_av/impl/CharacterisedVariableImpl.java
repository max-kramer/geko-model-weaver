...
import de_av.uka_av.ipd_av.sdq_av.stoex_av.impl.VariableImpl;
 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.parameter_av.impl.CharacterisedVariableImpl#getCharacterisationType <em>Characterisation Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterisedVariableImpl extends VariableImpl implements CharacterisedVariable {
   ...
   protected EClass eStaticClass() {
      return Parameter_avPackage.Literals.CHARACTERISED_VARIABLE;
   }
   ...
   public void setCharacterisationType(VariableCharacterisationType newCharacterisationType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_avPackage.CHARACTERISED_VARIABLE__CHARACTERISATION_TYPE, oldCharacterisationType, characterisationType));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Parameter_avPackage.CHARACTERISED_VARIABLE__CHARACTERISATION_TYPE:
