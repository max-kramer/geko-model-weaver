 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.protocol_av.Protocol#getProtocolTypeID <em>Protocol Type ID</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.protocol_av.Protocol_avPackage#getProtocol()
 * @model
 * @generated
 */
public interface Protocol extends EObject {
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.protocol_av.Protocol_avPackage#getProtocol_ProtocolTypeID()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.protocol_av.Protocol#getProtocolTypeID <em>Protocol Type ID</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
