 ...
 * <!-- end-model-doc -->
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.Qosannotations_avFactory
 * @model kind="package"
 * @generated
 */
public interface Qosannotations_avPackage extends EPackage {
   /**
    * The package name.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   String eNAME = "qosannotations_av";
    ...
    * @generated
    */
   String eNS_URI = "http://sdq.ipd.uka.de/PalladioComponentModel/QoSAnnotations/5.0_advice";
    ...
    * @generated
    */
   String eNS_PREFIX = "qosannotations_av";
    ...
    * @generated
    */
   Qosannotations_avPackage eINSTANCE = de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl.init();

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedQoSAnnotationImpl <em>Specified Qo SAnnotation</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedQoSAnnotationImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl#getSpecifiedQoSAnnotation()
    * @generated
    */
   ...
   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.QoSAnnotationsImpl <em>Qo SAnnotations</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.QoSAnnotationsImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl#getQoSAnnotations()
    * @generated
    */
    ...
    * @ordered
    */
   int QO_SANNOTATIONS__ID = Entity_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int QO_SANNOTATIONS__ENTITY_NAME = Entity_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS = Entity_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS = Entity_avPackage.ENTITY_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS = Entity_avPackage.ENTITY_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int QO_SANNOTATIONS_FEATURE_COUNT = Entity_avPackage.ENTITY_FEATURE_COUNT + 3;

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedOutputParameterAbstractionImpl <em>Specified Output Parameter Abstraction</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedOutputParameterAbstractionImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl#getSpecifiedOutputParameterAbstraction()
    * @generated
    */
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation <em>Specified Qo SAnnotation</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Specified Qo SAnnotation</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation
    * @generated
    */
   EClass getSpecifiedQoSAnnotation();

   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation#getSignature_SpecifiedQoSAnnation <em>Signature Specified Qo SAnnation</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Signature Specified Qo SAnnation</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation#getSignature_SpecifiedQoSAnnation()
   ...
   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation#getRole_SpecifiedQoSAnnotation <em>Role Specified Qo SAnnotation</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Role Specified Qo SAnnotation</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation#getRole_SpecifiedQoSAnnotation()
    * @see #getSpecifiedQoSAnnotation()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedQoSAnnotation#getQosAnnotations_SpecifiedQoSAnnotation <em>Qos Annotations Specified Qo SAnnotation</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations <em>Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Qo SAnnotations</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations
    * @generated
    */
   EClass getQoSAnnotations();

   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations#getSpecifiedOutputParameterAbstractions_QoSAnnotations <em>Specified Output Parameter Abstractions Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference list '<em>Specified Output Parameter Abstractions Qo SAnnotations</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations#getSpecifiedOutputParameterAbstractions_QoSAnnotations()
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations#getSystem_QoSAnnotations <em>System Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>System Qo SAnnotations</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations#getSystem_QoSAnnotations()
    * @see #getQoSAnnotations()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations#getSpecifiedQoSAnnotations_QoSAnnotations <em>Specified Qo SAnnotations Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference list '<em>Specified Qo SAnnotations Qo SAnnotations</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations#getSpecifiedQoSAnnotations_QoSAnnotations()
    * @see #getQoSAnnotations()
    * @generated
    */
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction <em>Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Specified Output Parameter Abstraction</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction
    * @generated
    */
   EClass getSpecifiedOutputParameterAbstraction();

   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction#getSignature_SpecifiedOutputParameterAbstraction <em>Signature Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Signature Specified Output Parameter Abstraction</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction#getSignature_SpecifiedOutputParameterAbstraction()
   ...
   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction#getRole_SpecifiedOutputParameterAbstraction <em>Role Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Role Specified Output Parameter Abstraction</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction#getRole_SpecifiedOutputParameterAbstraction()
    * @see #getSpecifiedOutputParameterAbstraction()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction#getExpectedExternalOutputs_SpecifiedOutputParameterAbstraction <em>Expected External Outputs Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction#getQosAnnotations_SpecifiedOutputParameterAbstraction <em>Qos Annotations Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   Qosannotations_avFactory getQosannotations_avFactory();
   ...
   interface Literals {
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedQoSAnnotationImpl <em>Specified Qo SAnnotation</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedQoSAnnotationImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl#getSpecifiedQoSAnnotation()
      ...
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.QoSAnnotationsImpl <em>Qo SAnnotations</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.QoSAnnotationsImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl#getQoSAnnotations()
      ...
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedOutputParameterAbstractionImpl <em>Specified Output Parameter Abstraction</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.SpecifiedOutputParameterAbstractionImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.impl.Qosannotations_avPackageImpl#getSpecifiedOutputParameterAbstraction()
