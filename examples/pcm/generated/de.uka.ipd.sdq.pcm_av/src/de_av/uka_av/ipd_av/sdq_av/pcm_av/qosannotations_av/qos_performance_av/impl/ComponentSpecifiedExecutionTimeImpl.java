...
import de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_performance_av.ComponentSpecifiedExecutionTime;
 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_performance_av.impl.ComponentSpecifiedExecutionTimeImpl#getAssemblyContext_ComponentSpecifiedExecutionTime <em>Assembly Context Component Specified Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentSpecifiedExecutionTimeImpl extends SpecifiedExecutionTimeImpl implements ComponentSpecifiedExecutionTime {
   ...
   protected EClass eStaticClass() {
      return Qos_performance_avPackage.Literals.COMPONENT_SPECIFIED_EXECUTION_TIME;
   }
      ...
      if (assemblyContext_ComponentSpecifiedExecutionTime != null && assemblyContext_ComponentSpecifiedExecutionTime.eIsProxy()) {
         ...
         if (assemblyContext_ComponentSpecifiedExecutionTime != oldAssemblyContext_ComponentSpecifiedExecutionTime) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Qos_performance_avPackage.COMPONENT_SPECIFIED_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME, oldAssemblyContext_ComponentSpecifiedExecutionTime, assemblyContext_ComponentSpecifiedExecutionTime));
         }
      }
   ...
   public void setAssemblyContext_ComponentSpecifiedExecutionTime(AssemblyContext newAssemblyContext_ComponentSpecifiedExecutionTime) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Qos_performance_avPackage.COMPONENT_SPECIFIED_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME, oldAssemblyContext_ComponentSpecifiedExecutionTime, assemblyContext_ComponentSpecifiedExecutionTime));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Qos_performance_avPackage.COMPONENT_SPECIFIED_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME:
