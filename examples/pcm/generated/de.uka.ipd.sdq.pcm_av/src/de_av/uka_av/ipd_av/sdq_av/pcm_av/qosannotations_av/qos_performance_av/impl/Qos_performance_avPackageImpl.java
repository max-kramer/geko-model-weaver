...
import de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_performance_av.Qos_performance_avFactory;
 ...
 * @generated
 */
public class Qos_performance_avPackageImpl extends EPackageImpl implements Qos_performance_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_performance_av.Qos_performance_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Qos_performance_avPackageImpl() {
      super(eNS_URI, Qos_performance_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Qos_performance_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Qos_performance_avPackage init() {
      if (isInited) return (Qos_performance_avPackage)EPackage.Registry.INSTANCE.getEPackage(Qos_performance_avPackage.eNS_URI);

      // Obtain or create and register package
      Qos_performance_avPackageImpl theQos_performance_avPackage = (Qos_performance_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Qos_performance_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Qos_performance_avPackageImpl());
         ...
         (theQos_performance_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Qos_performance_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theQos_performance_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Qos_performance_avPackage.eNS_URI, theQos_performance_avPackage);
      return theQos_performance_avPackage;
   }
    ...
    * @generated
    */
   public Qos_performance_avFactory getQos_performance_avFactory() {
      return (Qos_performance_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      specifiedExecutionTimeEClass.getESuperTypes().add(theQosannotations_avPackage.getSpecifiedQoSAnnotation());
      ...
      initEReference(getSpecifiedExecutionTime_Specification_SpecifiedExecutionTime(), theCore_avPackage.getPCMRandomVariable(), theCore_avPackage.getPCMRandomVariable_SpecifiedExecutionTime_PCMRandomVariable(), "specification_SpecifiedExecutionTime", null, 0, 1, SpecifiedExecutionTime.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
