...
import de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_performance_av.SystemSpecifiedExecutionTime;

import de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_performance_av.util.Qos_performance_avValidator;
...
public class SystemSpecifiedExecutionTimeImpl extends SpecifiedExecutionTimeImpl implements SystemSpecifiedExecutionTime {
   ...
   protected EClass eStaticClass() {
      return Qos_performance_avPackage.Literals.SYSTEM_SPECIFIED_EXECUTION_TIME;
   }
      ...
      if (false) {
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Qos_performance_avValidator.DIAGNOSTIC_SOURCE,
                   Qos_performance_avValidator.SYSTEM_SPECIFIED_EXECUTION_TIME__SYSTEM_SPECIFIED_EXECUTION_TIME_MUST_REFERENCE_REQUIRED_ROLE_OF_ASYSTEM,
