 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Interface#getParentInterfaces__Interface <em>Parent Interfaces Interface</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Interface#getProtocols__Interface <em>Protocols Interface</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Interface#getRequiredCharacterisations <em>Required Characterisations</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Interface#getRepository__Interface <em>Repository Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getInterface()
 * @model
 * @generated
 */
public interface Interface extends Entity {
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getInterface_ParentInterfaces__Interface()
    * @model ordered="false"
    * @generated
    */
    ...
    * The list contents are of type {@link de_av.uka_av.ipd_av.sdq_av.pcm_av.protocol_av.Protocol}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * <!-- begin-model-doc -->
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getInterface_Protocols__Interface()
    ...
    * The list contents are of type {@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.RequiredCharacterisation}.
    * It is bidirectional and its opposite is '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.RequiredCharacterisation#getInterface_RequiredCharacterisation <em>Interface Required Characterisation</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * <!-- begin-model-doc -->
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getInterface_RequiredCharacterisations()
    ...
    * It is bidirectional and its opposite is '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository#getInterfaces__Repository <em>Interfaces Repository</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * <!-- begin-model-doc -->
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getInterface_Repository__Interface()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Interface#getRepository__Interface <em>Repository Interface</em>}' container reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
