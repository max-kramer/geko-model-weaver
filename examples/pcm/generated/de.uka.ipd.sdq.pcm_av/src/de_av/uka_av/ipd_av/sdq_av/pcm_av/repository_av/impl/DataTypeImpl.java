 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.DataTypeImpl#getRepository__DataType <em>Repository Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataTypeImpl extends EObjectImpl implements DataType {
   ...
   protected EClass eStaticClass() {
      return Repository_avPackage.Literals.DATA_TYPE;
   }
   ...
   public Repository getRepository__DataType() {
      if (eContainerFeatureID() != Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE) return null;
   ...
   public NotificationChain basicSetRepository__DataType(Repository newRepository__DataType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__DataType, Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE, msgs);
      return msgs;
   }
   ...
   public void setRepository__DataType(Repository newRepository__DataType) {
      if (newRepository__DataType != eInternalContainer() || (eContainerFeatureID() != Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE && newRepository__DataType != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE, newRepository__DataType, newRepository__DataType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
