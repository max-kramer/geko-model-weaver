 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourcetype_av.impl.ProcessingResourceTypeImpl#getHardwareInducedFailureType__ProcessingResourceType <em>Hardware Induced Failure Type Processing Resource Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessingResourceTypeImpl extends ResourceTypeImpl implements ProcessingResourceType {
   ...
   protected EClass eStaticClass() {
      return Resourcetype_avPackage.Literals.PROCESSING_RESOURCE_TYPE;
   }
      ...
      if (hardwareInducedFailureType__ProcessingResourceType != null && hardwareInducedFailureType__ProcessingResourceType.eIsProxy()) {
         ...
         if (hardwareInducedFailureType__ProcessingResourceType != oldHardwareInducedFailureType__ProcessingResourceType) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Resourcetype_avPackage.PROCESSING_RESOURCE_TYPE__HARDWARE_INDUCED_FAILURE_TYPE_PROCESSING_RESOURCE_TYPE, oldHardwareInducedFailureType__ProcessingResourceType, hardwareInducedFailureType__ProcessingResourceType));
         }
      }
   ...
   public NotificationChain basicSetHardwareInducedFailureType__ProcessingResourceType(HardwareInducedFailureType newHardwareInducedFailureType__ProcessingResourceType, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Resourcetype_avPackage.PROCESSING_RESOURCE_TYPE__HARDWARE_INDUCED_FAILURE_TYPE_PROCESSING_RESOURCE_TYPE, oldHardwareInducedFailureType__ProcessingResourceType, newHardwareInducedFailureType__ProcessingResourceType);
   ...
   public void setHardwareInducedFailureType__ProcessingResourceType(HardwareInducedFailureType newHardwareInducedFailureType__ProcessingResourceType) {
      if (newHardwareInducedFailureType__ProcessingResourceType != hardwareInducedFailureType__ProcessingResourceType) {
         ...
         if (hardwareInducedFailureType__ProcessingResourceType != null)
            msgs = ((InternalEObject)hardwareInducedFailureType__ProcessingResourceType).eInverseRemove(this, Reliability_avPackage.HARDWARE_INDUCED_FAILURE_TYPE__PROCESSING_RESOURCE_TYPE_HARDWARE_INDUCED_FAILURE_TYPE, HardwareInducedFailureType.class, msgs);
         if (newHardwareInducedFailureType__ProcessingResourceType != null)
            msgs = ((InternalEObject)newHardwareInducedFailureType__ProcessingResourceType).eInverseAdd(this, Reliability_avPackage.HARDWARE_INDUCED_FAILURE_TYPE__PROCESSING_RESOURCE_TYPE_HARDWARE_INDUCED_FAILURE_TYPE, HardwareInducedFailureType.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Resourcetype_avPackage.PROCESSING_RESOURCE_TYPE__HARDWARE_INDUCED_FAILURE_TYPE_PROCESSING_RESOURCE_TYPE, newHardwareInducedFailureType__ProcessingResourceType, newHardwareInducedFailureType__ProcessingResourceType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Resourcetype_avPackage.PROCESSING_RESOURCE_TYPE__HARDWARE_INDUCED_FAILURE_TYPE_PROCESSING_RESOURCE_TYPE:
            if (hardwareInducedFailureType__ProcessingResourceType != null)
               msgs = ((InternalEObject)hardwareInducedFailureType__ProcessingResourceType).eInverseRemove(this, Reliability_avPackage.HARDWARE_INDUCED_FAILURE_TYPE__PROCESSING_RESOURCE_TYPE_HARDWARE_INDUCED_FAILURE_TYPE, HardwareInducedFailureType.class, msgs);
