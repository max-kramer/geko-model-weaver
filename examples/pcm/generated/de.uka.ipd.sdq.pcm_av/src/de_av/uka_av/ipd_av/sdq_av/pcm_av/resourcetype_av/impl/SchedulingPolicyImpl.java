 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourcetype_av.impl.SchedulingPolicyImpl#getResourceRepository__SchedulingPolicy <em>Resource Repository Scheduling Policy</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchedulingPolicyImpl extends EntityImpl implements SchedulingPolicy {
   ...
   protected EClass eStaticClass() {
      return Resourcetype_avPackage.Literals.SCHEDULING_POLICY;
   }
   ...
   public ResourceRepository getResourceRepository__SchedulingPolicy() {
      if (eContainerFeatureID() != Resourcetype_avPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY) return null;
   ...
   public NotificationChain basicSetResourceRepository__SchedulingPolicy(ResourceRepository newResourceRepository__SchedulingPolicy, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newResourceRepository__SchedulingPolicy, Resourcetype_avPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY, msgs);
      return msgs;
   }
   ...
   public void setResourceRepository__SchedulingPolicy(ResourceRepository newResourceRepository__SchedulingPolicy) {
      if (newResourceRepository__SchedulingPolicy != eInternalContainer() || (eContainerFeatureID() != Resourcetype_avPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY && newResourceRepository__SchedulingPolicy != null)) {
         ...
         if (newResourceRepository__SchedulingPolicy != null)
            msgs = ((InternalEObject)newResourceRepository__SchedulingPolicy).eInverseAdd(this, Resourcetype_avPackage.RESOURCE_REPOSITORY__SCHEDULING_POLICIES_RESOURCE_REPOSITORY, ResourceRepository.class, msgs);
         msgs = basicSetResourceRepository__SchedulingPolicy(newResourceRepository__SchedulingPolicy, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourcetype_avPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY, newResourceRepository__SchedulingPolicy, newResourceRepository__SchedulingPolicy));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Resourcetype_avPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Resourcetype_avPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY:
            return eInternalContainer().eInverseRemove(this, Resourcetype_avPackage.RESOURCE_REPOSITORY__SCHEDULING_POLICIES_RESOURCE_REPOSITORY, ResourceRepository.class, msgs);
      }
