 ...
 * @generated
 */
public class Resourcetype_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourcetype_avPackage.RESOURCE_SIGNATURE: {
         ...
         case Resourcetype_avPackage.PROCESSING_RESOURCE_TYPE: {
         ...
         case Resourcetype_avPackage.RESOURCE_TYPE: {
         ...
         case Resourcetype_avPackage.COMMUNICATION_LINK_RESOURCE_TYPE: {
         ...
         case Resourcetype_avPackage.RESOURCE_INTERFACE: {
