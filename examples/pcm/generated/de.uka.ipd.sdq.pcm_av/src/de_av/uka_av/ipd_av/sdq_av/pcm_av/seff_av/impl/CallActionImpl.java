 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.CallActionImpl#getInputVariableUsages__CallAction <em>Input Variable Usages Call Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CallActionImpl extends EObjectImpl implements CallAction {
   ...
   protected EClass eStaticClass() {
      return Seff_avPackage.Literals.CALL_ACTION;
   }
   ...
   public EList<VariableUsage> getInputVariableUsages__CallAction() {
      if (inputVariableUsages__CallAction == null) {
         inputVariableUsages__CallAction = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_avPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION, Parameter_avPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_avPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION:
