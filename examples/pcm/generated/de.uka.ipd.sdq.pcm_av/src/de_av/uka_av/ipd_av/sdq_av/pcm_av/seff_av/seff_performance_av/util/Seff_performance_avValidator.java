 ...
 * @generated
 */
public class Seff_performance_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Seff_performance_avValidator INSTANCE = new Seff_performance_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.seff_performance_av";
    ...
    * @generated
    */
   public Seff_performance_avValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Seff_performance_avPackage.INFRASTRUCTURE_CALL:
            return validateInfrastructureCall((InfrastructureCall)value, diagnostics, context);
         case Seff_performance_avPackage.RESOURCE_CALL:
            return validateResourceCall((ResourceCall)value, diagnostics, context);
         case Seff_performance_avPackage.PARAMETRIC_RESOURCE_DEMAND:
