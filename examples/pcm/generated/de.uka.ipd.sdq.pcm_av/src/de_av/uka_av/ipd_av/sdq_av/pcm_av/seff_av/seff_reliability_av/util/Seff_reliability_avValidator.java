 ...
 * @generated
 */
public class Seff_reliability_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Seff_reliability_avValidator INSTANCE = new Seff_reliability_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.seff_reliability_av";
    ...
    * @generated
    */
   protected Seff_avValidator seff_avValidator;
    ...
    * @generated
    */
   public Seff_reliability_avValidator() {
      super();
      identifier_avValidator = Identifier_avValidator.INSTANCE;
      seff_avValidator = Seff_avValidator.INSTANCE;
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Seff_reliability_avPackage.RECOVERY_ACTION_BEHAVIOUR:
            return validateRecoveryActionBehaviour((RecoveryActionBehaviour)value, diagnostics, context);
         case Seff_reliability_avPackage.RECOVERY_ACTION:
            return validateRecoveryAction((RecoveryAction)value, diagnostics, context);
         case Seff_reliability_avPackage.FAILURE_HANDLING_ENTITY:
   ...
   public boolean validateRecoveryActionBehaviour(RecoveryActionBehaviour recoveryActionBehaviour, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_avValidator.validateIdentifier_idHasToBeUnique(recoveryActionBehaviour, diagnostics, context);
      if (result || diagnostics != null) result &= seff_avValidator.validateResourceDemandingBehaviour_ExactlyOneStopAction(recoveryActionBehaviour, diagnostics, context);
      if (result || diagnostics != null) result &= seff_avValidator.validateResourceDemandingBehaviour_ExactlyOneStartAction(recoveryActionBehaviour, diagnostics, context);
      if (result || diagnostics != null) result &= seff_avValidator.validateResourceDemandingBehaviour_EachActionExceptStartActionandStopActionMustHhaveAPredecessorAndSuccessor(recoveryActionBehaviour, diagnostics, context);
   ...
   public boolean validateRecoveryAction(RecoveryAction recoveryAction, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_avValidator.validateIdentifier_idHasToBeUnique(recoveryAction, diagnostics, context);
   ...
   public boolean validateFailureHandlingEntity(FailureHandlingEntity failureHandlingEntity, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_avValidator.validateIdentifier_idHasToBeUnique(failureHandlingEntity, diagnostics, context);
      return result;
   }
