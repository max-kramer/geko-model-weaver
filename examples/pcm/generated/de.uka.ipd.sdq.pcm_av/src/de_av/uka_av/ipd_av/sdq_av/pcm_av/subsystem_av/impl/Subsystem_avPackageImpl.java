...
import de_av.uka_av.ipd_av.sdq_av.pcm_av.subsystem_av.SubSystem;
import de_av.uka_av.ipd_av.sdq_av.pcm_av.subsystem_av.Subsystem_avFactory;
 ...
 * @generated
 */
public class Subsystem_avPackageImpl extends EPackageImpl implements Subsystem_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.subsystem_av.Subsystem_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Subsystem_avPackageImpl() {
      super(eNS_URI, Subsystem_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Subsystem_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Subsystem_avPackage init() {
      if (isInited) return (Subsystem_avPackage)EPackage.Registry.INSTANCE.getEPackage(Subsystem_avPackage.eNS_URI);

      // Obtain or create and register package
      Subsystem_avPackageImpl theSubsystem_avPackage = (Subsystem_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Subsystem_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Subsystem_avPackageImpl());
      ...
      theSubsystem_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Subsystem_avPackage.eNS_URI, theSubsystem_avPackage);
      return theSubsystem_avPackage;
   }
    ...
    * @generated
    */
   public Subsystem_avFactory getSubsystem_avFactory() {
      return (Subsystem_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      subSystemEClass.getESuperTypes().add(theEntity_avPackage.getComposedProvidingRequiringEntity());
      subSystemEClass.getESuperTypes().add(theRepository_avPackage.getRepositoryComponent());
