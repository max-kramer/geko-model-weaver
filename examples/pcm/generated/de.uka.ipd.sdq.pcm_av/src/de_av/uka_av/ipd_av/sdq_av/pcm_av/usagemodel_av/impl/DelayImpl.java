 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.DelayImpl#getTimeSpecification_Delay <em>Time Specification Delay</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DelayImpl extends AbstractUserActionImpl implements Delay {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_avPackage.Literals.DELAY;
   }
   ...
   public NotificationChain basicSetTimeSpecification_Delay(PCMRandomVariable newTimeSpecification_Delay, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.DELAY__TIME_SPECIFICATION_DELAY, oldTimeSpecification_Delay, newTimeSpecification_Delay);
   ...
   public void setTimeSpecification_Delay(PCMRandomVariable newTimeSpecification_Delay) {
      if (newTimeSpecification_Delay != timeSpecification_Delay) {
         ...
         if (timeSpecification_Delay != null)
            msgs = ((InternalEObject)timeSpecification_Delay).eInverseRemove(this, Core_avPackage.PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION, PCMRandomVariable.class, msgs);
         if (newTimeSpecification_Delay != null)
            msgs = ((InternalEObject)newTimeSpecification_Delay).eInverseAdd(this, Core_avPackage.PCM_RANDOM_VARIABLE__DELAY_TIME_SPECIFICATION, PCMRandomVariable.class, msgs);
         msgs = basicSetTimeSpecification_Delay(newTimeSpecification_Delay, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.DELAY__TIME_SPECIFICATION_DELAY, newTimeSpecification_Delay, newTimeSpecification_Delay));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_avPackage.DELAY__TIME_SPECIFICATION_DELAY:
            if (timeSpecification_Delay != null)
               msgs = ((InternalEObject)timeSpecification_Delay).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Usagemodel_avPackage.DELAY__TIME_SPECIFICATION_DELAY, null, msgs);
