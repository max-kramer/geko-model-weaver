 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation#getTargetResourceEnvironment_Allocation <em>Target Resource Environment Allocation</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation#getSystem_Allocation <em>System Allocation</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation#getAllocationContexts_Allocation <em>Allocation Contexts Allocation</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation_av_avPackage#getAllocation()
 * @model
 * @generated
 */
public interface Allocation extends Entity {
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation_av_avPackage#getAllocation_TargetResourceEnvironment_Allocation()
    * @model ordered="false"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation#getTargetResourceEnvironment_Allocation <em>Target Resource Environment Allocation</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see #setSystem_Allocation(de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System)
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation_av_avPackage#getAllocation_System_Allocation()
    * @model ordered="false"
    * @generated
    */
   de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System getSystem_Allocation();

   /**
    * Sets the value of the '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation#getSystem_Allocation <em>System Allocation</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   void setSystem_Allocation(de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System value);

   /**
    * Returns the value of the '<em><b>Allocation Contexts Allocation</b></em>' containment reference list.
    * The list contents are of type {@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.AllocationContext}.
    * It is bidirectional and its opposite is '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.AllocationContext#getAllocation_AllocationContext <em>Allocation Allocation Context</em>}'.
    * <!-- begin-user-doc -->
    * <p>
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation_av_avPackage#getAllocation_AllocationContexts_Allocation()
