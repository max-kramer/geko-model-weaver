 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.impl.AllocationImpl#getTargetResourceEnvironment_Allocation <em>Target Resource Environment Allocation</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.impl.AllocationImpl#getSystem_Allocation <em>System Allocation</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.impl.AllocationImpl#getAllocationContexts_Allocation <em>Allocation Contexts Allocation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AllocationImpl extends EntityImpl implements Allocation {
    ...
    * @ordered
    */
   protected de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System system_Allocation;
   ...
   protected EClass eStaticClass() {
      return Allocation_av_avPackage.Literals.ALLOCATION;
   }
      ...
      if (targetResourceEnvironment_Allocation != null && targetResourceEnvironment_Allocation.eIsProxy()) {
         ...
         if (targetResourceEnvironment_Allocation != oldTargetResourceEnvironment_Allocation) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Allocation_av_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION, oldTargetResourceEnvironment_Allocation, targetResourceEnvironment_Allocation));
         }
      }
   ...
   public void setTargetResourceEnvironment_Allocation(ResourceEnvironment newTargetResourceEnvironment_Allocation) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Allocation_av_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION, oldTargetResourceEnvironment_Allocation, targetResourceEnvironment_Allocation));
   }
    ...
    * @generated
    */
   public de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System getSystem_Allocation() {
      if (system_Allocation != null && system_Allocation.eIsProxy()) {
         ...
         system_Allocation = (de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System)eResolveProxy(oldSystem_Allocation);
         if (system_Allocation != oldSystem_Allocation) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Allocation_av_avPackage.ALLOCATION__SYSTEM_ALLOCATION, oldSystem_Allocation, system_Allocation));
         }
      }
    ...
    * @generated
    */
   public de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System basicGetSystem_Allocation() {
      return system_Allocation;
   }
    ...
    * @generated
    */
   public void setSystem_Allocation(de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System newSystem_Allocation) {
      de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System oldSystem_Allocation = system_Allocation;
      system_Allocation = newSystem_Allocation;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Allocation_av_avPackage.ALLOCATION__SYSTEM_ALLOCATION, oldSystem_Allocation, system_Allocation));
   }
   ...
   public EList<AllocationContext> getAllocationContexts_Allocation() {
      if (allocationContexts_Allocation == null) {
         allocationContexts_Allocation = new EObjectContainmentWithInverseEList<AllocationContext>(AllocationContext.class, this, Allocation_av_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION, Allocation_av_avPackage.ALLOCATION_CONTEXT__ALLOCATION_ALLOCATION_CONTEXT);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Allocation_av_avValidator.ALLOCATION__EACH_ASSEMBLY_CONTEXT_WITHIN_SYSTEM_HAS_TO_BE_ALLOCATED_EXACTLY_ONCE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Allocation_av_avValidator.DIAGNOSTIC_SOURCE,
                   Allocation_av_avValidator.ALLOCATION__COMMUNICATING_SERVERS_HAVE_TO_BE_CONNECTED_BY_LINKING_RESOURCE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Allocation_av_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Allocation_av_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
            if (resolve) return getTargetResourceEnvironment_Allocation();
            return basicGetTargetResourceEnvironment_Allocation();
         case Allocation_av_avPackage.ALLOCATION__SYSTEM_ALLOCATION:
   ...
   public void eSet(int featureID, Object newValue) {
      switch (featureID) {
         case Allocation_av_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
            ...
            return;
         case Allocation_av_avPackage.ALLOCATION__SYSTEM_ALLOCATION:
            setSystem_Allocation((de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System)newValue);
            return;
         case Allocation_av_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
   ...
   public void eUnset(int featureID) {
      switch (featureID) {
         case Allocation_av_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
            ...
            return;
         case Allocation_av_avPackage.ALLOCATION__SYSTEM_ALLOCATION:
            setSystem_Allocation((de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System)null);
            return;
         case Allocation_av_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
            getAllocationContexts_Allocation().clear();
            return;
