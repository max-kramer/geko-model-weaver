 ...
 * @generated
 */
public class Allocation_av_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Allocation_av_avPackage modelPackage;
    ...
    * @generated
    */
   public Allocation_av_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Allocation_av_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Allocation_av_avSwitch<Adapter> modelSwitch =
      new Allocation_av_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.AllocationContext <em>Allocation Context</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.allocation_av_av.Allocation <em>Allocation</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Allocation_av_avAdapterFactory
