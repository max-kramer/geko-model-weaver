 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.composition_av_av.impl.EventChannelSourceConnectorImpl#getSourceRole__EventChannelSourceRole <em>Source Role Event Channel Source Role</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.composition_av_av.impl.EventChannelSourceConnectorImpl#getAssemblyContext__EventChannelSourceConnector <em>Assembly Context Event Channel Source Connector</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.composition_av_av.impl.EventChannelSourceConnectorImpl#getEventChannel__EventChannelSourceConnector <em>Event Channel Event Channel Source Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventChannelSourceConnectorImpl extends ConnectorImpl implements EventChannelSourceConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_av_avPackage.Literals.EVENT_CHANNEL_SOURCE_CONNECTOR;
   }
      ...
      if (sourceRole__EventChannelSourceRole != null && sourceRole__EventChannelSourceRole.eIsProxy()) {
         ...
         if (sourceRole__EventChannelSourceRole != oldSourceRole__EventChannelSourceRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__SOURCE_ROLE_EVENT_CHANNEL_SOURCE_ROLE, oldSourceRole__EventChannelSourceRole, sourceRole__EventChannelSourceRole));
         }
      }
   ...
   public void setSourceRole__EventChannelSourceRole(SourceRole newSourceRole__EventChannelSourceRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__SOURCE_ROLE_EVENT_CHANNEL_SOURCE_ROLE, oldSourceRole__EventChannelSourceRole, sourceRole__EventChannelSourceRole));
   }
   ...
   public AssemblyContext getAssemblyContext__EventChannelSourceConnector() {
      if (assemblyContext__EventChannelSourceConnector != null && assemblyContext__EventChannelSourceConnector.eIsProxy()) {
         ...
         if (assemblyContext__EventChannelSourceConnector != oldAssemblyContext__EventChannelSourceConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__ASSEMBLY_CONTEXT_EVENT_CHANNEL_SOURCE_CONNECTOR, oldAssemblyContext__EventChannelSourceConnector, assemblyContext__EventChannelSourceConnector));
         }
      }
   ...
   public void setAssemblyContext__EventChannelSourceConnector(AssemblyContext newAssemblyContext__EventChannelSourceConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__ASSEMBLY_CONTEXT_EVENT_CHANNEL_SOURCE_CONNECTOR, oldAssemblyContext__EventChannelSourceConnector, assemblyContext__EventChannelSourceConnector));
   }
   ...
   public EventChannel getEventChannel__EventChannelSourceConnector() {
      if (eventChannel__EventChannelSourceConnector != null && eventChannel__EventChannelSourceConnector.eIsProxy()) {
         ...
         if (eventChannel__EventChannelSourceConnector != oldEventChannel__EventChannelSourceConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SOURCE_CONNECTOR, oldEventChannel__EventChannelSourceConnector, eventChannel__EventChannelSourceConnector));
         }
      }
   ...
   public NotificationChain basicSetEventChannel__EventChannelSourceConnector(EventChannel newEventChannel__EventChannelSourceConnector, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SOURCE_CONNECTOR, oldEventChannel__EventChannelSourceConnector, newEventChannel__EventChannelSourceConnector);
   ...
   public void setEventChannel__EventChannelSourceConnector(EventChannel newEventChannel__EventChannelSourceConnector) {
      if (newEventChannel__EventChannelSourceConnector != eventChannel__EventChannelSourceConnector) {
         ...
         if (eventChannel__EventChannelSourceConnector != null)
            msgs = ((InternalEObject)eventChannel__EventChannelSourceConnector).eInverseRemove(this, Composition_av_avPackage.EVENT_CHANNEL__EVENT_CHANNEL_SOURCE_CONNECTOR_EVENT_CHANNEL, EventChannel.class, msgs);
         if (newEventChannel__EventChannelSourceConnector != null)
            msgs = ((InternalEObject)newEventChannel__EventChannelSourceConnector).eInverseAdd(this, Composition_av_avPackage.EVENT_CHANNEL__EVENT_CHANNEL_SOURCE_CONNECTOR_EVENT_CHANNEL, EventChannel.class, msgs);
         msgs = basicSetEventChannel__EventChannelSourceConnector(newEventChannel__EventChannelSourceConnector, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SOURCE_CONNECTOR, newEventChannel__EventChannelSourceConnector, newEventChannel__EventChannelSourceConnector));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SOURCE_CONNECTOR:
            if (eventChannel__EventChannelSourceConnector != null)
               msgs = ((InternalEObject)eventChannel__EventChannelSourceConnector).eInverseRemove(this, Composition_av_avPackage.EVENT_CHANNEL__EVENT_CHANNEL_SOURCE_CONNECTOR_EVENT_CHANNEL, EventChannel.class, msgs);
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__SOURCE_ROLE_EVENT_CHANNEL_SOURCE_ROLE:
            if (resolve) return getSourceRole__EventChannelSourceRole();
            return basicGetSourceRole__EventChannelSourceRole();
         case Composition_av_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR__ASSEMBLY_CONTEXT_EVENT_CHANNEL_SOURCE_CONNECTOR:
