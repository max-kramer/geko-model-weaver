 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.entity_av_av.impl.NamedElementImpl#getEntityName <em>Entity Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamedElementImpl extends EObjectImpl implements NamedElement {
   ...
   protected EClass eStaticClass() {
      return Entity_av_avPackage.Literals.NAMED_ELEMENT;
   }
   ...
   public void setEntityName(String newEntityName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Entity_av_avPackage.NAMED_ELEMENT__ENTITY_NAME, oldEntityName, entityName));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Entity_av_avPackage.NAMED_ELEMENT__ENTITY_NAME:
