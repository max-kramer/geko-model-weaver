 ...
 * @generated
 */
public class Qos_performance_av_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Qos_performance_av_avValidator INSTANCE = new Qos_performance_av_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.qosannotations_av_av.qos_performance_av_av";
    ...
    * @generated
    */
   public Qos_performance_av_avValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Qos_performance_av_avPackage.SYSTEM_SPECIFIED_EXECUTION_TIME:
            return validateSystemSpecifiedExecutionTime((SystemSpecifiedExecutionTime)value, diagnostics, context);
         case Qos_performance_av_avPackage.SPECIFIED_EXECUTION_TIME:
            return validateSpecifiedExecutionTime((SpecifiedExecutionTime)value, diagnostics, context);
         case Qos_performance_av_avPackage.COMPONENT_SPECIFIED_EXECUTION_TIME:
...
} //Qos_performance_av_avValidator
