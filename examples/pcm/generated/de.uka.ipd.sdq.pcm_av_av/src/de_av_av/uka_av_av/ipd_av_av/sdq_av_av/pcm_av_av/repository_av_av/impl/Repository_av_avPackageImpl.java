...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.CollectionDataType;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.CompleteComponentType;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ComponentType;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.CompositeComponent;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.CompositeDataType;
...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ImplementationComponentType;
...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.InnerDeclaration;
...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.PrimitiveDataType;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.PrimitiveTypeEnum;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ProvidedRole;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ProvidesComponentType;
...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.Repository_av_avFactory;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.Repository_av_avPackage;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.RequiredCharacterisation;
 ...
 * @generated
 */
public class Repository_av_avPackageImpl extends EPackageImpl implements Repository_av_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.Repository_av_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Repository_av_avPackageImpl() {
      super(eNS_URI, Repository_av_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Repository_av_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Repository_av_avPackage init() {
      if (isInited) return (Repository_av_avPackage)EPackage.Registry.INSTANCE.getEPackage(Repository_av_avPackage.eNS_URI);

      // Obtain or create and register package
      Repository_av_avPackageImpl theRepository_av_avPackage = (Repository_av_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Repository_av_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Repository_av_avPackageImpl());
         ...
         (theRepository_av_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Repository_av_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theRepository_av_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Repository_av_avPackage.eNS_URI, theRepository_av_avPackage);
      return theRepository_av_avPackage;
   }
    ...
    * @generated
    */
   public Repository_av_avFactory getRepository_av_avFactory() {
      return (Repository_av_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      passiveResourceEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      ...
      repositoryComponentEClass.getESuperTypes().add(theEntity_av_avPackage.getInterfaceProvidingRequiringEntity());
      providedRoleEClass.getESuperTypes().add(this.getRole());
      repositoryEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      interfaceEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      eventGroupEClass.getESuperTypes().add(this.getInterface());
      eventTypeEClass.getESuperTypes().add(this.getSignature());
      signatureEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      ...
      compositeComponentEClass.getESuperTypes().add(theEntity_av_avPackage.getComposedProvidingRequiringEntity());
      ...
      collectionDataTypeEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      collectionDataTypeEClass.getESuperTypes().add(this.getDataType());
      compositeDataTypeEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      compositeDataTypeEClass.getESuperTypes().add(this.getDataType());
      innerDeclarationEClass.getESuperTypes().add(theEntity_av_avPackage.getNamedElement());
      roleEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      ...
      initEReference(getPassiveResource_Capacity_PassiveResource(), theCore_av_avPackage.getPCMRandomVariable(), theCore_av_avPackage.getPCMRandomVariable_PassiveResource_capacity_PCMRandomVariable(), "capacity_PassiveResource", null, 0, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getProvidedRole_ProvidingEntity_ProvidedRole(), theEntity_av_avPackage.getInterfaceProvidingEntity(), theEntity_av_avPackage.getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity(), "providingEntity_ProvidedRole", null, 0, 1, ProvidedRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getParameter_ResourceSignature__Parameter(), theResourcetype_av_avPackage.getResourceSignature(), theResourcetype_av_avPackage.getResourceSignature_Parameter__ResourceSignature(), "resourceSignature__Parameter", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getRepository_FailureTypes__Repository(), theReliability_av_avPackage.getFailureType(), theReliability_av_avPackage.getFailureType_Repository__FailureType(), "failureTypes__Repository", null, 0, -1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getInterface_Protocols__Interface(), theProtocol_av_avPackage.getProtocol(), null, "protocols__Interface", null, 0, -1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEAttribute(getRequiredCharacterisation_Type(), theParameter_av_avPackage.getVariableCharacterisationType(), "type", null, 1, 1, RequiredCharacterisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getSignature_FailureType(), theReliability_av_avPackage.getFailureType(), null, "failureType", null, 0, -1, Signature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
