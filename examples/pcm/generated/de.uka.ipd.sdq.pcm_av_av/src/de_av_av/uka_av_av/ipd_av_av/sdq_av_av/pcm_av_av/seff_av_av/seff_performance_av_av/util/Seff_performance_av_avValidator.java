 ...
 * @generated
 */
public class Seff_performance_av_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Seff_performance_av_avValidator INSTANCE = new Seff_performance_av_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.seff_performance_av_av";
    ...
    * @generated
    */
   public Seff_performance_av_avValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Seff_performance_av_avPackage.INFRASTRUCTURE_CALL:
            return validateInfrastructureCall((InfrastructureCall)value, diagnostics, context);
         case Seff_performance_av_avPackage.RESOURCE_CALL:
            return validateResourceCall((ResourceCall)value, diagnostics, context);
         case Seff_performance_av_avPackage.PARAMETRIC_RESOURCE_DEMAND:
...
} //Seff_performance_av_avValidator
