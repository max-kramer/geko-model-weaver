...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.seff_reliability_av_av.Seff_reliability_av_avFactory;
 ...
 * @generated
 */
public class Seff_reliability_av_avPackageImpl extends EPackageImpl implements Seff_reliability_av_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.seff_reliability_av_av.Seff_reliability_av_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Seff_reliability_av_avPackageImpl() {
      super(eNS_URI, Seff_reliability_av_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Seff_reliability_av_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Seff_reliability_av_avPackage init() {
      if (isInited) return (Seff_reliability_av_avPackage)EPackage.Registry.INSTANCE.getEPackage(Seff_reliability_av_avPackage.eNS_URI);

      // Obtain or create and register package
      Seff_reliability_av_avPackageImpl theSeff_reliability_av_avPackage = (Seff_reliability_av_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Seff_reliability_av_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Seff_reliability_av_avPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theSeff_reliability_av_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Seff_reliability_av_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSeff_reliability_av_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Seff_reliability_av_avPackage.eNS_URI, theSeff_reliability_av_avPackage);
      return theSeff_reliability_av_avPackage;
   }
    ...
    * @generated
    */
   public Seff_reliability_av_avFactory getSeff_reliability_av_avFactory() {
      return (Seff_reliability_av_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      recoveryActionBehaviourEClass.getESuperTypes().add(theSeff_av_avPackage.getResourceDemandingBehaviour());
      recoveryActionEClass.getESuperTypes().add(theSeff_av_avPackage.getAbstractInternalControlFlowAction());
      failureHandlingEntityEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
