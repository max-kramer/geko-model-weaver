 ...
 * @generated
 */
public class Usagemodel_av_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Usagemodel_av_avValidator INSTANCE = new Usagemodel_av_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.usagemodel_av_av";
    ...
    * @generated
    */
   public Usagemodel_av_avValidator() {
      super();
   ...
   public boolean validateUsageScenario(UsageScenario usageScenario, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(usageScenario, diagnostics, context);
      return result;
   }
   ...
   public boolean validateEntryLevelSystemCall(EntryLevelSystemCall entryLevelSystemCall, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(entryLevelSystemCall, diagnostics, context);
   ...
   public boolean validateAbstractUserAction(AbstractUserAction abstractUserAction, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(abstractUserAction, diagnostics, context);
      return result;
   }
   ...
   public boolean validateScenarioBehaviour(ScenarioBehaviour scenarioBehaviour, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(scenarioBehaviour, diagnostics, context);
   ...
   public boolean validateBranch(Branch branch, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(branch, diagnostics, context);
   ...
   public boolean validateLoop(Loop loop, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(loop, diagnostics, context);
      return result;
   }
   ...
   public boolean validateStop(Stop stop, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(stop, diagnostics, context);
   ...
   public boolean validateStart(Start start, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(start, diagnostics, context);
   ...
   public boolean validateDelay(Delay delay, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(delay, diagnostics, context);
      return result;
   }
