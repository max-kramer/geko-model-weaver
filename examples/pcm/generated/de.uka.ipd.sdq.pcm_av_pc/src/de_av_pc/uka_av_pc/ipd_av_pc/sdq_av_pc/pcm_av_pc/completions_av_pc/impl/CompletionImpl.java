 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.completions_av_pc.impl.CompletionImpl#getRepository__RepositoryComponent <em>Repository Repository Component</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.completions_av_pc.impl.CompletionImpl#getParentCompleteComponentTypes <em>Parent Complete Component Types</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.completions_av_pc.impl.CompletionImpl#getComponentParameterUsage_ImplementationComponentType <em>Component Parameter Usage Implementation Component Type</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.completions_av_pc.impl.CompletionImpl#getComponentType <em>Component Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompletionImpl extends ComposedProvidingRequiringEntityImpl implements Completion {
   ...
   protected EClass eStaticClass() {
      return Completions_av_pcPackage.Literals.COMPLETION;
   }
   ...
   public Repository getRepository__RepositoryComponent() {
      if (eContainerFeatureID() != Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT) return null;
   ...
   public NotificationChain basicSetRepository__RepositoryComponent(Repository newRepository__RepositoryComponent, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__RepositoryComponent, Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT, msgs);
      return msgs;
   }
   ...
   public void setRepository__RepositoryComponent(Repository newRepository__RepositoryComponent) {
      if (newRepository__RepositoryComponent != eInternalContainer() || (eContainerFeatureID() != Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT && newRepository__RepositoryComponent != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT, newRepository__RepositoryComponent, newRepository__RepositoryComponent));
   }
   ...
   public EList<CompleteComponentType> getParentCompleteComponentTypes() {
      if (parentCompleteComponentTypes == null) {
         parentCompleteComponentTypes = new EObjectResolvingEList<CompleteComponentType>(CompleteComponentType.class, this, Completions_av_pcPackage.COMPLETION__PARENT_COMPLETE_COMPONENT_TYPES);
      }
   ...
   public EList<VariableUsage> getComponentParameterUsage_ImplementationComponentType() {
      if (componentParameterUsage_ImplementationComponentType == null) {
         componentParameterUsage_ImplementationComponentType = new EObjectContainmentEList<VariableUsage>(VariableUsage.class, this, Completions_av_pcPackage.COMPLETION__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE);
      }
   ...
   public void setComponentType(ComponentType newComponentType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Completions_av_pcPackage.COMPLETION__COMPONENT_TYPE, oldComponentType, componentType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         ...
         case Completions_av_pcPackage.COMPLETION__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Completions_av_pcPackage.COMPLETION__PARENT_COMPLETE_COMPONENT_TYPES:
            return getParentCompleteComponentTypes();
         case Completions_av_pcPackage.COMPLETION__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE:
            return getComponentParameterUsage_ImplementationComponentType();
         case Completions_av_pcPackage.COMPLETION__COMPONENT_TYPE:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == RepositoryComponent.class) {
         switch (derivedFeatureID) {
            case Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT: return Repository_av_pcPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT;
            default: return -1;
         }
      }
      if (baseClass == ImplementationComponentType.class) {
         switch (derivedFeatureID) {
            case Completions_av_pcPackage.COMPLETION__PARENT_COMPLETE_COMPONENT_TYPES: return Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE__PARENT_COMPLETE_COMPONENT_TYPES;
            case Completions_av_pcPackage.COMPLETION__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE: return Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE;
            case Completions_av_pcPackage.COMPLETION__COMPONENT_TYPE: return Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == RepositoryComponent.class) {
         switch (baseFeatureID) {
            case Repository_av_pcPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT: return Completions_av_pcPackage.COMPLETION__REPOSITORY_REPOSITORY_COMPONENT;
            default: return -1;
         }
      }
      if (baseClass == ImplementationComponentType.class) {
         switch (baseFeatureID) {
            case Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE__PARENT_COMPLETE_COMPONENT_TYPES: return Completions_av_pcPackage.COMPLETION__PARENT_COMPLETE_COMPONENT_TYPES;
            case Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE: return Completions_av_pcPackage.COMPLETION__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE;
            case Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_TYPE: return Completions_av_pcPackage.COMPLETION__COMPONENT_TYPE;
            default: return -1;
         }
      }
