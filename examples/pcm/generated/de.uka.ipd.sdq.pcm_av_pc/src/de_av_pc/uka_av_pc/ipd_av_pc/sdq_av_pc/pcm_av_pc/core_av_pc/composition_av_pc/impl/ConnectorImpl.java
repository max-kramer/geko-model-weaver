 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.ConnectorImpl#getParentStructure__Connector <em>Parent Structure Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConnectorImpl extends EntityImpl implements Connector {
   ...
   protected EClass eStaticClass() {
      return Composition_av_pcPackage.Literals.CONNECTOR;
   }
   ...
   public ComposedStructure getParentStructure__Connector() {
      if (eContainerFeatureID() != Composition_av_pcPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR) return null;
   ...
   public NotificationChain basicSetParentStructure__Connector(ComposedStructure newParentStructure__Connector, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newParentStructure__Connector, Composition_av_pcPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR, msgs);
      return msgs;
   }
   ...
   public void setParentStructure__Connector(ComposedStructure newParentStructure__Connector) {
      if (newParentStructure__Connector != eInternalContainer() || (eContainerFeatureID() != Composition_av_pcPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR && newParentStructure__Connector != null)) {
         ...
         if (newParentStructure__Connector != null)
            msgs = ((InternalEObject)newParentStructure__Connector).eInverseAdd(this, Composition_av_pcPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE, ComposedStructure.class, msgs);
         msgs = basicSetParentStructure__Connector(newParentStructure__Connector, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR, newParentStructure__Connector, newParentStructure__Connector));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Composition_av_pcPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Composition_av_pcPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR:
            return eInternalContainer().eInverseRemove(this, Composition_av_pcPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE, ComposedStructure.class, msgs);
      }
