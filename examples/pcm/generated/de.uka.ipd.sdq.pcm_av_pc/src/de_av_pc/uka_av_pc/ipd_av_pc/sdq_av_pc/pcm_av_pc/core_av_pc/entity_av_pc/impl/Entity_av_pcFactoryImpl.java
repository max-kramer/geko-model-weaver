 ...
 * @generated
 */
public class Entity_av_pcFactoryImpl extends EFactoryImpl implements Entity_av_pcFactory {
   /**
    ...
    * @generated
    */
   public static Entity_av_pcFactory init() {
      try {
         Entity_av_pcFactory theEntity_av_pcFactory = (Entity_av_pcFactory)EPackage.Registry.INSTANCE.getEFactory(Entity_av_pcPackage.eNS_URI);
         if (theEntity_av_pcFactory != null) {
            return theEntity_av_pcFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Entity_av_pcFactoryImpl();
   }
    ...
    * @generated
    */
   public Entity_av_pcFactoryImpl() {
      super();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Entity_av_pcPackage.RESOURCE_PROVIDED_ROLE: return createResourceProvidedRole();
         case Entity_av_pcPackage.INTERFACE_PROVIDING_REQUIRING_ENTITY: return createInterfaceProvidingRequiringEntity();
         case Entity_av_pcPackage.INTERFACE_PROVIDING_ENTITY: return createInterfaceProvidingEntity();
         case Entity_av_pcPackage.INTERFACE_REQUIRING_ENTITY: return createInterfaceRequiringEntity();
         case Entity_av_pcPackage.RESOURCE_INTERFACE_REQUIRING_ENTITY: return createResourceInterfaceRequiringEntity();
         case Entity_av_pcPackage.RESOURCE_REQUIRED_ROLE: return createResourceRequiredRole();
         case Entity_av_pcPackage.RESOURCE_INTERFACE_PROVIDING_ENTITY: return createResourceInterfaceProvidingEntity();
         case Entity_av_pcPackage.COMPOSED_PROVIDING_REQUIRING_ENTITY: return createComposedProvidingRequiringEntity();
         case Entity_av_pcPackage.NAMED_ELEMENT: return createNamedElement();
         case Entity_av_pcPackage.RESOURCE_INTERFACE_PROVIDING_REQUIRING_ENTITY: return createResourceInterfaceProvidingRequiringEntity();
         case Entity_av_pcPackage.ENTITY: return createEntity();
         default:
    ...
    * @generated
    */
   public Entity_av_pcPackage getEntity_av_pcPackage() {
      return (Entity_av_pcPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Entity_av_pcPackage getPackage() {
      return Entity_av_pcPackage.eINSTANCE;
   }

} //Entity_av_pcFactoryImpl
