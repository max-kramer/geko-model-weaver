 ...
 * @generated
 */
public class Core_av_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   public Core_av_pcAdapterFactory() {
    ...
    * @generated
    */
   protected Core_av_pcSwitch<Adapter> modelSwitch =
      new Core_av_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.PCMRandomVariable <em>PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
