 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.impl.PointcutImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointcutImpl extends EObjectImpl implements Pointcut {
   ...
   protected EClass eStaticClass() {
      return Pcm_av_pcPackage.Literals.POINTCUT;
   }
   ...
   public EList<EObject> getChildren() {
      if (children == null) {
         children = new EObjectContainmentEList<EObject>(EObject.class, this, Pcm_av_pcPackage.POINTCUT__CHILDREN);
      }
      return children;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Pcm_av_pcPackage.POINTCUT__CHILDREN:
