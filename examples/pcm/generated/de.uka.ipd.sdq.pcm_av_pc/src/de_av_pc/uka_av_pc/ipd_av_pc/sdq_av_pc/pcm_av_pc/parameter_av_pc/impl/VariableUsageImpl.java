 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getVariableCharacterisation_VariableUsage <em>Variable Characterisation Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getUserData_VariableUsage <em>User Data Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getCallAction__VariableUsage <em>Call Action Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getSynchronisationPoint_VariableUsage <em>Synchronisation Point Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getCallReturnAction__VariableUsage <em>Call Return Action Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getSetVariableAction_VariableUsage <em>Set Variable Action Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage <em>Specified Output Parameter Abstraction expected External Outputs Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getAssemblyContext__VariableUsage <em>Assembly Context Variable Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getEntryLevelSystemCall_InputParameterUsage <em>Entry Level System Call Input Parameter Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getEntryLevelSystemCall_OutputParameterUsage <em>Entry Level System Call Output Parameter Usage</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.parameter_av_pc.impl.VariableUsageImpl#getNamedReference__VariableUsage <em>Named Reference Variable Usage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableUsageImpl extends EObjectImpl implements VariableUsage {
   ...
   protected EClass eStaticClass() {
      return Parameter_av_pcPackage.Literals.VARIABLE_USAGE;
   }
   ...
   public UserData getUserData_VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetUserData_VariableUsage(UserData newUserData_VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUserData_VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setUserData_VariableUsage(UserData newUserData_VariableUsage) {
      if (newUserData_VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE && newUserData_VariableUsage != null)) {
         ...
         if (newUserData_VariableUsage != null)
            msgs = ((InternalEObject)newUserData_VariableUsage).eInverseAdd(this, Usagemodel_av_pcPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA, UserData.class, msgs);
         msgs = basicSetUserData_VariableUsage(newUserData_VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE, newUserData_VariableUsage, newUserData_VariableUsage));
   }
   ...
   public CallAction getCallAction__VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetCallAction__VariableUsage(CallAction newCallAction__VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newCallAction__VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setCallAction__VariableUsage(CallAction newCallAction__VariableUsage) {
      if (newCallAction__VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE && newCallAction__VariableUsage != null)) {
         ...
         if (newCallAction__VariableUsage != null)
            msgs = ((InternalEObject)newCallAction__VariableUsage).eInverseAdd(this, Seff_av_pcPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION, CallAction.class, msgs);
         msgs = basicSetCallAction__VariableUsage(newCallAction__VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE, newCallAction__VariableUsage, newCallAction__VariableUsage));
   }
   ...
   public SynchronisationPoint getSynchronisationPoint_VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetSynchronisationPoint_VariableUsage(SynchronisationPoint newSynchronisationPoint_VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newSynchronisationPoint_VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setSynchronisationPoint_VariableUsage(SynchronisationPoint newSynchronisationPoint_VariableUsage) {
      if (newSynchronisationPoint_VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE && newSynchronisationPoint_VariableUsage != null)) {
         ...
         if (newSynchronisationPoint_VariableUsage != null)
            msgs = ((InternalEObject)newSynchronisationPoint_VariableUsage).eInverseAdd(this, Seff_av_pcPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT, SynchronisationPoint.class, msgs);
         msgs = basicSetSynchronisationPoint_VariableUsage(newSynchronisationPoint_VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE, newSynchronisationPoint_VariableUsage, newSynchronisationPoint_VariableUsage));
   }
   ...
   public CallReturnAction getCallReturnAction__VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetCallReturnAction__VariableUsage(CallReturnAction newCallReturnAction__VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newCallReturnAction__VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setCallReturnAction__VariableUsage(CallReturnAction newCallReturnAction__VariableUsage) {
      if (newCallReturnAction__VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE && newCallReturnAction__VariableUsage != null)) {
         ...
         if (newCallReturnAction__VariableUsage != null)
            msgs = ((InternalEObject)newCallReturnAction__VariableUsage).eInverseAdd(this, Seff_av_pcPackage.CALL_RETURN_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION, CallReturnAction.class, msgs);
         msgs = basicSetCallReturnAction__VariableUsage(newCallReturnAction__VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE, newCallReturnAction__VariableUsage, newCallReturnAction__VariableUsage));
   }
   ...
   public SetVariableAction getSetVariableAction_VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetSetVariableAction_VariableUsage(SetVariableAction newSetVariableAction_VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newSetVariableAction_VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setSetVariableAction_VariableUsage(SetVariableAction newSetVariableAction_VariableUsage) {
      if (newSetVariableAction_VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE && newSetVariableAction_VariableUsage != null)) {
         ...
         if (newSetVariableAction_VariableUsage != null)
            msgs = ((InternalEObject)newSetVariableAction_VariableUsage).eInverseAdd(this, Seff_av_pcPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION, SetVariableAction.class, msgs);
         msgs = basicSetSetVariableAction_VariableUsage(newSetVariableAction_VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE, newSetVariableAction_VariableUsage, newSetVariableAction_VariableUsage));
   }
   ...
   public SpecifiedOutputParameterAbstraction getSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage(SpecifiedOutputParameterAbstraction newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage(SpecifiedOutputParameterAbstraction newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage) {
      if (newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE && newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage != null)) {
         ...
         if (newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage != null)
            msgs = ((InternalEObject)newSpecifiedOutputParameterAbstraction_expectedExternalOutputs_VariableUsage).eInverseAdd(this, Qosannotations_av_pcPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__EXPECTED_EXTERNAL_OUTPUTS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION, SpecifiedOutputParameterAbstraction.class, msgs);
   ...
   public AssemblyContext getAssemblyContext__VariableUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE) return null;
   ...
   public NotificationChain basicSetAssemblyContext__VariableUsage(AssemblyContext newAssemblyContext__VariableUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newAssemblyContext__VariableUsage, Parameter_av_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE, msgs);
      return msgs;
   }
   ...
   public void setAssemblyContext__VariableUsage(AssemblyContext newAssemblyContext__VariableUsage) {
      if (newAssemblyContext__VariableUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE && newAssemblyContext__VariableUsage != null)) {
         ...
         if (newAssemblyContext__VariableUsage != null)
            msgs = ((InternalEObject)newAssemblyContext__VariableUsage).eInverseAdd(this, Composition_av_pcPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT, AssemblyContext.class, msgs);
         msgs = basicSetAssemblyContext__VariableUsage(newAssemblyContext__VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE, newAssemblyContext__VariableUsage, newAssemblyContext__VariableUsage));
   }
   ...
   public EntryLevelSystemCall getEntryLevelSystemCall_InputParameterUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE) return null;
   ...
   public NotificationChain basicSetEntryLevelSystemCall_InputParameterUsage(EntryLevelSystemCall newEntryLevelSystemCall_InputParameterUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newEntryLevelSystemCall_InputParameterUsage, Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE, msgs);
      return msgs;
   }
   ...
   public void setEntryLevelSystemCall_InputParameterUsage(EntryLevelSystemCall newEntryLevelSystemCall_InputParameterUsage) {
      if (newEntryLevelSystemCall_InputParameterUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE && newEntryLevelSystemCall_InputParameterUsage != null)) {
         ...
         if (newEntryLevelSystemCall_InputParameterUsage != null)
            msgs = ((InternalEObject)newEntryLevelSystemCall_InputParameterUsage).eInverseAdd(this, Usagemodel_av_pcPackage.ENTRY_LEVEL_SYSTEM_CALL__INPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL, EntryLevelSystemCall.class, msgs);
         msgs = basicSetEntryLevelSystemCall_InputParameterUsage(newEntryLevelSystemCall_InputParameterUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE, newEntryLevelSystemCall_InputParameterUsage, newEntryLevelSystemCall_InputParameterUsage));
   }
   ...
   public EntryLevelSystemCall getEntryLevelSystemCall_OutputParameterUsage() {
      if (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE) return null;
      return (EntryLevelSystemCall)eInternalContainer();
   }
   ...
   public NotificationChain basicSetEntryLevelSystemCall_OutputParameterUsage(EntryLevelSystemCall newEntryLevelSystemCall_OutputParameterUsage, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newEntryLevelSystemCall_OutputParameterUsage, Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE, msgs);
      return msgs;
   }
   ...
   public void setEntryLevelSystemCall_OutputParameterUsage(EntryLevelSystemCall newEntryLevelSystemCall_OutputParameterUsage) {
      if (newEntryLevelSystemCall_OutputParameterUsage != eInternalContainer() || (eContainerFeatureID() != Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE && newEntryLevelSystemCall_OutputParameterUsage != null)) {
         ...
         if (newEntryLevelSystemCall_OutputParameterUsage != null)
            msgs = ((InternalEObject)newEntryLevelSystemCall_OutputParameterUsage).eInverseAdd(this, Usagemodel_av_pcPackage.ENTRY_LEVEL_SYSTEM_CALL__OUTPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL, EntryLevelSystemCall.class, msgs);
         msgs = basicSetEntryLevelSystemCall_OutputParameterUsage(newEntryLevelSystemCall_OutputParameterUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE, newEntryLevelSystemCall_OutputParameterUsage, newEntryLevelSystemCall_OutputParameterUsage));
   }
   ...
   public NotificationChain basicSetNamedReference__VariableUsage(AbstractNamedReference newNamedReference__VariableUsage, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__NAMED_REFERENCE_VARIABLE_USAGE, oldNamedReference__VariableUsage, newNamedReference__VariableUsage);
   ...
   public void setNamedReference__VariableUsage(AbstractNamedReference newNamedReference__VariableUsage) {
      if (newNamedReference__VariableUsage != namedReference__VariableUsage) {
         ...
         if (namedReference__VariableUsage != null)
            msgs = ((InternalEObject)namedReference__VariableUsage).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Parameter_av_pcPackage.VARIABLE_USAGE__NAMED_REFERENCE_VARIABLE_USAGE, null, msgs);
         if (newNamedReference__VariableUsage != null)
            msgs = ((InternalEObject)newNamedReference__VariableUsage).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Parameter_av_pcPackage.VARIABLE_USAGE__NAMED_REFERENCE_VARIABLE_USAGE, null, msgs);
         msgs = basicSetNamedReference__VariableUsage(newNamedReference__VariableUsage, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_av_pcPackage.VARIABLE_USAGE__NAMED_REFERENCE_VARIABLE_USAGE, newNamedReference__VariableUsage, newNamedReference__VariableUsage));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Parameter_av_pcPackage.VARIABLE_USAGE__VARIABLE_CHARACTERISATION_VARIABLE_USAGE:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getVariableCharacterisation_VariableUsage()).basicAdd(otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetUserData_VariableUsage((UserData)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetCallAction__VariableUsage((CallAction)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetSynchronisationPoint_VariableUsage((SynchronisationPoint)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetCallReturnAction__VariableUsage((CallReturnAction)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetSetVariableAction_VariableUsage((SetVariableAction)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
         ...
         case Parameter_av_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetAssemblyContext__VariableUsage((AssemblyContext)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetEntryLevelSystemCall_InputParameterUsage((EntryLevelSystemCall)otherEnd, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         ...
         case Parameter_av_pcPackage.VARIABLE_USAGE__NAMED_REFERENCE_VARIABLE_USAGE:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Parameter_av_pcPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Usagemodel_av_pcPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA, UserData.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Seff_av_pcPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION, CallAction.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Seff_av_pcPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT, SynchronisationPoint.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Seff_av_pcPackage.CALL_RETURN_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION, CallReturnAction.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Seff_av_pcPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION, SetVariableAction.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION_EXPECTED_EXTERNAL_OUTPUTS_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Qosannotations_av_pcPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION__EXPECTED_EXTERNAL_OUTPUTS_SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION, SpecifiedOutputParameterAbstraction.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE:
            return eInternalContainer().eInverseRemove(this, Composition_av_pcPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT, AssemblyContext.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_INPUT_PARAMETER_USAGE:
            return eInternalContainer().eInverseRemove(this, Usagemodel_av_pcPackage.ENTRY_LEVEL_SYSTEM_CALL__INPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL, EntryLevelSystemCall.class, msgs);
         case Parameter_av_pcPackage.VARIABLE_USAGE__ENTRY_LEVEL_SYSTEM_CALL_OUTPUT_PARAMETER_USAGE:
            return eInternalContainer().eInverseRemove(this, Usagemodel_av_pcPackage.ENTRY_LEVEL_SYSTEM_CALL__OUTPUT_PARAMETER_USAGES_ENTRY_LEVEL_SYSTEM_CALL, EntryLevelSystemCall.class, msgs);
      }
