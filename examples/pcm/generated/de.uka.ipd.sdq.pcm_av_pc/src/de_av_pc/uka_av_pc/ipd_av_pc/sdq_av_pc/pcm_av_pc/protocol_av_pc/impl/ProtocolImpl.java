 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.protocol_av_pc.impl.ProtocolImpl#getProtocolTypeID <em>Protocol Type ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProtocolImpl extends EObjectImpl implements Protocol {
   ...
   protected EClass eStaticClass() {
      return Protocol_av_pcPackage.Literals.PROTOCOL;
   }
   ...
   public void setProtocolTypeID(String newProtocolTypeID) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Protocol_av_pcPackage.PROTOCOL__PROTOCOL_TYPE_ID, oldProtocolTypeID, protocolTypeID));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Protocol_av_pcPackage.PROTOCOL__PROTOCOL_TYPE_ID:
