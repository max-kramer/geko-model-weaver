...
import de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.qos_performance_av_pc.Qos_performance_av_pcFactory;
 ...
 * @generated
 */
public class Qos_performance_av_pcPackageImpl extends EPackageImpl implements Qos_performance_av_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.qos_performance_av_pc.Qos_performance_av_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Qos_performance_av_pcPackageImpl() {
      super(eNS_URI, Qos_performance_av_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Qos_performance_av_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Qos_performance_av_pcPackage init() {
      if (isInited) return (Qos_performance_av_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Qos_performance_av_pcPackage.eNS_URI);

      // Obtain or create and register package
      Qos_performance_av_pcPackageImpl theQos_performance_av_pcPackage = (Qos_performance_av_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Qos_performance_av_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Qos_performance_av_pcPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theQos_performance_av_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Qos_performance_av_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theQos_performance_av_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Qos_performance_av_pcPackage.eNS_URI, theQos_performance_av_pcPackage);
      return theQos_performance_av_pcPackage;
   }
    ...
    * @generated
    */
   public Qos_performance_av_pcFactory getQos_performance_av_pcFactory() {
      return (Qos_performance_av_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      specifiedExecutionTimeEClass.getESuperTypes().add(theQosannotations_av_pcPackage.getSpecifiedQoSAnnotation());
      ...
      initEReference(getSpecifiedExecutionTime_Specification_SpecifiedExecutionTime(), theCore_av_pcPackage.getPCMRandomVariable(), theCore_av_pcPackage.getPCMRandomVariable_SpecifiedExecutionTime_PCMRandomVariable(), "specification_SpecifiedExecutionTime", null, 0, 1, SpecifiedExecutionTime.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
...
} //Qos_performance_av_pcPackageImpl
