 ...
 * @generated
 */
public class Qos_performance_av_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Qos_performance_av_pcValidator INSTANCE = new Qos_performance_av_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.qos_performance_av_pc";
    ...
    * @generated
    */
   public Qos_performance_av_pcValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Qos_performance_av_pcPackage.SYSTEM_SPECIFIED_EXECUTION_TIME:
            return validateSystemSpecifiedExecutionTime((SystemSpecifiedExecutionTime)value, diagnostics, context);
         case Qos_performance_av_pcPackage.SPECIFIED_EXECUTION_TIME:
            return validateSpecifiedExecutionTime((SpecifiedExecutionTime)value, diagnostics, context);
         case Qos_performance_av_pcPackage.COMPONENT_SPECIFIED_EXECUTION_TIME:
...
} //Qos_performance_av_pcValidator
