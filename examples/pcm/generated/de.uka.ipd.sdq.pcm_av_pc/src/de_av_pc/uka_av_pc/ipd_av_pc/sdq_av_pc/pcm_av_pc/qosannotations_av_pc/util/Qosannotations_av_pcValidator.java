 ...
 * @generated
 */
public class Qosannotations_av_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Qosannotations_av_pcValidator INSTANCE = new Qosannotations_av_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc";
    ...
    * @generated
    */
   public Qosannotations_av_pcValidator() {
      super();
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Qosannotations_av_pcPackage.SPECIFIED_QO_SANNOTATION:
            return validateSpecifiedQoSAnnotation((SpecifiedQoSAnnotation)value, diagnostics, context);
         case Qosannotations_av_pcPackage.QO_SANNOTATIONS:
            return validateQoSAnnotations((QoSAnnotations)value, diagnostics, context);
         case Qosannotations_av_pcPackage.SPECIFIED_OUTPUT_PARAMETER_ABSTRACTION:
   ...
   public boolean validateQoSAnnotations(QoSAnnotations qoSAnnotations, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_pcValidator.validateIdentifier_idHasToBeUnique(qoSAnnotations, diagnostics, context);
