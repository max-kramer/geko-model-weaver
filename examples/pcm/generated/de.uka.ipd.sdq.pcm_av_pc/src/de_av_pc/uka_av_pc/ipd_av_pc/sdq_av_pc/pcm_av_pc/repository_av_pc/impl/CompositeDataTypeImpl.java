 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.CompositeDataTypeImpl#getRepository__DataType <em>Repository Data Type</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.CompositeDataTypeImpl#getParentType_CompositeDataType <em>Parent Type Composite Data Type</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.CompositeDataTypeImpl#getInnerDeclaration_CompositeDataType <em>Inner Declaration Composite Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeDataTypeImpl extends EntityImpl implements CompositeDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_av_pcPackage.Literals.COMPOSITE_DATA_TYPE;
   }
   ...
   public Repository getRepository__DataType() {
      if (eContainerFeatureID() != Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE) return null;
   ...
   public NotificationChain basicSetRepository__DataType(Repository newRepository__DataType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__DataType, Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE, msgs);
      return msgs;
   }
   ...
   public void setRepository__DataType(Repository newRepository__DataType) {
      if (newRepository__DataType != eInternalContainer() || (eContainerFeatureID() != Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE && newRepository__DataType != null)) {
         ...
         if (newRepository__DataType != null)
            msgs = ((InternalEObject)newRepository__DataType).eInverseAdd(this, Repository_av_pcPackage.REPOSITORY__DATA_TYPES_REPOSITORY, Repository.class, msgs);
         msgs = basicSetRepository__DataType(newRepository__DataType, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE, newRepository__DataType, newRepository__DataType));
   }
   ...
   public EList<CompositeDataType> getParentType_CompositeDataType() {
      if (parentType_CompositeDataType == null) {
         parentType_CompositeDataType = new EObjectResolvingEList<CompositeDataType>(CompositeDataType.class, this, Repository_av_pcPackage.COMPOSITE_DATA_TYPE__PARENT_TYPE_COMPOSITE_DATA_TYPE);
      }
   ...
   public EList<InnerDeclaration> getInnerDeclaration_CompositeDataType() {
      if (innerDeclaration_CompositeDataType == null) {
         innerDeclaration_CompositeDataType = new EObjectContainmentWithInverseEList<InnerDeclaration>(InnerDeclaration.class, this, Repository_av_pcPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE, Repository_av_pcPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetRepository__DataType((Repository)otherEnd, msgs);
         case Repository_av_pcPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE:
            return eInternalContainer().eInverseRemove(this, Repository_av_pcPackage.REPOSITORY__DATA_TYPES_REPOSITORY, Repository.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Repository_av_pcPackage.COMPOSITE_DATA_TYPE__PARENT_TYPE_COMPOSITE_DATA_TYPE:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (derivedFeatureID) {
            case Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_av_pcPackage.DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (baseFeatureID) {
            case Repository_av_pcPackage.DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_av_pcPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
