 ...
 * @generated
 */
public class Repository_av_pcFactoryImpl extends EFactoryImpl implements Repository_av_pcFactory {
   /**
    ...
    * @generated
    */
   public static Repository_av_pcFactory init() {
      try {
         Repository_av_pcFactory theRepository_av_pcFactory = (Repository_av_pcFactory)EPackage.Registry.INSTANCE.getEFactory(Repository_av_pcPackage.eNS_URI);
         if (theRepository_av_pcFactory != null) {
            return theRepository_av_pcFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Repository_av_pcFactoryImpl();
   }
    ...
    * @generated
    */
   public Repository_av_pcFactoryImpl() {
      super();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Repository_av_pcPackage.PASSIVE_RESOURCE: return createPassiveResource();
         case Repository_av_pcPackage.BASIC_COMPONENT: return createBasicComponent();
         case Repository_av_pcPackage.IMPLEMENTATION_COMPONENT_TYPE: return createImplementationComponentType();
         case Repository_av_pcPackage.REPOSITORY_COMPONENT: return createRepositoryComponent();
         case Repository_av_pcPackage.PROVIDED_ROLE: return createProvidedRole();
         case Repository_av_pcPackage.PARAMETER: return createParameter();
         case Repository_av_pcPackage.DATA_TYPE: return createDataType();
         case Repository_av_pcPackage.REPOSITORY: return createRepository();
         case Repository_av_pcPackage.INTERFACE: return createInterface();
         case Repository_av_pcPackage.REQUIRED_CHARACTERISATION: return createRequiredCharacterisation();
         case Repository_av_pcPackage.EVENT_GROUP: return createEventGroup();
         case Repository_av_pcPackage.EVENT_TYPE: return createEventType();
         case Repository_av_pcPackage.SIGNATURE: return createSignature();
         case Repository_av_pcPackage.EXCEPTION_TYPE: return createExceptionType();
         case Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE: return createInfrastructureSignature();
         case Repository_av_pcPackage.INFRASTRUCTURE_INTERFACE: return createInfrastructureInterface();
         case Repository_av_pcPackage.INFRASTRUCTURE_REQUIRED_ROLE: return createInfrastructureRequiredRole();
         case Repository_av_pcPackage.REQUIRED_ROLE: return createRequiredRole();
         case Repository_av_pcPackage.OPERATION_SIGNATURE: return createOperationSignature();
         case Repository_av_pcPackage.OPERATION_INTERFACE: return createOperationInterface();
         case Repository_av_pcPackage.OPERATION_REQUIRED_ROLE: return createOperationRequiredRole();
         case Repository_av_pcPackage.SOURCE_ROLE: return createSourceRole();
         case Repository_av_pcPackage.SINK_ROLE: return createSinkRole();
         case Repository_av_pcPackage.OPERATION_PROVIDED_ROLE: return createOperationProvidedRole();
         case Repository_av_pcPackage.INFRASTRUCTURE_PROVIDED_ROLE: return createInfrastructureProvidedRole();
         case Repository_av_pcPackage.COMPLETE_COMPONENT_TYPE: return createCompleteComponentType();
         case Repository_av_pcPackage.PROVIDES_COMPONENT_TYPE: return createProvidesComponentType();
         case Repository_av_pcPackage.COMPOSITE_COMPONENT: return createCompositeComponent();
         case Repository_av_pcPackage.PRIMITIVE_DATA_TYPE: return createPrimitiveDataType();
         case Repository_av_pcPackage.COLLECTION_DATA_TYPE: return createCollectionDataType();
         case Repository_av_pcPackage.COMPOSITE_DATA_TYPE: return createCompositeDataType();
         case Repository_av_pcPackage.INNER_DECLARATION: return createInnerDeclaration();
         case Repository_av_pcPackage.ROLE: return createRole();
         default:
    ...
    * @generated
    */
   public Repository_av_pcPackage getRepository_av_pcPackage() {
      return (Repository_av_pcPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Repository_av_pcPackage getPackage() {
      return Repository_av_pcPackage.eINSTANCE;
   }

} //Repository_av_pcFactoryImpl
