 ...
 * @generated
 */
public class Resourcetype_av_pcSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourcetype_av_pcSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourcetype_av_pcPackage.RESOURCE_SIGNATURE: {
         ...
         case Resourcetype_av_pcPackage.PROCESSING_RESOURCE_TYPE: {
         ...
         case Resourcetype_av_pcPackage.RESOURCE_TYPE: {
         ...
         case Resourcetype_av_pcPackage.COMMUNICATION_LINK_RESOURCE_TYPE: {
         ...
         case Resourcetype_av_pcPackage.RESOURCE_INTERFACE: {
