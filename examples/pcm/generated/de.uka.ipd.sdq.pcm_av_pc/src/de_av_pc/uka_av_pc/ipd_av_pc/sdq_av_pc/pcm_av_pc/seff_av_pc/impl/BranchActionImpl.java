 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.impl.BranchActionImpl#getBranches_Branch <em>Branches Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchActionImpl extends AbstractInternalControlFlowActionImpl implements BranchAction {
   ...
   protected EClass eStaticClass() {
      return Seff_av_pcPackage.Literals.BRANCH_ACTION;
   }
   ...
   public EList<AbstractBranchTransition> getBranches_Branch() {
      if (branches_Branch == null) {
         branches_Branch = new EObjectContainmentWithInverseEList<AbstractBranchTransition>(AbstractBranchTransition.class, this, Seff_av_pcPackage.BRANCH_ACTION__BRANCHES_BRANCH, Seff_av_pcPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Seff_av_pcValidator.BRANCH_ACTION__EITHER_GUARDED_BRANCHES_OR_PROBABILISITIC_BRANCH_TRANSITIONS,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_av_pcValidator.DIAGNOSTIC_SOURCE,
                   Seff_av_pcValidator.BRANCH_ACTION__ALL_PROBABILISTIC_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_pcPackage.BRANCH_ACTION__BRANCHES_BRANCH:
