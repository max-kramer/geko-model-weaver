 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.impl.CallActionImpl#getInputVariableUsages__CallAction <em>Input Variable Usages Call Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CallActionImpl extends EObjectImpl implements CallAction {
   ...
   protected EClass eStaticClass() {
      return Seff_av_pcPackage.Literals.CALL_ACTION;
   }
   ...
   public EList<VariableUsage> getInputVariableUsages__CallAction() {
      if (inputVariableUsages__CallAction == null) {
         inputVariableUsages__CallAction = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_av_pcPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION, Parameter_av_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_pcPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION:
