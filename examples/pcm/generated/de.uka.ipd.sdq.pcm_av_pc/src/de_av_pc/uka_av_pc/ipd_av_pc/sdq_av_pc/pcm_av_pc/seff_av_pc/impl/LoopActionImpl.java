 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.impl.LoopActionImpl#getIterationCount_LoopAction <em>Iteration Count Loop Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoopActionImpl extends AbstractLoopActionImpl implements LoopAction {
   ...
   protected EClass eStaticClass() {
      return Seff_av_pcPackage.Literals.LOOP_ACTION;
   }
   ...
   public NotificationChain basicSetIterationCount_LoopAction(PCMRandomVariable newIterationCount_LoopAction, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_av_pcPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION, oldIterationCount_LoopAction, newIterationCount_LoopAction);
   ...
   public void setIterationCount_LoopAction(PCMRandomVariable newIterationCount_LoopAction) {
      if (newIterationCount_LoopAction != iterationCount_LoopAction) {
         ...
         if (iterationCount_LoopAction != null)
            msgs = ((InternalEObject)iterationCount_LoopAction).eInverseRemove(this, Core_av_pcPackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         if (newIterationCount_LoopAction != null)
            msgs = ((InternalEObject)newIterationCount_LoopAction).eInverseAdd(this, Core_av_pcPackage.PCM_RANDOM_VARIABLE__LOOP_ACTION_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         msgs = basicSetIterationCount_LoopAction(newIterationCount_LoopAction, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_pcPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION, newIterationCount_LoopAction, newIterationCount_LoopAction));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_pcPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION:
            if (iterationCount_LoopAction != null)
               msgs = ((InternalEObject)iterationCount_LoopAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Seff_av_pcPackage.LOOP_ACTION__ITERATION_COUNT_LOOP_ACTION, null, msgs);
