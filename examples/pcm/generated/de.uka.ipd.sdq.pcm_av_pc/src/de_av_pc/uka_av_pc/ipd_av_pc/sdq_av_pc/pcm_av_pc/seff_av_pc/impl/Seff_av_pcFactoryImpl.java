 ...
 * @generated
 */
public class Seff_av_pcFactoryImpl extends EFactoryImpl implements Seff_av_pcFactory {
   /**
    ...
    * @generated
    */
   public static Seff_av_pcFactory init() {
      try {
         Seff_av_pcFactory theSeff_av_pcFactory = (Seff_av_pcFactory)EPackage.Registry.INSTANCE.getEFactory(Seff_av_pcPackage.eNS_URI);
         if (theSeff_av_pcFactory != null) {
            return theSeff_av_pcFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Seff_av_pcFactoryImpl();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Seff_av_pcPackage.STOP_ACTION: return createStopAction();
         case Seff_av_pcPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION: return createAbstractInternalControlFlowAction();
         case Seff_av_pcPackage.ABSTRACT_ACTION: return createAbstractAction();
         case Seff_av_pcPackage.RESOURCE_DEMANDING_BEHAVIOUR: return createResourceDemandingBehaviour();
         case Seff_av_pcPackage.ABSTRACT_LOOP_ACTION: return createAbstractLoopAction();
         case Seff_av_pcPackage.ABSTRACT_BRANCH_TRANSITION: return createAbstractBranchTransition();
         case Seff_av_pcPackage.BRANCH_ACTION: return createBranchAction();
         case Seff_av_pcPackage.CALL_ACTION: return createCallAction();
         case Seff_av_pcPackage.START_ACTION: return createStartAction();
         case Seff_av_pcPackage.SERVICE_EFFECT_SPECIFICATION: return createServiceEffectSpecification();
         case Seff_av_pcPackage.RESOURCE_DEMANDING_SEFF: return createResourceDemandingSEFF();
         case Seff_av_pcPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR: return createResourceDemandingInternalBehaviour();
         case Seff_av_pcPackage.RELEASE_ACTION: return createReleaseAction();
         case Seff_av_pcPackage.LOOP_ACTION: return createLoopAction();
         case Seff_av_pcPackage.FORK_ACTION: return createForkAction();
         case Seff_av_pcPackage.FORKED_BEHAVIOUR: return createForkedBehaviour();
         case Seff_av_pcPackage.SYNCHRONISATION_POINT: return createSynchronisationPoint();
         case Seff_av_pcPackage.EXTERNAL_CALL_ACTION: return createExternalCallAction();
         case Seff_av_pcPackage.CALL_RETURN_ACTION: return createCallReturnAction();
         case Seff_av_pcPackage.PROBABILISTIC_BRANCH_TRANSITION: return createProbabilisticBranchTransition();
         case Seff_av_pcPackage.ACQUIRE_ACTION: return createAcquireAction();
         case Seff_av_pcPackage.COLLECTION_ITERATOR_ACTION: return createCollectionIteratorAction();
         case Seff_av_pcPackage.GUARDED_BRANCH_TRANSITION: return createGuardedBranchTransition();
         case Seff_av_pcPackage.SET_VARIABLE_ACTION: return createSetVariableAction();
         case Seff_av_pcPackage.INTERNAL_CALL_ACTION: return createInternalCallAction();
         case Seff_av_pcPackage.EMIT_EVENT_ACTION: return createEmitEventAction();
         case Seff_av_pcPackage.INTERNAL_ACTION: return createInternalAction();
         default:
    ...
    * @generated
    */
   public Seff_av_pcPackage getSeff_av_pcPackage() {
      return (Seff_av_pcPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Seff_av_pcPackage getPackage() {
      return Seff_av_pcPackage.eINSTANCE;
   }

} //Seff_av_pcFactoryImpl
