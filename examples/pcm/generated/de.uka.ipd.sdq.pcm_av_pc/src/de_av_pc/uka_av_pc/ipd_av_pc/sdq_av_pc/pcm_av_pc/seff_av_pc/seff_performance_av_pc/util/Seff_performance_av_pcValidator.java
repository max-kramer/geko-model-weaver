 ...
 * @generated
 */
public class Seff_performance_av_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Seff_performance_av_pcValidator INSTANCE = new Seff_performance_av_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.seff_performance_av_pc";
    ...
    * @generated
    */
   public Seff_performance_av_pcValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL:
            return validateInfrastructureCall((InfrastructureCall)value, diagnostics, context);
         case Seff_performance_av_pcPackage.RESOURCE_CALL:
            return validateResourceCall((ResourceCall)value, diagnostics, context);
         case Seff_performance_av_pcPackage.PARAMETRIC_RESOURCE_DEMAND:
...
} //Seff_performance_av_pcValidator
