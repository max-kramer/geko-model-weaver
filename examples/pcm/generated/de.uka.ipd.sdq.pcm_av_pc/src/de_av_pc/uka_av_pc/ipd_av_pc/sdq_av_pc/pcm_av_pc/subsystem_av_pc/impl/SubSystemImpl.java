 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.subsystem_av_pc.impl.SubSystemImpl#getRepository__RepositoryComponent <em>Repository Repository Component</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubSystemImpl extends ComposedProvidingRequiringEntityImpl implements SubSystem {
   ...
   protected EClass eStaticClass() {
      return Subsystem_av_pcPackage.Literals.SUB_SYSTEM;
   }
   ...
   public Repository getRepository__RepositoryComponent() {
      if (eContainerFeatureID() != Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT) return null;
   ...
   public NotificationChain basicSetRepository__RepositoryComponent(Repository newRepository__RepositoryComponent, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__RepositoryComponent, Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT, msgs);
      return msgs;
   }
   ...
   public void setRepository__RepositoryComponent(Repository newRepository__RepositoryComponent) {
      if (newRepository__RepositoryComponent != eInternalContainer() || (eContainerFeatureID() != Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT && newRepository__RepositoryComponent != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT, newRepository__RepositoryComponent, newRepository__RepositoryComponent));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == RepositoryComponent.class) {
         switch (derivedFeatureID) {
            case Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT: return Repository_av_pcPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == RepositoryComponent.class) {
         switch (baseFeatureID) {
            case Repository_av_pcPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT: return Subsystem_av_pcPackage.SUB_SYSTEM__REPOSITORY_REPOSITORY_COMPONENT;
            default: return -1;
         }
      }
