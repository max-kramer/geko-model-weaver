 ...
 * @generated
 */
public class System_av_pcPackageImpl extends EPackageImpl implements System_av_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.system_av_pc.System_av_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private System_av_pcPackageImpl() {
      super(eNS_URI, System_av_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link System_av_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static System_av_pcPackage init() {
      if (isInited) return (System_av_pcPackage)EPackage.Registry.INSTANCE.getEPackage(System_av_pcPackage.eNS_URI);

      // Obtain or create and register package
      System_av_pcPackageImpl theSystem_av_pcPackage = (System_av_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof System_av_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new System_av_pcPackageImpl());
         ...
         (theSystem_av_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return System_av_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSystem_av_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(System_av_pcPackage.eNS_URI, theSystem_av_pcPackage);
      return theSystem_av_pcPackage;
   }
    ...
    * @generated
    */
   public System_av_pcFactory getSystem_av_pcFactory() {
      return (System_av_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      systemEClass.getESuperTypes().add(theEntity_av_pcPackage.getEntity());
      systemEClass.getESuperTypes().add(theEntity_av_pcPackage.getComposedProvidingRequiringEntity());

      // Initialize classes and features; add operations and parameters
      initEClass(systemEClass, de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.system_av_pc.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getSystem_QosAnnotations_System(), theQosannotations_av_pcPackage.getQoSAnnotations(), theQosannotations_av_pcPackage.getQoSAnnotations_System_QoSAnnotations(), "qosAnnotations_System", null, 0, -1, de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.system_av_pc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
