 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.usagemodel_av_pc.impl.BranchImpl#getBranchTransitions_Branch <em>Branch Transitions Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchImpl extends AbstractUserActionImpl implements Branch {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_av_pcPackage.Literals.BRANCH;
   }
   ...
   public EList<BranchTransition> getBranchTransitions_Branch() {
      if (branchTransitions_Branch == null) {
         branchTransitions_Branch = new EObjectContainmentWithInverseEList<BranchTransition>(BranchTransition.class, this, Usagemodel_av_pcPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH, Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Usagemodel_av_pcValidator.BRANCH__ALL_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_av_pcPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
