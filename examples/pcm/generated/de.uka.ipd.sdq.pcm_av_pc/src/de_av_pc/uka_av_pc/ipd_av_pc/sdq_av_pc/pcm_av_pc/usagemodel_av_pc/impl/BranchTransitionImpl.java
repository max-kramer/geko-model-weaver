 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.usagemodel_av_pc.impl.BranchTransitionImpl#getBranchProbability <em>Branch Probability</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.usagemodel_av_pc.impl.BranchTransitionImpl#getBranch_BranchTransition <em>Branch Branch Transition</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.usagemodel_av_pc.impl.BranchTransitionImpl#getBranchedBehaviour_BranchTransition <em>Branched Behaviour Branch Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchTransitionImpl extends EObjectImpl implements BranchTransition {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_av_pcPackage.Literals.BRANCH_TRANSITION;
   }
   ...
   public void setBranchProbability(double newBranchProbability) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_PROBABILITY, oldBranchProbability, branchProbability));
   }
   ...
   public Branch getBranch_BranchTransition() {
      if (eContainerFeatureID() != Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION) return null;
   ...
   public NotificationChain basicSetBranch_BranchTransition(Branch newBranch_BranchTransition, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newBranch_BranchTransition, Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION, msgs);
      return msgs;
   }
   ...
   public void setBranch_BranchTransition(Branch newBranch_BranchTransition) {
      if (newBranch_BranchTransition != eInternalContainer() || (eContainerFeatureID() != Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION && newBranch_BranchTransition != null)) {
         ...
         if (newBranch_BranchTransition != null)
            msgs = ((InternalEObject)newBranch_BranchTransition).eInverseAdd(this, Usagemodel_av_pcPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH, Branch.class, msgs);
         msgs = basicSetBranch_BranchTransition(newBranch_BranchTransition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION, newBranch_BranchTransition, newBranch_BranchTransition));
   }
   ...
   public NotificationChain basicSetBranchedBehaviour_BranchTransition(ScenarioBehaviour newBranchedBehaviour_BranchTransition, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, oldBranchedBehaviour_BranchTransition, newBranchedBehaviour_BranchTransition);
   ...
   public void setBranchedBehaviour_BranchTransition(ScenarioBehaviour newBranchedBehaviour_BranchTransition) {
      if (newBranchedBehaviour_BranchTransition != branchedBehaviour_BranchTransition) {
         ...
         if (branchedBehaviour_BranchTransition != null)
            msgs = ((InternalEObject)branchedBehaviour_BranchTransition).eInverseRemove(this, Usagemodel_av_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
         if (newBranchedBehaviour_BranchTransition != null)
            msgs = ((InternalEObject)newBranchedBehaviour_BranchTransition).eInverseAdd(this, Usagemodel_av_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
         msgs = basicSetBranchedBehaviour_BranchTransition(newBranchedBehaviour_BranchTransition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, newBranchedBehaviour_BranchTransition, newBranchedBehaviour_BranchTransition));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetBranch_BranchTransition((Branch)otherEnd, msgs);
         case Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION:
            if (branchedBehaviour_BranchTransition != null)
               msgs = ((InternalEObject)branchedBehaviour_BranchTransition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, null, msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION:
            return eInternalContainer().eInverseRemove(this, Usagemodel_av_pcPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH, Branch.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Usagemodel_av_pcPackage.BRANCH_TRANSITION__BRANCH_PROBABILITY:
