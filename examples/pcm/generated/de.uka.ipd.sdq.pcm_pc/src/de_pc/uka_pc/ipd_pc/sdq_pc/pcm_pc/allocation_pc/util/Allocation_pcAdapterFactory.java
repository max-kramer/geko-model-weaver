 ...
 * @generated
 */
public class Allocation_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Allocation_pcPackage modelPackage;
    ...
    * @generated
    */
   public Allocation_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Allocation_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Allocation_pcSwitch<Adapter> modelSwitch =
      new Allocation_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.allocation_pc.AllocationContext <em>Allocation Context</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.allocation_pc.Allocation <em>Allocation</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
