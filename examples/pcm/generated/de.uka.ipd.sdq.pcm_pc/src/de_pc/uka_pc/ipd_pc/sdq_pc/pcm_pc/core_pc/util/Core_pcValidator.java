 ...
 * @generated
 */
public class Core_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Core_pcValidator INSTANCE = new Core_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.core_pc";
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Core_pcPackage.PCM_RANDOM_VARIABLE:
