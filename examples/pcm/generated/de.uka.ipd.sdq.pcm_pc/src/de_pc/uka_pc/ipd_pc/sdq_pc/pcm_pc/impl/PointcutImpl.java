 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.impl.PointcutImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointcutImpl extends EObjectImpl implements Pointcut {
   ...
   protected EClass eStaticClass() {
      return Pcm_pcPackage.Literals.POINTCUT;
   }
   ...
   public EList<EObject> getChildren() {
      if (children == null) {
         children = new EObjectContainmentEList<EObject>(EObject.class, this, Pcm_pcPackage.POINTCUT__CHILDREN);
      }
      return children;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Pcm_pcPackage.POINTCUT__CHILDREN:
