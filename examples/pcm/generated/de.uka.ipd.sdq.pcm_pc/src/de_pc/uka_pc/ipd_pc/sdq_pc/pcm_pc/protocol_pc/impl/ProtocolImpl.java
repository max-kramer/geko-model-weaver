 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.protocol_pc.impl.ProtocolImpl#getProtocolTypeID <em>Protocol Type ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProtocolImpl extends EObjectImpl implements Protocol {
   ...
   protected EClass eStaticClass() {
      return Protocol_pcPackage.Literals.PROTOCOL;
   }
   ...
   public void setProtocolTypeID(String newProtocolTypeID) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Protocol_pcPackage.PROTOCOL__PROTOCOL_TYPE_ID, oldProtocolTypeID, protocolTypeID));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Protocol_pcPackage.PROTOCOL__PROTOCOL_TYPE_ID:
