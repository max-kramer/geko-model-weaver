...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.qosannotations_pc.qos_performance_pc.ComponentSpecifiedExecutionTime;
 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.qosannotations_pc.qos_performance_pc.impl.ComponentSpecifiedExecutionTimeImpl#getAssemblyContext_ComponentSpecifiedExecutionTime <em>Assembly Context Component Specified Execution Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComponentSpecifiedExecutionTimeImpl extends SpecifiedExecutionTimeImpl implements ComponentSpecifiedExecutionTime {
   ...
   protected EClass eStaticClass() {
      return Qos_performance_pcPackage.Literals.COMPONENT_SPECIFIED_EXECUTION_TIME;
   }
      ...
      if (assemblyContext_ComponentSpecifiedExecutionTime != null && assemblyContext_ComponentSpecifiedExecutionTime.eIsProxy()) {
         ...
         if (assemblyContext_ComponentSpecifiedExecutionTime != oldAssemblyContext_ComponentSpecifiedExecutionTime) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Qos_performance_pcPackage.COMPONENT_SPECIFIED_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME, oldAssemblyContext_ComponentSpecifiedExecutionTime, assemblyContext_ComponentSpecifiedExecutionTime));
         }
      }
   ...
   public void setAssemblyContext_ComponentSpecifiedExecutionTime(AssemblyContext newAssemblyContext_ComponentSpecifiedExecutionTime) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Qos_performance_pcPackage.COMPONENT_SPECIFIED_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME, oldAssemblyContext_ComponentSpecifiedExecutionTime, assemblyContext_ComponentSpecifiedExecutionTime));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Qos_performance_pcPackage.COMPONENT_SPECIFIED_EXECUTION_TIME__ASSEMBLY_CONTEXT_COMPONENT_SPECIFIED_EXECUTION_TIME:
