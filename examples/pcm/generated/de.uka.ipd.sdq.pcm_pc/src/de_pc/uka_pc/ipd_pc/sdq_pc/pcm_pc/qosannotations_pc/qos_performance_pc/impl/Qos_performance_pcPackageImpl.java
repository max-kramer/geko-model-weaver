...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.qosannotations_pc.qos_performance_pc.Qos_performance_pcFactory;
 ...
 * @generated
 */
public class Qos_performance_pcPackageImpl extends EPackageImpl implements Qos_performance_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.qosannotations_pc.qos_performance_pc.Qos_performance_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Qos_performance_pcPackageImpl() {
      super(eNS_URI, Qos_performance_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Qos_performance_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Qos_performance_pcPackage init() {
      if (isInited) return (Qos_performance_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Qos_performance_pcPackage.eNS_URI);

      // Obtain or create and register package
      Qos_performance_pcPackageImpl theQos_performance_pcPackage = (Qos_performance_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Qos_performance_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Qos_performance_pcPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theQos_performance_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Qos_performance_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theQos_performance_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Qos_performance_pcPackage.eNS_URI, theQos_performance_pcPackage);
      return theQos_performance_pcPackage;
   }
    ...
    * @generated
    */
   public Qos_performance_pcFactory getQos_performance_pcFactory() {
      return (Qos_performance_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      specifiedExecutionTimeEClass.getESuperTypes().add(theQosannotations_pcPackage.getSpecifiedQoSAnnotation());
      ...
      initEReference(getSpecifiedExecutionTime_Specification_SpecifiedExecutionTime(), theCore_pcPackage.getPCMRandomVariable(), theCore_pcPackage.getPCMRandomVariable_SpecifiedExecutionTime_PCMRandomVariable(), "specification_SpecifiedExecutionTime", null, 0, 1, SpecifiedExecutionTime.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
