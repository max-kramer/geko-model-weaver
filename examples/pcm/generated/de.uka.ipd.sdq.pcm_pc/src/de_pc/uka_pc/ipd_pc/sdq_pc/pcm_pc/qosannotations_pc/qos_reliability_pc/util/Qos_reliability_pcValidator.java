 ...
 * @generated
 */
public class Qos_reliability_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Qos_reliability_pcValidator INSTANCE = new Qos_reliability_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.qosannotations_pc.qos_reliability_pc";
    ...
    * @generated
    */
   public Qos_reliability_pcValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Qos_reliability_pcPackage.SPECIFIED_RELIABILITY_ANNOTATION:
