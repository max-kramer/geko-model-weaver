 ...
 * @generated
 */
public class Reliability_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Reliability_pcValidator INSTANCE = new Reliability_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.reliability_pc";
    ...
    * @generated
    */
   public Reliability_pcValidator() {
      super();
   ...
   public boolean validateHardwareInducedFailureType(HardwareInducedFailureType hardwareInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(hardwareInducedFailureType, diagnostics, context);
   ...
   public boolean validateSoftwareInducedFailureType(SoftwareInducedFailureType softwareInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(softwareInducedFailureType, diagnostics, context);
      return result;
   }
   ...
   public boolean validateNetworkInducedFailureType(NetworkInducedFailureType networkInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(networkInducedFailureType, diagnostics, context);
   ...
   public boolean validateResourceTimeoutFailureType(ResourceTimeoutFailureType resourceTimeoutFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(resourceTimeoutFailureType, diagnostics, context);
      return result;
   }
   ...
   public boolean validateFailureType(FailureType failureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(failureType, diagnostics, context);
      return result;
   }
