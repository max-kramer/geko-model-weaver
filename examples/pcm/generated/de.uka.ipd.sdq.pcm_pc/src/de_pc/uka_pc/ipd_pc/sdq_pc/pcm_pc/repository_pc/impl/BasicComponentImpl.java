 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.BasicComponentImpl#getServiceEffectSpecifications__BasicComponent <em>Service Effect Specifications Basic Component</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.BasicComponentImpl#getPassiveResource_BasicComponent <em>Passive Resource Basic Component</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BasicComponentImpl extends ImplementationComponentTypeImpl implements BasicComponent {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.BASIC_COMPONENT;
   }
   ...
   public EList<ServiceEffectSpecification> getServiceEffectSpecifications__BasicComponent() {
      if (serviceEffectSpecifications__BasicComponent == null) {
         serviceEffectSpecifications__BasicComponent = new EObjectContainmentWithInverseEList<ServiceEffectSpecification>(ServiceEffectSpecification.class, this, Repository_pcPackage.BASIC_COMPONENT__SERVICE_EFFECT_SPECIFICATIONS_BASIC_COMPONENT, Seff_pcPackage.SERVICE_EFFECT_SPECIFICATION__BASIC_COMPONENT_SERVICE_EFFECT_SPECIFICATION);
      }
   ...
   public EList<PassiveResource> getPassiveResource_BasicComponent() {
      if (passiveResource_BasicComponent == null) {
         passiveResource_BasicComponent = new EObjectContainmentWithInverseEList<PassiveResource>(PassiveResource.class, this, Repository_pcPackage.BASIC_COMPONENT__PASSIVE_RESOURCE_BASIC_COMPONENT, Repository_pcPackage.PASSIVE_RESOURCE__BASIC_COMPONENT_PASSIVE_RESOURCE);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_pcValidator.BASIC_COMPONENT__NO_SEFF_TYPE_USED_TWICE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_pcValidator.DIAGNOSTIC_SOURCE,
                   Repository_pcValidator.BASIC_COMPONENT__PROVIDE_SAME_INTERFACES_AS_IMPLEMENTATION_TYPE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_pcValidator.DIAGNOSTIC_SOURCE,
                   Repository_pcValidator.BASIC_COMPONENT__REQUIRE_SAME_INTERFACES_AS_IMPLEMENTATION_TYPE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pcPackage.BASIC_COMPONENT__SERVICE_EFFECT_SPECIFICATIONS_BASIC_COMPONENT:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getServiceEffectSpecifications__BasicComponent()).basicAdd(otherEnd, msgs);
         case Repository_pcPackage.BASIC_COMPONENT__PASSIVE_RESOURCE_BASIC_COMPONENT:
