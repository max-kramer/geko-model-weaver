 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.EventGroupImpl#getEventTypes__EventGroup <em>Event Types Event Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventGroupImpl extends InterfaceImpl implements EventGroup {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.EVENT_GROUP;
   }
   ...
   public EList<EventType> getEventTypes__EventGroup() {
      if (eventTypes__EventGroup == null) {
         eventTypes__EventGroup = new EObjectContainmentWithInverseEList<EventType>(EventType.class, this, Repository_pcPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP, Repository_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pcPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
