...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.CollectionDataType;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.CompositeComponent;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.CompositeDataType;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.InfrastructureProvidedRole;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.InnerDeclaration;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.Interface;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.OperationInterface;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.OperationProvidedRole;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.PrimitiveDataType;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.PrimitiveTypeEnum;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.Repository_pcFactory;
 ...
 * @generated
 */
public class Repository_pcPackageImpl extends EPackageImpl implements Repository_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.Repository_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Repository_pcPackageImpl() {
      super(eNS_URI, Repository_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Repository_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Repository_pcPackage init() {
      if (isInited) return (Repository_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Repository_pcPackage.eNS_URI);

      // Obtain or create and register package
      Repository_pcPackageImpl theRepository_pcPackage = (Repository_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Repository_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Repository_pcPackageImpl());
         ...
         (theRepository_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Repository_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theRepository_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Repository_pcPackage.eNS_URI, theRepository_pcPackage);
      return theRepository_pcPackage;
   }
    ...
    * @generated
    */
   public Repository_pcFactory getRepository_pcFactory() {
      return (Repository_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      passiveResourceEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      ...
      repositoryComponentEClass.getESuperTypes().add(theEntity_pcPackage.getInterfaceProvidingRequiringEntity());
      providedRoleEClass.getESuperTypes().add(this.getRole());
      repositoryEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      interfaceEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      eventGroupEClass.getESuperTypes().add(this.getInterface());
      eventTypeEClass.getESuperTypes().add(this.getSignature());
      signatureEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      ...
      compositeComponentEClass.getESuperTypes().add(theEntity_pcPackage.getComposedProvidingRequiringEntity());
      ...
      collectionDataTypeEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      collectionDataTypeEClass.getESuperTypes().add(this.getDataType());
      compositeDataTypeEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      compositeDataTypeEClass.getESuperTypes().add(this.getDataType());
      innerDeclarationEClass.getESuperTypes().add(theEntity_pcPackage.getNamedElement());
      roleEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      ...
      initEReference(getPassiveResource_Capacity_PassiveResource(), theCore_pcPackage.getPCMRandomVariable(), theCore_pcPackage.getPCMRandomVariable_PassiveResource_capacity_PCMRandomVariable(), "capacity_PassiveResource", null, 0, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getPassiveResource_ResourceTimeoutFailureType__PassiveResource(), theReliability_pcPackage.getResourceTimeoutFailureType(), theReliability_pcPackage.getResourceTimeoutFailureType_PassiveResource__ResourceTimeoutFailureType(), "resourceTimeoutFailureType__PassiveResource", null, 0, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(basicComponentEClass, BasicComponent.class, "BasicComponent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getBasicComponent_ServiceEffectSpecifications__BasicComponent(), theSeff_pcPackage.getServiceEffectSpecification(), theSeff_pcPackage.getServiceEffectSpecification_BasicComponent_ServiceEffectSpecification(), "serviceEffectSpecifications__BasicComponent", null, 0, -1, BasicComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getProvidedRole_ProvidingEntity_ProvidedRole(), theEntity_pcPackage.getInterfaceProvidingEntity(), theEntity_pcPackage.getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity(), "providingEntity_ProvidedRole", null, 0, 1, ProvidedRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getParameter_ResourceSignature__Parameter(), theResourcetype_pcPackage.getResourceSignature(), theResourcetype_pcPackage.getResourceSignature_Parameter__ResourceSignature(), "resourceSignature__Parameter", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getInterface_Protocols__Interface(), theProtocol_pcPackage.getProtocol(), null, "protocols__Interface", null, 0, -1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEAttribute(getRequiredCharacterisation_Type(), theParameter_pcPackage.getVariableCharacterisationType(), "type", null, 1, 1, RequiredCharacterisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getSignature_FailureType(), theReliability_pcPackage.getFailureType(), null, "failureType", null, 0, -1, Signature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getRequiredRole_RequiringEntity_RequiredRole(), theEntity_pcPackage.getInterfaceRequiringEntity(), theEntity_pcPackage.getInterfaceRequiringEntity_RequiredRoles_InterfaceRequiringEntity(), "requiringEntity_RequiredRole", null, 0, 1, RequiredRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
