 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getMTTR <em>MTTR</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getMTTF <em>MTTF</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#isRequiredByContainer <em>Required By Container</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getSchedulingPolicy <em>Scheduling Policy</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getActiveResourceType_ActiveResourceSpecification <em>Active Resource Type Active Resource Specification</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getProcessingRate_ProcessingResourceSpecification <em>Processing Rate Processing Resource Specification</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getNumberOfReplicas <em>Number Of Replicas</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourceenvironment_pc.impl.ProcessingResourceSpecificationImpl#getResourceContainer_ProcessingResourceSpecification <em>Resource Container Processing Resource Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessingResourceSpecificationImpl extends IdentifierImpl implements ProcessingResourceSpecification {
   ...
   protected EClass eStaticClass() {
      return Resourceenvironment_pcPackage.Literals.PROCESSING_RESOURCE_SPECIFICATION;
   }
   ...
   public void setMTTR(double newMTTR) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__MTTR, oldMTTR, mttr));
   }
   ...
   public void setMTTF(double newMTTF) {
      ...
      mttf = newMTTF;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__MTTF, oldMTTF, mttf));
   }
   ...
   public void setRequiredByContainer(boolean newRequiredByContainer) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__REQUIRED_BY_CONTAINER, oldRequiredByContainer, requiredByContainer));
   }
   ...
   public SchedulingPolicy getSchedulingPolicy() {
      if (schedulingPolicy != null && schedulingPolicy.eIsProxy()) {
         ...
         if (schedulingPolicy != oldSchedulingPolicy) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__SCHEDULING_POLICY, oldSchedulingPolicy, schedulingPolicy));
         }
      }
   ...
   public void setSchedulingPolicy(SchedulingPolicy newSchedulingPolicy) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__SCHEDULING_POLICY, oldSchedulingPolicy, schedulingPolicy));
   }
   ...
   public ProcessingResourceType getActiveResourceType_ActiveResourceSpecification() {
      if (activeResourceType_ActiveResourceSpecification != null && activeResourceType_ActiveResourceSpecification.eIsProxy()) {
         ...
         if (activeResourceType_ActiveResourceSpecification != oldActiveResourceType_ActiveResourceSpecification) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__ACTIVE_RESOURCE_TYPE_ACTIVE_RESOURCE_SPECIFICATION, oldActiveResourceType_ActiveResourceSpecification, activeResourceType_ActiveResourceSpecification));
         }
      }
   ...
   public void setActiveResourceType_ActiveResourceSpecification(ProcessingResourceType newActiveResourceType_ActiveResourceSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__ACTIVE_RESOURCE_TYPE_ACTIVE_RESOURCE_SPECIFICATION, oldActiveResourceType_ActiveResourceSpecification, activeResourceType_ActiveResourceSpecification));
   }
   ...
   public NotificationChain basicSetProcessingRate_ProcessingResourceSpecification(PCMRandomVariable newProcessingRate_ProcessingResourceSpecification, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__PROCESSING_RATE_PROCESSING_RESOURCE_SPECIFICATION, oldProcessingRate_ProcessingResourceSpecification, newProcessingRate_ProcessingResourceSpecification);
   ...
   public void setProcessingRate_ProcessingResourceSpecification(PCMRandomVariable newProcessingRate_ProcessingResourceSpecification) {
      if (newProcessingRate_ProcessingResourceSpecification != processingRate_ProcessingResourceSpecification) {
         ...
         if (processingRate_ProcessingResourceSpecification != null)
            msgs = ((InternalEObject)processingRate_ProcessingResourceSpecification).eInverseRemove(this, Core_pcPackage.PCM_RANDOM_VARIABLE__PROCESSING_RESOURCE_SPECIFICATION_PROCESSING_RATE_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         if (newProcessingRate_ProcessingResourceSpecification != null)
            msgs = ((InternalEObject)newProcessingRate_ProcessingResourceSpecification).eInverseAdd(this, Core_pcPackage.PCM_RANDOM_VARIABLE__PROCESSING_RESOURCE_SPECIFICATION_PROCESSING_RATE_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__PROCESSING_RATE_PROCESSING_RESOURCE_SPECIFICATION, newProcessingRate_ProcessingResourceSpecification, newProcessingRate_ProcessingResourceSpecification));
   }
   ...
   public void setNumberOfReplicas(int newNumberOfReplicas) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__NUMBER_OF_REPLICAS, oldNumberOfReplicas, numberOfReplicas));
   }
   ...
   public ResourceContainer getResourceContainer_ProcessingResourceSpecification() {
      if (eContainerFeatureID() != Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION) return null;
   ...
   public NotificationChain basicSetResourceContainer_ProcessingResourceSpecification(ResourceContainer newResourceContainer_ProcessingResourceSpecification, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newResourceContainer_ProcessingResourceSpecification, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION, msgs);
      return msgs;
   }
   ...
   public void setResourceContainer_ProcessingResourceSpecification(ResourceContainer newResourceContainer_ProcessingResourceSpecification) {
      if (newResourceContainer_ProcessingResourceSpecification != eInternalContainer() || (eContainerFeatureID() != Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION && newResourceContainer_ProcessingResourceSpecification != null)) {
         ...
         if (newResourceContainer_ProcessingResourceSpecification != null)
            msgs = ((InternalEObject)newResourceContainer_ProcessingResourceSpecification).eInverseAdd(this, Resourceenvironment_pcPackage.RESOURCE_CONTAINER__ACTIVE_RESOURCE_SPECIFICATIONS_RESOURCE_CONTAINER, ResourceContainer.class, msgs);
         msgs = basicSetResourceContainer_ProcessingResourceSpecification(newResourceContainer_ProcessingResourceSpecification, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION, newResourceContainer_ProcessingResourceSpecification, newResourceContainer_ProcessingResourceSpecification));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__PROCESSING_RATE_PROCESSING_RESOURCE_SPECIFICATION:
            if (processingRate_ProcessingResourceSpecification != null)
               msgs = ((InternalEObject)processingRate_ProcessingResourceSpecification).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__PROCESSING_RATE_PROCESSING_RESOURCE_SPECIFICATION, null, msgs);
            return basicSetProcessingRate_ProcessingResourceSpecification((PCMRandomVariable)otherEnd, msgs);
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION:
            return eInternalContainer().eInverseRemove(this, Resourceenvironment_pcPackage.RESOURCE_CONTAINER__ACTIVE_RESOURCE_SPECIFICATIONS_RESOURCE_CONTAINER, ResourceContainer.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__MTTR:
            return getMTTR();
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__MTTF:
            return getMTTF();
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__REQUIRED_BY_CONTAINER:
            return isRequiredByContainer();
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__SCHEDULING_POLICY:
            if (resolve) return getSchedulingPolicy();
            return basicGetSchedulingPolicy();
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__ACTIVE_RESOURCE_TYPE_ACTIVE_RESOURCE_SPECIFICATION:
         ...
         case Resourceenvironment_pcPackage.PROCESSING_RESOURCE_SPECIFICATION__NUMBER_OF_REPLICAS:
