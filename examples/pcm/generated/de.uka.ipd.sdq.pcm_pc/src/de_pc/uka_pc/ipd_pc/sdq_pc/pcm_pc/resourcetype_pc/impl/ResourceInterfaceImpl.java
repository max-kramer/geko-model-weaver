 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourcetype_pc.impl.ResourceInterfaceImpl#getResourceRepository__ResourceInterface <em>Resource Repository Resource Interface</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourcetype_pc.impl.ResourceInterfaceImpl#getResourceSignatures__ResourceInterface <em>Resource Signatures Resource Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceInterfaceImpl extends EntityImpl implements ResourceInterface {
   ...
   protected EClass eStaticClass() {
      return Resourcetype_pcPackage.Literals.RESOURCE_INTERFACE;
   }
   ...
   public ResourceRepository getResourceRepository__ResourceInterface() {
      if (eContainerFeatureID() != Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE) return null;
   ...
   public NotificationChain basicSetResourceRepository__ResourceInterface(ResourceRepository newResourceRepository__ResourceInterface, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newResourceRepository__ResourceInterface, Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE, msgs);
      return msgs;
   }
   ...
   public void setResourceRepository__ResourceInterface(ResourceRepository newResourceRepository__ResourceInterface) {
      if (newResourceRepository__ResourceInterface != eInternalContainer() || (eContainerFeatureID() != Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE && newResourceRepository__ResourceInterface != null)) {
         ...
         if (newResourceRepository__ResourceInterface != null)
            msgs = ((InternalEObject)newResourceRepository__ResourceInterface).eInverseAdd(this, Resourcetype_pcPackage.RESOURCE_REPOSITORY__RESOURCE_INTERFACES_RESOURCE_REPOSITORY, ResourceRepository.class, msgs);
         msgs = basicSetResourceRepository__ResourceInterface(newResourceRepository__ResourceInterface, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE, newResourceRepository__ResourceInterface, newResourceRepository__ResourceInterface));
   }
   ...
   public EList<ResourceSignature> getResourceSignatures__ResourceInterface() {
      if (resourceSignatures__ResourceInterface == null) {
         resourceSignatures__ResourceInterface = new EObjectContainmentWithInverseEList<ResourceSignature>(ResourceSignature.class, this, Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE, Resourcetype_pcPackage.RESOURCE_SIGNATURE__RESOURCE_INTERFACE_RESOURCE_SIGNATURE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetResourceRepository__ResourceInterface((ResourceRepository)otherEnd, msgs);
         case Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE:
            return eInternalContainer().eInverseRemove(this, Resourcetype_pcPackage.RESOURCE_REPOSITORY__RESOURCE_INTERFACES_RESOURCE_REPOSITORY, ResourceRepository.class, msgs);
      }
