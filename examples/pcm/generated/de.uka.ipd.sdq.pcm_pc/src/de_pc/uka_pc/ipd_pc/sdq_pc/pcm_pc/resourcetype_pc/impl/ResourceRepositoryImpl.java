 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourcetype_pc.impl.ResourceRepositoryImpl#getResourceInterfaces__ResourceRepository <em>Resource Interfaces Resource Repository</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourcetype_pc.impl.ResourceRepositoryImpl#getSchedulingPolicies__ResourceRepository <em>Scheduling Policies Resource Repository</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.resourcetype_pc.impl.ResourceRepositoryImpl#getAvailableResourceTypes_ResourceRepository <em>Available Resource Types Resource Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceRepositoryImpl extends EObjectImpl implements ResourceRepository {
   ...
   protected EClass eStaticClass() {
      return Resourcetype_pcPackage.Literals.RESOURCE_REPOSITORY;
   }
   ...
   public EList<ResourceInterface> getResourceInterfaces__ResourceRepository() {
      if (resourceInterfaces__ResourceRepository == null) {
         resourceInterfaces__ResourceRepository = new EObjectContainmentWithInverseEList<ResourceInterface>(ResourceInterface.class, this, Resourcetype_pcPackage.RESOURCE_REPOSITORY__RESOURCE_INTERFACES_RESOURCE_REPOSITORY, Resourcetype_pcPackage.RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE);
      }
   ...
   public EList<SchedulingPolicy> getSchedulingPolicies__ResourceRepository() {
      if (schedulingPolicies__ResourceRepository == null) {
         schedulingPolicies__ResourceRepository = new EObjectContainmentWithInverseEList<SchedulingPolicy>(SchedulingPolicy.class, this, Resourcetype_pcPackage.RESOURCE_REPOSITORY__SCHEDULING_POLICIES_RESOURCE_REPOSITORY, Resourcetype_pcPackage.SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY);
      }
   ...
   public EList<ResourceType> getAvailableResourceTypes_ResourceRepository() {
      if (availableResourceTypes_ResourceRepository == null) {
         availableResourceTypes_ResourceRepository = new EObjectContainmentWithInverseEList<ResourceType>(ResourceType.class, this, Resourcetype_pcPackage.RESOURCE_REPOSITORY__AVAILABLE_RESOURCE_TYPES_RESOURCE_REPOSITORY, Resourcetype_pcPackage.RESOURCE_TYPE__RESOURCE_REPOSITORY_RESOURCE_TYPE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Resourcetype_pcPackage.RESOURCE_REPOSITORY__RESOURCE_INTERFACES_RESOURCE_REPOSITORY:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getResourceInterfaces__ResourceRepository()).basicAdd(otherEnd, msgs);
         case Resourcetype_pcPackage.RESOURCE_REPOSITORY__SCHEDULING_POLICIES_RESOURCE_REPOSITORY:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getSchedulingPolicies__ResourceRepository()).basicAdd(otherEnd, msgs);
         case Resourcetype_pcPackage.RESOURCE_REPOSITORY__AVAILABLE_RESOURCE_TYPES_RESOURCE_REPOSITORY:
