 ...
 * @generated
 */
public class Resourcetype_pcSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourcetype_pcPackage.RESOURCE_SIGNATURE: {
         ...
         case Resourcetype_pcPackage.PROCESSING_RESOURCE_TYPE: {
         ...
         case Resourcetype_pcPackage.RESOURCE_TYPE: {
         ...
         case Resourcetype_pcPackage.COMMUNICATION_LINK_RESOURCE_TYPE: {
         ...
         case Resourcetype_pcPackage.RESOURCE_INTERFACE: {
