 ...
 * @generated
 */
public class Seff_performance_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Seff_performance_pcValidator INSTANCE = new Seff_performance_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.seff_performance_pc";
    ...
    * @generated
    */
   public Seff_performance_pcValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Seff_performance_pcPackage.INFRASTRUCTURE_CALL:
            return validateInfrastructureCall((InfrastructureCall)value, diagnostics, context);
         case Seff_performance_pcPackage.RESOURCE_CALL:
            return validateResourceCall((ResourceCall)value, diagnostics, context);
         case Seff_performance_pcPackage.PARAMETRIC_RESOURCE_DEMAND:
