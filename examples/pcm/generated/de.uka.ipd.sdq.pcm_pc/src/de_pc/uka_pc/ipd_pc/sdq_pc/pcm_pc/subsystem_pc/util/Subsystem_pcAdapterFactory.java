/**
 */
package de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.subsystem_pc.util;
 ...
 * @generated
 */
public class Subsystem_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Subsystem_pcPackage modelPackage;
    ...
    * @generated
    */
   public Subsystem_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Subsystem_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Subsystem_pcSwitch<Adapter> modelSwitch =
      new Subsystem_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.subsystem_pc.SubSystem <em>Sub System</em>}'.
    * <!-- begin-user-doc -->
