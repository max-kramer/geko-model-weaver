 ...
 * @generated
 */
public class System_pcPackageImpl extends EPackageImpl implements System_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.system_pc.System_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private System_pcPackageImpl() {
      super(eNS_URI, System_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link System_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static System_pcPackage init() {
      if (isInited) return (System_pcPackage)EPackage.Registry.INSTANCE.getEPackage(System_pcPackage.eNS_URI);

      // Obtain or create and register package
      System_pcPackageImpl theSystem_pcPackage = (System_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof System_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new System_pcPackageImpl());
         ...
         (theSystem_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return System_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSystem_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(System_pcPackage.eNS_URI, theSystem_pcPackage);
      return theSystem_pcPackage;
   }
    ...
    * @generated
    */
   public System_pcFactory getSystem_pcFactory() {
      return (System_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      systemEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      systemEClass.getESuperTypes().add(theEntity_pcPackage.getComposedProvidingRequiringEntity());

      // Initialize classes and features; add operations and parameters
      initEClass(systemEClass, de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.system_pc.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getSystem_QosAnnotations_System(), theQosannotations_pcPackage.getQoSAnnotations(), theQosannotations_pcPackage.getQoSAnnotations_System_QoSAnnotations(), "qosAnnotations_System", null, 0, -1, de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.system_pc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
