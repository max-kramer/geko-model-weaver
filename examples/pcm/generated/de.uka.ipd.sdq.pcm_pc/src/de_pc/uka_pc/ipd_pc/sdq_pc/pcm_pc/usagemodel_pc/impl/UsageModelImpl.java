 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.UsageModelImpl#getUsageScenario_UsageModel <em>Usage Scenario Usage Model</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.UsageModelImpl#getUserData_UsageModel <em>User Data Usage Model</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UsageModelImpl extends EObjectImpl implements UsageModel {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pcPackage.Literals.USAGE_MODEL;
   }
   ...
   public EList<UsageScenario> getUsageScenario_UsageModel() {
      if (usageScenario_UsageModel == null) {
         usageScenario_UsageModel = new EObjectContainmentWithInverseEList<UsageScenario>(UsageScenario.class, this, Usagemodel_pcPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL, Usagemodel_pcPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO);
      }
   ...
   public EList<UserData> getUserData_UsageModel() {
      if (userData_UsageModel == null) {
         userData_UsageModel = new EObjectContainmentWithInverseEList<UserData>(UserData.class, this, Usagemodel_pcPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, Usagemodel_pcPackage.USER_DATA__USAGE_MODEL_USER_DATA);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pcPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getUsageScenario_UsageModel()).basicAdd(otherEnd, msgs);
         case Usagemodel_pcPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL:
