 ...
 * @generated
 */
public class Qosannotations_pc_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Qosannotations_pc_avValidator INSTANCE = new Qosannotations_pc_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.qosannotations_pc_av";
    ...
    * @generated
    */
   public Qosannotations_pc_avValidator() {
      super();
   ...
   public boolean validateQoSAnnotations(QoSAnnotations qoSAnnotations, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_avValidator.validateIdentifier_idHasToBeUnique(qoSAnnotations, diagnostics, context);
