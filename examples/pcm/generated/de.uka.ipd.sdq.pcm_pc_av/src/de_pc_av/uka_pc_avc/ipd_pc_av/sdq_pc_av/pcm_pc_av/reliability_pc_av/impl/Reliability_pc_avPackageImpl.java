...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.reliability_pc_av.FailureOccurrenceDescription;
...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.reliability_pc_av.Reliability_pc_avFactory;
 ...
 * @generated
 */
public class Reliability_pc_avPackageImpl extends EPackageImpl implements Reliability_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.reliability_pc_av.Reliability_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Reliability_pc_avPackageImpl() {
      super(eNS_URI, Reliability_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Reliability_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Reliability_pc_avPackage init() {
      if (isInited) return (Reliability_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Reliability_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Reliability_pc_avPackageImpl theReliability_pc_avPackage = (Reliability_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Reliability_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Reliability_pc_avPackageImpl());
         ...
         (theReliability_pc_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Reliability_pc_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theReliability_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Reliability_pc_avPackage.eNS_URI, theReliability_pc_avPackage);
      return theReliability_pc_avPackage;
   }
    ...
    * @generated
    */
   public Reliability_pc_avFactory getReliability_pc_avFactory() {
      return (Reliability_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      failureTypeEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      ...
      initEReference(getNetworkInducedFailureType_CommunicationLinkResourceType__NetworkInducedFailureType(), theResourcetype_pc_avPackage.getCommunicationLinkResourceType(), theResourcetype_pc_avPackage.getCommunicationLinkResourceType_NetworkInducedFailureType__CommunicationLinkResourceType(), "communicationLinkResourceType__NetworkInducedFailureType", null, 0, 1, NetworkInducedFailureType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
