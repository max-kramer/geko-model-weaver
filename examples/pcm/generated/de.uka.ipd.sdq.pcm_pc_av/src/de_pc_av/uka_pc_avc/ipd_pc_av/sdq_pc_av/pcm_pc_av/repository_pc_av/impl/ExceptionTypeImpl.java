 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.impl.ExceptionTypeImpl#getExceptionName <em>Exception Name</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.impl.ExceptionTypeImpl#getExceptionMessage <em>Exception Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_avPackage.Literals.EXCEPTION_TYPE;
   }
   ...
   public void setExceptionName(String newExceptionName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_avPackage.EXCEPTION_TYPE__EXCEPTION_NAME, oldExceptionName, exceptionName));
   }
   ...
   public void setExceptionMessage(String newExceptionMessage) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_avPackage.EXCEPTION_TYPE__EXCEPTION_MESSAGE, oldExceptionMessage, exceptionMessage));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pc_avPackage.EXCEPTION_TYPE__EXCEPTION_NAME:
            return getExceptionName();
         case Repository_pc_avPackage.EXCEPTION_TYPE__EXCEPTION_MESSAGE:
