 ...
 * @generated
 */
public class Repository_pc_avFactoryImpl extends EFactoryImpl implements Repository_pc_avFactory {
   /**
    ...
    * @generated
    */
   public static Repository_pc_avFactory init() {
      try {
         Repository_pc_avFactory theRepository_pc_avFactory = (Repository_pc_avFactory)EPackage.Registry.INSTANCE.getEFactory(Repository_pc_avPackage.eNS_URI);
         if (theRepository_pc_avFactory != null) {
            return theRepository_pc_avFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Repository_pc_avFactoryImpl();
   }
    ...
    * @generated
    */
   public Repository_pc_avFactoryImpl() {
      super();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Repository_pc_avPackage.PASSIVE_RESOURCE: return createPassiveResource();
         case Repository_pc_avPackage.BASIC_COMPONENT: return createBasicComponent();
         case Repository_pc_avPackage.IMPLEMENTATION_COMPONENT_TYPE: return createImplementationComponentType();
         case Repository_pc_avPackage.REPOSITORY_COMPONENT: return createRepositoryComponent();
         case Repository_pc_avPackage.PROVIDED_ROLE: return createProvidedRole();
         case Repository_pc_avPackage.PARAMETER: return createParameter();
         case Repository_pc_avPackage.DATA_TYPE: return createDataType();
         case Repository_pc_avPackage.REPOSITORY: return createRepository();
         case Repository_pc_avPackage.INTERFACE: return createInterface();
         case Repository_pc_avPackage.REQUIRED_CHARACTERISATION: return createRequiredCharacterisation();
         case Repository_pc_avPackage.EVENT_GROUP: return createEventGroup();
         case Repository_pc_avPackage.EVENT_TYPE: return createEventType();
         case Repository_pc_avPackage.SIGNATURE: return createSignature();
         case Repository_pc_avPackage.EXCEPTION_TYPE: return createExceptionType();
         case Repository_pc_avPackage.INFRASTRUCTURE_SIGNATURE: return createInfrastructureSignature();
         case Repository_pc_avPackage.INFRASTRUCTURE_INTERFACE: return createInfrastructureInterface();
         case Repository_pc_avPackage.INFRASTRUCTURE_REQUIRED_ROLE: return createInfrastructureRequiredRole();
         case Repository_pc_avPackage.REQUIRED_ROLE: return createRequiredRole();
         case Repository_pc_avPackage.OPERATION_SIGNATURE: return createOperationSignature();
         case Repository_pc_avPackage.OPERATION_INTERFACE: return createOperationInterface();
         case Repository_pc_avPackage.OPERATION_REQUIRED_ROLE: return createOperationRequiredRole();
         case Repository_pc_avPackage.SOURCE_ROLE: return createSourceRole();
         case Repository_pc_avPackage.SINK_ROLE: return createSinkRole();
         case Repository_pc_avPackage.OPERATION_PROVIDED_ROLE: return createOperationProvidedRole();
         case Repository_pc_avPackage.INFRASTRUCTURE_PROVIDED_ROLE: return createInfrastructureProvidedRole();
         case Repository_pc_avPackage.COMPLETE_COMPONENT_TYPE: return createCompleteComponentType();
         case Repository_pc_avPackage.PROVIDES_COMPONENT_TYPE: return createProvidesComponentType();
         case Repository_pc_avPackage.COMPOSITE_COMPONENT: return createCompositeComponent();
         case Repository_pc_avPackage.PRIMITIVE_DATA_TYPE: return createPrimitiveDataType();
         case Repository_pc_avPackage.COLLECTION_DATA_TYPE: return createCollectionDataType();
         case Repository_pc_avPackage.COMPOSITE_DATA_TYPE: return createCompositeDataType();
         case Repository_pc_avPackage.INNER_DECLARATION: return createInnerDeclaration();
         case Repository_pc_avPackage.ROLE: return createRole();
         default:
    ...
    * @generated
    */
   public Repository_pc_avPackage getRepository_pc_avPackage() {
      return (Repository_pc_avPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Repository_pc_avPackage getPackage() {
      return Repository_pc_avPackage.eINSTANCE;
   }

} //Repository_pc_avFactoryImpl
