 ...
 * @generated
 */
public class Resourceenvironment_pc_avSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourceenvironment_pc_avSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourceenvironment_pc_avPackage.RESOURCE_ENVIRONMENT: {
         ...
         case Resourceenvironment_pc_avPackage.LINKING_RESOURCE: {
         ...
         case Resourceenvironment_pc_avPackage.RESOURCE_CONTAINER: {
         ...
         case Resourceenvironment_pc_avPackage.PROCESSING_RESOURCE_SPECIFICATION: {
         ...
         case Resourceenvironment_pc_avPackage.COMMUNICATION_LINK_RESOURCE_SPECIFICATION: {
...
} //Resourceenvironment_pc_avSwitch
