 ...
 * <!-- end-model-doc -->
 * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.Resourcetype_pc_avFactory
 * @model kind="package"
 * @generated
 */
public interface Resourcetype_pc_avPackage extends EPackage {
   /**
    * The package name.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   String eNAME = "resourcetype_pc_av";
    ...
    * @generated
    */
   String eNS_URI = "http://sdq.ipd.uka.de/PalladioComponentModel/ResourceType/5.0_pointcut_advice";
    ...
    * @generated
    */
   String eNS_PREFIX = "resourcetype_pc_av";
    ...
    * @generated
    */
   Resourcetype_pc_avPackage eINSTANCE = de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl.init();

   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceSignatureImpl <em>Resource Signature</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceSignatureImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceSignature()
    * @generated
    */
    ...
    * @ordered
    */
   int RESOURCE_SIGNATURE__ID = Entity_pc_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int RESOURCE_SIGNATURE__ENTITY_NAME = Entity_pc_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int RESOURCE_SIGNATURE__PARAMETER_RESOURCE_SIGNATURE = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int RESOURCE_SIGNATURE__RESOURCE_SERVICE_ID = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int RESOURCE_SIGNATURE__RESOURCE_INTERFACE_RESOURCE_SIGNATURE = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int RESOURCE_SIGNATURE_FEATURE_COUNT = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 3;

   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceTypeImpl <em>Resource Type</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceTypeImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceType()
    * @generated
    */
   int RESOURCE_TYPE = 2;
    ...
    * @ordered
    */
   int RESOURCE_TYPE__ID = Entity_pc_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int RESOURCE_TYPE__ENTITY_NAME = Entity_pc_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int RESOURCE_TYPE__UNIT = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int RESOURCE_TYPE__UNIT_SPECIFICATION = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int RESOURCE_TYPE__RESOURCE_PROVIDED_ROLES_RESOURCE_INTERFACE_PROVIDING_ENTITY = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int RESOURCE_TYPE__RESOURCE_REPOSITORY_RESOURCE_TYPE = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 3;
    ...
    * @ordered
    */
   int RESOURCE_TYPE_FEATURE_COUNT = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 4;

   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ProcessingResourceTypeImpl <em>Processing Resource Type</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ProcessingResourceTypeImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getProcessingResourceType()
    * @generated
    */
   ...
   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceRepositoryImpl <em>Resource Repository</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceRepositoryImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceRepository()
    * @generated
    */
   ...
   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.SchedulingPolicyImpl <em>Scheduling Policy</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.SchedulingPolicyImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getSchedulingPolicy()
    * @generated
    */
    ...
    * @ordered
    */
   int SCHEDULING_POLICY__ID = Entity_pc_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int SCHEDULING_POLICY__ENTITY_NAME = Entity_pc_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int SCHEDULING_POLICY__RESOURCE_REPOSITORY_SCHEDULING_POLICY = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int SCHEDULING_POLICY_FEATURE_COUNT = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 1;

   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.CommunicationLinkResourceTypeImpl <em>Communication Link Resource Type</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.CommunicationLinkResourceTypeImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getCommunicationLinkResourceType()
    * @generated
    */
   ...
   /**
    * The meta object id for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceInterfaceImpl <em>Resource Interface</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceInterfaceImpl
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceInterface()
    * @generated
    */
    ...
    * @ordered
    */
   int RESOURCE_INTERFACE__ID = Entity_pc_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int RESOURCE_INTERFACE__ENTITY_NAME = Entity_pc_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int RESOURCE_INTERFACE__RESOURCE_REPOSITORY_RESOURCE_INTERFACE = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int RESOURCE_INTERFACE__RESOURCE_SIGNATURES_RESOURCE_INTERFACE = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int RESOURCE_INTERFACE_FEATURE_COUNT = Entity_pc_avPackage.ENTITY_FEATURE_COUNT + 2;


   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature <em>Resource Signature</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the containment reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature#getParameter__ResourceSignature <em>Parameter Resource Signature</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference '<em>Parameter Resource Signature</em>'.
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature#getParameter__ResourceSignature()
   ...
   /**
    * Returns the meta object for the attribute '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature#getResourceServiceId <em>Resource Service Id</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>Resource Service Id</em>'.
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature#getResourceServiceId()
    * @see #getResourceSignature()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature#getResourceInterface__ResourceSignature <em>Resource Interface Resource Signature</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Resource Interface Resource Signature</em>'.
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceSignature#getResourceInterface__ResourceSignature()
    * @see #getResourceSignature()
    * @generated
    */
   ...
   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ProcessingResourceType <em>Processing Resource Type</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ProcessingResourceType#getHardwareInducedFailureType__ProcessingResourceType <em>Hardware Induced Failure Type Processing Resource Type</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceType <em>Resource Type</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceType#getResourceRepository_ResourceType <em>Resource Repository Resource Type</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceRepository <em>Resource Repository</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceRepository#getResourceInterfaces__ResourceRepository <em>Resource Interfaces Resource Repository</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference list '<em>Resource Interfaces Resource Repository</em>'.
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceRepository#getResourceInterfaces__ResourceRepository()
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceRepository#getSchedulingPolicies__ResourceRepository <em>Scheduling Policies Resource Repository</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceRepository#getAvailableResourceTypes_ResourceRepository <em>Available Resource Types Resource Repository</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.SchedulingPolicy <em>Scheduling Policy</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.SchedulingPolicy#getResourceRepository__SchedulingPolicy <em>Resource Repository Scheduling Policy</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.CommunicationLinkResourceType <em>Communication Link Resource Type</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.CommunicationLinkResourceType#getNetworkInducedFailureType__CommunicationLinkResourceType <em>Network Induced Failure Type Communication Link Resource Type</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Network Induced Failure Type Communication Link Resource Type</em>'.
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.CommunicationLinkResourceType#getNetworkInducedFailureType__CommunicationLinkResourceType()
   ...
   /**
    * Returns the meta object for class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceInterface <em>Resource Interface</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceInterface#getResourceRepository__ResourceInterface <em>Resource Repository Resource Interface</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceInterface#getResourceSignatures__ResourceInterface <em>Resource Signatures Resource Interface</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference list '<em>Resource Signatures Resource Interface</em>'.
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.ResourceInterface#getResourceSignatures__ResourceInterface()
    * @see #getResourceInterface()
    * @generated
    */
    ...
    * @generated
    */
   Resourcetype_pc_avFactory getResourcetype_pc_avFactory();
   ...
   interface Literals {
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceSignatureImpl <em>Resource Signature</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceSignatureImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceSignature()
      ...
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ProcessingResourceTypeImpl <em>Processing Resource Type</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ProcessingResourceTypeImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getProcessingResourceType()
      ...
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceTypeImpl <em>Resource Type</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceTypeImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceType()
      ...
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceRepositoryImpl <em>Resource Repository</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceRepositoryImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceRepository()
      ...
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.SchedulingPolicyImpl <em>Scheduling Policy</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.SchedulingPolicyImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getSchedulingPolicy()
      ...
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.CommunicationLinkResourceTypeImpl <em>Communication Link Resource Type</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.CommunicationLinkResourceTypeImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getCommunicationLinkResourceType()
      ...
      /**
       * The meta object literal for the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceInterfaceImpl <em>Resource Interface</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.ResourceInterfaceImpl
       * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.resourcetype_pc_av.impl.Resourcetype_pc_avPackageImpl#getResourceInterface()
