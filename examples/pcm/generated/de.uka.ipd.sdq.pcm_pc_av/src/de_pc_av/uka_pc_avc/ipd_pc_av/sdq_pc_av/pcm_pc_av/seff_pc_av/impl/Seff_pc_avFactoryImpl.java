 ...
 * @generated
 */
public class Seff_pc_avFactoryImpl extends EFactoryImpl implements Seff_pc_avFactory {
   /**
    ...
    * @generated
    */
   public static Seff_pc_avFactory init() {
      try {
         Seff_pc_avFactory theSeff_pc_avFactory = (Seff_pc_avFactory)EPackage.Registry.INSTANCE.getEFactory(Seff_pc_avPackage.eNS_URI);
         if (theSeff_pc_avFactory != null) {
            return theSeff_pc_avFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Seff_pc_avFactoryImpl();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Seff_pc_avPackage.STOP_ACTION: return createStopAction();
         case Seff_pc_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION: return createAbstractInternalControlFlowAction();
         case Seff_pc_avPackage.ABSTRACT_ACTION: return createAbstractAction();
         case Seff_pc_avPackage.RESOURCE_DEMANDING_BEHAVIOUR: return createResourceDemandingBehaviour();
         case Seff_pc_avPackage.ABSTRACT_LOOP_ACTION: return createAbstractLoopAction();
         case Seff_pc_avPackage.ABSTRACT_BRANCH_TRANSITION: return createAbstractBranchTransition();
         case Seff_pc_avPackage.BRANCH_ACTION: return createBranchAction();
         case Seff_pc_avPackage.CALL_ACTION: return createCallAction();
         case Seff_pc_avPackage.START_ACTION: return createStartAction();
         case Seff_pc_avPackage.SERVICE_EFFECT_SPECIFICATION: return createServiceEffectSpecification();
         case Seff_pc_avPackage.RESOURCE_DEMANDING_SEFF: return createResourceDemandingSEFF();
         case Seff_pc_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR: return createResourceDemandingInternalBehaviour();
         case Seff_pc_avPackage.RELEASE_ACTION: return createReleaseAction();
         case Seff_pc_avPackage.LOOP_ACTION: return createLoopAction();
         case Seff_pc_avPackage.FORK_ACTION: return createForkAction();
         case Seff_pc_avPackage.FORKED_BEHAVIOUR: return createForkedBehaviour();
         case Seff_pc_avPackage.SYNCHRONISATION_POINT: return createSynchronisationPoint();
         case Seff_pc_avPackage.EXTERNAL_CALL_ACTION: return createExternalCallAction();
         case Seff_pc_avPackage.CALL_RETURN_ACTION: return createCallReturnAction();
         case Seff_pc_avPackage.PROBABILISTIC_BRANCH_TRANSITION: return createProbabilisticBranchTransition();
         case Seff_pc_avPackage.ACQUIRE_ACTION: return createAcquireAction();
         case Seff_pc_avPackage.COLLECTION_ITERATOR_ACTION: return createCollectionIteratorAction();
         case Seff_pc_avPackage.GUARDED_BRANCH_TRANSITION: return createGuardedBranchTransition();
         case Seff_pc_avPackage.SET_VARIABLE_ACTION: return createSetVariableAction();
         case Seff_pc_avPackage.INTERNAL_CALL_ACTION: return createInternalCallAction();
         case Seff_pc_avPackage.EMIT_EVENT_ACTION: return createEmitEventAction();
         case Seff_pc_avPackage.INTERNAL_ACTION: return createInternalAction();
         default:
    ...
    * @generated
    */
   public Seff_pc_avPackage getSeff_pc_avPackage() {
      return (Seff_pc_avPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Seff_pc_avPackage getPackage() {
      return Seff_pc_avPackage.eINSTANCE;
   }

} //Seff_pc_avFactoryImpl
