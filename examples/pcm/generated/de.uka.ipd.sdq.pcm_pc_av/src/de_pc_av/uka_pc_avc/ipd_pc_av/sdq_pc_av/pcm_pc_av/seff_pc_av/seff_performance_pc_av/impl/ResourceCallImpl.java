 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.seff_pc_av.seff_performance_pc_av.impl.ResourceCallImpl#getAction__ResourceCall <em>Action Resource Call</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.seff_pc_av.seff_performance_pc_av.impl.ResourceCallImpl#getResourceRequiredRole__ResourceCall <em>Resource Required Role Resource Call</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.seff_pc_av.seff_performance_pc_av.impl.ResourceCallImpl#getSignature__ResourceCall <em>Signature Resource Call</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.seff_pc_av.seff_performance_pc_av.impl.ResourceCallImpl#getNumberOfCalls__ResourceCall <em>Number Of Calls Resource Call</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceCallImpl extends CallActionImpl implements ResourceCall {
   ...
   protected EClass eStaticClass() {
      return Seff_performance_pc_avPackage.Literals.RESOURCE_CALL;
   }
   ...
   public AbstractInternalControlFlowAction getAction__ResourceCall() {
      if (eContainerFeatureID() != Seff_performance_pc_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL) return null;
   ...
   public NotificationChain basicSetAction__ResourceCall(AbstractInternalControlFlowAction newAction__ResourceCall, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newAction__ResourceCall, Seff_performance_pc_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL, msgs);
      return msgs;
   }
   ...
   public void setAction__ResourceCall(AbstractInternalControlFlowAction newAction__ResourceCall) {
      if (newAction__ResourceCall != eInternalContainer() || (eContainerFeatureID() != Seff_performance_pc_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL && newAction__ResourceCall != null)) {
         ...
         if (newAction__ResourceCall != null)
            msgs = ((InternalEObject)newAction__ResourceCall).eInverseAdd(this, Seff_pc_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_CALL_ACTION, AbstractInternalControlFlowAction.class, msgs);
         msgs = basicSetAction__ResourceCall(newAction__ResourceCall, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_pc_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL, newAction__ResourceCall, newAction__ResourceCall));
   }
      ...
      if (resourceRequiredRole__ResourceCall != null && resourceRequiredRole__ResourceCall.eIsProxy()) {
         ...
         if (resourceRequiredRole__ResourceCall != oldResourceRequiredRole__ResourceCall) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_performance_pc_avPackage.RESOURCE_CALL__RESOURCE_REQUIRED_ROLE_RESOURCE_CALL, oldResourceRequiredRole__ResourceCall, resourceRequiredRole__ResourceCall));
         }
      }
   ...
   public void setResourceRequiredRole__ResourceCall(ResourceRequiredRole newResourceRequiredRole__ResourceCall) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_pc_avPackage.RESOURCE_CALL__RESOURCE_REQUIRED_ROLE_RESOURCE_CALL, oldResourceRequiredRole__ResourceCall, resourceRequiredRole__ResourceCall));
   }
   ...
   public ResourceSignature getSignature__ResourceCall() {
      if (signature__ResourceCall != null && signature__ResourceCall.eIsProxy()) {
         ...
         if (signature__ResourceCall != oldSignature__ResourceCall) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_performance_pc_avPackage.RESOURCE_CALL__SIGNATURE_RESOURCE_CALL, oldSignature__ResourceCall, signature__ResourceCall));
         }
      }
   ...
   public void setSignature__ResourceCall(ResourceSignature newSignature__ResourceCall) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_pc_avPackage.RESOURCE_CALL__SIGNATURE_RESOURCE_CALL, oldSignature__ResourceCall, signature__ResourceCall));
   }
   ...
   public NotificationChain basicSetNumberOfCalls__ResourceCall(PCMRandomVariable newNumberOfCalls__ResourceCall, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_performance_pc_avPackage.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL, oldNumberOfCalls__ResourceCall, newNumberOfCalls__ResourceCall);
   ...
   public void setNumberOfCalls__ResourceCall(PCMRandomVariable newNumberOfCalls__ResourceCall) {
      if (newNumberOfCalls__ResourceCall != numberOfCalls__ResourceCall) {
         ...
         if (numberOfCalls__ResourceCall != null)
            msgs = ((InternalEObject)numberOfCalls__ResourceCall).eInverseRemove(this, Core_pc_avPackage.PCM_RANDOM_VARIABLE__RESOURCE_CALL_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         if (newNumberOfCalls__ResourceCall != null)
            msgs = ((InternalEObject)newNumberOfCalls__ResourceCall).eInverseAdd(this, Core_pc_avPackage.PCM_RANDOM_VARIABLE__RESOURCE_CALL_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         msgs = basicSetNumberOfCalls__ResourceCall(newNumberOfCalls__ResourceCall, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_pc_avPackage.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL, newNumberOfCalls__ResourceCall, newNumberOfCalls__ResourceCall));
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Seff_performance_pc_avValidator.RESOURCE_CALL__RESOURCE_SIGNATURE_BELONGS_TO_RESOURCE_REQUIRED_ROLE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_performance_pc_avValidator.DIAGNOSTIC_SOURCE,
                   Seff_performance_pc_avValidator.RESOURCE_CALL__RESOURCE_REQUIRED_ROLE_MUST_BE_REFERENCED_BY_COMPONENT,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_performance_pc_avValidator.DIAGNOSTIC_SOURCE,
                   Seff_performance_pc_avValidator.RESOURCE_CALL__SIGNATURE_ROLE_COMBINATION_MUST_BE_UNIQUE_WITHIN_ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_performance_pc_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetAction__ResourceCall((AbstractInternalControlFlowAction)otherEnd, msgs);
         case Seff_performance_pc_avPackage.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL:
            if (numberOfCalls__ResourceCall != null)
               msgs = ((InternalEObject)numberOfCalls__ResourceCall).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Seff_performance_pc_avPackage.RESOURCE_CALL__NUMBER_OF_CALLS_RESOURCE_CALL, null, msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Seff_performance_pc_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL:
            return eInternalContainer().eInverseRemove(this, Seff_pc_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_CALL_ACTION, AbstractInternalControlFlowAction.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Seff_performance_pc_avPackage.RESOURCE_CALL__RESOURCE_REQUIRED_ROLE_RESOURCE_CALL:
            if (resolve) return getResourceRequiredRole__ResourceCall();
            return basicGetResourceRequiredRole__ResourceCall();
         case Seff_performance_pc_avPackage.RESOURCE_CALL__SIGNATURE_RESOURCE_CALL:
