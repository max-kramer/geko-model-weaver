 ...
 * @generated
 */
public class Seff_performance_pc_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Seff_performance_pc_avValidator INSTANCE = new Seff_performance_pc_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.seff_pc_av.seff_performance_pc_av";
    ...
    * @generated
    */
   public Seff_performance_pc_avValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Seff_performance_pc_avPackage.INFRASTRUCTURE_CALL:
            return validateInfrastructureCall((InfrastructureCall)value, diagnostics, context);
         case Seff_performance_pc_avPackage.RESOURCE_CALL:
            return validateResourceCall((ResourceCall)value, diagnostics, context);
         case Seff_performance_pc_avPackage.PARAMETRIC_RESOURCE_DEMAND:
...
} //Seff_performance_pc_avValidator
