...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.subsystem_pc_av.SubSystem;
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.subsystem_pc_av.Subsystem_pc_avFactory;
 ...
 * @generated
 */
public class Subsystem_pc_avPackageImpl extends EPackageImpl implements Subsystem_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.subsystem_pc_av.Subsystem_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Subsystem_pc_avPackageImpl() {
      super(eNS_URI, Subsystem_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Subsystem_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Subsystem_pc_avPackage init() {
      if (isInited) return (Subsystem_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Subsystem_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Subsystem_pc_avPackageImpl theSubsystem_pc_avPackage = (Subsystem_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Subsystem_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Subsystem_pc_avPackageImpl());
      ...
      theSubsystem_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Subsystem_pc_avPackage.eNS_URI, theSubsystem_pc_avPackage);
      return theSubsystem_pc_avPackage;
   }
    ...
    * @generated
    */
   public Subsystem_pc_avFactory getSubsystem_pc_avFactory() {
      return (Subsystem_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      subSystemEClass.getESuperTypes().add(theEntity_pc_avPackage.getComposedProvidingRequiringEntity());
      subSystemEClass.getESuperTypes().add(theRepository_pc_avPackage.getRepositoryComponent());

      // Initialize classes and features; add operations and parameters
      initEClass(subSystemEClass, SubSystem.class, "SubSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
   }

} //Subsystem_pc_avPackageImpl
