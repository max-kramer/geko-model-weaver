 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.Workload#getUsageScenario_Workload <em>Usage Scenario Workload</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.Usagemodel_pc_avPackage#getWorkload()
 * @model
 * @generated
 */
public interface Workload extends EObject {
    ...
    * It is bidirectional and its opposite is '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.UsageScenario#getWorkload_UsageScenario <em>Workload Usage Scenario</em>}'.
    * <!-- begin-user-doc -->
    * <p>
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.Usagemodel_pc_avPackage#getWorkload_UsageScenario_Workload()
   ...
   /**
    * Sets the value of the '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.Workload#getUsageScenario_Workload <em>Usage Scenario Workload</em>}' container reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
