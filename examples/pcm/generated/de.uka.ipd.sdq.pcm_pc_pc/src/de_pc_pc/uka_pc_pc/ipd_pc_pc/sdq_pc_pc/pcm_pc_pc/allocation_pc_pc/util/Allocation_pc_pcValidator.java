 ...
 * @generated
 */
public class Allocation_pc_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Allocation_pc_pcValidator INSTANCE = new Allocation_pc_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.allocation_pc_pc";
    ...
    * @generated
    */
   public Allocation_pc_pcValidator() {
      super();
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Allocation_pc_pcPackage.ALLOCATION_CONTEXT:
            return validateAllocationContext((AllocationContext)value, diagnostics, context);
         case Allocation_pc_pcPackage.ALLOCATION:
   ...
   public boolean validateAllocationContext(AllocationContext allocationContext, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(allocationContext, diagnostics, context);
   ...
   public boolean validateAllocation(Allocation allocation, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(allocation, diagnostics, context);
