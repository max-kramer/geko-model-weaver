...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.CompletionRepository;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.Completions_pc_pcFactory;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.Completions_pc_pcPackage;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.DelegatingExternalCallAction;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.NetworkDemandParametricResourceDemand;
 ...
 * @generated
 */
public class Completions_pc_pcPackageImpl extends EPackageImpl implements Completions_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.Completions_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Completions_pc_pcPackageImpl() {
      super(eNS_URI, Completions_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Completions_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Completions_pc_pcPackage init() {
      if (isInited) return (Completions_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Completions_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      Completions_pc_pcPackageImpl theCompletions_pc_pcPackage = (Completions_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Completions_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Completions_pc_pcPackageImpl());
      ...
      theCompletions_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Completions_pc_pcPackage.eNS_URI, theCompletions_pc_pcPackage);
      return theCompletions_pc_pcPackage;
   }
    ...
    * @generated
    */
   public Completions_pc_pcFactory getCompletions_pc_pcFactory() {
      return (Completions_pc_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      completionEClass.getESuperTypes().add(theEntity_pc_pcPackage.getComposedProvidingRequiringEntity());
      completionEClass.getESuperTypes().add(theRepository_pc_pcPackage.getImplementationComponentType());
      delegatingExternalCallActionEClass.getESuperTypes().add(theSeff_pc_pcPackage.getExternalCallAction());
      networkDemandParametricResourceDemandEClass.getESuperTypes().add(theSeff_performance_pc_pcPackage.getParametricResourceDemand());
