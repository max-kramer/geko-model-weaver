 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.core_pc_pc.entity_pc_pc.impl.NamedElementImpl#getEntityName <em>Entity Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamedElementImpl extends EObjectImpl implements NamedElement {
   ...
   protected EClass eStaticClass() {
      return Entity_pc_pcPackage.Literals.NAMED_ELEMENT;
   }
   ...
   public void setEntityName(String newEntityName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Entity_pc_pcPackage.NAMED_ELEMENT__ENTITY_NAME, oldEntityName, entityName));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Entity_pc_pcPackage.NAMED_ELEMENT__ENTITY_NAME:
