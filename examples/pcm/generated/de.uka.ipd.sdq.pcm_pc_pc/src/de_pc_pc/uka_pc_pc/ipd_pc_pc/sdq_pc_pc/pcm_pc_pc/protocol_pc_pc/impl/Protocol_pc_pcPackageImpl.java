...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.protocol_pc_pc.Protocol_pc_pcFactory;
 ...
 * @generated
 */
public class Protocol_pc_pcPackageImpl extends EPackageImpl implements Protocol_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.protocol_pc_pc.Protocol_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Protocol_pc_pcPackageImpl() {
      super(eNS_URI, Protocol_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Protocol_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Protocol_pc_pcPackage init() {
      if (isInited) return (Protocol_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Protocol_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      Protocol_pc_pcPackageImpl theProtocol_pc_pcPackage = (Protocol_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Protocol_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Protocol_pc_pcPackageImpl());
      ...
      theProtocol_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Protocol_pc_pcPackage.eNS_URI, theProtocol_pc_pcPackage);
      return theProtocol_pc_pcPackage;
   }
    ...
    * @generated
    */
   public Protocol_pc_pcFactory getProtocol_pc_pcFactory() {
      return (Protocol_pc_pcFactory)getEFactoryInstance();
   }
