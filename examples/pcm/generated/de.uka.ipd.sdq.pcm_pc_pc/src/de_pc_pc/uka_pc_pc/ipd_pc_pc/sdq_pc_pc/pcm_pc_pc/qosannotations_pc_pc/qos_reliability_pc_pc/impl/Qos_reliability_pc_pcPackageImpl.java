...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.qosannotations_pc_pc.qos_reliability_pc_pc.Qos_reliability_pc_pcFactory;
 ...
 * @generated
 */
public class Qos_reliability_pc_pcPackageImpl extends EPackageImpl implements Qos_reliability_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.qosannotations_pc_pc.qos_reliability_pc_pc.Qos_reliability_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Qos_reliability_pc_pcPackageImpl() {
      super(eNS_URI, Qos_reliability_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Qos_reliability_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Qos_reliability_pc_pcPackage init() {
      if (isInited) return (Qos_reliability_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Qos_reliability_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      Qos_reliability_pc_pcPackageImpl theQos_reliability_pc_pcPackage = (Qos_reliability_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Qos_reliability_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Qos_reliability_pc_pcPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theQos_reliability_pc_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Qos_reliability_pc_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theQos_reliability_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Qos_reliability_pc_pcPackage.eNS_URI, theQos_reliability_pc_pcPackage);
      return theQos_reliability_pc_pcPackage;
   }
    ...
    * @generated
    */
   public Qos_reliability_pc_pcFactory getQos_reliability_pc_pcFactory() {
      return (Qos_reliability_pc_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      specifiedReliabilityAnnotationEClass.getESuperTypes().add(theQosannotations_pc_pcPackage.getSpecifiedQoSAnnotation());
      ...
      initEReference(getSpecifiedReliabilityAnnotation_ExternalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation(), theReliability_pc_pcPackage.getExternalFailureOccurrenceDescription(), theReliability_pc_pcPackage.getExternalFailureOccurrenceDescription_SpecifiedReliabilityAnnotation__ExternalFailureOccurrenceDescription(), "externalFailureOccurrenceDescriptions__SpecifiedReliabilityAnnotation", null, 0, -1, SpecifiedReliabilityAnnotation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
...
} //Qos_reliability_pc_pcPackageImpl
