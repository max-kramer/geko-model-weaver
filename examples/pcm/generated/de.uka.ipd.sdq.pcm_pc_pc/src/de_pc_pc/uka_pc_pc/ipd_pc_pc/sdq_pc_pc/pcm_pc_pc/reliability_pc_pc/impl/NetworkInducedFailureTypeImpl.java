 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.reliability_pc_pc.impl.NetworkInducedFailureTypeImpl#getCommunicationLinkResourceType__NetworkInducedFailureType <em>Communication Link Resource Type Network Induced Failure Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NetworkInducedFailureTypeImpl extends FailureTypeImpl implements NetworkInducedFailureType {
   ...
   protected EClass eStaticClass() {
      return Reliability_pc_pcPackage.Literals.NETWORK_INDUCED_FAILURE_TYPE;
   }
      ...
      if (communicationLinkResourceType__NetworkInducedFailureType != null && communicationLinkResourceType__NetworkInducedFailureType.eIsProxy()) {
         ...
         if (communicationLinkResourceType__NetworkInducedFailureType != oldCommunicationLinkResourceType__NetworkInducedFailureType) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Reliability_pc_pcPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE, oldCommunicationLinkResourceType__NetworkInducedFailureType, communicationLinkResourceType__NetworkInducedFailureType));
         }
      }
   ...
   public NotificationChain basicSetCommunicationLinkResourceType__NetworkInducedFailureType(CommunicationLinkResourceType newCommunicationLinkResourceType__NetworkInducedFailureType, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Reliability_pc_pcPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE, oldCommunicationLinkResourceType__NetworkInducedFailureType, newCommunicationLinkResourceType__NetworkInducedFailureType);
   ...
   public void setCommunicationLinkResourceType__NetworkInducedFailureType(CommunicationLinkResourceType newCommunicationLinkResourceType__NetworkInducedFailureType) {
      if (newCommunicationLinkResourceType__NetworkInducedFailureType != communicationLinkResourceType__NetworkInducedFailureType) {
         ...
         if (communicationLinkResourceType__NetworkInducedFailureType != null)
            msgs = ((InternalEObject)communicationLinkResourceType__NetworkInducedFailureType).eInverseRemove(this, Resourcetype_pc_pcPackage.COMMUNICATION_LINK_RESOURCE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_COMMUNICATION_LINK_RESOURCE_TYPE, CommunicationLinkResourceType.class, msgs);
         if (newCommunicationLinkResourceType__NetworkInducedFailureType != null)
            msgs = ((InternalEObject)newCommunicationLinkResourceType__NetworkInducedFailureType).eInverseAdd(this, Resourcetype_pc_pcPackage.COMMUNICATION_LINK_RESOURCE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_COMMUNICATION_LINK_RESOURCE_TYPE, CommunicationLinkResourceType.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Reliability_pc_pcPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE, newCommunicationLinkResourceType__NetworkInducedFailureType, newCommunicationLinkResourceType__NetworkInducedFailureType));
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Reliability_pc_pcValidator.NETWORK_INDUCED_FAILURE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_HAS_COMMUNICATION_LINK_RESOURCE_TYPE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Reliability_pc_pcPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE:
            if (communicationLinkResourceType__NetworkInducedFailureType != null)
               msgs = ((InternalEObject)communicationLinkResourceType__NetworkInducedFailureType).eInverseRemove(this, Resourcetype_pc_pcPackage.COMMUNICATION_LINK_RESOURCE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_COMMUNICATION_LINK_RESOURCE_TYPE, CommunicationLinkResourceType.class, msgs);
