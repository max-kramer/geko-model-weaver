 ...
 * @generated
 */
public class Reliability_pc_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Reliability_pc_pcValidator INSTANCE = new Reliability_pc_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.reliability_pc_pc";
    ...
    * @generated
    */
   public Reliability_pc_pcValidator() {
      super();
   ...
   public boolean validateHardwareInducedFailureType(HardwareInducedFailureType hardwareInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(hardwareInducedFailureType, diagnostics, context);
   ...
   public boolean validateSoftwareInducedFailureType(SoftwareInducedFailureType softwareInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(softwareInducedFailureType, diagnostics, context);
      return result;
   }
   ...
   public boolean validateNetworkInducedFailureType(NetworkInducedFailureType networkInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(networkInducedFailureType, diagnostics, context);
   ...
   public boolean validateResourceTimeoutFailureType(ResourceTimeoutFailureType resourceTimeoutFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(resourceTimeoutFailureType, diagnostics, context);
      return result;
   }
   ...
   public boolean validateFailureType(FailureType failureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(failureType, diagnostics, context);
      return result;
   }
