 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.EventGroupImpl#getEventTypes__EventGroup <em>Event Types Event Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventGroupImpl extends InterfaceImpl implements EventGroup {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_pcPackage.Literals.EVENT_GROUP;
   }
   ...
   public EList<EventType> getEventTypes__EventGroup() {
      if (eventTypes__EventGroup == null) {
         eventTypes__EventGroup = new EObjectContainmentWithInverseEList<EventType>(EventType.class, this, Repository_pc_pcPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP, Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_pcPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
