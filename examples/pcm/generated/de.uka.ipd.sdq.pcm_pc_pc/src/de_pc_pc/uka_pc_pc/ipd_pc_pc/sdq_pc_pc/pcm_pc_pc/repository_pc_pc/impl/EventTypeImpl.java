 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.EventTypeImpl#getParameter__EventType <em>Parameter Event Type</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.EventTypeImpl#getEventGroup__EventType <em>Event Group Event Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventTypeImpl extends SignatureImpl implements EventType {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_pcPackage.Literals.EVENT_TYPE;
   }
   ...
   public NotificationChain basicSetParameter__EventType(Parameter newParameter__EventType, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Repository_pc_pcPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE, oldParameter__EventType, newParameter__EventType);
   ...
   public void setParameter__EventType(Parameter newParameter__EventType) {
      if (newParameter__EventType != parameter__EventType) {
         ...
         if (parameter__EventType != null)
            msgs = ((InternalEObject)parameter__EventType).eInverseRemove(this, Repository_pc_pcPackage.PARAMETER__EVENT_TYPE_PARAMETER, Parameter.class, msgs);
         if (newParameter__EventType != null)
            msgs = ((InternalEObject)newParameter__EventType).eInverseAdd(this, Repository_pc_pcPackage.PARAMETER__EVENT_TYPE_PARAMETER, Parameter.class, msgs);
         msgs = basicSetParameter__EventType(newParameter__EventType, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_pcPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE, newParameter__EventType, newParameter__EventType));
   }
   ...
   public EventGroup getEventGroup__EventType() {
      if (eContainerFeatureID() != Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE) return null;
   ...
   public NotificationChain basicSetEventGroup__EventType(EventGroup newEventGroup__EventType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newEventGroup__EventType, Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE, msgs);
      return msgs;
   }
   ...
   public void setEventGroup__EventType(EventGroup newEventGroup__EventType) {
      if (newEventGroup__EventType != eInternalContainer() || (eContainerFeatureID() != Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE && newEventGroup__EventType != null)) {
         ...
         if (newEventGroup__EventType != null)
            msgs = ((InternalEObject)newEventGroup__EventType).eInverseAdd(this, Repository_pc_pcPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP, EventGroup.class, msgs);
         msgs = basicSetEventGroup__EventType(newEventGroup__EventType, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE, newEventGroup__EventType, newEventGroup__EventType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_pcPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE:
            if (parameter__EventType != null)
               msgs = ((InternalEObject)parameter__EventType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Repository_pc_pcPackage.EVENT_TYPE__PARAMETER_EVENT_TYPE, null, msgs);
            return basicSetParameter__EventType((Parameter)otherEnd, msgs);
         case Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Repository_pc_pcPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE:
            return eInternalContainer().eInverseRemove(this, Repository_pc_pcPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP, EventGroup.class, msgs);
      }
