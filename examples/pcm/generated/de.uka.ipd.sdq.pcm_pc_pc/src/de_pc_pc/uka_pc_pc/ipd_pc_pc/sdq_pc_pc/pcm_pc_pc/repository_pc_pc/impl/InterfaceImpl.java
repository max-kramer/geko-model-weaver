 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.InterfaceImpl#getParentInterfaces__Interface <em>Parent Interfaces Interface</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.InterfaceImpl#getProtocols__Interface <em>Protocols Interface</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.InterfaceImpl#getRequiredCharacterisations <em>Required Characterisations</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.InterfaceImpl#getRepository__Interface <em>Repository Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterfaceImpl extends EntityImpl implements Interface {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_pcPackage.Literals.INTERFACE;
   }
   ...
   public EList<Interface> getParentInterfaces__Interface() {
      if (parentInterfaces__Interface == null) {
         parentInterfaces__Interface = new EObjectResolvingEList<Interface>(Interface.class, this, Repository_pc_pcPackage.INTERFACE__PARENT_INTERFACES_INTERFACE);
      }
   ...
   public EList<Protocol> getProtocols__Interface() {
      if (protocols__Interface == null) {
         protocols__Interface = new EObjectContainmentEList<Protocol>(Protocol.class, this, Repository_pc_pcPackage.INTERFACE__PROTOCOLS_INTERFACE);
      }
   ...
   public EList<RequiredCharacterisation> getRequiredCharacterisations() {
      if (requiredCharacterisations == null) {
         requiredCharacterisations = new EObjectContainmentWithInverseEList<RequiredCharacterisation>(RequiredCharacterisation.class, this, Repository_pc_pcPackage.INTERFACE__REQUIRED_CHARACTERISATIONS, Repository_pc_pcPackage.REQUIRED_CHARACTERISATION__INTERFACE_REQUIRED_CHARACTERISATION);
      }
   ...
   public Repository getRepository__Interface() {
      if (eContainerFeatureID() != Repository_pc_pcPackage.INTERFACE__REPOSITORY_INTERFACE) return null;
   ...
   public NotificationChain basicSetRepository__Interface(Repository newRepository__Interface, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__Interface, Repository_pc_pcPackage.INTERFACE__REPOSITORY_INTERFACE, msgs);
      return msgs;
   }
   ...
   public void setRepository__Interface(Repository newRepository__Interface) {
      if (newRepository__Interface != eInternalContainer() || (eContainerFeatureID() != Repository_pc_pcPackage.INTERFACE__REPOSITORY_INTERFACE && newRepository__Interface != null)) {
         ...
         if (newRepository__Interface != null)
            msgs = ((InternalEObject)newRepository__Interface).eInverseAdd(this, Repository_pc_pcPackage.REPOSITORY__INTERFACES_REPOSITORY, Repository.class, msgs);
         msgs = basicSetRepository__Interface(newRepository__Interface, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_pcPackage.INTERFACE__REPOSITORY_INTERFACE, newRepository__Interface, newRepository__Interface));
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_pc_pcValidator.INTERFACE__NO_PROTOCOL_TYPE_ID_USED_TWICE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_pcPackage.INTERFACE__REQUIRED_CHARACTERISATIONS:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getRequiredCharacterisations()).basicAdd(otherEnd, msgs);
         case Repository_pc_pcPackage.INTERFACE__REPOSITORY_INTERFACE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_pcPackage.INTERFACE__PROTOCOLS_INTERFACE:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Repository_pc_pcPackage.INTERFACE__REPOSITORY_INTERFACE:
            return eInternalContainer().eInverseRemove(this, Repository_pc_pcPackage.REPOSITORY__INTERFACES_REPOSITORY, Repository.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pc_pcPackage.INTERFACE__PARENT_INTERFACES_INTERFACE:
