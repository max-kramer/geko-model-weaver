 ...
 * @generated
 */
public class Seff_reliability_pc_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Seff_reliability_pc_pcPackage modelPackage;
    ...
    * @generated
    */
   public Seff_reliability_pc_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Seff_reliability_pc_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Seff_reliability_pc_pcSwitch<Adapter> modelSwitch =
      new Seff_reliability_pc_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.seff_pc_pc.seff_reliability_pc_pc.RecoveryActionBehaviour <em>Recovery Action Behaviour</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.seff_pc_pc.seff_reliability_pc_pc.RecoveryAction <em>Recovery Action</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Seff_reliability_pc_pcAdapterFactory
