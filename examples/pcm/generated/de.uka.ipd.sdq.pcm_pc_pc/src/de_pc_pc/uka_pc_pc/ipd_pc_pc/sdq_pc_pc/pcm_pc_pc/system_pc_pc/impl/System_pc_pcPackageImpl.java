 ...
 * @generated
 */
public class System_pc_pcPackageImpl extends EPackageImpl implements System_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.system_pc_pc.System_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private System_pc_pcPackageImpl() {
      super(eNS_URI, System_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link System_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static System_pc_pcPackage init() {
      if (isInited) return (System_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(System_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      System_pc_pcPackageImpl theSystem_pc_pcPackage = (System_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof System_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new System_pc_pcPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theSystem_pc_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return System_pc_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSystem_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(System_pc_pcPackage.eNS_URI, theSystem_pc_pcPackage);
      return theSystem_pc_pcPackage;
   }
    ...
    * @generated
    */
   public System_pc_pcFactory getSystem_pc_pcFactory() {
      return (System_pc_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      systemEClass.getESuperTypes().add(theEntity_pc_pcPackage.getEntity());
      systemEClass.getESuperTypes().add(theEntity_pc_pcPackage.getComposedProvidingRequiringEntity());

      // Initialize classes and features; add operations and parameters
      initEClass(systemEClass, de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.system_pc_pc.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getSystem_QosAnnotations_System(), theQosannotations_pc_pcPackage.getQoSAnnotations(), theQosannotations_pc_pcPackage.getQoSAnnotations_System_QoSAnnotations(), "qosAnnotations_System", null, 0, -1, de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.system_pc_pc.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
