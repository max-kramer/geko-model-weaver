 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.impl.NormalDistributionImpl#getMu <em>Mu</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.impl.NormalDistributionImpl#getSigma <em>Sigma</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalDistributionImpl extends ContinuousPDFImpl implements NormalDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_avPackage.Literals.NORMAL_DISTRIBUTION;
   }
   ...
   public void setMu(double newMu) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_avPackage.NORMAL_DISTRIBUTION__MU, oldMu, mu));
   }
   ...
   public void setSigma(double newSigma) {
      ...
      sigma = newSigma;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_avPackage.NORMAL_DISTRIBUTION__SIGMA, oldSigma, sigma));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_avPackage.NORMAL_DISTRIBUTION__MU:
            return getMu();
         case Probfunction_avPackage.NORMAL_DISTRIBUTION__SIGMA:
            return getSigma();
      }
