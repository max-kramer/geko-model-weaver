...
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.Advice;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.BoxedPDF;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.Complex;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.ContinuousPDF;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.ContinuousSample;
...
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.GlobalScope;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.LognormalDistribution;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.NormalDistribution;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.PerJoinPointScope;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.ProbabilityDensityFunction;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.ProbabilityFunction;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.ProbabilityMassFunction;
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.Probfunction_avFactory;
...
import de_av.uka_av.ipd_av.sdq_av.probfunction_av.SamplePDF;
 ...
 * @generated
 */
public class Probfunction_avPackageImpl extends EPackageImpl implements Probfunction_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.probfunction_av.Probfunction_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Probfunction_avPackageImpl() {
      super(eNS_URI, Probfunction_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Probfunction_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Probfunction_avPackage init() {
      if (isInited) return (Probfunction_avPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_avPackage.eNS_URI);

      // Obtain or create and register package
      Probfunction_avPackageImpl theProbfunction_avPackage = (Probfunction_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Probfunction_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Probfunction_avPackageImpl());
      ...
      theProbfunction_avPackage.createPackageContents();

      // Initialize created meta-data
      theProbfunction_avPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theProbfunction_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Probfunction_avPackage.eNS_URI, theProbfunction_avPackage);
      return theProbfunction_avPackage;
   }
    ...
    * @generated
    */
   public Probfunction_avFactory getProbfunction_avFactory() {
      return (Probfunction_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      probabilityFunctionEClass.getESuperTypes().add(theUnits_avPackage.getUnitCarryingElement());
