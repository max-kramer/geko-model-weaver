 ...
 * @generated
 */
public class Probfunction_avSwitch<T1> extends Switch<T1> {
   /**
   ...
   protected T1 doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Probfunction_avPackage.BOXED_PDF: {
         ...
         case Probfunction_avPackage.PROBABILITY_DENSITY_FUNCTION: {
         ...
         case Probfunction_avPackage.PROBABILITY_FUNCTION: {
         ...
         case Probfunction_avPackage.SAMPLE: {
            Sample<?> sample = (Sample<?>)theEObject;
            T1 result = caseSample(sample);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_avPackage.SAMPLE_PDF: {
         ...
         case Probfunction_avPackage.COMPLEX: {
            Complex complex = (Complex)theEObject;
            T1 result = caseComplex(complex);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_avPackage.CONTINUOUS_PDF: {
         ...
         case Probfunction_avPackage.EXPONENTIAL_DISTRIBUTION: {
         ...
         case Probfunction_avPackage.NORMAL_DISTRIBUTION: {
         ...
         case Probfunction_avPackage.LOGNORMAL_DISTRIBUTION: {
         ...
         case Probfunction_avPackage.GAMMA_DISTRIBUTION: {
