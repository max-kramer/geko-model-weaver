 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.BoxedPDFImpl#getSamples <em>Samples</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoxedPDFImpl extends ProbabilityDensityFunctionImpl implements BoxedPDF {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_avPackage.Literals.BOXED_PDF;
   }
   ...
   public EList<ContinuousSample> getSamples() {
      if (samples == null) {
         samples = new EObjectContainmentEList<ContinuousSample>(ContinuousSample.class, this, Probfunction_av_avPackage.BOXED_PDF__SAMPLES);
      }
      return samples;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Probfunction_av_avPackage.BOXED_PDF__SAMPLES:
