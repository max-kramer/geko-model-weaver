 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.LognormalDistributionImpl#getMu <em>Mu</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.LognormalDistributionImpl#getSigma <em>Sigma</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LognormalDistributionImpl extends ContinuousPDFImpl implements LognormalDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_avPackage.Literals.LOGNORMAL_DISTRIBUTION;
   }
   ...
   public void setMu(double newMu) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_avPackage.LOGNORMAL_DISTRIBUTION__MU, oldMu, mu));
   }
   ...
   public void setSigma(double newSigma) {
      ...
      sigma = newSigma;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_avPackage.LOGNORMAL_DISTRIBUTION__SIGMA, oldSigma, sigma));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_avPackage.LOGNORMAL_DISTRIBUTION__MU:
            return getMu();
         case Probfunction_av_avPackage.LOGNORMAL_DISTRIBUTION__SIGMA:
            return getSigma();
      }
