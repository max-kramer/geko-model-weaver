 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.PerJoinPointScopeImpl#getScopedObject <em>Scoped Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PerJoinPointScopeImpl extends EObjectImpl implements PerJoinPointScope {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_avPackage.Literals.PER_JOIN_POINT_SCOPE;
   }
      ...
      if (scopedObject != null && scopedObject.eIsProxy()) {
         ...
         if (scopedObject != oldScopedObject) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Probfunction_av_avPackage.PER_JOIN_POINT_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
         }
      }
      return scopedObject;
   }
   ...
   public void setScopedObject(EObject newScopedObject) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_avPackage.PER_JOIN_POINT_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_avPackage.PER_JOIN_POINT_SCOPE__SCOPED_OBJECT:
