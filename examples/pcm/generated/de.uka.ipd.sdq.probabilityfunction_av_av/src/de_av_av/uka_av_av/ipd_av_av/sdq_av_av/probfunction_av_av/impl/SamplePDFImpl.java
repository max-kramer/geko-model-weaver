 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.SamplePDFImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.SamplePDFImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SamplePDFImpl extends ProbabilityDensityFunctionImpl implements SamplePDF {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_avPackage.Literals.SAMPLE_PDF;
   }
   ...
   public void setDistance(double newDistance) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_avPackage.SAMPLE_PDF__DISTANCE, oldDistance, distance));
   }
   ...
   public EList<Complex> getValues() {
      if (values == null) {
         values = new EObjectContainmentEList<Complex>(Complex.class, this, Probfunction_av_avPackage.SAMPLE_PDF__VALUES);
      }
      return values;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Probfunction_av_avPackage.SAMPLE_PDF__VALUES:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_avPackage.SAMPLE_PDF__DISTANCE:
            return getDistance();
         case Probfunction_av_avPackage.SAMPLE_PDF__VALUES:
            return getValues();
      }
