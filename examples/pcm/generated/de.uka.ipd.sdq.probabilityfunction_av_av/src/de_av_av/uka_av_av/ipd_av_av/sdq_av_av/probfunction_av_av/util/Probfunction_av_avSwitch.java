 ...
 * @generated
 */
public class Probfunction_av_avSwitch<T1> extends Switch<T1> {
   /**
    ...
    * @generated
    */
   public Probfunction_av_avSwitch() {
   ...
   protected T1 doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Probfunction_av_avPackage.BOXED_PDF: {
         ...
         case Probfunction_av_avPackage.PROBABILITY_DENSITY_FUNCTION: {
         ...
         case Probfunction_av_avPackage.PROBABILITY_FUNCTION: {
         ...
         case Probfunction_av_avPackage.SAMPLE: {
            Sample<?> sample = (Sample<?>)theEObject;
            T1 result = caseSample(sample);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.SAMPLE_PDF: {
         ...
         case Probfunction_av_avPackage.COMPLEX: {
            Complex complex = (Complex)theEObject;
            T1 result = caseComplex(complex);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.CONTINUOUS_PDF: {
         ...
         case Probfunction_av_avPackage.EXPONENTIAL_DISTRIBUTION: {
         ...
         case Probfunction_av_avPackage.NORMAL_DISTRIBUTION: {
         ...
         case Probfunction_av_avPackage.LOGNORMAL_DISTRIBUTION: {
         ...
         case Probfunction_av_avPackage.GAMMA_DISTRIBUTION: {
         ...
         case Probfunction_av_avPackage.ADVICE_ADVICE: {
            AdviceAdvice adviceAdvice = (AdviceAdvice)theEObject;
            T1 result = caseAdviceAdvice(adviceAdvice);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.GLOBAL_SCOPE_GLOBAL_SCOPE: {
            GlobalScopeGlobalScope globalScopeGlobalScope = (GlobalScopeGlobalScope)theEObject;
            T1 result = caseGlobalScopeGlobalScope(globalScopeGlobalScope);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.PER_JOIN_POINT_SCOPE_PER_JOIN_POINT_SCOPE: {
            PerJoinPointScopePerJoinPointScope perJoinPointScopePerJoinPointScope = (PerJoinPointScopePerJoinPointScope)theEObject;
            T1 result = casePerJoinPointScopePerJoinPointScope(perJoinPointScopePerJoinPointScope);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.ADVICE: {
            Advice advice = (Advice)theEObject;
            T1 result = caseAdvice(advice);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.GLOBAL_SCOPE: {
            GlobalScope globalScope = (GlobalScope)theEObject;
            T1 result = caseGlobalScope(globalScope);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_av_avPackage.PER_JOIN_POINT_SCOPE: {
    ...
    * @generated
    */
   public T1 caseAdviceAdvice(AdviceAdvice object) {
      return null;
   }
    ...
    * @generated
    */
   public T1 caseGlobalScopeGlobalScope(GlobalScopeGlobalScope object) {
      return null;
   }
    ...
    * @generated
    */
   public T1 casePerJoinPointScopePerJoinPointScope(PerJoinPointScopePerJoinPointScope object) {
      return null;
   }
