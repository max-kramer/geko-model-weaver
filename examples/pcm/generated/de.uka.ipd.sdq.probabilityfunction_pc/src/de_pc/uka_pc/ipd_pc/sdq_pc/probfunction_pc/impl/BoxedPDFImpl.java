 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.impl.BoxedPDFImpl#getSamples <em>Samples</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoxedPDFImpl extends ProbabilityDensityFunctionImpl implements BoxedPDF {
   ...
   protected EClass eStaticClass() {
      return Probfunction_pcPackage.Literals.BOXED_PDF;
   }
   ...
   public EList<ContinuousSample> getSamples() {
      if (samples == null) {
         samples = new EObjectContainmentEList<ContinuousSample>(ContinuousSample.class, this, Probfunction_pcPackage.BOXED_PDF__SAMPLES);
      }
      return samples;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Probfunction_pcPackage.BOXED_PDF__SAMPLES:
