...
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.BoxedPDF;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Complex;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.ContinuousPDF;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.LognormalDistribution;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.NormalDistribution;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Pointcut;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.ProbabilityDensityFunction;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.ProbabilityFunction;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.ProbabilityMassFunction;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Probfunction_pcFactory;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Probfunction_pcPackage;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Sample;
import de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.SamplePDF;
 ...
 * @generated
 */
public class Probfunction_pcPackageImpl extends EPackageImpl implements Probfunction_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Probfunction_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Probfunction_pcPackageImpl() {
      super(eNS_URI, Probfunction_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Probfunction_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Probfunction_pcPackage init() {
      if (isInited) return (Probfunction_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_pcPackage.eNS_URI);

      // Obtain or create and register package
      Probfunction_pcPackageImpl theProbfunction_pcPackage = (Probfunction_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Probfunction_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Probfunction_pcPackageImpl());
      ...
      theProbfunction_pcPackage.createPackageContents();

      // Initialize created meta-data
      theProbfunction_pcPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theProbfunction_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Probfunction_pcPackage.eNS_URI, theProbfunction_pcPackage);
      return theProbfunction_pcPackage;
   }
    ...
    * @generated
    */
   public Probfunction_pcFactory getProbfunction_pcFactory() {
      return (Probfunction_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      probabilityFunctionEClass.getESuperTypes().add(theUnits_pcPackage.getUnitCarryingElement());
