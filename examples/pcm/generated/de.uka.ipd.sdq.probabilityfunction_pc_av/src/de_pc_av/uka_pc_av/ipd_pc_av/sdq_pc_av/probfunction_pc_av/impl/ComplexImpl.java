 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.impl.ComplexImpl#getReal <em>Real</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.impl.ComplexImpl#getImaginary <em>Imaginary</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexImpl extends EObjectImpl implements Complex {
   ...
   protected EClass eStaticClass() {
      return Probfunction_pc_avPackage.Literals.COMPLEX;
   }
   ...
   public void setReal(double newReal) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pc_avPackage.COMPLEX__REAL, oldReal, real));
   }
   ...
   public void setImaginary(double newImaginary) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pc_avPackage.COMPLEX__IMAGINARY, oldImaginary, imaginary));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_pc_avPackage.COMPLEX__REAL:
            return getReal();
         case Probfunction_pc_avPackage.COMPLEX__IMAGINARY:
            return getImaginary();
      }
