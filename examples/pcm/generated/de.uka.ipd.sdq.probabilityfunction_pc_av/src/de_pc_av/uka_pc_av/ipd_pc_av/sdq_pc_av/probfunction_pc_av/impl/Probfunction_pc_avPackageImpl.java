/**
 */
package de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.impl;

import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Advice;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.BoxedPDF;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Complex;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.ContinuousPDF;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.ContinuousSample;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.ExponentialDistribution;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.GammaDistribution;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.GlobalScope;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.LognormalDistribution;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.NormalDistribution;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.PerJoinPointScope;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Pointcut;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.ProbabilityDensityFunction;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.ProbabilityFunction;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.ProbabilityMassFunction;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Probfunction_pc_avFactory;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Probfunction_pc_avPackage;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Sample;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.SamplePDF;
 ...
 * @generated
 */
public class Probfunction_pc_avPackageImpl extends EPackageImpl implements Probfunction_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.probfunction_pc_av.Probfunction_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Probfunction_pc_avPackageImpl() {
      super(eNS_URI, Probfunction_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Probfunction_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Probfunction_pc_avPackage init() {
      if (isInited) return (Probfunction_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Probfunction_pc_avPackageImpl theProbfunction_pc_avPackage = (Probfunction_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Probfunction_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Probfunction_pc_avPackageImpl());
      ...
      theProbfunction_pc_avPackage.createPackageContents();

      // Initialize created meta-data
      theProbfunction_pc_avPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theProbfunction_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Probfunction_pc_avPackage.eNS_URI, theProbfunction_pc_avPackage);
      return theProbfunction_pc_avPackage;
   }
    ...
    * @generated
    */
   public Probfunction_pc_avFactory getProbfunction_pc_avFactory() {
      return (Probfunction_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      probabilityFunctionEClass.getESuperTypes().add(theUnits_pc_avPackage.getUnitCarryingElement());
