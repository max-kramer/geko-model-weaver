 ...
 * @generated
 */
public class Probfunction_pc_avSwitch<T1> extends Switch<T1> {
   /**
    ...
    * @generated
    */
   public Probfunction_pc_avSwitch() {
   ...
   protected T1 doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Probfunction_pc_avPackage.BOXED_PDF: {
         ...
         case Probfunction_pc_avPackage.PROBABILITY_DENSITY_FUNCTION: {
         ...
         case Probfunction_pc_avPackage.PROBABILITY_FUNCTION: {
         ...
         case Probfunction_pc_avPackage.SAMPLE: {
            Sample<?> sample = (Sample<?>)theEObject;
            T1 result = caseSample(sample);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_pc_avPackage.SAMPLE_PDF: {
         ...
         case Probfunction_pc_avPackage.COMPLEX: {
            Complex complex = (Complex)theEObject;
            T1 result = caseComplex(complex);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_pc_avPackage.CONTINUOUS_PDF: {
         ...
         case Probfunction_pc_avPackage.EXPONENTIAL_DISTRIBUTION: {
         ...
         case Probfunction_pc_avPackage.NORMAL_DISTRIBUTION: {
         ...
         case Probfunction_pc_avPackage.LOGNORMAL_DISTRIBUTION: {
         ...
         case Probfunction_pc_avPackage.GAMMA_DISTRIBUTION: {
