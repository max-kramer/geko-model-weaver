 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.impl.GammaDistributionImpl#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.impl.GammaDistributionImpl#getTheta <em>Theta</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GammaDistributionImpl extends ContinuousPDFImpl implements GammaDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_pc_pcPackage.Literals.GAMMA_DISTRIBUTION;
   }
   ...
   public void setAlpha(double newAlpha) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pc_pcPackage.GAMMA_DISTRIBUTION__ALPHA, oldAlpha, alpha));
   }
   ...
   public void setTheta(double newTheta) {
      ...
      theta = newTheta;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pc_pcPackage.GAMMA_DISTRIBUTION__THETA, oldTheta, theta));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_pc_pcPackage.GAMMA_DISTRIBUTION__ALPHA:
            return getAlpha();
         case Probfunction_pc_pcPackage.GAMMA_DISTRIBUTION__THETA:
            return getTheta();
      }
