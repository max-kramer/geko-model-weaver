...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.ContinuousPDF;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.ContinuousSample;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.ExponentialDistribution;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.GammaDistribution;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.LognormalDistribution;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.NormalDistribution;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.Pointcut;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.PointcutPointcut;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.ProbabilityDensityFunction;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.ProbabilityFunction;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.ProbabilityMassFunction;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.Probfunction_pc_pcFactory;
 ...
 * @generated
 */
public class Probfunction_pc_pcPackageImpl extends EPackageImpl implements Probfunction_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.Probfunction_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Probfunction_pc_pcPackageImpl() {
      super(eNS_URI, Probfunction_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Probfunction_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Probfunction_pc_pcPackage init() {
      if (isInited) return (Probfunction_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      Probfunction_pc_pcPackageImpl theProbfunction_pc_pcPackage = (Probfunction_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Probfunction_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Probfunction_pc_pcPackageImpl());
      ...
      theProbfunction_pc_pcPackage.createPackageContents();

      // Initialize created meta-data
      theProbfunction_pc_pcPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theProbfunction_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Probfunction_pc_pcPackage.eNS_URI, theProbfunction_pc_pcPackage);
      return theProbfunction_pc_pcPackage;
   }
    ...
    * @generated
    */
   public Probfunction_pc_pcFactory getProbfunction_pc_pcFactory() {
      return (Probfunction_pc_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      probabilityFunctionEClass.getESuperTypes().add(theUnits_pc_pcPackage.getUnitCarryingElement());
