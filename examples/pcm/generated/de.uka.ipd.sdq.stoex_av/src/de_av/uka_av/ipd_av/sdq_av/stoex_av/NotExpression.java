 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.stoex_av.NotExpression#getInner <em>Inner</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avPackage#getNotExpression()
 * @model
 * @generated
 */
public interface NotExpression extends Unary {
    ...
    * @see #setInner(Unary)
    * @see de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avPackage#getNotExpression_Inner()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.stoex_av.NotExpression#getInner <em>Inner</em>}' containment reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
