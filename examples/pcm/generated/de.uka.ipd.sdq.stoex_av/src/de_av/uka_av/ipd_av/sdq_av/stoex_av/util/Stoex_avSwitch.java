 ...
 * @generated
 */
public class Stoex_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Stoex_avPackage.VARIABLE_REFERENCE: {
         ...
         case Stoex_avPackage.ABSTRACT_NAMED_REFERENCE: {
         ...
         case Stoex_avPackage.NAMESPACE_REFERENCE: {
         ...
         case Stoex_avPackage.COMPARISON: {
         ...
         case Stoex_avPackage.BOOLEAN_EXPRESSION: {
         ...
         case Stoex_avPackage.EXPRESSION: {
            Expression expression = (Expression)theEObject;
            T result = caseExpression(expression);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Stoex_avPackage.TERM_EXPRESSION: {
         ...
         case Stoex_avPackage.PRODUCT_EXPRESSION: {
         ...
         case Stoex_avPackage.PROBABILITY_FUNCTION_LITERAL: {
         ...
         case Stoex_avPackage.PARENTHESIS: {
         ...
         case Stoex_avPackage.NUMERIC_LITERAL: {
         ...
         case Stoex_avPackage.INT_LITERAL: {
         ...
         case Stoex_avPackage.DOUBLE_LITERAL: {
         ...
         case Stoex_avPackage.COMPARE_EXPRESSION: {
         ...
         case Stoex_avPackage.BOOL_LITERAL: {
         ...
         case Stoex_avPackage.STRING_LITERAL: {
         ...
         case Stoex_avPackage.POWER_EXPRESSION: {
         ...
         case Stoex_avPackage.BOOLEAN_OPERATOR_EXPRESSION: {
         ...
         case Stoex_avPackage.NOT_EXPRESSION: {
         ...
         case Stoex_avPackage.NEGATIVE_EXPRESSION: {
         ...
         case Stoex_avPackage.FUNCTION_LITERAL: {
         ...
         case Stoex_avPackage.IF_ELSE_EXPRESSION: {
