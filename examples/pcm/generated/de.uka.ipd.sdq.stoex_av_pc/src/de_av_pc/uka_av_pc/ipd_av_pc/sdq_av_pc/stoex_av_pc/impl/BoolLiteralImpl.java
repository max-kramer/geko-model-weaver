 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.BoolLiteralImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoolLiteralImpl extends AtomImpl implements BoolLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.BOOL_LITERAL;
   }
   ...
   public void setValue(boolean newValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.BOOL_LITERAL__VALUE, oldValue, value));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_pcPackage.BOOL_LITERAL__VALUE:
            return isValue();
      }
