 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends AtomImpl implements StringLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.STRING_LITERAL;
   }
   ...
   public void setValue(String newValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.STRING_LITERAL__VALUE, oldValue, value));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_pcPackage.STRING_LITERAL__VALUE:
            return getValue();
      }
