 ...
 * @generated
 */
public class Stoex_pcSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Stoex_pcPackage.VARIABLE_REFERENCE: {
         ...
         case Stoex_pcPackage.ABSTRACT_NAMED_REFERENCE: {
         ...
         case Stoex_pcPackage.NAMESPACE_REFERENCE: {
         ...
         case Stoex_pcPackage.COMPARISON: {
         ...
         case Stoex_pcPackage.BOOLEAN_EXPRESSION: {
         ...
         case Stoex_pcPackage.EXPRESSION: {
            Expression expression = (Expression)theEObject;
            T result = caseExpression(expression);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Stoex_pcPackage.TERM_EXPRESSION: {
         ...
         case Stoex_pcPackage.PRODUCT_EXPRESSION: {
         ...
         case Stoex_pcPackage.PROBABILITY_FUNCTION_LITERAL: {
         ...
         case Stoex_pcPackage.PARENTHESIS: {
         ...
         case Stoex_pcPackage.NUMERIC_LITERAL: {
         ...
         case Stoex_pcPackage.INT_LITERAL: {
         ...
         case Stoex_pcPackage.DOUBLE_LITERAL: {
         ...
         case Stoex_pcPackage.COMPARE_EXPRESSION: {
         ...
         case Stoex_pcPackage.BOOL_LITERAL: {
         ...
         case Stoex_pcPackage.STRING_LITERAL: {
         ...
         case Stoex_pcPackage.POWER_EXPRESSION: {
         ...
         case Stoex_pcPackage.BOOLEAN_OPERATOR_EXPRESSION: {
         ...
         case Stoex_pcPackage.NOT_EXPRESSION: {
         ...
         case Stoex_pcPackage.NEGATIVE_EXPRESSION: {
         ...
         case Stoex_pcPackage.FUNCTION_LITERAL: {
         ...
         case Stoex_pcPackage.IF_ELSE_EXPRESSION: {
