 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.impl.FunctionLiteralImpl#getId <em>Id</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.impl.FunctionLiteralImpl#getParameters_FunctionLiteral <em>Parameters Function Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionLiteralImpl extends AtomImpl implements FunctionLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_avPackage.Literals.FUNCTION_LITERAL;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_avPackage.FUNCTION_LITERAL__ID, oldId, id));
   }
   ...
   public EList<Expression> getParameters_FunctionLiteral() {
      if (parameters_FunctionLiteral == null) {
         parameters_FunctionLiteral = new EObjectContainmentEList<Expression>(Expression.class, this, Stoex_pc_avPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL);
      }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_pc_avPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_avPackage.FUNCTION_LITERAL__ID:
            return getId();
         case Stoex_pc_avPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL:
