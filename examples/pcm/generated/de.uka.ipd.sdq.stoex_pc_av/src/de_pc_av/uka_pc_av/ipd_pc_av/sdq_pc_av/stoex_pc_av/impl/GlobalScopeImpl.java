 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.impl.GlobalScopeImpl#getScopedObject <em>Scoped Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GlobalScopeImpl extends EObjectImpl implements GlobalScope {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_avPackage.Literals.GLOBAL_SCOPE;
   }
      ...
      if (scopedObject != null && scopedObject.eIsProxy()) {
         ...
         if (scopedObject != oldScopedObject) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Stoex_pc_avPackage.GLOBAL_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
         }
      }
      return scopedObject;
   }
   ...
   public void setScopedObject(EObject newScopedObject) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_avPackage.GLOBAL_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_avPackage.GLOBAL_SCOPE__SCOPED_OBJECT:
