...
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Advice;
...
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.BooleanOperations;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.BooleanOperatorExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.CompareExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.CompareOperations;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Comparison;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.DoubleLiteral;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Expression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.FunctionLiteral;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.GlobalScope;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.IfElse;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.IfElseExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.IntLiteral;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.NamespaceReference;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.NegativeExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.NotExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.NumericLiteral;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Parenthesis;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.PerJoinPointScope;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Pointcut;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Power;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.PowerExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.ProbabilityFunctionLiteral;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Product;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.ProductExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.ProductOperations;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.RandomVariable;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Stoex_pc_avFactory;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Stoex_pc_avPackage;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.StringLiteral;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Term;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.TermExpression;
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.TermOperations;
...
import de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.VariableReference;
 ...
 * @generated
 */
public class Stoex_pc_avPackageImpl extends EPackageImpl implements Stoex_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.Stoex_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Stoex_pc_avPackageImpl() {
      super(eNS_URI, Stoex_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Stoex_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Stoex_pc_avPackage init() {
      if (isInited) return (Stoex_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Stoex_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Stoex_pc_avPackageImpl theStoex_pc_avPackage = (Stoex_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Stoex_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Stoex_pc_avPackageImpl());
      ...
      theStoex_pc_avPackage.createPackageContents();

      // Initialize created meta-data
      theStoex_pc_avPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theStoex_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Stoex_pc_avPackage.eNS_URI, theStoex_pc_avPackage);
      return theStoex_pc_avPackage;
   }
    ...
    * @generated
    */
   public Stoex_pc_avFactory getStoex_pc_avFactory() {
      return (Stoex_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      Probfunction_pc_avPackage theProbfunction_pc_avPackage = (Probfunction_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_pc_avPackage.eNS_URI);
      ...
      numericLiteralEClass.getESuperTypes().add(theUnits_pc_avPackage.getUnitCarryingElement());
      ...
      initEReference(getProbabilityFunctionLiteral_Function_ProbabilityFunctionLiteral(), theProbfunction_pc_avPackage.getProbabilityFunction(), null, "function_ProbabilityFunctionLiteral", null, 0, 1, ProbabilityFunctionLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
