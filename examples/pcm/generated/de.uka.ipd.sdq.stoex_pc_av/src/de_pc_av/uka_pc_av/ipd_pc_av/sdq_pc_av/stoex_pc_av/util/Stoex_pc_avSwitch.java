 ...
 * @generated
 */
public class Stoex_pc_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Stoex_pc_avPackage.VARIABLE_REFERENCE: {
         ...
         case Stoex_pc_avPackage.ABSTRACT_NAMED_REFERENCE: {
         ...
         case Stoex_pc_avPackage.NAMESPACE_REFERENCE: {
         ...
         case Stoex_pc_avPackage.VARIABLE: {
         ...
         case Stoex_pc_avPackage.PRODUCT: {
         ...
         case Stoex_pc_avPackage.COMPARISON: {
         ...
         case Stoex_pc_avPackage.BOOLEAN_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.IF_ELSE: {
         ...
         case Stoex_pc_avPackage.EXPRESSION: {
            Expression expression = (Expression)theEObject;
            T result = caseExpression(expression);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Stoex_pc_avPackage.TERM_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.PRODUCT_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.PROBABILITY_FUNCTION_LITERAL: {
         ...
         case Stoex_pc_avPackage.PARENTHESIS: {
         ...
         case Stoex_pc_avPackage.NUMERIC_LITERAL: {
         ...
         case Stoex_pc_avPackage.INT_LITERAL: {
         ...
         case Stoex_pc_avPackage.DOUBLE_LITERAL: {
         ...
         case Stoex_pc_avPackage.COMPARE_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.BOOL_LITERAL: {
         ...
         case Stoex_pc_avPackage.STRING_LITERAL: {
         ...
         case Stoex_pc_avPackage.POWER_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.BOOLEAN_OPERATOR_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.NOT_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.NEGATIVE_EXPRESSION: {
         ...
         case Stoex_pc_avPackage.FUNCTION_LITERAL: {
         ...
         case Stoex_pc_avPackage.IF_ELSE_EXPRESSION: {
