 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.BoolLiteralImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoolLiteralImpl extends AtomImpl implements BoolLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_pcPackage.Literals.BOOL_LITERAL;
   }
   ...
   public void setValue(boolean newValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_pcPackage.BOOL_LITERAL__VALUE, oldValue, value));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_pcPackage.BOOL_LITERAL__VALUE:
            return isValue();
      }
