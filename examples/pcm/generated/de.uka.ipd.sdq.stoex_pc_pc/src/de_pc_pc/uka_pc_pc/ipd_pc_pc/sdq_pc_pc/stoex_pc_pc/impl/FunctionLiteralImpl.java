 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.FunctionLiteralImpl#getId <em>Id</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.FunctionLiteralImpl#getParameters_FunctionLiteral <em>Parameters Function Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionLiteralImpl extends AtomImpl implements FunctionLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_pcPackage.Literals.FUNCTION_LITERAL;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_pcPackage.FUNCTION_LITERAL__ID, oldId, id));
   }
   ...
   public EList<Expression> getParameters_FunctionLiteral() {
      if (parameters_FunctionLiteral == null) {
         parameters_FunctionLiteral = new EObjectContainmentEList<Expression>(Expression.class, this, Stoex_pc_pcPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL);
      }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_pc_pcPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_pcPackage.FUNCTION_LITERAL__ID:
            return getId();
         case Stoex_pc_pcPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL:
