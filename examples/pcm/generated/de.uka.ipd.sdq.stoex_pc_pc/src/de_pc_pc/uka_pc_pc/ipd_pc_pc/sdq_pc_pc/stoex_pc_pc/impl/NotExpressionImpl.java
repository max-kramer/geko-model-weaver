 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.NotExpressionImpl#getInner <em>Inner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NotExpressionImpl extends UnaryImpl implements NotExpression {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_pcPackage.Literals.NOT_EXPRESSION;
   }
   ...
   public NotificationChain basicSetInner(Unary newInner, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Stoex_pc_pcPackage.NOT_EXPRESSION__INNER, oldInner, newInner);
   ...
   public void setInner(Unary newInner) {
      if (newInner != inner) {
         ...
         if (inner != null)
            msgs = ((InternalEObject)inner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Stoex_pc_pcPackage.NOT_EXPRESSION__INNER, null, msgs);
         if (newInner != null)
            msgs = ((InternalEObject)newInner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Stoex_pc_pcPackage.NOT_EXPRESSION__INNER, null, msgs);
         msgs = basicSetInner(newInner, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_pcPackage.NOT_EXPRESSION__INNER, newInner, newInner));
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_pc_pcPackage.NOT_EXPRESSION__INNER:
