 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.units_av.UnitCarryingElement#getUnit <em>Unit</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.units_av.UnitCarryingElement#getUnitSpecification <em>Unit Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.units_av.Units_avPackage#getUnitCarryingElement()
 * @model
 * @generated
 */
public interface UnitCarryingElement extends EObject {
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.units_av.Units_avPackage#getUnitCarryingElement_Unit()
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.units_av.Units_avPackage#getUnitCarryingElement_UnitSpecification()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.units_av.UnitCarryingElement#getUnitSpecification <em>Unit Specification</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
