 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.units_av_av.impl.UnitMultiplicationImpl#getUnits <em>Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitMultiplicationImpl extends UnitImpl implements UnitMultiplication {
   ...
   protected EClass eStaticClass() {
      return Units_av_avPackage.Literals.UNIT_MULTIPLICATION;
   }
   ...
   public EList<Unit> getUnits() {
      if (units == null) {
         units = new EObjectContainmentEList<Unit>(Unit.class, this, Units_av_avPackage.UNIT_MULTIPLICATION__UNITS);
      }
      return units;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_av_avPackage.UNIT_MULTIPLICATION__UNITS:
