 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.units_av_av.impl.UnitRepositoryImpl#getUnits <em>Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitRepositoryImpl extends EObjectImpl implements UnitRepository {
   ...
   protected EClass eStaticClass() {
      return Units_av_avPackage.Literals.UNIT_REPOSITORY;
   }
   ...
   public EList<BaseUnit> getUnits() {
      if (units == null) {
         units = new EObjectContainmentEList<BaseUnit>(BaseUnit.class, this, Units_av_avPackage.UNIT_REPOSITORY__UNITS);
      }
      return units;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_av_avPackage.UNIT_REPOSITORY__UNITS:
