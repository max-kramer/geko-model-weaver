 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.units_av_pc.impl.BaseUnitImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseUnitImpl extends EObjectImpl implements BaseUnit {
   ...
   protected EClass eStaticClass() {
      return Units_av_pcPackage.Literals.BASE_UNIT;
   }
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_av_pcPackage.BASE_UNIT__NAME, oldName, name));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_av_pcPackage.BASE_UNIT__NAME:
            return getName();
      }
