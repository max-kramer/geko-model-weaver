 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.units_av_pc.impl.PerJoinPointScopeImpl#getScopedObject <em>Scoped Object</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PerJoinPointScopeImpl extends EObjectImpl implements PerJoinPointScope {
   ...
   protected EClass eStaticClass() {
      return Units_av_pcPackage.Literals.PER_JOIN_POINT_SCOPE;
   }
      ...
      if (scopedObject != null && scopedObject.eIsProxy()) {
         ...
         if (scopedObject != oldScopedObject) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Units_av_pcPackage.PER_JOIN_POINT_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
         }
      }
      return scopedObject;
   }
   ...
   public void setScopedObject(EObject newScopedObject) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_av_pcPackage.PER_JOIN_POINT_SCOPE__SCOPED_OBJECT, oldScopedObject, scopedObject));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_av_pcPackage.PER_JOIN_POINT_SCOPE__SCOPED_OBJECT:
