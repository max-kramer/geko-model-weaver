 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.units_av_pc.impl.UnitRepositoryImpl#getUnits <em>Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitRepositoryImpl extends EObjectImpl implements UnitRepository {
   ...
   protected EClass eStaticClass() {
      return Units_av_pcPackage.Literals.UNIT_REPOSITORY;
   }
   ...
   public EList<BaseUnit> getUnits() {
      if (units == null) {
         units = new EObjectContainmentEList<BaseUnit>(BaseUnit.class, this, Units_av_pcPackage.UNIT_REPOSITORY__UNITS);
      }
      return units;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_av_pcPackage.UNIT_REPOSITORY__UNITS:
