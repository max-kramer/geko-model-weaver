 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.units_pc_pc.impl.BaseUnitImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseUnitImpl extends EObjectImpl implements BaseUnit {
   ...
   protected EClass eStaticClass() {
      return Units_pc_pcPackage.Literals.BASE_UNIT;
   }
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_pc_pcPackage.BASE_UNIT__NAME, oldName, name));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_pc_pcPackage.BASE_UNIT__NAME:
            return getName();
      }
