 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.units_pc_pc.impl.UnitCarryingElementImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.units_pc_pc.impl.UnitCarryingElementImpl#getUnitSpecification <em>Unit Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitCarryingElementImpl extends EObjectImpl implements UnitCarryingElement {
   ...
   protected EClass eStaticClass() {
      return Units_pc_pcPackage.Literals.UNIT_CARRYING_ELEMENT;
   }
   ...
   public void setUnitSpecification(String newUnitSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_pc_pcPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION, oldUnitSpecification, unitSpecification));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_pc_pcPackage.UNIT_CARRYING_ELEMENT__UNIT:
            if (resolve) return getUnit();
            return basicGetUnit();
         case Units_pc_pcPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION:
