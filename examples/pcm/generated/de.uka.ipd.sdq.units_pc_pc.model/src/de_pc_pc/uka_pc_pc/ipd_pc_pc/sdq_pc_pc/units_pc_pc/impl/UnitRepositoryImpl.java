 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.units_pc_pc.impl.UnitRepositoryImpl#getUnits <em>Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitRepositoryImpl extends EObjectImpl implements UnitRepository {
   ...
   protected EClass eStaticClass() {
      return Units_pc_pcPackage.Literals.UNIT_REPOSITORY;
   }
   ...
   public EList<BaseUnit> getUnits() {
      if (units == null) {
         units = new EObjectContainmentEList<BaseUnit>(BaseUnit.class, this, Units_pc_pcPackage.UNIT_REPOSITORY__UNITS);
      }
      return units;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_pc_pcPackage.UNIT_REPOSITORY__UNITS:
