...
public class UnorderedReferencesRespectingEqualityHelper extends EqualityHelper {
	...
	private Map<EObject, Set<EObject>> eObject2EqualEObjectsMap = new HashMap<EObject, Set<EObject>>();
	...
	// that an EObject is equal to AT MOST ONE EObject
	// FIXME MK find out why the developers of EcoreUtil.EqualityHelper never remove an entry from even in cases where they return false
	// FIXME MK replace this workaround with a clean solution once the questions have been answered
	@Override
