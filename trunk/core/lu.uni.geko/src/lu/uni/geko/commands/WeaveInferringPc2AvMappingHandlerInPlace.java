 ...
 * @author Max E. Kramer
 */
public class WeaveInferringPc2AvMappingHandlerInPlace extends AbstractFileHandler {
   ...
   protected Runnable getRunnable(final URI baseMURI, final URI pointcutMURI, final URI adviceMURI, final List<List<URI>> uris) {
      return new Runnable() {
         @Override
         public void run() {
            ActionsFacade.weaveInferringPc2AvMapping(baseMURI, pointcutMURI, adviceMURI, true);
         }
      };
   }
}
