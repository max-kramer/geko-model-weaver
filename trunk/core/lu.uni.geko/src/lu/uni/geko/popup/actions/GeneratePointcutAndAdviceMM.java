...
public class GeneratePointcutAndAdviceMM extends AbstractSingleFileTypeAction {
	public GeneratePointcutAndAdviceMM() {
		super();
	}
	...
	@Override
	protected boolean isSelectableFile(IFile iFile) {
