...
public class InstallAndStartGeneratedEditorPlugin extends AbstractFilesAction {
	@Override
			...
			Runnable runnable = new Runnable() {	
				...
				public void run() {
					...
					SimpleMessageConsoleManager.getConsole(GeKoConstants.CONSOLE_NAME).confirm(
							...
							"add your generated model code plug-in to the required bundles and its packages to the imported packages!");
				}
			};
