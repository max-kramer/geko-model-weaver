 ...
 * <ul>
 *   <li>{@link bsd.impl.EventImpl#getOwningLifeline <em>Owning Lifeline</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EventImpl extends NamedElementImpl implements Event {
	...
	protected EClass eStaticClass() {
		return BsdPackage.Literals.EVENT;
	}
		...
		if (owningLifeline != null && owningLifeline.eIsProxy()) {
			...
			if (owningLifeline != oldOwningLifeline) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BsdPackage.EVENT__OWNING_LIFELINE, oldOwningLifeline, owningLifeline));
			}
		}
	...
	public void setOwningLifeline(Lifeline newOwningLifeline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BsdPackage.EVENT__OWNING_LIFELINE, oldOwningLifeline, owningLifeline));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BsdPackage.EVENT__OWNING_LIFELINE:
