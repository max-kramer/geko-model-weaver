 ...
 * <ul>
 *   <li>{@link lts_av.impl.AdviceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdviceImpl extends EObjectImpl implements Advice {
	...
	protected EClass eStaticClass() {
		return Lts_avPackage.Literals.ADVICE;
	}
	...
	public EList<EObject> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<EObject>(EObject.class, this, Lts_avPackage.ADVICE__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Lts_avPackage.ADVICE__CHILDREN:
