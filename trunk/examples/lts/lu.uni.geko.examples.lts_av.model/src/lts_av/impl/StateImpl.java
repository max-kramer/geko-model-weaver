 ...
 * <ul>
 *   <li>{@link lts_av.impl.StateImpl#getOwningLTS <em>Owning LTS</em>}</li>
 *   <li>{@link lts_av.impl.StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link lts_av.impl.StateImpl#getOutgoingTransition <em>Outgoing Transition</em>}</li>
 *   <li>{@link lts_av.impl.StateImpl#getIncomingTransition <em>Incoming Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateImpl extends EObjectImpl implements State {
	...
	protected EClass eStaticClass() {
		return Lts_avPackage.Literals.STATE;
	}
	...
	public LTS getOwningLTS() {
		if (eContainerFeatureID() != Lts_avPackage.STATE__OWNING_LTS) return null;
	...
	public NotificationChain basicSetOwningLTS(LTS newOwningLTS, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newOwningLTS, Lts_avPackage.STATE__OWNING_LTS, msgs);
		return msgs;
	}
	...
	public void setOwningLTS(LTS newOwningLTS) {
		if (newOwningLTS != eInternalContainer() || (eContainerFeatureID() != Lts_avPackage.STATE__OWNING_LTS && newOwningLTS != null)) {
			...
			if (newOwningLTS != null)
				msgs = ((InternalEObject)newOwningLTS).eInverseAdd(this, Lts_avPackage.LTS__OWNED_STATE, LTS.class, msgs);
			msgs = basicSetOwningLTS(newOwningLTS, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lts_avPackage.STATE__OWNING_LTS, newOwningLTS, newOwningLTS));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Lts_avPackage.STATE__NAME, oldName, name));
	}
	...
	public EList<Transition> getOutgoingTransition() {
		if (outgoingTransition == null) {
			outgoingTransition = new EObjectContainmentWithInverseEList<Transition>(Transition.class, this, Lts_avPackage.STATE__OUTGOING_TRANSITION, Lts_avPackage.TRANSITION__SOURCE);
		}
	...
	public EList<Transition> getIncomingTransition() {
		if (incomingTransition == null) {
			incomingTransition = new EObjectWithInverseResolvingEList<Transition>(Transition.class, this, Lts_avPackage.STATE__INCOMING_TRANSITION, Lts_avPackage.TRANSITION__TARGET);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Lts_avPackage.STATE__OWNING_LTS:
				return eInternalContainer().eInverseRemove(this, Lts_avPackage.LTS__OWNED_STATE, LTS.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Lts_avPackage.STATE__OWNING_LTS:
				return getOwningLTS();
			case Lts_avPackage.STATE__NAME:
				return getName();
			case Lts_avPackage.STATE__OUTGOING_TRANSITION:
