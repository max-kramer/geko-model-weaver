 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.identifier_av.Identifier#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.identifier_av.Identifier_avPackage#getIdentifier()
 * @model
 * @generated
 */
public interface Identifier extends EObject {
    ...
    * @see #setId(String)
    * @see de_av.uka_av.ipd_av.sdq_av.identifier_av.Identifier_avPackage#getIdentifier_Id()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.identifier_av.Identifier#getId <em>Id</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
