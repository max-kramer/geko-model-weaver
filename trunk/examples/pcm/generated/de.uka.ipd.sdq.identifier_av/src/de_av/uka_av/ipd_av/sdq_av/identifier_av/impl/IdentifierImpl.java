 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.identifier_av.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifierImpl extends EObjectImpl implements Identifier {
   ...
   protected EClass eStaticClass() {
      return Identifier_avPackage.Literals.IDENTIFIER;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Identifier_avPackage.IDENTIFIER__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Identifier_avPackage.IDENTIFIER__ID:
            return getId();
      }
