 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.identifier_pc.impl.IdentifierImpl#getId <em>Id</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdentifierImpl extends EObjectImpl implements Identifier {
   ...
   protected EClass eStaticClass() {
      return Identifier_pcPackage.Literals.IDENTIFIER;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Identifier_pcPackage.IDENTIFIER__ID, oldId, id));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Identifier_pcPackage.IDENTIFIER__ID:
            return getId();
      }
