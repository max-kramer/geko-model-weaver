 ...
 * @generated
 */
public class Identifier_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Identifier_pcPackage modelPackage;
    ...
    * @generated
    */
   public Identifier_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Identifier_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Identifier_pcSwitch<Adapter> modelSwitch =
      new Identifier_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc.uka_pc.ipd_pc.sdq_pc.identifier_pc.Pointcut <em>Pointcut</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
