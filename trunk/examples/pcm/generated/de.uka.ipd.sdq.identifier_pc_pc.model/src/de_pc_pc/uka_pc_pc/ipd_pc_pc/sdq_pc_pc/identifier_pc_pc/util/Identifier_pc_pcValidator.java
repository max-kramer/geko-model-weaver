/**
 */
package de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc.util;
 ...
 * @generated
 */
public class Identifier_pc_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Identifier_pc_pcValidator INSTANCE = new Identifier_pc_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.identifier_pc_pc";
    ...
    * @generated
    */
   public Identifier_pc_pcValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Identifier_pc_pcPackage.IDENTIFIER:
            return validateIdentifier((Identifier)value, diagnostics, context);
         case Identifier_pc_pcPackage.POINTCUT_POINTCUT:
            return validatePointcutPointcut((PointcutPointcut)value, diagnostics, context);
         case Identifier_pc_pcPackage.POINTCUT:
    ...
    * @generated
    */
   public boolean validatePointcutPointcut(PointcutPointcut pointcutPointcut, DiagnosticChain diagnostics, Map<Object, Object> context) {
      return validate_EveryDefaultConstraint(pointcutPointcut, diagnostics, context);
   }
