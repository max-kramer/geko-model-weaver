...
import de_av.uka_av.ipd_av.sdq_av.pcm_av.completions_av.CompletionRepository;
 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.completions_av.impl.CompletionRepositoryImpl#getCompletions_CompletionRepository <em>Completions Completion Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompletionRepositoryImpl extends EObjectImpl implements CompletionRepository {
   ...
   protected EClass eStaticClass() {
      return Completions_avPackage.Literals.COMPLETION_REPOSITORY;
   }
   ...
   public EList<Completion> getCompletions_CompletionRepository() {
      if (completions_CompletionRepository == null) {
         completions_CompletionRepository = new EObjectContainmentEList<Completion>(Completion.class, this, Completions_avPackage.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY);
      }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Completions_avPackage.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY:
