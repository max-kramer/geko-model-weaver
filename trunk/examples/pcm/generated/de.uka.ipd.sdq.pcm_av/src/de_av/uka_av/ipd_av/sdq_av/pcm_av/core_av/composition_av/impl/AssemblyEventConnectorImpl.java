 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.AssemblyEventConnectorImpl#getSinkRole__AssemblyEventConnector <em>Sink Role Assembly Event Connector</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.AssemblyEventConnectorImpl#getSourceRole__AssemblyEventConnector <em>Source Role Assembly Event Connector</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.AssemblyEventConnectorImpl#getSinkAssemblyContext__AssemblyEventConnector <em>Sink Assembly Context Assembly Event Connector</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.AssemblyEventConnectorImpl#getSourceAssemblyContext__AssemblyEventConnector <em>Source Assembly Context Assembly Event Connector</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.AssemblyEventConnectorImpl#getFilterCondition__AssemblyEventConnector <em>Filter Condition Assembly Event Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssemblyEventConnectorImpl extends ConnectorImpl implements AssemblyEventConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_avPackage.Literals.ASSEMBLY_EVENT_CONNECTOR;
   }
      ...
      if (sinkRole__AssemblyEventConnector != null && sinkRole__AssemblyEventConnector.eIsProxy()) {
         ...
         if (sinkRole__AssemblyEventConnector != oldSinkRole__AssemblyEventConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SINK_ROLE_ASSEMBLY_EVENT_CONNECTOR, oldSinkRole__AssemblyEventConnector, sinkRole__AssemblyEventConnector));
         }
      }
   ...
   public void setSinkRole__AssemblyEventConnector(SinkRole newSinkRole__AssemblyEventConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SINK_ROLE_ASSEMBLY_EVENT_CONNECTOR, oldSinkRole__AssemblyEventConnector, sinkRole__AssemblyEventConnector));
   }
   ...
   public SourceRole getSourceRole__AssemblyEventConnector() {
      if (sourceRole__AssemblyEventConnector != null && sourceRole__AssemblyEventConnector.eIsProxy()) {
         ...
         if (sourceRole__AssemblyEventConnector != oldSourceRole__AssemblyEventConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SOURCE_ROLE_ASSEMBLY_EVENT_CONNECTOR, oldSourceRole__AssemblyEventConnector, sourceRole__AssemblyEventConnector));
         }
      }
   ...
   public void setSourceRole__AssemblyEventConnector(SourceRole newSourceRole__AssemblyEventConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SOURCE_ROLE_ASSEMBLY_EVENT_CONNECTOR, oldSourceRole__AssemblyEventConnector, sourceRole__AssemblyEventConnector));
   }
   ...
   public AssemblyContext getSinkAssemblyContext__AssemblyEventConnector() {
      if (sinkAssemblyContext__AssemblyEventConnector != null && sinkAssemblyContext__AssemblyEventConnector.eIsProxy()) {
         ...
         if (sinkAssemblyContext__AssemblyEventConnector != oldSinkAssemblyContext__AssemblyEventConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SINK_ASSEMBLY_CONTEXT_ASSEMBLY_EVENT_CONNECTOR, oldSinkAssemblyContext__AssemblyEventConnector, sinkAssemblyContext__AssemblyEventConnector));
         }
      }
   ...
   public void setSinkAssemblyContext__AssemblyEventConnector(AssemblyContext newSinkAssemblyContext__AssemblyEventConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SINK_ASSEMBLY_CONTEXT_ASSEMBLY_EVENT_CONNECTOR, oldSinkAssemblyContext__AssemblyEventConnector, sinkAssemblyContext__AssemblyEventConnector));
   }
   ...
   public AssemblyContext getSourceAssemblyContext__AssemblyEventConnector() {
      if (sourceAssemblyContext__AssemblyEventConnector != null && sourceAssemblyContext__AssemblyEventConnector.eIsProxy()) {
         ...
         if (sourceAssemblyContext__AssemblyEventConnector != oldSourceAssemblyContext__AssemblyEventConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SOURCE_ASSEMBLY_CONTEXT_ASSEMBLY_EVENT_CONNECTOR, oldSourceAssemblyContext__AssemblyEventConnector, sourceAssemblyContext__AssemblyEventConnector));
         }
      }
   ...
   public void setSourceAssemblyContext__AssemblyEventConnector(AssemblyContext newSourceAssemblyContext__AssemblyEventConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SOURCE_ASSEMBLY_CONTEXT_ASSEMBLY_EVENT_CONNECTOR, oldSourceAssemblyContext__AssemblyEventConnector, sourceAssemblyContext__AssemblyEventConnector));
   }
   ...
   public NotificationChain basicSetFilterCondition__AssemblyEventConnector(PCMRandomVariable newFilterCondition__AssemblyEventConnector, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, oldFilterCondition__AssemblyEventConnector, newFilterCondition__AssemblyEventConnector);
   ...
   public void setFilterCondition__AssemblyEventConnector(PCMRandomVariable newFilterCondition__AssemblyEventConnector) {
      if (newFilterCondition__AssemblyEventConnector != filterCondition__AssemblyEventConnector) {
         ...
         if (filterCondition__AssemblyEventConnector != null)
            msgs = ((InternalEObject)filterCondition__AssemblyEventConnector).eInverseRemove(this, Core_avPackage.PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION, PCMRandomVariable.class, msgs);
         if (newFilterCondition__AssemblyEventConnector != null)
            msgs = ((InternalEObject)newFilterCondition__AssemblyEventConnector).eInverseAdd(this, Core_avPackage.PCM_RANDOM_VARIABLE__ASSEMBLY_EVENT_CONNECTOR_FILTER_CONDITION, PCMRandomVariable.class, msgs);
         msgs = basicSetFilterCondition__AssemblyEventConnector(newFilterCondition__AssemblyEventConnector, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, newFilterCondition__AssemblyEventConnector, newFilterCondition__AssemblyEventConnector));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR:
            if (filterCondition__AssemblyEventConnector != null)
               msgs = ((InternalEObject)filterCondition__AssemblyEventConnector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__FILTER_CONDITION_ASSEMBLY_EVENT_CONNECTOR, null, msgs);
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SINK_ROLE_ASSEMBLY_EVENT_CONNECTOR:
            if (resolve) return getSinkRole__AssemblyEventConnector();
            return basicGetSinkRole__AssemblyEventConnector();
         case Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SOURCE_ROLE_ASSEMBLY_EVENT_CONNECTOR:
            if (resolve) return getSourceRole__AssemblyEventConnector();
            return basicGetSourceRole__AssemblyEventConnector();
         case Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SINK_ASSEMBLY_CONTEXT_ASSEMBLY_EVENT_CONNECTOR:
         ...
         case Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR__SOURCE_ASSEMBLY_CONTEXT_ASSEMBLY_EVENT_CONNECTOR:
