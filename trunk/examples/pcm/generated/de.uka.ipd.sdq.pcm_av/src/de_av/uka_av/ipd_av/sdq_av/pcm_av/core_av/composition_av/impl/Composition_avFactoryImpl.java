 ...
 * @generated
 */
public class Composition_avFactoryImpl extends EFactoryImpl implements Composition_avFactory {
   /**
    ...
    * @generated
    */
   public static Composition_avFactory init() {
      try {
         Composition_avFactory theComposition_avFactory = (Composition_avFactory)EPackage.Registry.INSTANCE.getEFactory(Composition_avPackage.eNS_URI);
         if (theComposition_avFactory != null) {
            return theComposition_avFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Composition_avFactoryImpl();
   }
    ...
    * @generated
    */
   public Composition_avFactoryImpl() {
      super();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Composition_avPackage.DELEGATION_CONNECTOR: return createDelegationConnector();
         case Composition_avPackage.CONNECTOR: return createConnector();
         case Composition_avPackage.COMPOSED_STRUCTURE: return createComposedStructure();
         case Composition_avPackage.RESOURCE_REQUIRED_DELEGATION_CONNECTOR: return createResourceRequiredDelegationConnector();
         case Composition_avPackage.EVENT_CHANNEL: return createEventChannel();
         case Composition_avPackage.EVENT_CHANNEL_SOURCE_CONNECTOR: return createEventChannelSourceConnector();
         case Composition_avPackage.EVENT_CHANNEL_SINK_CONNECTOR: return createEventChannelSinkConnector();
         case Composition_avPackage.PROVIDED_DELEGATION_CONNECTOR: return createProvidedDelegationConnector();
         case Composition_avPackage.REQUIRED_DELEGATION_CONNECTOR: return createRequiredDelegationConnector();
         case Composition_avPackage.ASSEMBLY_CONNECTOR: return createAssemblyConnector();
         case Composition_avPackage.ASSEMBLY_EVENT_CONNECTOR: return createAssemblyEventConnector();
         case Composition_avPackage.SOURCE_DELEGATION_CONNECTOR: return createSourceDelegationConnector();
         case Composition_avPackage.SINK_DELEGATION_CONNECTOR: return createSinkDelegationConnector();
         case Composition_avPackage.ASSEMBLY_INFRASTRUCTURE_CONNECTOR: return createAssemblyInfrastructureConnector();
         case Composition_avPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR: return createProvidedInfrastructureDelegationConnector();
         case Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR: return createRequiredInfrastructureDelegationConnector();
         case Composition_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR: return createRequiredResourceDelegationConnector();
         case Composition_avPackage.ASSEMBLY_CONTEXT: return createAssemblyContext();
         default:
    ...
    * @generated
    */
   public Composition_avPackage getComposition_avPackage() {
      return (Composition_avPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Composition_avPackage getPackage() {
      return Composition_avPackage.eINSTANCE;
   }

} //Composition_avFactoryImpl
