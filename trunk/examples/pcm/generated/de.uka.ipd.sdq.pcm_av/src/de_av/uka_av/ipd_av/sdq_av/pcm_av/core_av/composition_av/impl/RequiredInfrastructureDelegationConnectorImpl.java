 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.RequiredInfrastructureDelegationConnectorImpl#getInnerRequiredRole__RequiredInfrastructureDelegationConnector <em>Inner Required Role Required Infrastructure Delegation Connector</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.RequiredInfrastructureDelegationConnectorImpl#getOuterRequiredRole__RequiredInfrastructureDelegationConnector <em>Outer Required Role Required Infrastructure Delegation Connector</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.RequiredInfrastructureDelegationConnectorImpl#getAssemblyContext__RequiredInfrastructureDelegationConnector <em>Assembly Context Required Infrastructure Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequiredInfrastructureDelegationConnectorImpl extends DelegationConnectorImpl implements RequiredInfrastructureDelegationConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_avPackage.Literals.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR;
   }
      ...
      if (innerRequiredRole__RequiredInfrastructureDelegationConnector != null && innerRequiredRole__RequiredInfrastructureDelegationConnector.eIsProxy()) {
         ...
         if (innerRequiredRole__RequiredInfrastructureDelegationConnector != oldInnerRequiredRole__RequiredInfrastructureDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__INNER_REQUIRED_ROLE_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldInnerRequiredRole__RequiredInfrastructureDelegationConnector, innerRequiredRole__RequiredInfrastructureDelegationConnector));
         }
      }
   ...
   public void setInnerRequiredRole__RequiredInfrastructureDelegationConnector(InfrastructureRequiredRole newInnerRequiredRole__RequiredInfrastructureDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__INNER_REQUIRED_ROLE_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldInnerRequiredRole__RequiredInfrastructureDelegationConnector, innerRequiredRole__RequiredInfrastructureDelegationConnector));
   }
   ...
   public InfrastructureRequiredRole getOuterRequiredRole__RequiredInfrastructureDelegationConnector() {
      if (outerRequiredRole__RequiredInfrastructureDelegationConnector != null && outerRequiredRole__RequiredInfrastructureDelegationConnector.eIsProxy()) {
         ...
         if (outerRequiredRole__RequiredInfrastructureDelegationConnector != oldOuterRequiredRole__RequiredInfrastructureDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__OUTER_REQUIRED_ROLE_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldOuterRequiredRole__RequiredInfrastructureDelegationConnector, outerRequiredRole__RequiredInfrastructureDelegationConnector));
         }
      }
   ...
   public void setOuterRequiredRole__RequiredInfrastructureDelegationConnector(InfrastructureRequiredRole newOuterRequiredRole__RequiredInfrastructureDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__OUTER_REQUIRED_ROLE_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldOuterRequiredRole__RequiredInfrastructureDelegationConnector, outerRequiredRole__RequiredInfrastructureDelegationConnector));
   }
   ...
   public AssemblyContext getAssemblyContext__RequiredInfrastructureDelegationConnector() {
      if (assemblyContext__RequiredInfrastructureDelegationConnector != null && assemblyContext__RequiredInfrastructureDelegationConnector.eIsProxy()) {
         ...
         if (assemblyContext__RequiredInfrastructureDelegationConnector != oldAssemblyContext__RequiredInfrastructureDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldAssemblyContext__RequiredInfrastructureDelegationConnector, assemblyContext__RequiredInfrastructureDelegationConnector));
         }
      }
   ...
   public void setAssemblyContext__RequiredInfrastructureDelegationConnector(AssemblyContext newAssemblyContext__RequiredInfrastructureDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldAssemblyContext__RequiredInfrastructureDelegationConnector, assemblyContext__RequiredInfrastructureDelegationConnector));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__INNER_REQUIRED_ROLE_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR:
         ...
         case Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__OUTER_REQUIRED_ROLE_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR:
         ...
         case Composition_avPackage.REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_REQUIRED_INFRASTRUCTURE_DELEGATION_CONNECTOR:
