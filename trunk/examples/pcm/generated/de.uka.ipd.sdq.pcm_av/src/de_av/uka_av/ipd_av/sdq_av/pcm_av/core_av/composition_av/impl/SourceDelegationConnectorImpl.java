 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.SourceDelegationConnectorImpl#getInnerSourceRole__SourceRole <em>Inner Source Role Source Role</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.SourceDelegationConnectorImpl#getOuterSourceRole__SourceRole <em>Outer Source Role Source Role</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.composition_av.impl.SourceDelegationConnectorImpl#getAssemblyContext__SourceDelegationConnector <em>Assembly Context Source Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourceDelegationConnectorImpl extends DelegationConnectorImpl implements SourceDelegationConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_avPackage.Literals.SOURCE_DELEGATION_CONNECTOR;
   }
      ...
      if (innerSourceRole__SourceRole != null && innerSourceRole__SourceRole.eIsProxy()) {
         ...
         if (innerSourceRole__SourceRole != oldInnerSourceRole__SourceRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__INNER_SOURCE_ROLE_SOURCE_ROLE, oldInnerSourceRole__SourceRole, innerSourceRole__SourceRole));
         }
      }
   ...
   public void setInnerSourceRole__SourceRole(SourceRole newInnerSourceRole__SourceRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__INNER_SOURCE_ROLE_SOURCE_ROLE, oldInnerSourceRole__SourceRole, innerSourceRole__SourceRole));
   }
   ...
   public SourceRole getOuterSourceRole__SourceRole() {
      if (outerSourceRole__SourceRole != null && outerSourceRole__SourceRole.eIsProxy()) {
         ...
         if (outerSourceRole__SourceRole != oldOuterSourceRole__SourceRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__OUTER_SOURCE_ROLE_SOURCE_ROLE, oldOuterSourceRole__SourceRole, outerSourceRole__SourceRole));
         }
      }
   ...
   public void setOuterSourceRole__SourceRole(SourceRole newOuterSourceRole__SourceRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__OUTER_SOURCE_ROLE_SOURCE_ROLE, oldOuterSourceRole__SourceRole, outerSourceRole__SourceRole));
   }
   ...
   public AssemblyContext getAssemblyContext__SourceDelegationConnector() {
      if (assemblyContext__SourceDelegationConnector != null && assemblyContext__SourceDelegationConnector.eIsProxy()) {
         ...
         if (assemblyContext__SourceDelegationConnector != oldAssemblyContext__SourceDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_SOURCE_DELEGATION_CONNECTOR, oldAssemblyContext__SourceDelegationConnector, assemblyContext__SourceDelegationConnector));
         }
      }
   ...
   public void setAssemblyContext__SourceDelegationConnector(AssemblyContext newAssemblyContext__SourceDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_SOURCE_DELEGATION_CONNECTOR, oldAssemblyContext__SourceDelegationConnector, assemblyContext__SourceDelegationConnector));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__INNER_SOURCE_ROLE_SOURCE_ROLE:
            if (resolve) return getInnerSourceRole__SourceRole();
            return basicGetInnerSourceRole__SourceRole();
         case Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__OUTER_SOURCE_ROLE_SOURCE_ROLE:
            if (resolve) return getOuterSourceRole__SourceRole();
            return basicGetOuterSourceRole__SourceRole();
         case Composition_avPackage.SOURCE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_SOURCE_DELEGATION_CONNECTOR:
