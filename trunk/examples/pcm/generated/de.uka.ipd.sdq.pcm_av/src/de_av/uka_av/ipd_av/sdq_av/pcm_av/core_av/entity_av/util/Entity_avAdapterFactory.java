 ...
 * @generated
 */
public class Entity_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Entity_avPackage modelPackage;
    ...
    * @generated
    */
   public Entity_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Entity_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Entity_avSwitch<Adapter> modelSwitch =
      new Entity_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.ResourceProvidedRole <em>Resource Provided Role</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.ResourceRequiredRole <em>Resource Required Role</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.entity_av.ResourceInterfaceProvidingRequiringEntity <em>Resource Interface Providing Requiring Entity</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
