 ...
 * @generated
 */
public class Core_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Core_avPackage modelPackage;
    ...
    * @generated
    */
   public Core_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Core_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Core_avSwitch<Adapter> modelSwitch =
      new Core_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.core_av.PCMRandomVariable <em>PCM Random Variable</em>}'.
    * <!-- begin-user-doc -->
