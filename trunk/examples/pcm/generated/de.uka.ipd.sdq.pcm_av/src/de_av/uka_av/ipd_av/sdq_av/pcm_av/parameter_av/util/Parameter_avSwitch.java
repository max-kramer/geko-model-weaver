 ...
 * @generated
 */
public class Parameter_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         ...
         case Parameter_avPackage.CHARACTERISED_VARIABLE: {
