 ...
 * @generated
 */
public class Qos_reliability_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Qos_reliability_avValidator INSTANCE = new Qos_reliability_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.qos_reliability_av";
    ...
    * @generated
    */
   public Qos_reliability_avValidator() {
      super();
   }
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Qos_reliability_avPackage.SPECIFIED_RELIABILITY_ANNOTATION:
