 ...
 * @generated
 */
public class Qosannotations_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Qosannotations_avPackage modelPackage;
    ...
    * @generated
    */
   public Qosannotations_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Qosannotations_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Qosannotations_avSwitch<Adapter> modelSwitch =
      new Qosannotations_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.QoSAnnotations <em>Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.qosannotations_av.SpecifiedOutputParameterAbstraction <em>Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Qosannotations_avAdapterFactory
