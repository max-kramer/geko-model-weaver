 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.reliability_av.impl.FailureTypeImpl#getRepository__FailureType <em>Repository Failure Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FailureTypeImpl extends EntityImpl implements FailureType {
   ...
   protected EClass eStaticClass() {
      return Reliability_avPackage.Literals.FAILURE_TYPE;
   }
   ...
   public Repository getRepository__FailureType() {
      if (eContainerFeatureID() != Reliability_avPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE) return null;
   ...
   public NotificationChain basicSetRepository__FailureType(Repository newRepository__FailureType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__FailureType, Reliability_avPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE, msgs);
      return msgs;
   }
   ...
   public void setRepository__FailureType(Repository newRepository__FailureType) {
      if (newRepository__FailureType != eInternalContainer() || (eContainerFeatureID() != Reliability_avPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE && newRepository__FailureType != null)) {
         ...
         if (newRepository__FailureType != null)
            msgs = ((InternalEObject)newRepository__FailureType).eInverseAdd(this, Repository_avPackage.REPOSITORY__FAILURE_TYPES_REPOSITORY, Repository.class, msgs);
         msgs = basicSetRepository__FailureType(newRepository__FailureType, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Reliability_avPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE, newRepository__FailureType, newRepository__FailureType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Reliability_avPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Reliability_avPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE:
            return eInternalContainer().eInverseRemove(this, Repository_avPackage.REPOSITORY__FAILURE_TYPES_REPOSITORY, Repository.class, msgs);
      }
