 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Signature#getExceptions__Signature <em>Exceptions Signature</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Signature#getFailureType <em>Failure Type</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getSignature()
 * @model
 * @generated
 */
public interface Signature extends Entity {
    ...
    * The list contents are of type {@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.ExceptionType}.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * <!-- begin-model-doc -->
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getSignature_Exceptions__Signature()
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.Repository_avPackage#getSignature_FailureType()
    * @model ordered="false"
    * @generated
    */
