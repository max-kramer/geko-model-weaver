 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.CompositeDataTypeImpl#getRepository__DataType <em>Repository Data Type</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.CompositeDataTypeImpl#getParentType_CompositeDataType <em>Parent Type Composite Data Type</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.CompositeDataTypeImpl#getInnerDeclaration_CompositeDataType <em>Inner Declaration Composite Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeDataTypeImpl extends EntityImpl implements CompositeDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_avPackage.Literals.COMPOSITE_DATA_TYPE;
   }
   ...
   public Repository getRepository__DataType() {
      if (eContainerFeatureID() != Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE) return null;
   ...
   public NotificationChain basicSetRepository__DataType(Repository newRepository__DataType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__DataType, Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE, msgs);
      return msgs;
   }
   ...
   public void setRepository__DataType(Repository newRepository__DataType) {
      if (newRepository__DataType != eInternalContainer() || (eContainerFeatureID() != Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE && newRepository__DataType != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE, newRepository__DataType, newRepository__DataType));
   }
   ...
   public EList<CompositeDataType> getParentType_CompositeDataType() {
      if (parentType_CompositeDataType == null) {
         parentType_CompositeDataType = new EObjectResolvingEList<CompositeDataType>(CompositeDataType.class, this, Repository_avPackage.COMPOSITE_DATA_TYPE__PARENT_TYPE_COMPOSITE_DATA_TYPE);
      }
   ...
   public EList<InnerDeclaration> getInnerDeclaration_CompositeDataType() {
      if (innerDeclaration_CompositeDataType == null) {
         innerDeclaration_CompositeDataType = new EObjectContainmentWithInverseEList<InnerDeclaration>(InnerDeclaration.class, this, Repository_avPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE, Repository_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetRepository__DataType((Repository)otherEnd, msgs);
         case Repository_avPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Repository_avPackage.COMPOSITE_DATA_TYPE__PARENT_TYPE_COMPOSITE_DATA_TYPE:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (derivedFeatureID) {
            case Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (baseFeatureID) {
            case Repository_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_avPackage.COMPOSITE_DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
