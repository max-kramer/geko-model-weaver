 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.EventGroupImpl#getEventTypes__EventGroup <em>Event Types Event Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventGroupImpl extends InterfaceImpl implements EventGroup {
   ...
   protected EClass eStaticClass() {
      return Repository_avPackage.Literals.EVENT_GROUP;
   }
   ...
   public EList<EventType> getEventTypes__EventGroup() {
      if (eventTypes__EventGroup == null) {
         eventTypes__EventGroup = new EObjectContainmentWithInverseEList<EventType>(EventType.class, this, Repository_avPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP, Repository_avPackage.EVENT_TYPE__EVENT_GROUP_EVENT_TYPE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_avPackage.EVENT_GROUP__EVENT_TYPES_EVENT_GROUP:
