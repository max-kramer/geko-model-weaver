 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.OperationInterfaceImpl#getSignatures__OperationInterface <em>Signatures Operation Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationInterfaceImpl extends InterfaceImpl implements OperationInterface {
   ...
   protected EClass eStaticClass() {
      return Repository_avPackage.Literals.OPERATION_INTERFACE;
   }
   ...
   public EList<OperationSignature> getSignatures__OperationInterface() {
      if (signatures__OperationInterface == null) {
         signatures__OperationInterface = new EObjectContainmentWithInverseEList<OperationSignature>(OperationSignature.class, this, Repository_avPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE, Repository_avPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_avValidator.OPERATION_INTERFACE__SIGNATURES_HAVE_TO_BE_UNIQUE_FOR_AN_INTERFACE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_avPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE:
