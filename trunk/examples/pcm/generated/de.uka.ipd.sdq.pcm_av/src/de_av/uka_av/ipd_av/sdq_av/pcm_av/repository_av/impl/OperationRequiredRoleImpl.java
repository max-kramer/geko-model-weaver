 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.OperationRequiredRoleImpl#getRequiredInterface__OperationRequiredRole <em>Required Interface Operation Required Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationRequiredRoleImpl extends RequiredRoleImpl implements OperationRequiredRole {
   ...
   protected EClass eStaticClass() {
      return Repository_avPackage.Literals.OPERATION_REQUIRED_ROLE;
   }
      ...
      if (requiredInterface__OperationRequiredRole != null && requiredInterface__OperationRequiredRole.eIsProxy()) {
         ...
         if (requiredInterface__OperationRequiredRole != oldRequiredInterface__OperationRequiredRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_avPackage.OPERATION_REQUIRED_ROLE__REQUIRED_INTERFACE_OPERATION_REQUIRED_ROLE, oldRequiredInterface__OperationRequiredRole, requiredInterface__OperationRequiredRole));
         }
      }
   ...
   public void setRequiredInterface__OperationRequiredRole(OperationInterface newRequiredInterface__OperationRequiredRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_avPackage.OPERATION_REQUIRED_ROLE__REQUIRED_INTERFACE_OPERATION_REQUIRED_ROLE, oldRequiredInterface__OperationRequiredRole, requiredInterface__OperationRequiredRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_avPackage.OPERATION_REQUIRED_ROLE__REQUIRED_INTERFACE_OPERATION_REQUIRED_ROLE:
