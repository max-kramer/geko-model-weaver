 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.repository_av.impl.PrimitiveDataTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimitiveDataTypeImpl extends DataTypeImpl implements PrimitiveDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_avPackage.Literals.PRIMITIVE_DATA_TYPE;
   }
   ...
   public void setType(PrimitiveTypeEnum newType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_avPackage.PRIMITIVE_DATA_TYPE__TYPE, oldType, type));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_avPackage.PRIMITIVE_DATA_TYPE__TYPE:
            return getType();
      }
