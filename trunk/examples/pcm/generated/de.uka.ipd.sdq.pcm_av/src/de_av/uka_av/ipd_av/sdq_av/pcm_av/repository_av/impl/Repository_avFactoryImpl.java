 ...
 * @generated
 */
public class Repository_avFactoryImpl extends EFactoryImpl implements Repository_avFactory {
   /**
    ...
    * @generated
    */
   public static Repository_avFactory init() {
      try {
         Repository_avFactory theRepository_avFactory = (Repository_avFactory)EPackage.Registry.INSTANCE.getEFactory(Repository_avPackage.eNS_URI);
         if (theRepository_avFactory != null) {
            return theRepository_avFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Repository_avFactoryImpl();
   }
    ...
    * @generated
    */
   public Repository_avFactoryImpl() {
      super();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Repository_avPackage.PASSIVE_RESOURCE: return createPassiveResource();
         case Repository_avPackage.BASIC_COMPONENT: return createBasicComponent();
         case Repository_avPackage.IMPLEMENTATION_COMPONENT_TYPE: return createImplementationComponentType();
         case Repository_avPackage.REPOSITORY_COMPONENT: return createRepositoryComponent();
         case Repository_avPackage.PROVIDED_ROLE: return createProvidedRole();
         case Repository_avPackage.PARAMETER: return createParameter();
         case Repository_avPackage.DATA_TYPE: return createDataType();
         case Repository_avPackage.REPOSITORY: return createRepository();
         case Repository_avPackage.INTERFACE: return createInterface();
         case Repository_avPackage.REQUIRED_CHARACTERISATION: return createRequiredCharacterisation();
         case Repository_avPackage.EVENT_GROUP: return createEventGroup();
         case Repository_avPackage.EVENT_TYPE: return createEventType();
         case Repository_avPackage.SIGNATURE: return createSignature();
         case Repository_avPackage.EXCEPTION_TYPE: return createExceptionType();
         case Repository_avPackage.INFRASTRUCTURE_SIGNATURE: return createInfrastructureSignature();
         case Repository_avPackage.INFRASTRUCTURE_INTERFACE: return createInfrastructureInterface();
         case Repository_avPackage.INFRASTRUCTURE_REQUIRED_ROLE: return createInfrastructureRequiredRole();
         case Repository_avPackage.REQUIRED_ROLE: return createRequiredRole();
         case Repository_avPackage.OPERATION_SIGNATURE: return createOperationSignature();
         case Repository_avPackage.OPERATION_INTERFACE: return createOperationInterface();
         case Repository_avPackage.OPERATION_REQUIRED_ROLE: return createOperationRequiredRole();
         case Repository_avPackage.SOURCE_ROLE: return createSourceRole();
         case Repository_avPackage.SINK_ROLE: return createSinkRole();
         case Repository_avPackage.OPERATION_PROVIDED_ROLE: return createOperationProvidedRole();
         case Repository_avPackage.INFRASTRUCTURE_PROVIDED_ROLE: return createInfrastructureProvidedRole();
         case Repository_avPackage.COMPLETE_COMPONENT_TYPE: return createCompleteComponentType();
         case Repository_avPackage.PROVIDES_COMPONENT_TYPE: return createProvidesComponentType();
         case Repository_avPackage.COMPOSITE_COMPONENT: return createCompositeComponent();
         case Repository_avPackage.PRIMITIVE_DATA_TYPE: return createPrimitiveDataType();
         case Repository_avPackage.COLLECTION_DATA_TYPE: return createCollectionDataType();
         case Repository_avPackage.COMPOSITE_DATA_TYPE: return createCompositeDataType();
         case Repository_avPackage.INNER_DECLARATION: return createInnerDeclaration();
         case Repository_avPackage.ROLE: return createRole();
         default:
    ...
    * @generated
    */
   public Repository_avPackage getRepository_avPackage() {
      return (Repository_avPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Repository_avPackage getPackage() {
      return Repository_avPackage.eINSTANCE;
   }

} //Repository_avFactoryImpl
