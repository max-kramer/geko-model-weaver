 ...
 * <!-- end-model-doc -->
 * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.Resourceenvironment_avFactory
 * @model kind="package"
 * @generated
 */
public interface Resourceenvironment_avPackage extends EPackage {
   /**
    * The package name.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    */
   String eNAME = "resourceenvironment_av";
    ...
    * @generated
    */
   String eNS_URI = "http://sdq.ipd.uka.de/PalladioComponentModel/ResourceEnvironment/5.0_advice";
    ...
    * @generated
    */
   String eNS_PREFIX = "resourceenvironment_av";
    ...
    * @generated
    */
   Resourceenvironment_avPackage eINSTANCE = de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl.init();

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceEnvironmentImpl <em>Resource Environment</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceEnvironmentImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getResourceEnvironment()
    * @generated
    */
    ...
    * @ordered
    */
   int RESOURCE_ENVIRONMENT__ENTITY_NAME = Entity_avPackage.NAMED_ELEMENT__ENTITY_NAME;
    ...
    * @ordered
    */
   int RESOURCE_ENVIRONMENT__LINKING_RESOURCES_RESOURCE_ENVIRONMENT = Entity_avPackage.NAMED_ELEMENT_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int RESOURCE_ENVIRONMENT__RESOURCE_CONTAINER_RESOURCE_ENVIRONMENT = Entity_avPackage.NAMED_ELEMENT_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int RESOURCE_ENVIRONMENT_FEATURE_COUNT = Entity_avPackage.NAMED_ELEMENT_FEATURE_COUNT + 2;

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.LinkingResourceImpl <em>Linking Resource</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.LinkingResourceImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getLinkingResource()
    * @generated
    */
    ...
    * @ordered
    */
   int LINKING_RESOURCE__ID = Entity_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int LINKING_RESOURCE__ENTITY_NAME = Entity_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int LINKING_RESOURCE__CONNECTED_RESOURCE_CONTAINERS_LINKING_RESOURCE = Entity_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int LINKING_RESOURCE__COMMUNICATION_LINK_RESOURCE_SPECIFICATIONS_LINKING_RESOURCE = Entity_avPackage.ENTITY_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int LINKING_RESOURCE__RESOURCE_ENVIRONMENT_LINKING_RESOURCE = Entity_avPackage.ENTITY_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int LINKING_RESOURCE_FEATURE_COUNT = Entity_avPackage.ENTITY_FEATURE_COUNT + 3;

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceContainerImpl <em>Resource Container</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceContainerImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getResourceContainer()
    * @generated
    */
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER__ID = Entity_avPackage.ENTITY__ID;
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER__ENTITY_NAME = Entity_avPackage.ENTITY__ENTITY_NAME;
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER__ACTIVE_RESOURCE_SPECIFICATIONS_RESOURCE_CONTAINER = Entity_avPackage.ENTITY_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER__RESOURCE_ENVIRONMENT_RESOURCE_CONTAINER = Entity_avPackage.ENTITY_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER__NESTED_RESOURCE_CONTAINERS_RESOURCE_CONTAINER = Entity_avPackage.ENTITY_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER__PARENT_RESOURCE_CONTAINER_RESOURCE_CONTAINER = Entity_avPackage.ENTITY_FEATURE_COUNT + 3;
    ...
    * @ordered
    */
   int RESOURCE_CONTAINER_FEATURE_COUNT = Entity_avPackage.ENTITY_FEATURE_COUNT + 4;

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ProcessingResourceSpecificationImpl <em>Processing Resource Specification</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ProcessingResourceSpecificationImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getProcessingResourceSpecification()
    * @generated
    */
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__ID = Identifier_avPackage.IDENTIFIER__ID;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__MTTR = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__MTTF = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__REQUIRED_BY_CONTAINER = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__SCHEDULING_POLICY = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 3;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__ACTIVE_RESOURCE_TYPE_ACTIVE_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 4;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__PROCESSING_RATE_PROCESSING_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 5;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__NUMBER_OF_REPLICAS = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 6;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION__RESOURCE_CONTAINER_PROCESSING_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 7;
    ...
    * @ordered
    */
   int PROCESSING_RESOURCE_SPECIFICATION_FEATURE_COUNT = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 8;

   /**
    * The meta object id for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.CommunicationLinkResourceSpecificationImpl <em>Communication Link Resource Specification</em>}' class.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.CommunicationLinkResourceSpecificationImpl
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getCommunicationLinkResourceSpecification()
    * @generated
    */
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__ID = Identifier_avPackage.IDENTIFIER__ID;
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__LINKING_RESOURCE_COMMUNICATION_LINK_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 0;
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__FAILURE_PROBABILITY = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 1;
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__COMMUNICATION_LINK_RESOURCE_TYPE_COMMUNICATION_LINK_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 2;
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__LATENCY_COMMUNICATION_LINK_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 3;
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION__THROUGHPUT_COMMUNICATION_LINK_RESOURCE_SPECIFICATION = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 4;
    ...
    * @ordered
    */
   int COMMUNICATION_LINK_RESOURCE_SPECIFICATION_FEATURE_COUNT = Identifier_avPackage.IDENTIFIER_FEATURE_COUNT + 5;


   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceEnvironment <em>Resource Environment</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Resource Environment</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceEnvironment
    * @generated
    */
   EClass getResourceEnvironment();

   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceEnvironment#getLinkingResources__ResourceEnvironment <em>Linking Resources Resource Environment</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference list '<em>Linking Resources Resource Environment</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceEnvironment#getLinkingResources__ResourceEnvironment()
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceEnvironment#getResourceContainer_ResourceEnvironment <em>Resource Container Resource Environment</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.LinkingResource <em>Linking Resource</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Linking Resource</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.LinkingResource
    * @generated
    */
   EClass getLinkingResource();

   /**
    * Returns the meta object for the reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.LinkingResource#getConnectedResourceContainers_LinkingResource <em>Connected Resource Containers Linking Resource</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference list '<em>Connected Resource Containers Linking Resource</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.LinkingResource#getConnectedResourceContainers_LinkingResource()
   ...
   /**
    * Returns the meta object for the containment reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.LinkingResource#getCommunicationLinkResourceSpecifications_LinkingResource <em>Communication Link Resource Specifications Linking Resource</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.LinkingResource#getResourceEnvironment_LinkingResource <em>Resource Environment Linking Resource</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer <em>Resource Container</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Resource Container</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer
    * @generated
    */
   EClass getResourceContainer();

   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer#getActiveResourceSpecifications_ResourceContainer <em>Active Resource Specifications Resource Container</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the containment reference list '<em>Active Resource Specifications Resource Container</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer#getActiveResourceSpecifications_ResourceContainer()
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer#getResourceEnvironment_ResourceContainer <em>Resource Environment Resource Container</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the containment reference list '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer#getNestedResourceContainers__ResourceContainer <em>Nested Resource Containers Resource Container</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ResourceContainer#getParentResourceContainer__ResourceContainer <em>Parent Resource Container Resource Container</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification <em>Processing Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Processing Resource Specification</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification
    * @generated
    */
   EClass getProcessingResourceSpecification();

   /**
    * Returns the meta object for the attribute '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getMTTR <em>MTTR</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>MTTR</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getMTTR()
   ...
   /**
    * Returns the meta object for the attribute '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getMTTF <em>MTTF</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>MTTF</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getMTTF()
    * @see #getProcessingResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the attribute '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#isRequiredByContainer <em>Required By Container</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>Required By Container</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#isRequiredByContainer()
    * @see #getProcessingResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getSchedulingPolicy <em>Scheduling Policy</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Scheduling Policy</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getSchedulingPolicy()
    * @see #getProcessingResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getActiveResourceType_ActiveResourceSpecification <em>Active Resource Type Active Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the reference '<em>Active Resource Type Active Resource Specification</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getActiveResourceType_ActiveResourceSpecification()
    * @see #getProcessingResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the containment reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getProcessingRate_ProcessingResourceSpecification <em>Processing Rate Processing Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the attribute '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getNumberOfReplicas <em>Number Of Replicas</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>Number Of Replicas</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getNumberOfReplicas()
    * @see #getProcessingResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.ProcessingResourceSpecification#getResourceContainer_ProcessingResourceSpecification <em>Resource Container Processing Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification <em>Communication Link Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for class '<em>Communication Link Resource Specification</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification
    * @generated
    */
   EClass getCommunicationLinkResourceSpecification();

   /**
    * Returns the meta object for the container reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getLinkingResource_CommunicationLinkResourceSpecification <em>Linking Resource Communication Link Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the container reference '<em>Linking Resource Communication Link Resource Specification</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getLinkingResource_CommunicationLinkResourceSpecification()
   ...
   /**
    * Returns the meta object for the attribute '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getFailureProbability <em>Failure Probability</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the attribute '<em>Failure Probability</em>'.
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getFailureProbability()
    * @see #getCommunicationLinkResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getCommunicationLinkResourceType_CommunicationLinkResourceSpecification <em>Communication Link Resource Type Communication Link Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getCommunicationLinkResourceType_CommunicationLinkResourceSpecification()
    * @see #getCommunicationLinkResourceSpecification()
    * @generated
    */
   ...
   /**
    * Returns the meta object for the containment reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getLatency_CommunicationLinkResourceSpecification <em>Latency Communication Link Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * Returns the meta object for the containment reference '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.CommunicationLinkResourceSpecification#getThroughput_CommunicationLinkResourceSpecification <em>Throughput Communication Link Resource Specification</em>}'.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @generated
    */
   Resourceenvironment_avFactory getResourceenvironment_avFactory();
   ...
   interface Literals {
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceEnvironmentImpl <em>Resource Environment</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceEnvironmentImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getResourceEnvironment()
      ...
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.LinkingResourceImpl <em>Linking Resource</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.LinkingResourceImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getLinkingResource()
      ...
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceContainerImpl <em>Resource Container</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ResourceContainerImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getResourceContainer()
      ...
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ProcessingResourceSpecificationImpl <em>Processing Resource Specification</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.ProcessingResourceSpecificationImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getProcessingResourceSpecification()
      ...
      /**
       * The meta object literal for the '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.CommunicationLinkResourceSpecificationImpl <em>Communication Link Resource Specification</em>}' class.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.CommunicationLinkResourceSpecificationImpl
       * @see de_av.uka_av.ipd_av.sdq_av.pcm_av.resourceenvironment_av.impl.Resourceenvironment_avPackageImpl#getCommunicationLinkResourceSpecification()
