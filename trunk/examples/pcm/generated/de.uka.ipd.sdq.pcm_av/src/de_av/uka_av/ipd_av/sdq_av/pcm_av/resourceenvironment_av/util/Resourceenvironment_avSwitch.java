 ...
 * @generated
 */
public class Resourceenvironment_avSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourceenvironment_avSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourceenvironment_avPackage.RESOURCE_ENVIRONMENT: {
         ...
         case Resourceenvironment_avPackage.LINKING_RESOURCE: {
         ...
         case Resourceenvironment_avPackage.RESOURCE_CONTAINER: {
         ...
         case Resourceenvironment_avPackage.PROCESSING_RESOURCE_SPECIFICATION: {
         ...
         case Resourceenvironment_avPackage.COMMUNICATION_LINK_RESOURCE_SPECIFICATION: {
