 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getId <em>Id</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getEntityName <em>Entity Name</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getPredecessor_AbstractAction <em>Predecessor Abstract Action</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getSuccessor_AbstractAction <em>Successor Abstract Action</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getResourceDemandingBehaviour_AbstractAction <em>Resource Demanding Behaviour Abstract Action</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getResourceDemand_Action <em>Resource Demand Action</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getInfrastructureCall__Action <em>Infrastructure Call Action</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getResourceCall__Action <em>Resource Call Action</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.InternalCallActionImpl#getCalledResourceDemandingInternalBehaviour <em>Called Resource Demanding Internal Behaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InternalCallActionImpl extends CallActionImpl implements InternalCallAction {
   ...
   protected EClass eStaticClass() {
      return Seff_avPackage.Literals.INTERNAL_CALL_ACTION;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__ID, oldId, id));
   }
   ...
   public void setEntityName(String newEntityName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__ENTITY_NAME, oldEntityName, entityName));
   }
   ...
   public AbstractAction getPredecessor_AbstractAction() {
      if (predecessor_AbstractAction != null && predecessor_AbstractAction.eIsProxy()) {
         ...
         if (predecessor_AbstractAction != oldPredecessor_AbstractAction) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_avPackage.INTERNAL_CALL_ACTION__PREDECESSOR_ABSTRACT_ACTION, oldPredecessor_AbstractAction, predecessor_AbstractAction));
         }
      }
   ...
   public NotificationChain basicSetPredecessor_AbstractAction(AbstractAction newPredecessor_AbstractAction, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__PREDECESSOR_ABSTRACT_ACTION, oldPredecessor_AbstractAction, newPredecessor_AbstractAction);
   ...
   public void setPredecessor_AbstractAction(AbstractAction newPredecessor_AbstractAction) {
      if (newPredecessor_AbstractAction != predecessor_AbstractAction) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__PREDECESSOR_ABSTRACT_ACTION, newPredecessor_AbstractAction, newPredecessor_AbstractAction));
   }
   ...
   public AbstractAction getSuccessor_AbstractAction() {
      if (successor_AbstractAction != null && successor_AbstractAction.eIsProxy()) {
         ...
         if (successor_AbstractAction != oldSuccessor_AbstractAction) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_avPackage.INTERNAL_CALL_ACTION__SUCCESSOR_ABSTRACT_ACTION, oldSuccessor_AbstractAction, successor_AbstractAction));
         }
      }
   ...
   public NotificationChain basicSetSuccessor_AbstractAction(AbstractAction newSuccessor_AbstractAction, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__SUCCESSOR_ABSTRACT_ACTION, oldSuccessor_AbstractAction, newSuccessor_AbstractAction);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setSuccessor_AbstractAction(AbstractAction newSuccessor_AbstractAction) {
      if (newSuccessor_AbstractAction != successor_AbstractAction) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__SUCCESSOR_ABSTRACT_ACTION, newSuccessor_AbstractAction, newSuccessor_AbstractAction));
   }
   ...
   public ResourceDemandingBehaviour getResourceDemandingBehaviour_AbstractAction() {
      if (eContainerFeatureID() != Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION) return null;
   ...
   public NotificationChain basicSetResourceDemandingBehaviour_AbstractAction(ResourceDemandingBehaviour newResourceDemandingBehaviour_AbstractAction, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newResourceDemandingBehaviour_AbstractAction, Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION, msgs);
      return msgs;
   }
   ...
   public void setResourceDemandingBehaviour_AbstractAction(ResourceDemandingBehaviour newResourceDemandingBehaviour_AbstractAction) {
      if (newResourceDemandingBehaviour_AbstractAction != eInternalContainer() || (eContainerFeatureID() != Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION && newResourceDemandingBehaviour_AbstractAction != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION, newResourceDemandingBehaviour_AbstractAction, newResourceDemandingBehaviour_AbstractAction));
   }
   ...
   public EList<ParametricResourceDemand> getResourceDemand_Action() {
      if (resourceDemand_Action == null) {
         resourceDemand_Action = new EObjectContainmentWithInverseEList<ParametricResourceDemand>(ParametricResourceDemand.class, this, Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMAND_ACTION, Seff_performance_avPackage.PARAMETRIC_RESOURCE_DEMAND__ACTION_PARAMETRIC_RESOURCE_DEMAND);
      }
   ...
   public EList<InfrastructureCall> getInfrastructureCall__Action() {
      if (infrastructureCall__Action == null) {
         infrastructureCall__Action = new EObjectContainmentWithInverseEList<InfrastructureCall>(InfrastructureCall.class, this, Seff_avPackage.INTERNAL_CALL_ACTION__INFRASTRUCTURE_CALL_ACTION, Seff_performance_avPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL);
      }
   ...
   public EList<ResourceCall> getResourceCall__Action() {
      if (resourceCall__Action == null) {
         resourceCall__Action = new EObjectContainmentWithInverseEList<ResourceCall>(ResourceCall.class, this, Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_CALL_ACTION, Seff_performance_avPackage.RESOURCE_CALL__ACTION_RESOURCE_CALL);
      }
   ...
   public ResourceDemandingInternalBehaviour getCalledResourceDemandingInternalBehaviour() {
      if (calledResourceDemandingInternalBehaviour != null && calledResourceDemandingInternalBehaviour.eIsProxy()) {
         ...
         if (calledResourceDemandingInternalBehaviour != oldCalledResourceDemandingInternalBehaviour) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_avPackage.INTERNAL_CALL_ACTION__CALLED_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR, oldCalledResourceDemandingInternalBehaviour, calledResourceDemandingInternalBehaviour));
         }
      }
   ...
   public void setCalledResourceDemandingInternalBehaviour(ResourceDemandingInternalBehaviour newCalledResourceDemandingInternalBehaviour) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.INTERNAL_CALL_ACTION__CALLED_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR, oldCalledResourceDemandingInternalBehaviour, calledResourceDemandingInternalBehaviour));
   }
      ...
      if (false) {
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Identifier_avValidator.DIAGNOSTIC_SOURCE,
                   Identifier_avValidator.IDENTIFIER__ID_HAS_TO_BE_UNIQUE,
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Seff_avPackage.INTERNAL_CALL_ACTION__ID:
            return getId();
         case Seff_avPackage.INTERNAL_CALL_ACTION__ENTITY_NAME:
         ...
         case Seff_avPackage.INTERNAL_CALL_ACTION__CALLED_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == Identifier.class) {
         switch (derivedFeatureID) {
            case Seff_avPackage.INTERNAL_CALL_ACTION__ID: return Identifier_avPackage.IDENTIFIER__ID;
            default: return -1;
         }
      }
      if (baseClass == NamedElement.class) {
         switch (derivedFeatureID) {
            case Seff_avPackage.INTERNAL_CALL_ACTION__ENTITY_NAME: return Entity_avPackage.NAMED_ELEMENT__ENTITY_NAME;
            default: return -1;
         }
      }
      ...
      if (baseClass == AbstractAction.class) {
         switch (derivedFeatureID) {
            case Seff_avPackage.INTERNAL_CALL_ACTION__PREDECESSOR_ABSTRACT_ACTION: return Seff_avPackage.ABSTRACT_ACTION__PREDECESSOR_ABSTRACT_ACTION;
            case Seff_avPackage.INTERNAL_CALL_ACTION__SUCCESSOR_ABSTRACT_ACTION: return Seff_avPackage.ABSTRACT_ACTION__SUCCESSOR_ABSTRACT_ACTION;
            case Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION: return Seff_avPackage.ABSTRACT_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
            default: return -1;
         }
      }
      if (baseClass == AbstractInternalControlFlowAction.class) {
         switch (derivedFeatureID) {
            case Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMAND_ACTION: return Seff_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_DEMAND_ACTION;
            case Seff_avPackage.INTERNAL_CALL_ACTION__INFRASTRUCTURE_CALL_ACTION: return Seff_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__INFRASTRUCTURE_CALL_ACTION;
            case Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_CALL_ACTION: return Seff_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_CALL_ACTION;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == Identifier.class) {
         switch (baseFeatureID) {
            case Identifier_avPackage.IDENTIFIER__ID: return Seff_avPackage.INTERNAL_CALL_ACTION__ID;
            default: return -1;
         }
      }
      if (baseClass == NamedElement.class) {
         switch (baseFeatureID) {
            case Entity_avPackage.NAMED_ELEMENT__ENTITY_NAME: return Seff_avPackage.INTERNAL_CALL_ACTION__ENTITY_NAME;
            default: return -1;
         }
      }
      if (baseClass == Entity.class) {
      ...
      if (baseClass == AbstractAction.class) {
         switch (baseFeatureID) {
            case Seff_avPackage.ABSTRACT_ACTION__PREDECESSOR_ABSTRACT_ACTION: return Seff_avPackage.INTERNAL_CALL_ACTION__PREDECESSOR_ABSTRACT_ACTION;
            case Seff_avPackage.ABSTRACT_ACTION__SUCCESSOR_ABSTRACT_ACTION: return Seff_avPackage.INTERNAL_CALL_ACTION__SUCCESSOR_ABSTRACT_ACTION;
            case Seff_avPackage.ABSTRACT_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION: return Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMANDING_BEHAVIOUR_ABSTRACT_ACTION;
            default: return -1;
         }
      }
      if (baseClass == AbstractInternalControlFlowAction.class) {
         switch (baseFeatureID) {
            case Seff_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_DEMAND_ACTION: return Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_DEMAND_ACTION;
            case Seff_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__INFRASTRUCTURE_CALL_ACTION: return Seff_avPackage.INTERNAL_CALL_ACTION__INFRASTRUCTURE_CALL_ACTION;
            case Seff_avPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__RESOURCE_CALL_ACTION: return Seff_avPackage.INTERNAL_CALL_ACTION__RESOURCE_CALL_ACTION;
            default: return -1;
         }
      }
