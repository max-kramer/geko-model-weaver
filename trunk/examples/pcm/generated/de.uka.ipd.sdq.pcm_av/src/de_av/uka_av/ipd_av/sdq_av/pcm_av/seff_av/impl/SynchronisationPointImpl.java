 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.SynchronisationPointImpl#getOutputParameterUsage_SynchronisationPoint <em>Output Parameter Usage Synchronisation Point</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.SynchronisationPointImpl#getForkAction_SynchronisationPoint <em>Fork Action Synchronisation Point</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.impl.SynchronisationPointImpl#getSynchronousForkedBehaviours_SynchronisationPoint <em>Synchronous Forked Behaviours Synchronisation Point</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SynchronisationPointImpl extends EObjectImpl implements SynchronisationPoint {
   ...
   protected EClass eStaticClass() {
      return Seff_avPackage.Literals.SYNCHRONISATION_POINT;
   }
   ...
   public EList<VariableUsage> getOutputParameterUsage_SynchronisationPoint() {
      if (outputParameterUsage_SynchronisationPoint == null) {
         outputParameterUsage_SynchronisationPoint = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_avPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT, Parameter_avPackage.VARIABLE_USAGE__SYNCHRONISATION_POINT_VARIABLE_USAGE);
      }
   ...
   public ForkAction getForkAction_SynchronisationPoint() {
      if (eContainerFeatureID() != Seff_avPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT) return null;
   ...
   public NotificationChain basicSetForkAction_SynchronisationPoint(ForkAction newForkAction_SynchronisationPoint, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newForkAction_SynchronisationPoint, Seff_avPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, msgs);
      return msgs;
   }
   ...
   public void setForkAction_SynchronisationPoint(ForkAction newForkAction_SynchronisationPoint) {
      if (newForkAction_SynchronisationPoint != eInternalContainer() || (eContainerFeatureID() != Seff_avPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT && newForkAction_SynchronisationPoint != null)) {
         ...
         if (newForkAction_SynchronisationPoint != null)
            msgs = ((InternalEObject)newForkAction_SynchronisationPoint).eInverseAdd(this, Seff_avPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, ForkAction.class, msgs);
         msgs = basicSetForkAction_SynchronisationPoint(newForkAction_SynchronisationPoint, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_avPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, newForkAction_SynchronisationPoint, newForkAction_SynchronisationPoint));
   }
   ...
   public EList<ForkedBehaviour> getSynchronousForkedBehaviours_SynchronisationPoint() {
      if (synchronousForkedBehaviours_SynchronisationPoint == null) {
         synchronousForkedBehaviours_SynchronisationPoint = new EObjectContainmentWithInverseEList<ForkedBehaviour>(ForkedBehaviour.class, this, Seff_avPackage.SYNCHRONISATION_POINT__SYNCHRONOUS_FORKED_BEHAVIOURS_SYNCHRONISATION_POINT, Seff_avPackage.FORKED_BEHAVIOUR__SYNCHRONISATION_POINT_FORKED_BEHAVIOUR);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_avPackage.SYNCHRONISATION_POINT__OUTPUT_PARAMETER_USAGE_SYNCHRONISATION_POINT:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getOutputParameterUsage_SynchronisationPoint()).basicAdd(otherEnd, msgs);
         case Seff_avPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetForkAction_SynchronisationPoint((ForkAction)otherEnd, msgs);
         case Seff_avPackage.SYNCHRONISATION_POINT__SYNCHRONOUS_FORKED_BEHAVIOURS_SYNCHRONISATION_POINT:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Seff_avPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT:
            return eInternalContainer().eInverseRemove(this, Seff_avPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, ForkAction.class, msgs);
      }
