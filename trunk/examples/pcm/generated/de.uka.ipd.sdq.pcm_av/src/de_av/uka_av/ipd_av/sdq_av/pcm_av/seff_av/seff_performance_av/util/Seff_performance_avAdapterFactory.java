 ...
 * @generated
 */
public class Seff_performance_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Seff_performance_avPackage modelPackage;
    ...
    * @generated
    */
   public Seff_performance_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Seff_performance_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Seff_performance_avSwitch<Adapter> modelSwitch =
      new Seff_performance_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.seff_performance_av.InfrastructureCall <em>Infrastructure Call</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.seff_performance_av.ResourceCall <em>Resource Call</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Seff_performance_avAdapterFactory
