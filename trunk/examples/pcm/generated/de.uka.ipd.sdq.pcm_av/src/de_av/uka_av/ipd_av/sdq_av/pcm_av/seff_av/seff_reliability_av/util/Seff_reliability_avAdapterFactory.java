 ...
 * @generated
 */
public class Seff_reliability_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Seff_reliability_avPackage modelPackage;
    ...
    * @generated
    */
   public Seff_reliability_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Seff_reliability_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Seff_reliability_avSwitch<Adapter> modelSwitch =
      new Seff_reliability_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.seff_reliability_av.RecoveryActionBehaviour <em>Recovery Action Behaviour</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.seff_av.seff_reliability_av.RecoveryAction <em>Recovery Action</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Seff_reliability_avAdapterFactory
