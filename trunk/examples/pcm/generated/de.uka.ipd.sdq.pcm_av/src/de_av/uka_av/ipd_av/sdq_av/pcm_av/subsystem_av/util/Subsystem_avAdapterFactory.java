 ...
 * @generated
 */
public class Subsystem_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Subsystem_avPackage modelPackage;
    ...
    * @generated
    */
   public Subsystem_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Subsystem_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Subsystem_avSwitch<Adapter> modelSwitch =
      new Subsystem_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.subsystem_av.SubSystem <em>Sub System</em>}'.
    * <!-- begin-user-doc -->
