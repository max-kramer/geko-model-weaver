 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getAssemblyContexts__ComposedStructure <em>Assembly Contexts Composed Structure</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getResourceRequiredDelegationConnectors_ComposedStructure <em>Resource Required Delegation Connectors Composed Structure</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getEventChannel__ComposedStructure <em>Event Channel Composed Structure</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getConnectors__ComposedStructure <em>Connectors Composed Structure</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getProvidedRoles_InterfaceProvidingEntity <em>Provided Roles Interface Providing Entity</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getResourceRequiredRoles__ResourceInterfaceRequiringEntity <em>Resource Required Roles Resource Interface Requiring Entity</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getRequiredRoles_InterfaceRequiringEntity <em>Required Roles Interface Requiring Entity</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.impl.SystemImpl#getQosAnnotations_System <em>Qos Annotations System</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SystemImpl extends EntityImpl implements de_av.uka_av.ipd_av.sdq_av.pcm_av.system_av.System {
   /**
   ...
   protected EClass eStaticClass() {
      return System_avPackage.Literals.SYSTEM;
   }
   ...
   public EList<AssemblyContext> getAssemblyContexts__ComposedStructure() {
      if (assemblyContexts__ComposedStructure == null) {
         assemblyContexts__ComposedStructure = new EObjectContainmentWithInverseEList<AssemblyContext>(AssemblyContext.class, this, System_avPackage.SYSTEM__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE, Composition_avPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT);
      }
   ...
   public EList<EventChannel> getEventChannel__ComposedStructure() {
      if (eventChannel__ComposedStructure == null) {
         eventChannel__ComposedStructure = new EObjectContainmentWithInverseEList<EventChannel>(EventChannel.class, this, System_avPackage.SYSTEM__EVENT_CHANNEL_COMPOSED_STRUCTURE, Composition_avPackage.EVENT_CHANNEL__PARENT_STRUCTURE_EVENT_CHANNEL);
      }
   ...
   public EList<Connector> getConnectors__ComposedStructure() {
      if (connectors__ComposedStructure == null) {
         connectors__ComposedStructure = new EObjectContainmentWithInverseEList<Connector>(Connector.class, this, System_avPackage.SYSTEM__CONNECTORS_COMPOSED_STRUCTURE, Composition_avPackage.CONNECTOR__PARENT_STRUCTURE_CONNECTOR);
      }
   ...
   public EList<ProvidedRole> getProvidedRoles_InterfaceProvidingEntity() {
      if (providedRoles_InterfaceProvidingEntity == null) {
         providedRoles_InterfaceProvidingEntity = new EObjectContainmentWithInverseEList<ProvidedRole>(ProvidedRole.class, this, System_avPackage.SYSTEM__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY, Repository_avPackage.PROVIDED_ROLE__PROVIDING_ENTITY_PROVIDED_ROLE);
      }
   ...
   public EList<ResourceRequiredRole> getResourceRequiredRoles__ResourceInterfaceRequiringEntity() {
      if (resourceRequiredRoles__ResourceInterfaceRequiringEntity == null) {
         resourceRequiredRoles__ResourceInterfaceRequiringEntity = new EObjectContainmentWithInverseEList<ResourceRequiredRole>(ResourceRequiredRole.class, this, System_avPackage.SYSTEM__RESOURCE_REQUIRED_ROLES_RESOURCE_INTERFACE_REQUIRING_ENTITY, Entity_avPackage.RESOURCE_REQUIRED_ROLE__RESOURCE_INTERFACE_REQUIRING_ENTITY_RESOURCE_REQUIRED_ROLE);
      }
   ...
   public EList<RequiredRole> getRequiredRoles_InterfaceRequiringEntity() {
      if (requiredRoles_InterfaceRequiringEntity == null) {
         requiredRoles_InterfaceRequiringEntity = new EObjectContainmentWithInverseEList<RequiredRole>(RequiredRole.class, this, System_avPackage.SYSTEM__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY, Repository_avPackage.REQUIRED_ROLE__REQUIRING_ENTITY_REQUIRED_ROLE);
      }
   ...
   public EList<QoSAnnotations> getQosAnnotations_System() {
      if (qosAnnotations_System == null) {
         qosAnnotations_System = new EObjectContainmentWithInverseEList<QoSAnnotations>(QoSAnnotations.class, this, System_avPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM, Qosannotations_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS);
      }
      ...
      if (false) {
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   System_avValidator.DIAGNOSTIC_SOURCE,
                   System_avValidator.SYSTEM__SYSTEM_MUST_HAVE_AT_LEAST_ONE_PROVIDED_ROLE,
      ...
      if (false) {
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Composition_avValidator.DIAGNOSTIC_SOURCE,
                   Composition_avValidator.COMPOSED_STRUCTURE__MULTIPLE_CONNECTORS_CONSTRAINT,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Composition_avValidator.DIAGNOSTIC_SOURCE,
                   Composition_avValidator.COMPOSED_STRUCTURE__MULTIPLE_CONNECTORS_CONSTRAINT_FOR_ASSEMBLY_CONNECTORS,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case System_avPackage.SYSTEM__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getAssemblyContexts__ComposedStructure()).basicAdd(otherEnd, msgs);
         case System_avPackage.SYSTEM__RESOURCE_REQUIRED_DELEGATION_CONNECTORS_COMPOSED_STRUCTURE:
         ...
         case System_avPackage.SYSTEM__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getRequiredRoles_InterfaceRequiringEntity()).basicAdd(otherEnd, msgs);
         case System_avPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == ComposedStructure.class) {
         switch (derivedFeatureID) {
            case System_avPackage.SYSTEM__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE: return Composition_avPackage.COMPOSED_STRUCTURE__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE;
            case System_avPackage.SYSTEM__RESOURCE_REQUIRED_DELEGATION_CONNECTORS_COMPOSED_STRUCTURE: return Composition_avPackage.COMPOSED_STRUCTURE__RESOURCE_REQUIRED_DELEGATION_CONNECTORS_COMPOSED_STRUCTURE;
            case System_avPackage.SYSTEM__EVENT_CHANNEL_COMPOSED_STRUCTURE: return Composition_avPackage.COMPOSED_STRUCTURE__EVENT_CHANNEL_COMPOSED_STRUCTURE;
            case System_avPackage.SYSTEM__CONNECTORS_COMPOSED_STRUCTURE: return Composition_avPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE;
            default: return -1;
         }
      }
      if (baseClass == InterfaceProvidingEntity.class) {
         switch (derivedFeatureID) {
            case System_avPackage.SYSTEM__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY: return Entity_avPackage.INTERFACE_PROVIDING_ENTITY__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY;
            default: return -1;
         }
      }
      if (baseClass == ResourceInterfaceRequiringEntity.class) {
         switch (derivedFeatureID) {
            case System_avPackage.SYSTEM__RESOURCE_REQUIRED_ROLES_RESOURCE_INTERFACE_REQUIRING_ENTITY: return Entity_avPackage.RESOURCE_INTERFACE_REQUIRING_ENTITY__RESOURCE_REQUIRED_ROLES_RESOURCE_INTERFACE_REQUIRING_ENTITY;
            default: return -1;
         }
      }
      if (baseClass == InterfaceRequiringEntity.class) {
         switch (derivedFeatureID) {
            case System_avPackage.SYSTEM__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY: return Entity_avPackage.INTERFACE_REQUIRING_ENTITY__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == ComposedStructure.class) {
         switch (baseFeatureID) {
            case Composition_avPackage.COMPOSED_STRUCTURE__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE: return System_avPackage.SYSTEM__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE;
            case Composition_avPackage.COMPOSED_STRUCTURE__RESOURCE_REQUIRED_DELEGATION_CONNECTORS_COMPOSED_STRUCTURE: return System_avPackage.SYSTEM__RESOURCE_REQUIRED_DELEGATION_CONNECTORS_COMPOSED_STRUCTURE;
            case Composition_avPackage.COMPOSED_STRUCTURE__EVENT_CHANNEL_COMPOSED_STRUCTURE: return System_avPackage.SYSTEM__EVENT_CHANNEL_COMPOSED_STRUCTURE;
            case Composition_avPackage.COMPOSED_STRUCTURE__CONNECTORS_COMPOSED_STRUCTURE: return System_avPackage.SYSTEM__CONNECTORS_COMPOSED_STRUCTURE;
            default: return -1;
         }
      }
      if (baseClass == InterfaceProvidingEntity.class) {
         switch (baseFeatureID) {
            case Entity_avPackage.INTERFACE_PROVIDING_ENTITY__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY: return System_avPackage.SYSTEM__PROVIDED_ROLES_INTERFACE_PROVIDING_ENTITY;
            default: return -1;
         }
      }
      if (baseClass == ResourceInterfaceRequiringEntity.class) {
         switch (baseFeatureID) {
            case Entity_avPackage.RESOURCE_INTERFACE_REQUIRING_ENTITY__RESOURCE_REQUIRED_ROLES_RESOURCE_INTERFACE_REQUIRING_ENTITY: return System_avPackage.SYSTEM__RESOURCE_REQUIRED_ROLES_RESOURCE_INTERFACE_REQUIRING_ENTITY;
            default: return -1;
         }
      }
      if (baseClass == InterfaceRequiringEntity.class) {
         switch (baseFeatureID) {
            case Entity_avPackage.INTERFACE_REQUIRING_ENTITY__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY: return System_avPackage.SYSTEM__REQUIRED_ROLES_INTERFACE_REQUIRING_ENTITY;
            default: return -1;
         }
      }
      if (baseClass == InterfaceProvidingRequiringEntity.class) {
