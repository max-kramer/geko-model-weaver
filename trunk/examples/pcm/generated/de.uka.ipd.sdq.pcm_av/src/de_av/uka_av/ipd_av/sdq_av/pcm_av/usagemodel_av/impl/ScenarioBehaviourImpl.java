 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.ScenarioBehaviourImpl#getUsageScenario_SenarioBehaviour <em>Usage Scenario Senario Behaviour</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.ScenarioBehaviourImpl#getBranchTransition_ScenarioBehaviour <em>Branch Transition Scenario Behaviour</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.ScenarioBehaviourImpl#getLoop_ScenarioBehaviour <em>Loop Scenario Behaviour</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.ScenarioBehaviourImpl#getActions_ScenarioBehaviour <em>Actions Scenario Behaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScenarioBehaviourImpl extends EntityImpl implements ScenarioBehaviour {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_avPackage.Literals.SCENARIO_BEHAVIOUR;
   }
   ...
   public UsageScenario getUsageScenario_SenarioBehaviour() {
      if (eContainerFeatureID() != Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetUsageScenario_SenarioBehaviour(UsageScenario newUsageScenario_SenarioBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUsageScenario_SenarioBehaviour, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setUsageScenario_SenarioBehaviour(UsageScenario newUsageScenario_SenarioBehaviour) {
      if (newUsageScenario_SenarioBehaviour != eInternalContainer() || (eContainerFeatureID() != Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR && newUsageScenario_SenarioBehaviour != null)) {
         ...
         if (newUsageScenario_SenarioBehaviour != null)
            msgs = ((InternalEObject)newUsageScenario_SenarioBehaviour).eInverseAdd(this, Usagemodel_avPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, UsageScenario.class, msgs);
         msgs = basicSetUsageScenario_SenarioBehaviour(newUsageScenario_SenarioBehaviour, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR, newUsageScenario_SenarioBehaviour, newUsageScenario_SenarioBehaviour));
   }
   ...
   public BranchTransition getBranchTransition_ScenarioBehaviour() {
      if (eContainerFeatureID() != Usagemodel_avPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetBranchTransition_ScenarioBehaviour(BranchTransition newBranchTransition_ScenarioBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newBranchTransition_ScenarioBehaviour, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setBranchTransition_ScenarioBehaviour(BranchTransition newBranchTransition_ScenarioBehaviour) {
      if (newBranchTransition_ScenarioBehaviour != eInternalContainer() || (eContainerFeatureID() != Usagemodel_avPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR && newBranchTransition_ScenarioBehaviour != null)) {
         ...
         if (newBranchTransition_ScenarioBehaviour != null)
            msgs = ((InternalEObject)newBranchTransition_ScenarioBehaviour).eInverseAdd(this, Usagemodel_avPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, BranchTransition.class, msgs);
         msgs = basicSetBranchTransition_ScenarioBehaviour(newBranchTransition_ScenarioBehaviour, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR, newBranchTransition_ScenarioBehaviour, newBranchTransition_ScenarioBehaviour));
   }
   ...
   public Loop getLoop_ScenarioBehaviour() {
      if (eContainerFeatureID() != Usagemodel_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetLoop_ScenarioBehaviour(Loop newLoop_ScenarioBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newLoop_ScenarioBehaviour, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setLoop_ScenarioBehaviour(Loop newLoop_ScenarioBehaviour) {
      if (newLoop_ScenarioBehaviour != eInternalContainer() || (eContainerFeatureID() != Usagemodel_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR && newLoop_ScenarioBehaviour != null)) {
         ...
         if (newLoop_ScenarioBehaviour != null)
            msgs = ((InternalEObject)newLoop_ScenarioBehaviour).eInverseAdd(this, Usagemodel_avPackage.LOOP__BODY_BEHAVIOUR_LOOP, Loop.class, msgs);
         msgs = basicSetLoop_ScenarioBehaviour(newLoop_ScenarioBehaviour, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, newLoop_ScenarioBehaviour, newLoop_ScenarioBehaviour));
   }
   ...
   public EList<AbstractUserAction> getActions_ScenarioBehaviour() {
      if (actions_ScenarioBehaviour == null) {
         actions_ScenarioBehaviour = new EObjectContainmentWithInverseEList<AbstractUserAction>(AbstractUserAction.class, this, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR, Usagemodel_avPackage.ABSTRACT_USER_ACTION__SCENARIO_BEHAVIOUR_ABSTRACT_USER_ACTION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Usagemodel_avValidator.SCENARIO_BEHAVIOUR__EXACTLYONESTART,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Usagemodel_avValidator.DIAGNOSTIC_SOURCE,
                   Usagemodel_avValidator.SCENARIO_BEHAVIOUR__EXACTLYONESTOP,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Usagemodel_avValidator.DIAGNOSTIC_SOURCE,
                   Usagemodel_avValidator.SCENARIO_BEHAVIOUR__EACHUSERACTIONEXCEPT_STARTAND_STOPMUSTHAVEAPREDECESSORANDSUCCESSOR,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetUsageScenario_SenarioBehaviour((UsageScenario)otherEnd, msgs);
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetBranchTransition_ScenarioBehaviour((BranchTransition)otherEnd, msgs);
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetLoop_ScenarioBehaviour((Loop)otherEnd, msgs);
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Usagemodel_avPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, UsageScenario.class, msgs);
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Usagemodel_avPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, BranchTransition.class, msgs);
         case Usagemodel_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Usagemodel_avPackage.LOOP__BODY_BEHAVIOUR_LOOP, Loop.class, msgs);
      }
