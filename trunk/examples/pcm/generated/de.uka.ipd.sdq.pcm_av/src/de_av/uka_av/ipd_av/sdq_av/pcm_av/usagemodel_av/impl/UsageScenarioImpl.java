 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.UsageScenarioImpl#getUsageModel_UsageScenario <em>Usage Model Usage Scenario</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.UsageScenarioImpl#getScenarioBehaviour_UsageScenario <em>Scenario Behaviour Usage Scenario</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.pcm_av.usagemodel_av.impl.UsageScenarioImpl#getWorkload_UsageScenario <em>Workload Usage Scenario</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UsageScenarioImpl extends EntityImpl implements UsageScenario {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_avPackage.Literals.USAGE_SCENARIO;
   }
   ...
   public UsageModel getUsageModel_UsageScenario() {
      if (eContainerFeatureID() != Usagemodel_avPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO) return null;
   ...
   public NotificationChain basicSetUsageModel_UsageScenario(UsageModel newUsageModel_UsageScenario, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUsageModel_UsageScenario, Usagemodel_avPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO, msgs);
      return msgs;
   }
   ...
   public void setUsageModel_UsageScenario(UsageModel newUsageModel_UsageScenario) {
      if (newUsageModel_UsageScenario != eInternalContainer() || (eContainerFeatureID() != Usagemodel_avPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO && newUsageModel_UsageScenario != null)) {
         ...
         if (newUsageModel_UsageScenario != null)
            msgs = ((InternalEObject)newUsageModel_UsageScenario).eInverseAdd(this, Usagemodel_avPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL, UsageModel.class, msgs);
         msgs = basicSetUsageModel_UsageScenario(newUsageModel_UsageScenario, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO, newUsageModel_UsageScenario, newUsageModel_UsageScenario));
   }
   ...
   public NotificationChain basicSetScenarioBehaviour_UsageScenario(ScenarioBehaviour newScenarioBehaviour_UsageScenario, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, oldScenarioBehaviour_UsageScenario, newScenarioBehaviour_UsageScenario);
   ...
   public void setScenarioBehaviour_UsageScenario(ScenarioBehaviour newScenarioBehaviour_UsageScenario) {
      if (newScenarioBehaviour_UsageScenario != scenarioBehaviour_UsageScenario) {
         ...
         if (scenarioBehaviour_UsageScenario != null)
            msgs = ((InternalEObject)scenarioBehaviour_UsageScenario).eInverseRemove(this, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
         if (newScenarioBehaviour_UsageScenario != null)
            msgs = ((InternalEObject)newScenarioBehaviour_UsageScenario).eInverseAdd(this, Usagemodel_avPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
         msgs = basicSetScenarioBehaviour_UsageScenario(newScenarioBehaviour_UsageScenario, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, newScenarioBehaviour_UsageScenario, newScenarioBehaviour_UsageScenario));
   }
   ...
   public NotificationChain basicSetWorkload_UsageScenario(Workload newWorkload_UsageScenario, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, oldWorkload_UsageScenario, newWorkload_UsageScenario);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setWorkload_UsageScenario(Workload newWorkload_UsageScenario) {
      if (newWorkload_UsageScenario != workload_UsageScenario) {
         ...
         if (workload_UsageScenario != null)
            msgs = ((InternalEObject)workload_UsageScenario).eInverseRemove(this, Usagemodel_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, Workload.class, msgs);
         if (newWorkload_UsageScenario != null)
            msgs = ((InternalEObject)newWorkload_UsageScenario).eInverseAdd(this, Usagemodel_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, Workload.class, msgs);
         msgs = basicSetWorkload_UsageScenario(newWorkload_UsageScenario, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_avPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, newWorkload_UsageScenario, newWorkload_UsageScenario));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_avPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetUsageModel_UsageScenario((UsageModel)otherEnd, msgs);
         case Usagemodel_avPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO:
            if (scenarioBehaviour_UsageScenario != null)
               msgs = ((InternalEObject)scenarioBehaviour_UsageScenario).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Usagemodel_avPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, null, msgs);
            return basicSetScenarioBehaviour_UsageScenario((ScenarioBehaviour)otherEnd, msgs);
         case Usagemodel_avPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO:
            if (workload_UsageScenario != null)
               msgs = ((InternalEObject)workload_UsageScenario).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Usagemodel_avPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, null, msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_avPackage.USAGE_SCENARIO__USAGE_MODEL_USAGE_SCENARIO:
            return eInternalContainer().eInverseRemove(this, Usagemodel_avPackage.USAGE_MODEL__USAGE_SCENARIO_USAGE_MODEL, UsageModel.class, msgs);
      }
