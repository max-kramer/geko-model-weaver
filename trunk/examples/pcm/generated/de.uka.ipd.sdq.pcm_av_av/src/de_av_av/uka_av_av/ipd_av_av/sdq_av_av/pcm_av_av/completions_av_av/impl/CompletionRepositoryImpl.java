...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.completions_av_av.CompletionRepository;
 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.completions_av_av.impl.CompletionRepositoryImpl#getCompletions_CompletionRepository <em>Completions Completion Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompletionRepositoryImpl extends EObjectImpl implements CompletionRepository {
   ...
   protected EClass eStaticClass() {
      return Completions_av_avPackage.Literals.COMPLETION_REPOSITORY;
   }
   ...
   public EList<Completion> getCompletions_CompletionRepository() {
      if (completions_CompletionRepository == null) {
         completions_CompletionRepository = new EObjectContainmentEList<Completion>(Completion.class, this, Completions_av_avPackage.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY);
      }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Completions_av_avPackage.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY:
