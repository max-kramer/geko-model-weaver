/**
 */
package de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.completions_av_av.util;
 ...
 * <!-- end-user-doc -->
 * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.completions_av_av.Completions_av_avPackage
 * @generated
 */
public class Completions_av_avSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   protected static Completions_av_avPackage modelPackage;
    ...
    * @generated
    */
   public Completions_av_avSwitch() {
      if (modelPackage == null) {
         modelPackage = Completions_av_avPackage.eINSTANCE;
      }
   }
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Completions_av_avPackage.COMPLETION: {
         ...
         case Completions_av_avPackage.COMPLETION_REPOSITORY: {
         ...
         case Completions_av_avPackage.DELEGATING_EXTERNAL_CALL_ACTION: {
         ...
         case Completions_av_avPackage.NETWORK_DEMAND_PARAMETRIC_RESOURCE_DEMAND: {
