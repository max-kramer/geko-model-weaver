 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.composition_av_av.impl.RequiredResourceDelegationConnectorImpl#getAssemblyContext__RequiredResourceDelegationConnector <em>Assembly Context Required Resource Delegation Connector</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.composition_av_av.impl.RequiredResourceDelegationConnectorImpl#getInnerRequiredRole__RequiredResourceDelegationConnector <em>Inner Required Role Required Resource Delegation Connector</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.composition_av_av.impl.RequiredResourceDelegationConnectorImpl#getOuterRequiredRole__RequiredResourceDelegationConnector <em>Outer Required Role Required Resource Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequiredResourceDelegationConnectorImpl extends DelegationConnectorImpl implements RequiredResourceDelegationConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_av_avPackage.Literals.REQUIRED_RESOURCE_DELEGATION_CONNECTOR;
   }
      ...
      if (assemblyContext__RequiredResourceDelegationConnector != null && assemblyContext__RequiredResourceDelegationConnector.eIsProxy()) {
         ...
         if (assemblyContext__RequiredResourceDelegationConnector != oldAssemblyContext__RequiredResourceDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_REQUIRED_RESOURCE_DELEGATION_CONNECTOR, oldAssemblyContext__RequiredResourceDelegationConnector, assemblyContext__RequiredResourceDelegationConnector));
         }
      }
   ...
   public void setAssemblyContext__RequiredResourceDelegationConnector(AssemblyContext newAssemblyContext__RequiredResourceDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_REQUIRED_RESOURCE_DELEGATION_CONNECTOR, oldAssemblyContext__RequiredResourceDelegationConnector, assemblyContext__RequiredResourceDelegationConnector));
   }
   ...
   public ResourceRequiredRole getInnerRequiredRole__RequiredResourceDelegationConnector() {
      if (innerRequiredRole__RequiredResourceDelegationConnector != null && innerRequiredRole__RequiredResourceDelegationConnector.eIsProxy()) {
         ...
         if (innerRequiredRole__RequiredResourceDelegationConnector != oldInnerRequiredRole__RequiredResourceDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__INNER_REQUIRED_ROLE_REQUIRED_RESOURCE_DELEGATION_CONNECTOR, oldInnerRequiredRole__RequiredResourceDelegationConnector, innerRequiredRole__RequiredResourceDelegationConnector));
         }
      }
   ...
   public void setInnerRequiredRole__RequiredResourceDelegationConnector(ResourceRequiredRole newInnerRequiredRole__RequiredResourceDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__INNER_REQUIRED_ROLE_REQUIRED_RESOURCE_DELEGATION_CONNECTOR, oldInnerRequiredRole__RequiredResourceDelegationConnector, innerRequiredRole__RequiredResourceDelegationConnector));
   }
   ...
   public ResourceRequiredRole getOuterRequiredRole__RequiredResourceDelegationConnector() {
      if (outerRequiredRole__RequiredResourceDelegationConnector != null && outerRequiredRole__RequiredResourceDelegationConnector.eIsProxy()) {
         ...
         if (outerRequiredRole__RequiredResourceDelegationConnector != oldOuterRequiredRole__RequiredResourceDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__OUTER_REQUIRED_ROLE_REQUIRED_RESOURCE_DELEGATION_CONNECTOR, oldOuterRequiredRole__RequiredResourceDelegationConnector, outerRequiredRole__RequiredResourceDelegationConnector));
         }
      }
   ...
   public void setOuterRequiredRole__RequiredResourceDelegationConnector(ResourceRequiredRole newOuterRequiredRole__RequiredResourceDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__OUTER_REQUIRED_ROLE_REQUIRED_RESOURCE_DELEGATION_CONNECTOR, oldOuterRequiredRole__RequiredResourceDelegationConnector, outerRequiredRole__RequiredResourceDelegationConnector));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_REQUIRED_RESOURCE_DELEGATION_CONNECTOR:
         ...
         case Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__INNER_REQUIRED_ROLE_REQUIRED_RESOURCE_DELEGATION_CONNECTOR:
         ...
         case Composition_av_avPackage.REQUIRED_RESOURCE_DELEGATION_CONNECTOR__OUTER_REQUIRED_ROLE_REQUIRED_RESOURCE_DELEGATION_CONNECTOR:
