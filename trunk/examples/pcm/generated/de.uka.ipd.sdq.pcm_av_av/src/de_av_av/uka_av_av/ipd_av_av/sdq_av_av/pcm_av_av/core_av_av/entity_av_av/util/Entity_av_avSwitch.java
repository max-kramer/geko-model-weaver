 ...
 * @generated
 */
public class Entity_av_avSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   protected static Entity_av_avPackage modelPackage;
    ...
    * @generated
    */
   public Entity_av_avSwitch() {
      if (modelPackage == null) {
         modelPackage = Entity_av_avPackage.eINSTANCE;
      }
   }
