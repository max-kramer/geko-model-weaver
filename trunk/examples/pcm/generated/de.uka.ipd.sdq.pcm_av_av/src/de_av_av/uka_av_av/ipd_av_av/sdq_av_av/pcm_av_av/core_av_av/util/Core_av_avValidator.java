 ...
 * @generated
 */
public class Core_av_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Core_av_avValidator INSTANCE = new Core_av_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av";
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Core_av_avPackage.PCM_RANDOM_VARIABLE:
