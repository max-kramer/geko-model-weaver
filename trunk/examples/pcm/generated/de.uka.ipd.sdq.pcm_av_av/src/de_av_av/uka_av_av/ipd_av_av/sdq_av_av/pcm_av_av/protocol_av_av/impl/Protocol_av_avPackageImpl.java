...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.protocol_av_av.Protocol_av_avFactory;
 ...
 * @generated
 */
public class Protocol_av_avPackageImpl extends EPackageImpl implements Protocol_av_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.protocol_av_av.Protocol_av_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Protocol_av_avPackageImpl() {
      super(eNS_URI, Protocol_av_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Protocol_av_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Protocol_av_avPackage init() {
      if (isInited) return (Protocol_av_avPackage)EPackage.Registry.INSTANCE.getEPackage(Protocol_av_avPackage.eNS_URI);

      // Obtain or create and register package
      Protocol_av_avPackageImpl theProtocol_av_avPackage = (Protocol_av_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Protocol_av_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Protocol_av_avPackageImpl());
      ...
      theProtocol_av_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Protocol_av_avPackage.eNS_URI, theProtocol_av_avPackage);
      return theProtocol_av_avPackage;
   }
    ...
    * @generated
    */
   public Protocol_av_avFactory getProtocol_av_avFactory() {
      return (Protocol_av_avFactory)getEFactoryInstance();
   }
