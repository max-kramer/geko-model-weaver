 ...
 * @generated
 */
public class Reliability_av_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Reliability_av_avValidator INSTANCE = new Reliability_av_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.reliability_av_av";
    ...
    * @generated
    */
   public Reliability_av_avValidator() {
      super();
   ...
   public boolean validateHardwareInducedFailureType(HardwareInducedFailureType hardwareInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(hardwareInducedFailureType, diagnostics, context);
   ...
   public boolean validateSoftwareInducedFailureType(SoftwareInducedFailureType softwareInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(softwareInducedFailureType, diagnostics, context);
      return result;
   }
   ...
   public boolean validateNetworkInducedFailureType(NetworkInducedFailureType networkInducedFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(networkInducedFailureType, diagnostics, context);
   ...
   public boolean validateResourceTimeoutFailureType(ResourceTimeoutFailureType resourceTimeoutFailureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(resourceTimeoutFailureType, diagnostics, context);
      return result;
   }
   ...
   public boolean validateFailureType(FailureType failureType, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_av_avValidator.validateIdentifier_idHasToBeUnique(failureType, diagnostics, context);
      return result;
   }
