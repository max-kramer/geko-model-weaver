 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ExceptionType#getExceptionName <em>Exception Name</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ExceptionType#getExceptionMessage <em>Exception Message</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.Repository_av_avPackage#getExceptionType()
 * @model
 * @generated
 */
public interface ExceptionType extends EObject {
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.Repository_av_avPackage#getExceptionType_ExceptionName()
   ...
   /**
    * Sets the value of the '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ExceptionType#getExceptionName <em>Exception Name</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.Repository_av_avPackage#getExceptionType_ExceptionMessage()
    * @model unique="false" required="true" ordered="false"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.ExceptionType#getExceptionMessage <em>Exception Message</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
