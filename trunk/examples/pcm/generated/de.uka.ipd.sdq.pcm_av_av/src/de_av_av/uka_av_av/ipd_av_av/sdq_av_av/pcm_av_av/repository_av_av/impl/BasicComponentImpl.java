 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.BasicComponentImpl#getServiceEffectSpecifications__BasicComponent <em>Service Effect Specifications Basic Component</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.BasicComponentImpl#getPassiveResource_BasicComponent <em>Passive Resource Basic Component</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BasicComponentImpl extends ImplementationComponentTypeImpl implements BasicComponent {
   ...
   protected EClass eStaticClass() {
      return Repository_av_avPackage.Literals.BASIC_COMPONENT;
   }
   ...
   public EList<ServiceEffectSpecification> getServiceEffectSpecifications__BasicComponent() {
      if (serviceEffectSpecifications__BasicComponent == null) {
         serviceEffectSpecifications__BasicComponent = new EObjectContainmentWithInverseEList<ServiceEffectSpecification>(ServiceEffectSpecification.class, this, Repository_av_avPackage.BASIC_COMPONENT__SERVICE_EFFECT_SPECIFICATIONS_BASIC_COMPONENT, Seff_av_avPackage.SERVICE_EFFECT_SPECIFICATION__BASIC_COMPONENT_SERVICE_EFFECT_SPECIFICATION);
      }
   ...
   public EList<PassiveResource> getPassiveResource_BasicComponent() {
      if (passiveResource_BasicComponent == null) {
         passiveResource_BasicComponent = new EObjectContainmentWithInverseEList<PassiveResource>(PassiveResource.class, this, Repository_av_avPackage.BASIC_COMPONENT__PASSIVE_RESOURCE_BASIC_COMPONENT, Repository_av_avPackage.PASSIVE_RESOURCE__BASIC_COMPONENT_PASSIVE_RESOURCE);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_av_avValidator.BASIC_COMPONENT__NO_SEFF_TYPE_USED_TWICE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_av_avValidator.DIAGNOSTIC_SOURCE,
                   Repository_av_avValidator.BASIC_COMPONENT__PROVIDE_SAME_INTERFACES_AS_IMPLEMENTATION_TYPE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_av_avValidator.DIAGNOSTIC_SOURCE,
                   Repository_av_avValidator.BASIC_COMPONENT__REQUIRE_SAME_INTERFACES_AS_IMPLEMENTATION_TYPE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_av_avPackage.BASIC_COMPONENT__SERVICE_EFFECT_SPECIFICATIONS_BASIC_COMPONENT:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getServiceEffectSpecifications__BasicComponent()).basicAdd(otherEnd, msgs);
         case Repository_av_avPackage.BASIC_COMPONENT__PASSIVE_RESOURCE_BASIC_COMPONENT:
