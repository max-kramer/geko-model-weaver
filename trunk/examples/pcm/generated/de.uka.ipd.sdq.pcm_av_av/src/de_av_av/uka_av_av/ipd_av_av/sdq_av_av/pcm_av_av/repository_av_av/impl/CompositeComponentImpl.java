 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.CompositeComponentImpl#getRepository__RepositoryComponent <em>Repository Repository Component</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.CompositeComponentImpl#getParentCompleteComponentTypes <em>Parent Complete Component Types</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.CompositeComponentImpl#getComponentParameterUsage_ImplementationComponentType <em>Component Parameter Usage Implementation Component Type</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.CompositeComponentImpl#getComponentType <em>Component Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeComponentImpl extends ComposedProvidingRequiringEntityImpl implements CompositeComponent {
   ...
   protected EClass eStaticClass() {
      return Repository_av_avPackage.Literals.COMPOSITE_COMPONENT;
   }
   ...
   public Repository getRepository__RepositoryComponent() {
      if (eContainerFeatureID() != Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT) return null;
   ...
   public NotificationChain basicSetRepository__RepositoryComponent(Repository newRepository__RepositoryComponent, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__RepositoryComponent, Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT, msgs);
      return msgs;
   }
   ...
   public void setRepository__RepositoryComponent(Repository newRepository__RepositoryComponent) {
      if (newRepository__RepositoryComponent != eInternalContainer() || (eContainerFeatureID() != Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT && newRepository__RepositoryComponent != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT, newRepository__RepositoryComponent, newRepository__RepositoryComponent));
   }
   ...
   public EList<CompleteComponentType> getParentCompleteComponentTypes() {
      if (parentCompleteComponentTypes == null) {
         parentCompleteComponentTypes = new EObjectResolvingEList<CompleteComponentType>(CompleteComponentType.class, this, Repository_av_avPackage.COMPOSITE_COMPONENT__PARENT_COMPLETE_COMPONENT_TYPES);
      }
   ...
   public EList<VariableUsage> getComponentParameterUsage_ImplementationComponentType() {
      if (componentParameterUsage_ImplementationComponentType == null) {
         componentParameterUsage_ImplementationComponentType = new EObjectContainmentEList<VariableUsage>(VariableUsage.class, this, Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE);
      }
   ...
   public void setComponentType(ComponentType newComponentType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_TYPE, oldComponentType, componentType));
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_av_avValidator.COMPOSITE_COMPONENT__PROVIDE_SAME_INTERFACES,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_av_avValidator.DIAGNOSTIC_SOURCE,
                   Repository_av_avValidator.COMPOSITE_COMPONENT__REQUIRE_SAME_INTERFACES,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_av_avValidator.DIAGNOSTIC_SOURCE,
                   Repository_av_avValidator.IMPLEMENTATION_COMPONENT_TYPE__REQUIRED_INTERFACES_HAVE_TO_CONFORM_TO_COMPLETE_TYPE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_av_avValidator.DIAGNOSTIC_SOURCE,
                   Repository_av_avValidator.IMPLEMENTATION_COMPONENT_TYPE__PROVIDED_INTERFACES_HAVE_TO_CONFORM_TO_COMPLETE_TYPE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Repository_av_avValidator.DIAGNOSTIC_SOURCE,
                   Repository_av_avValidator.IMPLEMENTATION_COMPONENT_TYPE__PROVIDED_INTERFACE_HAVE_TO_CONFORM_TO_COMPONENT_TYPE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         ...
         case Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Repository_av_avPackage.COMPOSITE_COMPONENT__PARENT_COMPLETE_COMPONENT_TYPES:
            return getParentCompleteComponentTypes();
         case Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE:
            return getComponentParameterUsage_ImplementationComponentType();
         case Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_TYPE:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == RepositoryComponent.class) {
         switch (derivedFeatureID) {
            case Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT: return Repository_av_avPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT;
            default: return -1;
         }
      }
      if (baseClass == ImplementationComponentType.class) {
         switch (derivedFeatureID) {
            case Repository_av_avPackage.COMPOSITE_COMPONENT__PARENT_COMPLETE_COMPONENT_TYPES: return Repository_av_avPackage.IMPLEMENTATION_COMPONENT_TYPE__PARENT_COMPLETE_COMPONENT_TYPES;
            case Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE: return Repository_av_avPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE;
            case Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_TYPE: return Repository_av_avPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == RepositoryComponent.class) {
         switch (baseFeatureID) {
            case Repository_av_avPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT: return Repository_av_avPackage.COMPOSITE_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT;
            default: return -1;
         }
      }
      if (baseClass == ImplementationComponentType.class) {
         switch (baseFeatureID) {
            case Repository_av_avPackage.IMPLEMENTATION_COMPONENT_TYPE__PARENT_COMPLETE_COMPONENT_TYPES: return Repository_av_avPackage.COMPOSITE_COMPONENT__PARENT_COMPLETE_COMPONENT_TYPES;
            case Repository_av_avPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE: return Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_PARAMETER_USAGE_IMPLEMENTATION_COMPONENT_TYPE;
            case Repository_av_avPackage.IMPLEMENTATION_COMPONENT_TYPE__COMPONENT_TYPE: return Repository_av_avPackage.COMPOSITE_COMPONENT__COMPONENT_TYPE;
            default: return -1;
         }
      }
