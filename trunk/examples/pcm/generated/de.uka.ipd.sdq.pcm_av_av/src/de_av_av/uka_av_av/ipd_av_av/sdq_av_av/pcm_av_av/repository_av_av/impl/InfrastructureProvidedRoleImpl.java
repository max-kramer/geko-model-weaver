 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.InfrastructureProvidedRoleImpl#getProvidedInterface__InfrastructureProvidedRole <em>Provided Interface Infrastructure Provided Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InfrastructureProvidedRoleImpl extends ProvidedRoleImpl implements InfrastructureProvidedRole {
   ...
   protected EClass eStaticClass() {
      return Repository_av_avPackage.Literals.INFRASTRUCTURE_PROVIDED_ROLE;
   }
      ...
      if (providedInterface__InfrastructureProvidedRole != null && providedInterface__InfrastructureProvidedRole.eIsProxy()) {
         ...
         if (providedInterface__InfrastructureProvidedRole != oldProvidedInterface__InfrastructureProvidedRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_av_avPackage.INFRASTRUCTURE_PROVIDED_ROLE__PROVIDED_INTERFACE_INFRASTRUCTURE_PROVIDED_ROLE, oldProvidedInterface__InfrastructureProvidedRole, providedInterface__InfrastructureProvidedRole));
         }
      }
   ...
   public void setProvidedInterface__InfrastructureProvidedRole(InfrastructureInterface newProvidedInterface__InfrastructureProvidedRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_avPackage.INFRASTRUCTURE_PROVIDED_ROLE__PROVIDED_INTERFACE_INFRASTRUCTURE_PROVIDED_ROLE, oldProvidedInterface__InfrastructureProvidedRole, providedInterface__InfrastructureProvidedRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_av_avPackage.INFRASTRUCTURE_PROVIDED_ROLE__PROVIDED_INTERFACE_INFRASTRUCTURE_PROVIDED_ROLE:
