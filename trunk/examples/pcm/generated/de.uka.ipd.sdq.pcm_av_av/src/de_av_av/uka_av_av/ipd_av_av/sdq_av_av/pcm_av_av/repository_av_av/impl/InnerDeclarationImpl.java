...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.core_av_av.entity_av_av.impl.NamedElementImpl;
 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.InnerDeclarationImpl#getDatatype_InnerDeclaration <em>Datatype Inner Declaration</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.InnerDeclarationImpl#getCompositeDataType_InnerDeclaration <em>Composite Data Type Inner Declaration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InnerDeclarationImpl extends NamedElementImpl implements InnerDeclaration {
   ...
   protected EClass eStaticClass() {
      return Repository_av_avPackage.Literals.INNER_DECLARATION;
   }
      ...
      if (datatype_InnerDeclaration != null && datatype_InnerDeclaration.eIsProxy()) {
         ...
         if (datatype_InnerDeclaration != oldDatatype_InnerDeclaration) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_av_avPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION, oldDatatype_InnerDeclaration, datatype_InnerDeclaration));
         }
      }
   ...
   public void setDatatype_InnerDeclaration(DataType newDatatype_InnerDeclaration) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_avPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION, oldDatatype_InnerDeclaration, datatype_InnerDeclaration));
   }
   ...
   public CompositeDataType getCompositeDataType_InnerDeclaration() {
      if (eContainerFeatureID() != Repository_av_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION) return null;
   ...
   public NotificationChain basicSetCompositeDataType_InnerDeclaration(CompositeDataType newCompositeDataType_InnerDeclaration, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newCompositeDataType_InnerDeclaration, Repository_av_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION, msgs);
      return msgs;
   }
   ...
   public void setCompositeDataType_InnerDeclaration(CompositeDataType newCompositeDataType_InnerDeclaration) {
      if (newCompositeDataType_InnerDeclaration != eInternalContainer() || (eContainerFeatureID() != Repository_av_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION && newCompositeDataType_InnerDeclaration != null)) {
         ...
         if (newCompositeDataType_InnerDeclaration != null)
            msgs = ((InternalEObject)newCompositeDataType_InnerDeclaration).eInverseAdd(this, Repository_av_avPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE, CompositeDataType.class, msgs);
         msgs = basicSetCompositeDataType_InnerDeclaration(newCompositeDataType_InnerDeclaration, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION, newCompositeDataType_InnerDeclaration, newCompositeDataType_InnerDeclaration));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_av_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Repository_av_avPackage.INNER_DECLARATION__COMPOSITE_DATA_TYPE_INNER_DECLARATION:
            return eInternalContainer().eInverseRemove(this, Repository_av_avPackage.COMPOSITE_DATA_TYPE__INNER_DECLARATION_COMPOSITE_DATA_TYPE, CompositeDataType.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_av_avPackage.INNER_DECLARATION__DATATYPE_INNER_DECLARATION:
