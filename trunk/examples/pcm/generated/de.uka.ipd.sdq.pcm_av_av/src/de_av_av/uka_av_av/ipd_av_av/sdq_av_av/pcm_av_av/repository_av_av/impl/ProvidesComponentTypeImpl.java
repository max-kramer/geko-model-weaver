...
public class ProvidesComponentTypeImpl extends RepositoryComponentImpl implements ProvidesComponentType {
   ...
   protected EClass eStaticClass() {
      return Repository_av_avPackage.Literals.PROVIDES_COMPONENT_TYPE;
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_av_avValidator.PROVIDES_COMPONENT_TYPE__AT_LEAST_ONE_INTERFACE_HAS_TO_BE_PROVIDED_BY_AUSEFULL_PROVIDES_COMPONENT_TYPE,
