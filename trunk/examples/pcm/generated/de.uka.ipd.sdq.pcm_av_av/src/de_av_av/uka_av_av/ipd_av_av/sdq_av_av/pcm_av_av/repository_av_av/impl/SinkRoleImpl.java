 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.repository_av_av.impl.SinkRoleImpl#getEventGroup__SinkRole <em>Event Group Sink Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SinkRoleImpl extends ProvidedRoleImpl implements SinkRole {
   ...
   protected EClass eStaticClass() {
      return Repository_av_avPackage.Literals.SINK_ROLE;
   }
      ...
      if (eventGroup__SinkRole != null && eventGroup__SinkRole.eIsProxy()) {
         ...
         if (eventGroup__SinkRole != oldEventGroup__SinkRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_av_avPackage.SINK_ROLE__EVENT_GROUP_SINK_ROLE, oldEventGroup__SinkRole, eventGroup__SinkRole));
         }
      }
   ...
   public void setEventGroup__SinkRole(EventGroup newEventGroup__SinkRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_avPackage.SINK_ROLE__EVENT_GROUP_SINK_ROLE, oldEventGroup__SinkRole, eventGroup__SinkRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_av_avPackage.SINK_ROLE__EVENT_GROUP_SINK_ROLE:
