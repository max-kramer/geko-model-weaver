 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.resourcetype_av_av.impl.CommunicationLinkResourceTypeImpl#getNetworkInducedFailureType__CommunicationLinkResourceType <em>Network Induced Failure Type Communication Link Resource Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommunicationLinkResourceTypeImpl extends ResourceTypeImpl implements CommunicationLinkResourceType {
   ...
   protected EClass eStaticClass() {
      return Resourcetype_av_avPackage.Literals.COMMUNICATION_LINK_RESOURCE_TYPE;
   }
      ...
      if (networkInducedFailureType__CommunicationLinkResourceType != null && networkInducedFailureType__CommunicationLinkResourceType.eIsProxy()) {
         ...
         if (networkInducedFailureType__CommunicationLinkResourceType != oldNetworkInducedFailureType__CommunicationLinkResourceType) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Resourcetype_av_avPackage.COMMUNICATION_LINK_RESOURCE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_COMMUNICATION_LINK_RESOURCE_TYPE, oldNetworkInducedFailureType__CommunicationLinkResourceType, networkInducedFailureType__CommunicationLinkResourceType));
         }
      }
   ...
   public void setNetworkInducedFailureType__CommunicationLinkResourceType(NetworkInducedFailureType newNetworkInducedFailureType__CommunicationLinkResourceType) {
      if (newNetworkInducedFailureType__CommunicationLinkResourceType != networkInducedFailureType__CommunicationLinkResourceType) {
         ...
         if (networkInducedFailureType__CommunicationLinkResourceType != null)
            msgs = ((InternalEObject)networkInducedFailureType__CommunicationLinkResourceType).eInverseRemove(this, Reliability_av_avPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE, NetworkInducedFailureType.class, msgs);
         if (newNetworkInducedFailureType__CommunicationLinkResourceType != null)
            msgs = ((InternalEObject)newNetworkInducedFailureType__CommunicationLinkResourceType).eInverseAdd(this, Reliability_av_avPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE, NetworkInducedFailureType.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Resourcetype_av_avPackage.COMMUNICATION_LINK_RESOURCE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_COMMUNICATION_LINK_RESOURCE_TYPE, newNetworkInducedFailureType__CommunicationLinkResourceType, newNetworkInducedFailureType__CommunicationLinkResourceType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Resourcetype_av_avPackage.COMMUNICATION_LINK_RESOURCE_TYPE__NETWORK_INDUCED_FAILURE_TYPE_COMMUNICATION_LINK_RESOURCE_TYPE:
            if (networkInducedFailureType__CommunicationLinkResourceType != null)
               msgs = ((InternalEObject)networkInducedFailureType__CommunicationLinkResourceType).eInverseRemove(this, Reliability_av_avPackage.NETWORK_INDUCED_FAILURE_TYPE__COMMUNICATION_LINK_RESOURCE_TYPE_NETWORK_INDUCED_FAILURE_TYPE, NetworkInducedFailureType.class, msgs);
