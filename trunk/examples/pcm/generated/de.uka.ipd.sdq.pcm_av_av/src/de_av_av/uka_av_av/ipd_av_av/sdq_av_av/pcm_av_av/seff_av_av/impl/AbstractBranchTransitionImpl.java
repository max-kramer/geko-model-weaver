 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.AbstractBranchTransitionImpl#getBranchAction_AbstractBranchTransition <em>Branch Action Abstract Branch Transition</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.AbstractBranchTransitionImpl#getBranchBehaviour_BranchTransition <em>Branch Behaviour Branch Transition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractBranchTransitionImpl extends EntityImpl implements AbstractBranchTransition {
   ...
   protected EClass eStaticClass() {
      return Seff_av_avPackage.Literals.ABSTRACT_BRANCH_TRANSITION;
   }
   ...
   public BranchAction getBranchAction_AbstractBranchTransition() {
      if (eContainerFeatureID() != Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION) return null;
   ...
   public NotificationChain basicSetBranchAction_AbstractBranchTransition(BranchAction newBranchAction_AbstractBranchTransition, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newBranchAction_AbstractBranchTransition, Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION, msgs);
      return msgs;
   }
   ...
   public void setBranchAction_AbstractBranchTransition(BranchAction newBranchAction_AbstractBranchTransition) {
      if (newBranchAction_AbstractBranchTransition != eInternalContainer() || (eContainerFeatureID() != Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION && newBranchAction_AbstractBranchTransition != null)) {
         ...
         if (newBranchAction_AbstractBranchTransition != null)
            msgs = ((InternalEObject)newBranchAction_AbstractBranchTransition).eInverseAdd(this, Seff_av_avPackage.BRANCH_ACTION__BRANCHES_BRANCH, BranchAction.class, msgs);
         msgs = basicSetBranchAction_AbstractBranchTransition(newBranchAction_AbstractBranchTransition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION, newBranchAction_AbstractBranchTransition, newBranchAction_AbstractBranchTransition));
   }
   ...
   public NotificationChain basicSetBranchBehaviour_BranchTransition(ResourceDemandingBehaviour newBranchBehaviour_BranchTransition, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION, oldBranchBehaviour_BranchTransition, newBranchBehaviour_BranchTransition);
   ...
   public void setBranchBehaviour_BranchTransition(ResourceDemandingBehaviour newBranchBehaviour_BranchTransition) {
      if (newBranchBehaviour_BranchTransition != branchBehaviour_BranchTransition) {
         ...
         if (branchBehaviour_BranchTransition != null)
            msgs = ((InternalEObject)branchBehaviour_BranchTransition).eInverseRemove(this, Seff_av_avPackage.RESOURCE_DEMANDING_BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR, ResourceDemandingBehaviour.class, msgs);
         if (newBranchBehaviour_BranchTransition != null)
            msgs = ((InternalEObject)newBranchBehaviour_BranchTransition).eInverseAdd(this, Seff_av_avPackage.RESOURCE_DEMANDING_BEHAVIOUR__ABSTRACT_BRANCH_TRANSITION_RESOURCE_DEMANDING_BEHAVIOUR, ResourceDemandingBehaviour.class, msgs);
         msgs = basicSetBranchBehaviour_BranchTransition(newBranchBehaviour_BranchTransition, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION, newBranchBehaviour_BranchTransition, newBranchBehaviour_BranchTransition));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetBranchAction_AbstractBranchTransition((BranchAction)otherEnd, msgs);
         case Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION:
            if (branchBehaviour_BranchTransition != null)
               msgs = ((InternalEObject)branchBehaviour_BranchTransition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_BEHAVIOUR_BRANCH_TRANSITION, null, msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Seff_av_avPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION:
            return eInternalContainer().eInverseRemove(this, Seff_av_avPackage.BRANCH_ACTION__BRANCHES_BRANCH, BranchAction.class, msgs);
      }
