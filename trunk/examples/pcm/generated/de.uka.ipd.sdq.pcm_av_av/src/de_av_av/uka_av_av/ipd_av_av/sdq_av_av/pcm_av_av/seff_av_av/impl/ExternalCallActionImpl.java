...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.seff_reliability_av_av.FailureHandlingEntity;
 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ExternalCallActionImpl#getInputVariableUsages__CallAction <em>Input Variable Usages Call Action</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ExternalCallActionImpl#getReturnVariableUsage__CallReturnAction <em>Return Variable Usage Call Return Action</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ExternalCallActionImpl#getFailureTypes_FailureHandlingEntity <em>Failure Types Failure Handling Entity</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ExternalCallActionImpl#getCalledService_ExternalService <em>Called Service External Service</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ExternalCallActionImpl#getRole_ExternalService <em>Role External Service</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ExternalCallActionImpl#getRetryCount <em>Retry Count</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExternalCallActionImpl extends AbstractActionImpl implements ExternalCallAction {
   ...
   protected EClass eStaticClass() {
      return Seff_av_avPackage.Literals.EXTERNAL_CALL_ACTION;
   }
   ...
   public EList<VariableUsage> getInputVariableUsages__CallAction() {
      if (inputVariableUsages__CallAction == null) {
         inputVariableUsages__CallAction = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_av_avPackage.EXTERNAL_CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION, Parameter_av_avPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE);
      }
   ...
   public EList<VariableUsage> getReturnVariableUsage__CallReturnAction() {
      if (returnVariableUsage__CallReturnAction == null) {
         returnVariableUsage__CallReturnAction = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_av_avPackage.EXTERNAL_CALL_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION, Parameter_av_avPackage.VARIABLE_USAGE__CALL_RETURN_ACTION_VARIABLE_USAGE);
      }
   ...
   public EList<FailureType> getFailureTypes_FailureHandlingEntity() {
      if (failureTypes_FailureHandlingEntity == null) {
         failureTypes_FailureHandlingEntity = new EObjectResolvingEList<FailureType>(FailureType.class, this, Seff_av_avPackage.EXTERNAL_CALL_ACTION__FAILURE_TYPES_FAILURE_HANDLING_ENTITY);
      }
      ...
      if (calledService_ExternalService != null && calledService_ExternalService.eIsProxy()) {
         ...
         if (calledService_ExternalService != oldCalledService_ExternalService) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_av_avPackage.EXTERNAL_CALL_ACTION__CALLED_SERVICE_EXTERNAL_SERVICE, oldCalledService_ExternalService, calledService_ExternalService));
         }
      }
   ...
   public void setCalledService_ExternalService(OperationSignature newCalledService_ExternalService) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.EXTERNAL_CALL_ACTION__CALLED_SERVICE_EXTERNAL_SERVICE, oldCalledService_ExternalService, calledService_ExternalService));
   }
   ...
   public OperationRequiredRole getRole_ExternalService() {
      if (role_ExternalService != null && role_ExternalService.eIsProxy()) {
         ...
         if (role_ExternalService != oldRole_ExternalService) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_av_avPackage.EXTERNAL_CALL_ACTION__ROLE_EXTERNAL_SERVICE, oldRole_ExternalService, role_ExternalService));
         }
      }
   ...
   public void setRole_ExternalService(OperationRequiredRole newRole_ExternalService) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.EXTERNAL_CALL_ACTION__ROLE_EXTERNAL_SERVICE, oldRole_ExternalService, role_ExternalService));
   }
   ...
   public void setRetryCount(int newRetryCount) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.EXTERNAL_CALL_ACTION__RETRY_COUNT, oldRetryCount, retryCount));
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Seff_av_avValidator.EXTERNAL_CALL_ACTION__SIGNATURE_BELONGS_TO_ROLE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_av_avValidator.DIAGNOSTIC_SOURCE,
                   Seff_av_avValidator.EXTERNAL_CALL_ACTION__OPERATION_REQUIRED_ROLE_MUST_BE_REFERENCED_BY_CONTAINER,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_avPackage.EXTERNAL_CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getInputVariableUsages__CallAction()).basicAdd(otherEnd, msgs);
         case Seff_av_avPackage.EXTERNAL_CALL_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Seff_av_avPackage.EXTERNAL_CALL_ACTION__FAILURE_TYPES_FAILURE_HANDLING_ENTITY:
            return getFailureTypes_FailureHandlingEntity();
         case Seff_av_avPackage.EXTERNAL_CALL_ACTION__CALLED_SERVICE_EXTERNAL_SERVICE:
            if (resolve) return getCalledService_ExternalService();
            return basicGetCalledService_ExternalService();
         case Seff_av_avPackage.EXTERNAL_CALL_ACTION__ROLE_EXTERNAL_SERVICE:
            if (resolve) return getRole_ExternalService();
            return basicGetRole_ExternalService();
         case Seff_av_avPackage.EXTERNAL_CALL_ACTION__RETRY_COUNT:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == CallAction.class) {
         switch (derivedFeatureID) {
            case Seff_av_avPackage.EXTERNAL_CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION: return Seff_av_avPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION;
            default: return -1;
         }
      }
      if (baseClass == CallReturnAction.class) {
         switch (derivedFeatureID) {
            case Seff_av_avPackage.EXTERNAL_CALL_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION: return Seff_av_avPackage.CALL_RETURN_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION;
            default: return -1;
         }
      }
      if (baseClass == FailureHandlingEntity.class) {
         switch (derivedFeatureID) {
            case Seff_av_avPackage.EXTERNAL_CALL_ACTION__FAILURE_TYPES_FAILURE_HANDLING_ENTITY: return Seff_reliability_av_avPackage.FAILURE_HANDLING_ENTITY__FAILURE_TYPES_FAILURE_HANDLING_ENTITY;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == CallAction.class) {
         switch (baseFeatureID) {
            case Seff_av_avPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION: return Seff_av_avPackage.EXTERNAL_CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION;
            default: return -1;
         }
      }
      if (baseClass == CallReturnAction.class) {
         switch (baseFeatureID) {
            case Seff_av_avPackage.CALL_RETURN_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION: return Seff_av_avPackage.EXTERNAL_CALL_ACTION__RETURN_VARIABLE_USAGE_CALL_RETURN_ACTION;
            default: return -1;
         }
      }
      if (baseClass == FailureHandlingEntity.class) {
         switch (baseFeatureID) {
            case Seff_reliability_av_avPackage.FAILURE_HANDLING_ENTITY__FAILURE_TYPES_FAILURE_HANDLING_ENTITY: return Seff_av_avPackage.EXTERNAL_CALL_ACTION__FAILURE_TYPES_FAILURE_HANDLING_ENTITY;
            default: return -1;
         }
      }
