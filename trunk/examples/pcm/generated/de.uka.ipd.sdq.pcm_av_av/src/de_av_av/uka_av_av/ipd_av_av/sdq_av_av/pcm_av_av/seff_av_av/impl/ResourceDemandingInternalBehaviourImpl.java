 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.seff_av_av.impl.ResourceDemandingInternalBehaviourImpl#getResourceDemandingSEFF_ResourceDemandingInternalBehaviour <em>Resource Demanding SEFF Resource Demanding Internal Behaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResourceDemandingInternalBehaviourImpl extends ResourceDemandingBehaviourImpl implements ResourceDemandingInternalBehaviour {
   ...
   protected EClass eStaticClass() {
      return Seff_av_avPackage.Literals.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR;
   }
   ...
   public ResourceDemandingSEFF getResourceDemandingSEFF_ResourceDemandingInternalBehaviour() {
      if (eContainerFeatureID() != Seff_av_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetResourceDemandingSEFF_ResourceDemandingInternalBehaviour(ResourceDemandingSEFF newResourceDemandingSEFF_ResourceDemandingInternalBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newResourceDemandingSEFF_ResourceDemandingInternalBehaviour, Seff_av_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setResourceDemandingSEFF_ResourceDemandingInternalBehaviour(ResourceDemandingSEFF newResourceDemandingSEFF_ResourceDemandingInternalBehaviour) {
      if (newResourceDemandingSEFF_ResourceDemandingInternalBehaviour != eInternalContainer() || (eContainerFeatureID() != Seff_av_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR && newResourceDemandingSEFF_ResourceDemandingInternalBehaviour != null)) {
         ...
         if (newResourceDemandingSEFF_ResourceDemandingInternalBehaviour != null)
            msgs = ((InternalEObject)newResourceDemandingSEFF_ResourceDemandingInternalBehaviour).eInverseAdd(this, Seff_av_avPackage.RESOURCE_DEMANDING_SEFF__RESOURCE_DEMANDING_INTERNAL_BEHAVIOURS, ResourceDemandingSEFF.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR, newResourceDemandingSEFF_ResourceDemandingInternalBehaviour, newResourceDemandingSEFF_ResourceDemandingInternalBehaviour));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Seff_av_avPackage.RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR__RESOURCE_DEMANDING_SEFF_RESOURCE_DEMANDING_INTERNAL_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Seff_av_avPackage.RESOURCE_DEMANDING_SEFF__RESOURCE_DEMANDING_INTERNAL_BEHAVIOURS, ResourceDemandingSEFF.class, msgs);
      }
