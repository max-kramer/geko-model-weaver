 ...
 * @generated
 */
public class System_av_avPackageImpl extends EPackageImpl implements System_av_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System_av_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private System_av_avPackageImpl() {
      super(eNS_URI, System_av_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link System_av_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static System_av_avPackage init() {
      if (isInited) return (System_av_avPackage)EPackage.Registry.INSTANCE.getEPackage(System_av_avPackage.eNS_URI);

      // Obtain or create and register package
      System_av_avPackageImpl theSystem_av_avPackage = (System_av_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof System_av_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new System_av_avPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theSystem_av_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return System_av_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSystem_av_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(System_av_avPackage.eNS_URI, theSystem_av_avPackage);
      return theSystem_av_avPackage;
   }
    ...
    * @generated
    */
   public System_av_avFactory getSystem_av_avFactory() {
      return (System_av_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      systemEClass.getESuperTypes().add(theEntity_av_avPackage.getEntity());
      systemEClass.getESuperTypes().add(theEntity_av_avPackage.getComposedProvidingRequiringEntity());

      // Initialize classes and features; add operations and parameters
      initEClass(systemEClass, de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getSystem_QosAnnotations_System(), theQosannotations_av_avPackage.getQoSAnnotations(), theQosannotations_av_avPackage.getQoSAnnotations_System_QoSAnnotations(), "qosAnnotations_System", null, 0, -1, de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
