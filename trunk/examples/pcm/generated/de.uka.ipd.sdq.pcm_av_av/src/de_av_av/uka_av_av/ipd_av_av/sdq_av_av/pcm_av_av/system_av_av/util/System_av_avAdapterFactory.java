 ...
 * @generated
 */
public class System_av_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static System_av_avPackage modelPackage;
    ...
    * @generated
    */
   public System_av_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = System_av_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected System_av_avSwitch<Adapter> modelSwitch =
      new System_av_avSwitch<Adapter>() {
         @Override
         public Adapter caseSystem(de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System object) {
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.system_av_av.System <em>System</em>}'.
    * <!-- begin-user-doc -->
