 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.pcm_av_av.usagemodel_av_av.impl.WorkloadImpl#getUsageScenario_Workload <em>Usage Scenario Workload</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkloadImpl extends EObjectImpl implements Workload {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_av_avPackage.Literals.WORKLOAD;
   }
   ...
   public UsageScenario getUsageScenario_Workload() {
      if (eContainerFeatureID() != Usagemodel_av_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD) return null;
   ...
   public NotificationChain basicSetUsageScenario_Workload(UsageScenario newUsageScenario_Workload, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUsageScenario_Workload, Usagemodel_av_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, msgs);
      return msgs;
   }
   ...
   public void setUsageScenario_Workload(UsageScenario newUsageScenario_Workload) {
      if (newUsageScenario_Workload != eInternalContainer() || (eContainerFeatureID() != Usagemodel_av_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD && newUsageScenario_Workload != null)) {
         ...
         if (newUsageScenario_Workload != null)
            msgs = ((InternalEObject)newUsageScenario_Workload).eInverseAdd(this, Usagemodel_av_avPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, UsageScenario.class, msgs);
         msgs = basicSetUsageScenario_Workload(newUsageScenario_Workload, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_av_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, newUsageScenario_Workload, newUsageScenario_Workload));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_av_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_av_avPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD:
            return eInternalContainer().eInverseRemove(this, Usagemodel_av_avPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, UsageScenario.class, msgs);
      }
