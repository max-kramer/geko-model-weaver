 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.EventChannelSinkConnectorImpl#getSinkRole__EventChannelSinkConnector <em>Sink Role Event Channel Sink Connector</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.EventChannelSinkConnectorImpl#getFilterCondition__EventChannelSinkConnector <em>Filter Condition Event Channel Sink Connector</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.EventChannelSinkConnectorImpl#getAssemblyContext__EventChannelSinkConnector <em>Assembly Context Event Channel Sink Connector</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.EventChannelSinkConnectorImpl#getEventChannel__EventChannelSinkConnector <em>Event Channel Event Channel Sink Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EventChannelSinkConnectorImpl extends ConnectorImpl implements EventChannelSinkConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_av_pcPackage.Literals.EVENT_CHANNEL_SINK_CONNECTOR;
   }
      ...
      if (sinkRole__EventChannelSinkConnector != null && sinkRole__EventChannelSinkConnector.eIsProxy()) {
         ...
         if (sinkRole__EventChannelSinkConnector != oldSinkRole__EventChannelSinkConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__SINK_ROLE_EVENT_CHANNEL_SINK_CONNECTOR, oldSinkRole__EventChannelSinkConnector, sinkRole__EventChannelSinkConnector));
         }
      }
   ...
   public void setSinkRole__EventChannelSinkConnector(SinkRole newSinkRole__EventChannelSinkConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__SINK_ROLE_EVENT_CHANNEL_SINK_CONNECTOR, oldSinkRole__EventChannelSinkConnector, sinkRole__EventChannelSinkConnector));
   }
   ...
   public NotificationChain basicSetFilterCondition__EventChannelSinkConnector(PCMRandomVariable newFilterCondition__EventChannelSinkConnector, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__FILTER_CONDITION_EVENT_CHANNEL_SINK_CONNECTOR, oldFilterCondition__EventChannelSinkConnector, newFilterCondition__EventChannelSinkConnector);
   ...
   public void setFilterCondition__EventChannelSinkConnector(PCMRandomVariable newFilterCondition__EventChannelSinkConnector) {
      if (newFilterCondition__EventChannelSinkConnector != filterCondition__EventChannelSinkConnector) {
         ...
         if (filterCondition__EventChannelSinkConnector != null)
            msgs = ((InternalEObject)filterCondition__EventChannelSinkConnector).eInverseRemove(this, Core_av_pcPackage.PCM_RANDOM_VARIABLE__EVENT_CHANNEL_SINK_CONNECTOR_FILTER_CONDITION, PCMRandomVariable.class, msgs);
         if (newFilterCondition__EventChannelSinkConnector != null)
            msgs = ((InternalEObject)newFilterCondition__EventChannelSinkConnector).eInverseAdd(this, Core_av_pcPackage.PCM_RANDOM_VARIABLE__EVENT_CHANNEL_SINK_CONNECTOR_FILTER_CONDITION, PCMRandomVariable.class, msgs);
         msgs = basicSetFilterCondition__EventChannelSinkConnector(newFilterCondition__EventChannelSinkConnector, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__FILTER_CONDITION_EVENT_CHANNEL_SINK_CONNECTOR, newFilterCondition__EventChannelSinkConnector, newFilterCondition__EventChannelSinkConnector));
   }
   ...
   public AssemblyContext getAssemblyContext__EventChannelSinkConnector() {
      if (assemblyContext__EventChannelSinkConnector != null && assemblyContext__EventChannelSinkConnector.eIsProxy()) {
         ...
         if (assemblyContext__EventChannelSinkConnector != oldAssemblyContext__EventChannelSinkConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__ASSEMBLY_CONTEXT_EVENT_CHANNEL_SINK_CONNECTOR, oldAssemblyContext__EventChannelSinkConnector, assemblyContext__EventChannelSinkConnector));
         }
      }
   ...
   public void setAssemblyContext__EventChannelSinkConnector(AssemblyContext newAssemblyContext__EventChannelSinkConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__ASSEMBLY_CONTEXT_EVENT_CHANNEL_SINK_CONNECTOR, oldAssemblyContext__EventChannelSinkConnector, assemblyContext__EventChannelSinkConnector));
   }
   ...
   public EventChannel getEventChannel__EventChannelSinkConnector() {
      if (eventChannel__EventChannelSinkConnector != null && eventChannel__EventChannelSinkConnector.eIsProxy()) {
         ...
         if (eventChannel__EventChannelSinkConnector != oldEventChannel__EventChannelSinkConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SINK_CONNECTOR, oldEventChannel__EventChannelSinkConnector, eventChannel__EventChannelSinkConnector));
         }
      }
   ...
   public NotificationChain basicSetEventChannel__EventChannelSinkConnector(EventChannel newEventChannel__EventChannelSinkConnector, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SINK_CONNECTOR, oldEventChannel__EventChannelSinkConnector, newEventChannel__EventChannelSinkConnector);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setEventChannel__EventChannelSinkConnector(EventChannel newEventChannel__EventChannelSinkConnector) {
      if (newEventChannel__EventChannelSinkConnector != eventChannel__EventChannelSinkConnector) {
         ...
         if (eventChannel__EventChannelSinkConnector != null)
            msgs = ((InternalEObject)eventChannel__EventChannelSinkConnector).eInverseRemove(this, Composition_av_pcPackage.EVENT_CHANNEL__EVENT_CHANNEL_SINK_CONNECTOR_EVENT_CHANNEL, EventChannel.class, msgs);
         if (newEventChannel__EventChannelSinkConnector != null)
            msgs = ((InternalEObject)newEventChannel__EventChannelSinkConnector).eInverseAdd(this, Composition_av_pcPackage.EVENT_CHANNEL__EVENT_CHANNEL_SINK_CONNECTOR_EVENT_CHANNEL, EventChannel.class, msgs);
         msgs = basicSetEventChannel__EventChannelSinkConnector(newEventChannel__EventChannelSinkConnector, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SINK_CONNECTOR, newEventChannel__EventChannelSinkConnector, newEventChannel__EventChannelSinkConnector));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__FILTER_CONDITION_EVENT_CHANNEL_SINK_CONNECTOR:
            if (filterCondition__EventChannelSinkConnector != null)
               msgs = ((InternalEObject)filterCondition__EventChannelSinkConnector).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__FILTER_CONDITION_EVENT_CHANNEL_SINK_CONNECTOR, null, msgs);
            return basicSetFilterCondition__EventChannelSinkConnector((PCMRandomVariable)otherEnd, msgs);
         case Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__EVENT_CHANNEL_EVENT_CHANNEL_SINK_CONNECTOR:
            if (eventChannel__EventChannelSinkConnector != null)
               msgs = ((InternalEObject)eventChannel__EventChannelSinkConnector).eInverseRemove(this, Composition_av_pcPackage.EVENT_CHANNEL__EVENT_CHANNEL_SINK_CONNECTOR_EVENT_CHANNEL, EventChannel.class, msgs);
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__SINK_ROLE_EVENT_CHANNEL_SINK_CONNECTOR:
         ...
         case Composition_av_pcPackage.EVENT_CHANNEL_SINK_CONNECTOR__ASSEMBLY_CONTEXT_EVENT_CHANNEL_SINK_CONNECTOR:
