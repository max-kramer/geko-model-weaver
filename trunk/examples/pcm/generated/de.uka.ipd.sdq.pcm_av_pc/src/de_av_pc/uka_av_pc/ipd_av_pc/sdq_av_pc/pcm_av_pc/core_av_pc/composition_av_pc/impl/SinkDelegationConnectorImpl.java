 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.SinkDelegationConnectorImpl#getAssemblyContext__SinkDelegationConnector <em>Assembly Context Sink Delegation Connector</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.SinkDelegationConnectorImpl#getInnerSinkRole__SinkRole <em>Inner Sink Role Sink Role</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.core_av_pc.composition_av_pc.impl.SinkDelegationConnectorImpl#getOuterSinkRole__SinkRole <em>Outer Sink Role Sink Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SinkDelegationConnectorImpl extends DelegationConnectorImpl implements SinkDelegationConnector {
   ...
   protected EClass eStaticClass() {
      return Composition_av_pcPackage.Literals.SINK_DELEGATION_CONNECTOR;
   }
      ...
      if (assemblyContext__SinkDelegationConnector != null && assemblyContext__SinkDelegationConnector.eIsProxy()) {
         ...
         if (assemblyContext__SinkDelegationConnector != oldAssemblyContext__SinkDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_SINK_DELEGATION_CONNECTOR, oldAssemblyContext__SinkDelegationConnector, assemblyContext__SinkDelegationConnector));
         }
      }
   ...
   public void setAssemblyContext__SinkDelegationConnector(AssemblyContext newAssemblyContext__SinkDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_SINK_DELEGATION_CONNECTOR, oldAssemblyContext__SinkDelegationConnector, assemblyContext__SinkDelegationConnector));
   }
   ...
   public SinkRole getInnerSinkRole__SinkRole() {
      if (innerSinkRole__SinkRole != null && innerSinkRole__SinkRole.eIsProxy()) {
         ...
         if (innerSinkRole__SinkRole != oldInnerSinkRole__SinkRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__INNER_SINK_ROLE_SINK_ROLE, oldInnerSinkRole__SinkRole, innerSinkRole__SinkRole));
         }
      }
   ...
   public void setInnerSinkRole__SinkRole(SinkRole newInnerSinkRole__SinkRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__INNER_SINK_ROLE_SINK_ROLE, oldInnerSinkRole__SinkRole, innerSinkRole__SinkRole));
   }
   ...
   public SinkRole getOuterSinkRole__SinkRole() {
      if (outerSinkRole__SinkRole != null && outerSinkRole__SinkRole.eIsProxy()) {
         ...
         if (outerSinkRole__SinkRole != oldOuterSinkRole__SinkRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__OUTER_SINK_ROLE_SINK_ROLE, oldOuterSinkRole__SinkRole, outerSinkRole__SinkRole));
         }
      }
   ...
   public void setOuterSinkRole__SinkRole(SinkRole newOuterSinkRole__SinkRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__OUTER_SINK_ROLE_SINK_ROLE, oldOuterSinkRole__SinkRole, outerSinkRole__SinkRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_SINK_DELEGATION_CONNECTOR:
            if (resolve) return getAssemblyContext__SinkDelegationConnector();
            return basicGetAssemblyContext__SinkDelegationConnector();
         case Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__INNER_SINK_ROLE_SINK_ROLE:
            if (resolve) return getInnerSinkRole__SinkRole();
            return basicGetInnerSinkRole__SinkRole();
         case Composition_av_pcPackage.SINK_DELEGATION_CONNECTOR__OUTER_SINK_ROLE_SINK_ROLE:
