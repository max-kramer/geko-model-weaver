...
import de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.protocol_av_pc.Protocol_av_pcFactory;
 ...
 * @generated
 */
public class Protocol_av_pcPackageImpl extends EPackageImpl implements Protocol_av_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.protocol_av_pc.Protocol_av_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Protocol_av_pcPackageImpl() {
      super(eNS_URI, Protocol_av_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Protocol_av_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Protocol_av_pcPackage init() {
      if (isInited) return (Protocol_av_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Protocol_av_pcPackage.eNS_URI);

      // Obtain or create and register package
      Protocol_av_pcPackageImpl theProtocol_av_pcPackage = (Protocol_av_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Protocol_av_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Protocol_av_pcPackageImpl());
      ...
      theProtocol_av_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Protocol_av_pcPackage.eNS_URI, theProtocol_av_pcPackage);
      return theProtocol_av_pcPackage;
   }
    ...
    * @generated
    */
   public Protocol_av_pcFactory getProtocol_av_pcFactory() {
      return (Protocol_av_pcFactory)getEFactoryInstance();
   }
