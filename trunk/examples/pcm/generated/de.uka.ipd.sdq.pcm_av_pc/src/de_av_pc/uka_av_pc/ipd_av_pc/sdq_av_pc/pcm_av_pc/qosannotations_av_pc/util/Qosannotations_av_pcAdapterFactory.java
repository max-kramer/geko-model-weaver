...
import de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.*;
 ...
 * <!-- end-user-doc -->
 * @see de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.Qosannotations_av_pcPackage
 * @generated
 */
public class Qosannotations_av_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Qosannotations_av_pcPackage modelPackage;
    ...
    * @generated
    */
   public Qosannotations_av_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Qosannotations_av_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Qosannotations_av_pcSwitch<Adapter> modelSwitch =
      new Qosannotations_av_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.QoSAnnotations <em>Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.qosannotations_av_pc.SpecifiedOutputParameterAbstraction <em>Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Qosannotations_av_pcAdapterFactory
