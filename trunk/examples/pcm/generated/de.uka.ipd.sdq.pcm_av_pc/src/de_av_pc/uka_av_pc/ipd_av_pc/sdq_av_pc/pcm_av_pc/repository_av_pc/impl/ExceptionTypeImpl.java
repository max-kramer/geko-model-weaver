 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.ExceptionTypeImpl#getExceptionName <em>Exception Name</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.ExceptionTypeImpl#getExceptionMessage <em>Exception Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExceptionTypeImpl extends EObjectImpl implements ExceptionType {
   ...
   protected EClass eStaticClass() {
      return Repository_av_pcPackage.Literals.EXCEPTION_TYPE;
   }
   ...
   public void setExceptionName(String newExceptionName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_pcPackage.EXCEPTION_TYPE__EXCEPTION_NAME, oldExceptionName, exceptionName));
   }
   ...
   public void setExceptionMessage(String newExceptionMessage) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_pcPackage.EXCEPTION_TYPE__EXCEPTION_MESSAGE, oldExceptionMessage, exceptionMessage));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_av_pcPackage.EXCEPTION_TYPE__EXCEPTION_NAME:
            return getExceptionName();
         case Repository_av_pcPackage.EXCEPTION_TYPE__EXCEPTION_MESSAGE:
