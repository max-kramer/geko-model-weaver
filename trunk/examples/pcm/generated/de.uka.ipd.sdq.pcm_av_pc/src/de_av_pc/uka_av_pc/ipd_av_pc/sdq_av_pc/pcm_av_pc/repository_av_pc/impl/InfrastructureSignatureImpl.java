 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.InfrastructureSignatureImpl#getParameters__InfrastructureSignature <em>Parameters Infrastructure Signature</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.InfrastructureSignatureImpl#getInfrastructureInterface__InfrastructureSignature <em>Infrastructure Interface Infrastructure Signature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InfrastructureSignatureImpl extends SignatureImpl implements InfrastructureSignature {
   ...
   protected EClass eStaticClass() {
      return Repository_av_pcPackage.Literals.INFRASTRUCTURE_SIGNATURE;
   }
   ...
   public EList<Parameter> getParameters__InfrastructureSignature() {
      if (parameters__InfrastructureSignature == null) {
         parameters__InfrastructureSignature = new EObjectContainmentWithInverseEList<Parameter>(Parameter.class, this, Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__PARAMETERS_INFRASTRUCTURE_SIGNATURE, Repository_av_pcPackage.PARAMETER__INFRASTRUCTURE_SIGNATURE_PARAMETER);
      }
   ...
   public InfrastructureInterface getInfrastructureInterface__InfrastructureSignature() {
      if (eContainerFeatureID() != Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__INFRASTRUCTURE_INTERFACE_INFRASTRUCTURE_SIGNATURE) return null;
   ...
   public NotificationChain basicSetInfrastructureInterface__InfrastructureSignature(InfrastructureInterface newInfrastructureInterface__InfrastructureSignature, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newInfrastructureInterface__InfrastructureSignature, Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__INFRASTRUCTURE_INTERFACE_INFRASTRUCTURE_SIGNATURE, msgs);
      return msgs;
   }
   ...
   public void setInfrastructureInterface__InfrastructureSignature(InfrastructureInterface newInfrastructureInterface__InfrastructureSignature) {
      if (newInfrastructureInterface__InfrastructureSignature != eInternalContainer() || (eContainerFeatureID() != Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__INFRASTRUCTURE_INTERFACE_INFRASTRUCTURE_SIGNATURE && newInfrastructureInterface__InfrastructureSignature != null)) {
         ...
         if (newInfrastructureInterface__InfrastructureSignature != null)
            msgs = ((InternalEObject)newInfrastructureInterface__InfrastructureSignature).eInverseAdd(this, Repository_av_pcPackage.INFRASTRUCTURE_INTERFACE__INFRASTRUCTURE_SIGNATURES_INFRASTRUCTURE_INTERFACE, InfrastructureInterface.class, msgs);
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__INFRASTRUCTURE_INTERFACE_INFRASTRUCTURE_SIGNATURE, newInfrastructureInterface__InfrastructureSignature, newInfrastructureInterface__InfrastructureSignature));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__PARAMETERS_INFRASTRUCTURE_SIGNATURE:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getParameters__InfrastructureSignature()).basicAdd(otherEnd, msgs);
         case Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__INFRASTRUCTURE_INTERFACE_INFRASTRUCTURE_SIGNATURE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Repository_av_pcPackage.INFRASTRUCTURE_SIGNATURE__INFRASTRUCTURE_INTERFACE_INFRASTRUCTURE_SIGNATURE:
            return eInternalContainer().eInverseRemove(this, Repository_av_pcPackage.INFRASTRUCTURE_INTERFACE__INFRASTRUCTURE_SIGNATURES_INFRASTRUCTURE_INTERFACE, InfrastructureInterface.class, msgs);
      }
