 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.OperationInterfaceImpl#getSignatures__OperationInterface <em>Signatures Operation Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationInterfaceImpl extends InterfaceImpl implements OperationInterface {
   ...
   protected EClass eStaticClass() {
      return Repository_av_pcPackage.Literals.OPERATION_INTERFACE;
   }
   ...
   public EList<OperationSignature> getSignatures__OperationInterface() {
      if (signatures__OperationInterface == null) {
         signatures__OperationInterface = new EObjectContainmentWithInverseEList<OperationSignature>(OperationSignature.class, this, Repository_av_pcPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE, Repository_av_pcPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_av_pcValidator.OPERATION_INTERFACE__SIGNATURES_HAVE_TO_BE_UNIQUE_FOR_AN_INTERFACE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_av_pcPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE:
