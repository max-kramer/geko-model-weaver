 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.PrimitiveDataTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimitiveDataTypeImpl extends DataTypeImpl implements PrimitiveDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_av_pcPackage.Literals.PRIMITIVE_DATA_TYPE;
   }
   ...
   public void setType(PrimitiveTypeEnum newType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_pcPackage.PRIMITIVE_DATA_TYPE__TYPE, oldType, type));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_av_pcPackage.PRIMITIVE_DATA_TYPE__TYPE:
            return getType();
      }
