 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.repository_av_pc.impl.SourceRoleImpl#getEventGroup__SourceRole <em>Event Group Source Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SourceRoleImpl extends RequiredRoleImpl implements SourceRole {
   ...
   protected EClass eStaticClass() {
      return Repository_av_pcPackage.Literals.SOURCE_ROLE;
   }
      ...
      if (eventGroup__SourceRole != null && eventGroup__SourceRole.eIsProxy()) {
         ...
         if (eventGroup__SourceRole != oldEventGroup__SourceRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_av_pcPackage.SOURCE_ROLE__EVENT_GROUP_SOURCE_ROLE, oldEventGroup__SourceRole, eventGroup__SourceRole));
         }
      }
   ...
   public void setEventGroup__SourceRole(EventGroup newEventGroup__SourceRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_av_pcPackage.SOURCE_ROLE__EVENT_GROUP_SOURCE_ROLE, oldEventGroup__SourceRole, eventGroup__SourceRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_av_pcPackage.SOURCE_ROLE__EVENT_GROUP_SOURCE_ROLE:
