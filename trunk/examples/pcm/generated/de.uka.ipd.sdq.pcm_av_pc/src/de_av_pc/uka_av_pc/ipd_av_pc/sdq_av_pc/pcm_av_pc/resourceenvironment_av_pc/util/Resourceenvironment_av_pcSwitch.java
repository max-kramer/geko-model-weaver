 ...
 * @generated
 */
public class Resourceenvironment_av_pcSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourceenvironment_av_pcSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourceenvironment_av_pcPackage.RESOURCE_ENVIRONMENT: {
         ...
         case Resourceenvironment_av_pcPackage.LINKING_RESOURCE: {
         ...
         case Resourceenvironment_av_pcPackage.RESOURCE_CONTAINER: {
         ...
         case Resourceenvironment_av_pcPackage.PROCESSING_RESOURCE_SPECIFICATION: {
         ...
         case Resourceenvironment_av_pcPackage.COMMUNICATION_LINK_RESOURCE_SPECIFICATION: {
...
} //Resourceenvironment_av_pcSwitch
