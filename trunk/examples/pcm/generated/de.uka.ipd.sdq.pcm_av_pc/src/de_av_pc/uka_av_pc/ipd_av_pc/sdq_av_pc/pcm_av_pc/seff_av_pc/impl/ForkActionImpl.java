 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.impl.ForkActionImpl#getAsynchronousForkedBehaviours_ForkAction <em>Asynchronous Forked Behaviours Fork Action</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.impl.ForkActionImpl#getSynchronisingBehaviours_ForkAction <em>Synchronising Behaviours Fork Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ForkActionImpl extends AbstractInternalControlFlowActionImpl implements ForkAction {
   ...
   protected EClass eStaticClass() {
      return Seff_av_pcPackage.Literals.FORK_ACTION;
   }
   ...
   public EList<ForkedBehaviour> getAsynchronousForkedBehaviours_ForkAction() {
      if (asynchronousForkedBehaviours_ForkAction == null) {
         asynchronousForkedBehaviours_ForkAction = new EObjectContainmentWithInverseEList<ForkedBehaviour>(ForkedBehaviour.class, this, Seff_av_pcPackage.FORK_ACTION__ASYNCHRONOUS_FORKED_BEHAVIOURS_FORK_ACTION, Seff_av_pcPackage.FORKED_BEHAVIOUR__FORK_ACTION_FORKED_BEHAIVOUR);
      }
   ...
   public NotificationChain basicSetSynchronisingBehaviours_ForkAction(SynchronisationPoint newSynchronisingBehaviours_ForkAction, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_av_pcPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, oldSynchronisingBehaviours_ForkAction, newSynchronisingBehaviours_ForkAction);
   ...
   public void setSynchronisingBehaviours_ForkAction(SynchronisationPoint newSynchronisingBehaviours_ForkAction) {
      if (newSynchronisingBehaviours_ForkAction != synchronisingBehaviours_ForkAction) {
         ...
         if (synchronisingBehaviours_ForkAction != null)
            msgs = ((InternalEObject)synchronisingBehaviours_ForkAction).eInverseRemove(this, Seff_av_pcPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, SynchronisationPoint.class, msgs);
         if (newSynchronisingBehaviours_ForkAction != null)
            msgs = ((InternalEObject)newSynchronisingBehaviours_ForkAction).eInverseAdd(this, Seff_av_pcPackage.SYNCHRONISATION_POINT__FORK_ACTION_SYNCHRONISATION_POINT, SynchronisationPoint.class, msgs);
         msgs = basicSetSynchronisingBehaviours_ForkAction(newSynchronisingBehaviours_ForkAction, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_av_pcPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, newSynchronisingBehaviours_ForkAction, newSynchronisingBehaviours_ForkAction));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_av_pcPackage.FORK_ACTION__ASYNCHRONOUS_FORKED_BEHAVIOURS_FORK_ACTION:
            return ((InternalEList<InternalEObject>)(InternalEList<?>)getAsynchronousForkedBehaviours_ForkAction()).basicAdd(otherEnd, msgs);
         case Seff_av_pcPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION:
            if (synchronisingBehaviours_ForkAction != null)
               msgs = ((InternalEObject)synchronisingBehaviours_ForkAction).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Seff_av_pcPackage.FORK_ACTION__SYNCHRONISING_BEHAVIOURS_FORK_ACTION, null, msgs);
