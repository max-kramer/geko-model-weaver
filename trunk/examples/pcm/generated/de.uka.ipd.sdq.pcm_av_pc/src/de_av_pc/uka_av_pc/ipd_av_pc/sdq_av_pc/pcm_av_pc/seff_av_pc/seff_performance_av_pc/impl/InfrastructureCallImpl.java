...
import de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.impl.CallActionImpl;
 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.seff_performance_av_pc.impl.InfrastructureCallImpl#getSignature__InfrastructureCall <em>Signature Infrastructure Call</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.seff_performance_av_pc.impl.InfrastructureCallImpl#getNumberOfCalls__InfrastructureCall <em>Number Of Calls Infrastructure Call</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.seff_performance_av_pc.impl.InfrastructureCallImpl#getAction__InfrastructureCall <em>Action Infrastructure Call</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.seff_av_pc.seff_performance_av_pc.impl.InfrastructureCallImpl#getRequiredRole__InfrastructureCall <em>Required Role Infrastructure Call</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InfrastructureCallImpl extends CallActionImpl implements InfrastructureCall {
   ...
   protected EClass eStaticClass() {
      return Seff_performance_av_pcPackage.Literals.INFRASTRUCTURE_CALL;
   }
      ...
      if (signature__InfrastructureCall != null && signature__InfrastructureCall.eIsProxy()) {
         ...
         if (signature__InfrastructureCall != oldSignature__InfrastructureCall) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__SIGNATURE_INFRASTRUCTURE_CALL, oldSignature__InfrastructureCall, signature__InfrastructureCall));
         }
      }
   ...
   public void setSignature__InfrastructureCall(InfrastructureSignature newSignature__InfrastructureCall) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__SIGNATURE_INFRASTRUCTURE_CALL, oldSignature__InfrastructureCall, signature__InfrastructureCall));
   }
   ...
   public NotificationChain basicSetNumberOfCalls__InfrastructureCall(PCMRandomVariable newNumberOfCalls__InfrastructureCall, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__NUMBER_OF_CALLS_INFRASTRUCTURE_CALL, oldNumberOfCalls__InfrastructureCall, newNumberOfCalls__InfrastructureCall);
   ...
   public void setNumberOfCalls__InfrastructureCall(PCMRandomVariable newNumberOfCalls__InfrastructureCall) {
      if (newNumberOfCalls__InfrastructureCall != numberOfCalls__InfrastructureCall) {
         ...
         if (numberOfCalls__InfrastructureCall != null)
            msgs = ((InternalEObject)numberOfCalls__InfrastructureCall).eInverseRemove(this, Core_av_pcPackage.PCM_RANDOM_VARIABLE__INFRASTRUCTURE_CALL_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         if (newNumberOfCalls__InfrastructureCall != null)
            msgs = ((InternalEObject)newNumberOfCalls__InfrastructureCall).eInverseAdd(this, Core_av_pcPackage.PCM_RANDOM_VARIABLE__INFRASTRUCTURE_CALL_PCM_RANDOM_VARIABLE, PCMRandomVariable.class, msgs);
         msgs = basicSetNumberOfCalls__InfrastructureCall(newNumberOfCalls__InfrastructureCall, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__NUMBER_OF_CALLS_INFRASTRUCTURE_CALL, newNumberOfCalls__InfrastructureCall, newNumberOfCalls__InfrastructureCall));
   }
   ...
   public AbstractInternalControlFlowAction getAction__InfrastructureCall() {
      if (eContainerFeatureID() != Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL) return null;
   ...
   public NotificationChain basicSetAction__InfrastructureCall(AbstractInternalControlFlowAction newAction__InfrastructureCall, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newAction__InfrastructureCall, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL, msgs);
      return msgs;
   }
   ...
   public void setAction__InfrastructureCall(AbstractInternalControlFlowAction newAction__InfrastructureCall) {
      if (newAction__InfrastructureCall != eInternalContainer() || (eContainerFeatureID() != Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL && newAction__InfrastructureCall != null)) {
         ...
         if (newAction__InfrastructureCall != null)
            msgs = ((InternalEObject)newAction__InfrastructureCall).eInverseAdd(this, Seff_av_pcPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__INFRASTRUCTURE_CALL_ACTION, AbstractInternalControlFlowAction.class, msgs);
         msgs = basicSetAction__InfrastructureCall(newAction__InfrastructureCall, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL, newAction__InfrastructureCall, newAction__InfrastructureCall));
   }
   ...
   public InfrastructureRequiredRole getRequiredRole__InfrastructureCall() {
      if (requiredRole__InfrastructureCall != null && requiredRole__InfrastructureCall.eIsProxy()) {
         ...
         if (requiredRole__InfrastructureCall != oldRequiredRole__InfrastructureCall) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__REQUIRED_ROLE_INFRASTRUCTURE_CALL, oldRequiredRole__InfrastructureCall, requiredRole__InfrastructureCall));
         }
      }
   ...
   public void setRequiredRole__InfrastructureCall(InfrastructureRequiredRole newRequiredRole__InfrastructureCall) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__REQUIRED_ROLE_INFRASTRUCTURE_CALL, oldRequiredRole__InfrastructureCall, requiredRole__InfrastructureCall));
   }
      ...
      if (false) {
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_performance_av_pcValidator.DIAGNOSTIC_SOURCE,
                   Seff_performance_av_pcValidator.INFRASTRUCTURE_CALL__SIGNATURE_MUST_BELONG_TO_USED_REQUIRED_ROLE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_performance_av_pcValidator.DIAGNOSTIC_SOURCE,
                   Seff_performance_av_pcValidator.INFRASTRUCTURE_CALL__REFERENCED_REQUIRED_ROLE_MUST_BE_REQUIRED_BY_COMPONENT,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_performance_av_pcValidator.DIAGNOSTIC_SOURCE,
                   Seff_performance_av_pcValidator.INFRASTRUCTURE_CALL__SIGNATURE_ROLE_COMBINATION_MUST_BE_UNIQUE_WITHIN_ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__NUMBER_OF_CALLS_INFRASTRUCTURE_CALL:
            if (numberOfCalls__InfrastructureCall != null)
               msgs = ((InternalEObject)numberOfCalls__InfrastructureCall).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__NUMBER_OF_CALLS_INFRASTRUCTURE_CALL, null, msgs);
            return basicSetNumberOfCalls__InfrastructureCall((PCMRandomVariable)otherEnd, msgs);
         case Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__ACTION_INFRASTRUCTURE_CALL:
            return eInternalContainer().eInverseRemove(this, Seff_av_pcPackage.ABSTRACT_INTERNAL_CONTROL_FLOW_ACTION__INFRASTRUCTURE_CALL_ACTION, AbstractInternalControlFlowAction.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__SIGNATURE_INFRASTRUCTURE_CALL:
         ...
         case Seff_performance_av_pcPackage.INFRASTRUCTURE_CALL__REQUIRED_ROLE_INFRASTRUCTURE_CALL:
