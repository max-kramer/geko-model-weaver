...
import de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.subsystem_av_pc.SubSystem;
import de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.subsystem_av_pc.Subsystem_av_pcFactory;
 ...
 * @generated
 */
public class Subsystem_av_pcPackageImpl extends EPackageImpl implements Subsystem_av_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.pcm_av_pc.subsystem_av_pc.Subsystem_av_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Subsystem_av_pcPackageImpl() {
      super(eNS_URI, Subsystem_av_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Subsystem_av_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Subsystem_av_pcPackage init() {
      if (isInited) return (Subsystem_av_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Subsystem_av_pcPackage.eNS_URI);

      // Obtain or create and register package
      Subsystem_av_pcPackageImpl theSubsystem_av_pcPackage = (Subsystem_av_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Subsystem_av_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Subsystem_av_pcPackageImpl());
      ...
      theSubsystem_av_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Subsystem_av_pcPackage.eNS_URI, theSubsystem_av_pcPackage);
      return theSubsystem_av_pcPackage;
   }
    ...
    * @generated
    */
   public Subsystem_av_pcFactory getSubsystem_av_pcFactory() {
      return (Subsystem_av_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      subSystemEClass.getESuperTypes().add(theEntity_av_pcPackage.getComposedProvidingRequiringEntity());
      subSystemEClass.getESuperTypes().add(theRepository_av_pcPackage.getRepositoryComponent());

      // Initialize classes and features; add operations and parameters
      initEClass(subSystemEClass, SubSystem.class, "SubSystem", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
   }

} //Subsystem_av_pcPackageImpl
