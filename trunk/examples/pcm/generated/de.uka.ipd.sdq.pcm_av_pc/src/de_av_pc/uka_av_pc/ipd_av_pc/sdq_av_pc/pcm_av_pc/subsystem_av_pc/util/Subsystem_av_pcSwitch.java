 ...
 * @generated
 */
public class Subsystem_av_pcSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   protected static Subsystem_av_pcPackage modelPackage;
    ...
    * @generated
    */
   public Subsystem_av_pcSwitch() {
      if (modelPackage == null) {
         modelPackage = Subsystem_av_pcPackage.eINSTANCE;
      }
   }
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Subsystem_av_pcPackage.SUB_SYSTEM: {
