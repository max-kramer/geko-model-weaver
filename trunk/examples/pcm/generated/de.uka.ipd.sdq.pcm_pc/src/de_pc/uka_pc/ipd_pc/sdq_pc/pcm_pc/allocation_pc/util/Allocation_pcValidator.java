 ...
 * @generated
 */
public class Allocation_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Allocation_pcValidator INSTANCE = new Allocation_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.allocation_pc";
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Allocation_pcPackage.ALLOCATION_CONTEXT:
            return validateAllocationContext((AllocationContext)value, diagnostics, context);
         case Allocation_pcPackage.ALLOCATION:
   ...
   public boolean validateAllocationContext(AllocationContext allocationContext, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(allocationContext, diagnostics, context);
   ...
   public boolean validateAllocation(Allocation allocation, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pcValidator.validateIdentifier_idHasToBeUnique(allocation, diagnostics, context);
