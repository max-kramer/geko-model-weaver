 ...
 * @generated
 */
public class Completions_pcSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Completions_pcPackage.COMPLETION: {
         ...
         case Completions_pcPackage.COMPLETION_REPOSITORY: {
         ...
         case Completions_pcPackage.DELEGATING_EXTERNAL_CALL_ACTION: {
         ...
         case Completions_pcPackage.NETWORK_DEMAND_PARAMETRIC_RESOURCE_DEMAND: {
