 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.core_pc.composition_pc.impl.ProvidedInfrastructureDelegationConnectorImpl#getInnerProvidedRole__ProvidedInfrastructureDelegationConnector <em>Inner Provided Role Provided Infrastructure Delegation Connector</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.core_pc.composition_pc.impl.ProvidedInfrastructureDelegationConnectorImpl#getOuterProvidedRole__ProvidedInfrastructureDelegationConnector <em>Outer Provided Role Provided Infrastructure Delegation Connector</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.core_pc.composition_pc.impl.ProvidedInfrastructureDelegationConnectorImpl#getAssemblyContext__ProvidedInfrastructureDelegationConnector <em>Assembly Context Provided Infrastructure Delegation Connector</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ProvidedInfrastructureDelegationConnectorImpl extends DelegationConnectorImpl implements ProvidedInfrastructureDelegationConnector {
   /**
    * The cached value of the '{@link #getInnerProvidedRole__ProvidedInfrastructureDelegationConnector() <em>Inner Provided Role Provided Infrastructure Delegation Connector</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * The cached value of the '{@link #getOuterProvidedRole__ProvidedInfrastructureDelegationConnector() <em>Outer Provided Role Provided Infrastructure Delegation Connector</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   /**
    * The cached value of the '{@link #getAssemblyContext__ProvidedInfrastructureDelegationConnector() <em>Assembly Context Provided Infrastructure Delegation Connector</em>}' reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
   ...
   protected EClass eStaticClass() {
      return Composition_pcPackage.Literals.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR;
   }
      ...
      if (innerProvidedRole__ProvidedInfrastructureDelegationConnector != null && innerProvidedRole__ProvidedInfrastructureDelegationConnector.eIsProxy()) {
         ...
         if (innerProvidedRole__ProvidedInfrastructureDelegationConnector != oldInnerProvidedRole__ProvidedInfrastructureDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__INNER_PROVIDED_ROLE_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldInnerProvidedRole__ProvidedInfrastructureDelegationConnector, innerProvidedRole__ProvidedInfrastructureDelegationConnector));
         }
      }
    ...
    * @generated
    */
   public void setInnerProvidedRole__ProvidedInfrastructureDelegationConnector(InfrastructureProvidedRole newInnerProvidedRole__ProvidedInfrastructureDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__INNER_PROVIDED_ROLE_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldInnerProvidedRole__ProvidedInfrastructureDelegationConnector, innerProvidedRole__ProvidedInfrastructureDelegationConnector));
   }
   ...
   public InfrastructureProvidedRole getOuterProvidedRole__ProvidedInfrastructureDelegationConnector() {
      if (outerProvidedRole__ProvidedInfrastructureDelegationConnector != null && outerProvidedRole__ProvidedInfrastructureDelegationConnector.eIsProxy()) {
         ...
         if (outerProvidedRole__ProvidedInfrastructureDelegationConnector != oldOuterProvidedRole__ProvidedInfrastructureDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldOuterProvidedRole__ProvidedInfrastructureDelegationConnector, outerProvidedRole__ProvidedInfrastructureDelegationConnector));
         }
      }
    ...
    * @generated
    */
   public void setOuterProvidedRole__ProvidedInfrastructureDelegationConnector(InfrastructureProvidedRole newOuterProvidedRole__ProvidedInfrastructureDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldOuterProvidedRole__ProvidedInfrastructureDelegationConnector, outerProvidedRole__ProvidedInfrastructureDelegationConnector));
   }
   ...
   public AssemblyContext getAssemblyContext__ProvidedInfrastructureDelegationConnector() {
      if (assemblyContext__ProvidedInfrastructureDelegationConnector != null && assemblyContext__ProvidedInfrastructureDelegationConnector.eIsProxy()) {
         ...
         if (assemblyContext__ProvidedInfrastructureDelegationConnector != oldAssemblyContext__ProvidedInfrastructureDelegationConnector) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldAssemblyContext__ProvidedInfrastructureDelegationConnector, assemblyContext__ProvidedInfrastructureDelegationConnector));
         }
      }
    ...
    * @generated
    */
   public void setAssemblyContext__ProvidedInfrastructureDelegationConnector(AssemblyContext newAssemblyContext__ProvidedInfrastructureDelegationConnector) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR, oldAssemblyContext__ProvidedInfrastructureDelegationConnector, assemblyContext__ProvidedInfrastructureDelegationConnector));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__INNER_PROVIDED_ROLE_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR:
         ...
         case Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__OUTER_PROVIDED_ROLE_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR:
         ...
         case Composition_pcPackage.PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR__ASSEMBLY_CONTEXT_PROVIDED_INFRASTRUCTURE_DELEGATION_CONNECTOR:
