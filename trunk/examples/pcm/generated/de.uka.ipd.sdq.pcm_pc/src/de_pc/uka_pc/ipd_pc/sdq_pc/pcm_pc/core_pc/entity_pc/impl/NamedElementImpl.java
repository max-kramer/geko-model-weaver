 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.core_pc.entity_pc.impl.NamedElementImpl#getEntityName <em>Entity Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NamedElementImpl extends EObjectImpl implements NamedElement {
   ...
   protected EClass eStaticClass() {
      return Entity_pcPackage.Literals.NAMED_ELEMENT;
   }
   ...
   public void setEntityName(String newEntityName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Entity_pcPackage.NAMED_ELEMENT__ENTITY_NAME, oldEntityName, entityName));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Entity_pcPackage.NAMED_ELEMENT__ENTITY_NAME:
