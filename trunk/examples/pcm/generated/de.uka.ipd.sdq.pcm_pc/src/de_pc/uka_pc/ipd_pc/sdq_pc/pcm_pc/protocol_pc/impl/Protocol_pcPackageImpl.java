...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.protocol_pc.Protocol_pcFactory;
 ...
 * @generated
 */
public class Protocol_pcPackageImpl extends EPackageImpl implements Protocol_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.protocol_pc.Protocol_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Protocol_pcPackageImpl() {
      super(eNS_URI, Protocol_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Protocol_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Protocol_pcPackage init() {
      if (isInited) return (Protocol_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Protocol_pcPackage.eNS_URI);

      // Obtain or create and register package
      Protocol_pcPackageImpl theProtocol_pcPackage = (Protocol_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Protocol_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Protocol_pcPackageImpl());
      ...
      theProtocol_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Protocol_pcPackage.eNS_URI, theProtocol_pcPackage);
      return theProtocol_pcPackage;
   }
    ...
    * @generated
    */
   public Protocol_pcFactory getProtocol_pcFactory() {
      return (Protocol_pcFactory)getEFactoryInstance();
   }
