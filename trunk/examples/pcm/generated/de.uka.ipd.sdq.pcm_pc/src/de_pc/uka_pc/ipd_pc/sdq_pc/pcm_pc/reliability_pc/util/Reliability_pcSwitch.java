 ...
 * @generated
 */
public class Reliability_pcSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   protected static Reliability_pcPackage modelPackage;
    ...
    * @generated
    */
   public Reliability_pcSwitch() {
      if (modelPackage == null) {
         modelPackage = Reliability_pcPackage.eINSTANCE;
      }
   }
