 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.ExceptionType#getExceptionName <em>Exception Name</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.ExceptionType#getExceptionMessage <em>Exception Message</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.Repository_pcPackage#getExceptionType()
 * @model
 * @generated
 */
public interface ExceptionType extends EObject {
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.Repository_pcPackage#getExceptionType_ExceptionName()
   ...
   /**
    * Sets the value of the '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.ExceptionType#getExceptionName <em>Exception Name</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.Repository_pcPackage#getExceptionType_ExceptionMessage()
    * @model unique="false" required="true" ordered="false"
    * @generated
    */
   ...
   /**
    * Sets the value of the '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.ExceptionType#getExceptionMessage <em>Exception Message</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
