 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.CollectionDataTypeImpl#getRepository__DataType <em>Repository Data Type</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.CollectionDataTypeImpl#getInnerType_CollectionDataType <em>Inner Type Collection Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionDataTypeImpl extends EntityImpl implements CollectionDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.COLLECTION_DATA_TYPE;
   }
   ...
   public Repository getRepository__DataType() {
      if (eContainerFeatureID() != Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE) return null;
   ...
   public NotificationChain basicSetRepository__DataType(Repository newRepository__DataType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__DataType, Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE, msgs);
      return msgs;
   }
   ...
   public void setRepository__DataType(Repository newRepository__DataType) {
      if (newRepository__DataType != eInternalContainer() || (eContainerFeatureID() != Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE && newRepository__DataType != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE, newRepository__DataType, newRepository__DataType));
   }
      ...
      if (innerType_CollectionDataType != null && innerType_CollectionDataType.eIsProxy()) {
         ...
         if (innerType_CollectionDataType != oldInnerType_CollectionDataType) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_pcPackage.COLLECTION_DATA_TYPE__INNER_TYPE_COLLECTION_DATA_TYPE, oldInnerType_CollectionDataType, innerType_CollectionDataType));
         }
      }
   ...
   public void setInnerType_CollectionDataType(DataType newInnerType_CollectionDataType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pcPackage.COLLECTION_DATA_TYPE__INNER_TYPE_COLLECTION_DATA_TYPE, oldInnerType_CollectionDataType, innerType_CollectionDataType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Repository_pcPackage.COLLECTION_DATA_TYPE__INNER_TYPE_COLLECTION_DATA_TYPE:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (derivedFeatureID) {
            case Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_pcPackage.DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (baseFeatureID) {
            case Repository_pcPackage.DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_pcPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
