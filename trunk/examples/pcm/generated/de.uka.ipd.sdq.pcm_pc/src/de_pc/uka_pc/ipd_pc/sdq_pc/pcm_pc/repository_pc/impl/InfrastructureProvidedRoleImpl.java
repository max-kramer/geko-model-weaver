 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.InfrastructureProvidedRoleImpl#getProvidedInterface__InfrastructureProvidedRole <em>Provided Interface Infrastructure Provided Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InfrastructureProvidedRoleImpl extends ProvidedRoleImpl implements InfrastructureProvidedRole {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.INFRASTRUCTURE_PROVIDED_ROLE;
   }
      ...
      if (providedInterface__InfrastructureProvidedRole != null && providedInterface__InfrastructureProvidedRole.eIsProxy()) {
         ...
         if (providedInterface__InfrastructureProvidedRole != oldProvidedInterface__InfrastructureProvidedRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_pcPackage.INFRASTRUCTURE_PROVIDED_ROLE__PROVIDED_INTERFACE_INFRASTRUCTURE_PROVIDED_ROLE, oldProvidedInterface__InfrastructureProvidedRole, providedInterface__InfrastructureProvidedRole));
         }
      }
   ...
   public void setProvidedInterface__InfrastructureProvidedRole(InfrastructureInterface newProvidedInterface__InfrastructureProvidedRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pcPackage.INFRASTRUCTURE_PROVIDED_ROLE__PROVIDED_INTERFACE_INFRASTRUCTURE_PROVIDED_ROLE, oldProvidedInterface__InfrastructureProvidedRole, providedInterface__InfrastructureProvidedRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pcPackage.INFRASTRUCTURE_PROVIDED_ROLE__PROVIDED_INTERFACE_INFRASTRUCTURE_PROVIDED_ROLE:
