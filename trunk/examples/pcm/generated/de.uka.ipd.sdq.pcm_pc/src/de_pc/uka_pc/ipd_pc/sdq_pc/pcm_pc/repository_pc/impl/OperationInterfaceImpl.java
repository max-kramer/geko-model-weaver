 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.OperationInterfaceImpl#getSignatures__OperationInterface <em>Signatures Operation Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationInterfaceImpl extends InterfaceImpl implements OperationInterface {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.OPERATION_INTERFACE;
   }
   ...
   public EList<OperationSignature> getSignatures__OperationInterface() {
      if (signatures__OperationInterface == null) {
         signatures__OperationInterface = new EObjectContainmentWithInverseEList<OperationSignature>(OperationSignature.class, this, Repository_pcPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE, Repository_pcPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_pcValidator.OPERATION_INTERFACE__SIGNATURES_HAVE_TO_BE_UNIQUE_FOR_AN_INTERFACE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pcPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE:
