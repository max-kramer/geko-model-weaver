 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.PrimitiveDataTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimitiveDataTypeImpl extends DataTypeImpl implements PrimitiveDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.PRIMITIVE_DATA_TYPE;
   }
   ...
   public void setType(PrimitiveTypeEnum newType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pcPackage.PRIMITIVE_DATA_TYPE__TYPE, oldType, type));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pcPackage.PRIMITIVE_DATA_TYPE__TYPE:
            return getType();
      }
