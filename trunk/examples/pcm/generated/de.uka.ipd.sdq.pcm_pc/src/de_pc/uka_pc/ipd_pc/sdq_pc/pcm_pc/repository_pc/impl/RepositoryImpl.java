 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.RepositoryImpl#getRepositoryDescription <em>Repository Description</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.RepositoryImpl#getComponents__Repository <em>Components Repository</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.RepositoryImpl#getInterfaces__Repository <em>Interfaces Repository</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.RepositoryImpl#getFailureTypes__Repository <em>Failure Types Repository</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.repository_pc.impl.RepositoryImpl#getDataTypes__Repository <em>Data Types Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoryImpl extends EntityImpl implements Repository {
   ...
   protected EClass eStaticClass() {
      return Repository_pcPackage.Literals.REPOSITORY;
   }
   ...
   public void setRepositoryDescription(String newRepositoryDescription) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pcPackage.REPOSITORY__REPOSITORY_DESCRIPTION, oldRepositoryDescription, repositoryDescription));
   }
   ...
   public EList<RepositoryComponent> getComponents__Repository() {
      if (components__Repository == null) {
         components__Repository = new EObjectContainmentWithInverseEList<RepositoryComponent>(RepositoryComponent.class, this, Repository_pcPackage.REPOSITORY__COMPONENTS_REPOSITORY, Repository_pcPackage.REPOSITORY_COMPONENT__REPOSITORY_REPOSITORY_COMPONENT);
      }
   ...
   public EList<Interface> getInterfaces__Repository() {
      if (interfaces__Repository == null) {
         interfaces__Repository = new EObjectContainmentWithInverseEList<Interface>(Interface.class, this, Repository_pcPackage.REPOSITORY__INTERFACES_REPOSITORY, Repository_pcPackage.INTERFACE__REPOSITORY_INTERFACE);
      }
   ...
   public EList<FailureType> getFailureTypes__Repository() {
      if (failureTypes__Repository == null) {
         failureTypes__Repository = new EObjectContainmentWithInverseEList<FailureType>(FailureType.class, this, Repository_pcPackage.REPOSITORY__FAILURE_TYPES_REPOSITORY, Reliability_pcPackage.FAILURE_TYPE__REPOSITORY_FAILURE_TYPE);
      }
   ...
   public EList<DataType> getDataTypes__Repository() {
      if (dataTypes__Repository == null) {
         dataTypes__Repository = new EObjectContainmentWithInverseEList<DataType>(DataType.class, this, Repository_pcPackage.REPOSITORY__DATA_TYPES_REPOSITORY, Repository_pcPackage.DATA_TYPE__REPOSITORY_DATA_TYPE);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pcPackage.REPOSITORY__REPOSITORY_DESCRIPTION:
