 ...
 * @generated
 */
public class Repository_pcFactoryImpl extends EFactoryImpl implements Repository_pcFactory {
   /**
    ...
    * @generated
    */
   public static Repository_pcFactory init() {
      try {
         Repository_pcFactory theRepository_pcFactory = (Repository_pcFactory)EPackage.Registry.INSTANCE.getEFactory(Repository_pcPackage.eNS_URI);
         if (theRepository_pcFactory != null) {
            return theRepository_pcFactory;
         }
      }
      catch (Exception exception) {
         EcorePlugin.INSTANCE.log(exception);
      }
      return new Repository_pcFactoryImpl();
   }
    ...
    * @generated
    */
   public Repository_pcFactoryImpl() {
      super();
   }
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case Repository_pcPackage.PASSIVE_RESOURCE: return createPassiveResource();
         case Repository_pcPackage.BASIC_COMPONENT: return createBasicComponent();
         case Repository_pcPackage.IMPLEMENTATION_COMPONENT_TYPE: return createImplementationComponentType();
         case Repository_pcPackage.REPOSITORY_COMPONENT: return createRepositoryComponent();
         case Repository_pcPackage.PROVIDED_ROLE: return createProvidedRole();
         case Repository_pcPackage.PARAMETER: return createParameter();
         case Repository_pcPackage.DATA_TYPE: return createDataType();
         case Repository_pcPackage.REPOSITORY: return createRepository();
         case Repository_pcPackage.INTERFACE: return createInterface();
         case Repository_pcPackage.REQUIRED_CHARACTERISATION: return createRequiredCharacterisation();
         case Repository_pcPackage.EVENT_GROUP: return createEventGroup();
         case Repository_pcPackage.EVENT_TYPE: return createEventType();
         case Repository_pcPackage.SIGNATURE: return createSignature();
         case Repository_pcPackage.EXCEPTION_TYPE: return createExceptionType();
         case Repository_pcPackage.INFRASTRUCTURE_SIGNATURE: return createInfrastructureSignature();
         case Repository_pcPackage.INFRASTRUCTURE_INTERFACE: return createInfrastructureInterface();
         case Repository_pcPackage.INFRASTRUCTURE_REQUIRED_ROLE: return createInfrastructureRequiredRole();
         case Repository_pcPackage.REQUIRED_ROLE: return createRequiredRole();
         case Repository_pcPackage.OPERATION_SIGNATURE: return createOperationSignature();
         case Repository_pcPackage.OPERATION_INTERFACE: return createOperationInterface();
         case Repository_pcPackage.OPERATION_REQUIRED_ROLE: return createOperationRequiredRole();
         case Repository_pcPackage.SOURCE_ROLE: return createSourceRole();
         case Repository_pcPackage.SINK_ROLE: return createSinkRole();
         case Repository_pcPackage.OPERATION_PROVIDED_ROLE: return createOperationProvidedRole();
         case Repository_pcPackage.INFRASTRUCTURE_PROVIDED_ROLE: return createInfrastructureProvidedRole();
         case Repository_pcPackage.COMPLETE_COMPONENT_TYPE: return createCompleteComponentType();
         case Repository_pcPackage.PROVIDES_COMPONENT_TYPE: return createProvidesComponentType();
         case Repository_pcPackage.COMPOSITE_COMPONENT: return createCompositeComponent();
         case Repository_pcPackage.PRIMITIVE_DATA_TYPE: return createPrimitiveDataType();
         case Repository_pcPackage.COLLECTION_DATA_TYPE: return createCollectionDataType();
         case Repository_pcPackage.COMPOSITE_DATA_TYPE: return createCompositeDataType();
         case Repository_pcPackage.INNER_DECLARATION: return createInnerDeclaration();
         case Repository_pcPackage.ROLE: return createRole();
         default:
    ...
    * @generated
    */
   public Repository_pcPackage getRepository_pcPackage() {
      return (Repository_pcPackage)getEPackage();
   }
    ...
    */
   @Deprecated
   public static Repository_pcPackage getPackage() {
      return Repository_pcPackage.eINSTANCE;
   }

} //Repository_pcFactoryImpl
