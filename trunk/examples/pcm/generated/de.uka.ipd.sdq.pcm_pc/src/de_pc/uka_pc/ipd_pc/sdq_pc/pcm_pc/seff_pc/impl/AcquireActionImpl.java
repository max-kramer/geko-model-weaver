 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.impl.AcquireActionImpl#getPassiveresource_AcquireAction <em>Passiveresource Acquire Action</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.impl.AcquireActionImpl#isTimeout <em>Timeout</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.impl.AcquireActionImpl#getTimeoutValue <em>Timeout Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AcquireActionImpl extends AbstractInternalControlFlowActionImpl implements AcquireAction {
   ...
   protected EClass eStaticClass() {
      return Seff_pcPackage.Literals.ACQUIRE_ACTION;
   }
      ...
      if (passiveresource_AcquireAction != null && passiveresource_AcquireAction.eIsProxy()) {
         ...
         if (passiveresource_AcquireAction != oldPassiveresource_AcquireAction) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Seff_pcPackage.ACQUIRE_ACTION__PASSIVERESOURCE_ACQUIRE_ACTION, oldPassiveresource_AcquireAction, passiveresource_AcquireAction));
         }
      }
   ...
   public void setPassiveresource_AcquireAction(PassiveResource newPassiveresource_AcquireAction) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_pcPackage.ACQUIRE_ACTION__PASSIVERESOURCE_ACQUIRE_ACTION, oldPassiveresource_AcquireAction, passiveresource_AcquireAction));
   }
   ...
   public void setTimeout(boolean newTimeout) {
      ...
      timeout = newTimeout;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_pcPackage.ACQUIRE_ACTION__TIMEOUT, oldTimeout, timeout));
   }
   ...
   public void setTimeoutValue(double newTimeoutValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Seff_pcPackage.ACQUIRE_ACTION__TIMEOUT_VALUE, oldTimeoutValue, timeoutValue));
   }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Seff_pcValidator.ACQUIRE_ACTION__TIMEOUT_VALUE_OF_ACQUIRE_ACTION_MUST_NOT_BE_NEGATIVE,
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Seff_pcPackage.ACQUIRE_ACTION__PASSIVERESOURCE_ACQUIRE_ACTION:
            if (resolve) return getPassiveresource_AcquireAction();
            return basicGetPassiveresource_AcquireAction();
         case Seff_pcPackage.ACQUIRE_ACTION__TIMEOUT:
            return isTimeout();
         case Seff_pcPackage.ACQUIRE_ACTION__TIMEOUT_VALUE:
