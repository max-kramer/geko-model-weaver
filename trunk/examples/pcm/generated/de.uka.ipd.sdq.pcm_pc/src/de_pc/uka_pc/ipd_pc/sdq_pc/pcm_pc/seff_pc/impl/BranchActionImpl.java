 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.impl.BranchActionImpl#getBranches_Branch <em>Branches Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchActionImpl extends AbstractInternalControlFlowActionImpl implements BranchAction {
   ...
   protected EClass eStaticClass() {
      return Seff_pcPackage.Literals.BRANCH_ACTION;
   }
   ...
   public EList<AbstractBranchTransition> getBranches_Branch() {
      if (branches_Branch == null) {
         branches_Branch = new EObjectContainmentWithInverseEList<AbstractBranchTransition>(AbstractBranchTransition.class, this, Seff_pcPackage.BRANCH_ACTION__BRANCHES_BRANCH, Seff_pcPackage.ABSTRACT_BRANCH_TRANSITION__BRANCH_ACTION_ABSTRACT_BRANCH_TRANSITION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Seff_pcValidator.BRANCH_ACTION__EITHER_GUARDED_BRANCHES_OR_PROBABILISITIC_BRANCH_TRANSITIONS,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Seff_pcValidator.DIAGNOSTIC_SOURCE,
                   Seff_pcValidator.BRANCH_ACTION__ALL_PROBABILISTIC_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_pcPackage.BRANCH_ACTION__BRANCHES_BRANCH:
