...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.AcquireAction;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.BranchAction;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.CollectionIteratorAction;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.EmitEventAction;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.ProbabilisticBranchTransition;
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.ReleaseAction;
...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.Seff_pcFactory;
 ...
 * @generated
 */
public class Seff_pcPackageImpl extends EPackageImpl implements Seff_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.Seff_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Seff_pcPackageImpl() {
      super(eNS_URI, Seff_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Seff_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Seff_pcPackage init() {
      if (isInited) return (Seff_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Seff_pcPackage.eNS_URI);

      // Obtain or create and register package
      Seff_pcPackageImpl theSeff_pcPackage = (Seff_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Seff_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Seff_pcPackageImpl());
         ...
         (theSeff_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Seff_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSeff_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Seff_pcPackage.eNS_URI, theSeff_pcPackage);
      return theSeff_pcPackage;
   }
    ...
    * @generated
    */
   public Seff_pcFactory getSeff_pcFactory() {
      return (Seff_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      Seff_reliability_pcPackage theSeff_reliability_pcPackage = (Seff_reliability_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Seff_reliability_pcPackage.eNS_URI);
      ...
      // Add subpackages
      getESubpackages().add(theSeff_performance_pcPackage);
      getESubpackages().add(theSeff_reliability_pcPackage);
      ...
      abstractActionEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      resourceDemandingBehaviourEClass.getESuperTypes().add(theIdentifier_pcPackage.getIdentifier());
      abstractLoopActionEClass.getESuperTypes().add(this.getAbstractInternalControlFlowAction());
      abstractBranchTransitionEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
      ...
      resourceDemandingSEFFEClass.getESuperTypes().add(theIdentifier_pcPackage.getIdentifier());
      ...
      externalCallActionEClass.getESuperTypes().add(theSeff_reliability_pcPackage.getFailureHandlingEntity());
      ...
      initEReference(getAbstractInternalControlFlowAction_ResourceDemand_Action(), theSeff_performance_pcPackage.getParametricResourceDemand(), theSeff_performance_pcPackage.getParametricResourceDemand_Action_ParametricResourceDemand(), "resourceDemand_Action", null, 0, -1, AbstractInternalControlFlowAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getAbstractInternalControlFlowAction_InfrastructureCall__Action(), theSeff_performance_pcPackage.getInfrastructureCall(), theSeff_performance_pcPackage.getInfrastructureCall_Action__InfrastructureCall(), "infrastructureCall__Action", null, 0, -1, AbstractInternalControlFlowAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getAbstractInternalControlFlowAction_ResourceCall__Action(), theSeff_performance_pcPackage.getResourceCall(), theSeff_performance_pcPackage.getResourceCall_Action__ResourceCall(), "resourceCall__Action", null, 0, -1, AbstractInternalControlFlowAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getCallAction_InputVariableUsages__CallAction(), theParameter_pcPackage.getVariableUsage(), theParameter_pcPackage.getVariableUsage_CallAction__VariableUsage(), "inputVariableUsages__CallAction", null, 0, -1, CallAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getServiceEffectSpecification_DescribedService__SEFF(), theRepository_pcPackage.getSignature(), null, "describedService__SEFF", null, 0, 1, ServiceEffectSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getServiceEffectSpecification_BasicComponent_ServiceEffectSpecification(), theRepository_pcPackage.getBasicComponent(), theRepository_pcPackage.getBasicComponent_ServiceEffectSpecifications__BasicComponent(), "basicComponent_ServiceEffectSpecification", null, 0, 1, ServiceEffectSpecification.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getReleaseAction_PassiveResource_ReleaseAction(), theRepository_pcPackage.getPassiveResource(), null, "passiveResource_ReleaseAction", null, 0, 1, ReleaseAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(loopActionEClass, LoopAction.class, "LoopAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getLoopAction_IterationCount_LoopAction(), theCore_pcPackage.getPCMRandomVariable(), theCore_pcPackage.getPCMRandomVariable_LoopAction_PCMRandomVariable(), "iterationCount_LoopAction", null, 0, 1, LoopAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getSynchronisationPoint_OutputParameterUsage_SynchronisationPoint(), theParameter_pcPackage.getVariableUsage(), theParameter_pcPackage.getVariableUsage_SynchronisationPoint_VariableUsage(), "outputParameterUsage_SynchronisationPoint", null, 0, -1, SynchronisationPoint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getExternalCallAction_CalledService_ExternalService(), theRepository_pcPackage.getOperationSignature(), null, "calledService_ExternalService", null, 0, 1, ExternalCallAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getExternalCallAction_Role_ExternalService(), theRepository_pcPackage.getOperationRequiredRole(), null, "role_ExternalService", null, 0, 1, ExternalCallAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getCallReturnAction_ReturnVariableUsage__CallReturnAction(), theParameter_pcPackage.getVariableUsage(), theParameter_pcPackage.getVariableUsage_CallReturnAction__VariableUsage(), "returnVariableUsage__CallReturnAction", null, 0, -1, CallReturnAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getAcquireAction_Passiveresource_AcquireAction(), theRepository_pcPackage.getPassiveResource(), null, "passiveresource_AcquireAction", null, 0, 1, AcquireAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getCollectionIteratorAction_Parameter_CollectionIteratorAction(), theRepository_pcPackage.getParameter(), null, "parameter_CollectionIteratorAction", null, 0, 1, CollectionIteratorAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getGuardedBranchTransition_BranchCondition_GuardedBranchTransition(), theCore_pcPackage.getPCMRandomVariable(), theCore_pcPackage.getPCMRandomVariable_GuardedBranchTransition_PCMRandomVariable(), "branchCondition_GuardedBranchTransition", null, 0, 1, GuardedBranchTransition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getSetVariableAction_LocalVariableUsages_SetVariableAction(), theParameter_pcPackage.getVariableUsage(), theParameter_pcPackage.getVariableUsage_SetVariableAction_VariableUsage(), "localVariableUsages_SetVariableAction", null, 0, -1, SetVariableAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getEmitEventAction_EventType__EmitEventAction(), theRepository_pcPackage.getEventType(), null, "eventType__EmitEventAction", null, 0, 1, EmitEventAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      initEReference(getEmitEventAction_SourceRole__EmitEventAction(), theRepository_pcPackage.getSourceRole(), null, "sourceRole__EmitEventAction", null, 0, 1, EmitEventAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(internalActionEClass, InternalAction.class, "InternalAction", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getInternalAction_InternalFailureOccurrenceDescriptions__InternalAction(), theReliability_pcPackage.getInternalFailureOccurrenceDescription(), theReliability_pcPackage.getInternalFailureOccurrenceDescription_InternalAction__InternalFailureOccurrenceDescription(), "internalFailureOccurrenceDescriptions__InternalAction", null, 0, -1, InternalAction.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
