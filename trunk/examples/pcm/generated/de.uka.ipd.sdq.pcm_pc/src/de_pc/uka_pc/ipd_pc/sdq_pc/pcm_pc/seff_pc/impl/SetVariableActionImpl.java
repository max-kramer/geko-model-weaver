 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.impl.SetVariableActionImpl#getLocalVariableUsages_SetVariableAction <em>Local Variable Usages Set Variable Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SetVariableActionImpl extends AbstractInternalControlFlowActionImpl implements SetVariableAction {
   ...
   protected EClass eStaticClass() {
      return Seff_pcPackage.Literals.SET_VARIABLE_ACTION;
   }
   ...
   public EList<VariableUsage> getLocalVariableUsages_SetVariableAction() {
      if (localVariableUsages_SetVariableAction == null) {
         localVariableUsages_SetVariableAction = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_pcPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION, Parameter_pcPackage.VARIABLE_USAGE__SET_VARIABLE_ACTION_VARIABLE_USAGE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_pcPackage.SET_VARIABLE_ACTION__LOCAL_VARIABLE_USAGES_SET_VARIABLE_ACTION:
