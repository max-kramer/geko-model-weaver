 ...
 * @generated
 */
public class Seff_performance_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Seff_performance_pcPackage modelPackage;
    ...
    * @generated
    */
   public Seff_performance_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Seff_performance_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Seff_performance_pcSwitch<Adapter> modelSwitch =
      new Seff_performance_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.seff_performance_pc.InfrastructureCall <em>Infrastructure Call</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.seff_performance_pc.ResourceCall <em>Resource Call</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Seff_performance_pcAdapterFactory
