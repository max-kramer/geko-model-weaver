...
import de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.seff_reliability_pc.Seff_reliability_pcFactory;
 ...
 * @generated
 */
public class Seff_reliability_pcPackageImpl extends EPackageImpl implements Seff_reliability_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.seff_pc.seff_reliability_pc.Seff_reliability_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Seff_reliability_pcPackageImpl() {
      super(eNS_URI, Seff_reliability_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Seff_reliability_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Seff_reliability_pcPackage init() {
      if (isInited) return (Seff_reliability_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Seff_reliability_pcPackage.eNS_URI);

      // Obtain or create and register package
      Seff_reliability_pcPackageImpl theSeff_reliability_pcPackage = (Seff_reliability_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Seff_reliability_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Seff_reliability_pcPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theSeff_reliability_pcPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Seff_reliability_pcValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSeff_reliability_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Seff_reliability_pcPackage.eNS_URI, theSeff_reliability_pcPackage);
      return theSeff_reliability_pcPackage;
   }
    ...
    * @generated
    */
   public Seff_reliability_pcFactory getSeff_reliability_pcFactory() {
      return (Seff_reliability_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      recoveryActionBehaviourEClass.getESuperTypes().add(theSeff_pcPackage.getResourceDemandingBehaviour());
      recoveryActionEClass.getESuperTypes().add(theSeff_pcPackage.getAbstractInternalControlFlowAction());
      failureHandlingEntityEClass.getESuperTypes().add(theEntity_pcPackage.getEntity());
