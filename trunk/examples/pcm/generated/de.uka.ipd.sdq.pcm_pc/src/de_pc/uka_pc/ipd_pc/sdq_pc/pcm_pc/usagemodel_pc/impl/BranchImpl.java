 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.BranchImpl#getBranchTransitions_Branch <em>Branch Transitions Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchImpl extends AbstractUserActionImpl implements Branch {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pcPackage.Literals.BRANCH;
   }
   ...
   public EList<BranchTransition> getBranchTransitions_Branch() {
      if (branchTransitions_Branch == null) {
         branchTransitions_Branch = new EObjectContainmentWithInverseEList<BranchTransition>(BranchTransition.class, this, Usagemodel_pcPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH, Usagemodel_pcPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Usagemodel_pcValidator.BRANCH__ALL_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pcPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
