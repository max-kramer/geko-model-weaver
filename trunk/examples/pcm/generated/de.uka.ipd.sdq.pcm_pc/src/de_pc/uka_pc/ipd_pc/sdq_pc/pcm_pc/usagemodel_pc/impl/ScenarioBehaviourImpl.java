 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.ScenarioBehaviourImpl#getUsageScenario_SenarioBehaviour <em>Usage Scenario Senario Behaviour</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.ScenarioBehaviourImpl#getBranchTransition_ScenarioBehaviour <em>Branch Transition Scenario Behaviour</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.ScenarioBehaviourImpl#getLoop_ScenarioBehaviour <em>Loop Scenario Behaviour</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.pcm_pc.usagemodel_pc.impl.ScenarioBehaviourImpl#getActions_ScenarioBehaviour <em>Actions Scenario Behaviour</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ScenarioBehaviourImpl extends EntityImpl implements ScenarioBehaviour {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pcPackage.Literals.SCENARIO_BEHAVIOUR;
   }
   ...
   public UsageScenario getUsageScenario_SenarioBehaviour() {
      if (eContainerFeatureID() != Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetUsageScenario_SenarioBehaviour(UsageScenario newUsageScenario_SenarioBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUsageScenario_SenarioBehaviour, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setUsageScenario_SenarioBehaviour(UsageScenario newUsageScenario_SenarioBehaviour) {
      if (newUsageScenario_SenarioBehaviour != eInternalContainer() || (eContainerFeatureID() != Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR && newUsageScenario_SenarioBehaviour != null)) {
         ...
         if (newUsageScenario_SenarioBehaviour != null)
            msgs = ((InternalEObject)newUsageScenario_SenarioBehaviour).eInverseAdd(this, Usagemodel_pcPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, UsageScenario.class, msgs);
         msgs = basicSetUsageScenario_SenarioBehaviour(newUsageScenario_SenarioBehaviour, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR, newUsageScenario_SenarioBehaviour, newUsageScenario_SenarioBehaviour));
   }
   ...
   public BranchTransition getBranchTransition_ScenarioBehaviour() {
      if (eContainerFeatureID() != Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetBranchTransition_ScenarioBehaviour(BranchTransition newBranchTransition_ScenarioBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newBranchTransition_ScenarioBehaviour, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setBranchTransition_ScenarioBehaviour(BranchTransition newBranchTransition_ScenarioBehaviour) {
      if (newBranchTransition_ScenarioBehaviour != eInternalContainer() || (eContainerFeatureID() != Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR && newBranchTransition_ScenarioBehaviour != null)) {
         ...
         if (newBranchTransition_ScenarioBehaviour != null)
            msgs = ((InternalEObject)newBranchTransition_ScenarioBehaviour).eInverseAdd(this, Usagemodel_pcPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, BranchTransition.class, msgs);
         msgs = basicSetBranchTransition_ScenarioBehaviour(newBranchTransition_ScenarioBehaviour, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR, newBranchTransition_ScenarioBehaviour, newBranchTransition_ScenarioBehaviour));
   }
   ...
   public Loop getLoop_ScenarioBehaviour() {
      if (eContainerFeatureID() != Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR) return null;
   ...
   public NotificationChain basicSetLoop_ScenarioBehaviour(Loop newLoop_ScenarioBehaviour, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newLoop_ScenarioBehaviour, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, msgs);
      return msgs;
   }
   ...
   public void setLoop_ScenarioBehaviour(Loop newLoop_ScenarioBehaviour) {
      if (newLoop_ScenarioBehaviour != eInternalContainer() || (eContainerFeatureID() != Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR && newLoop_ScenarioBehaviour != null)) {
         ...
         if (newLoop_ScenarioBehaviour != null)
            msgs = ((InternalEObject)newLoop_ScenarioBehaviour).eInverseAdd(this, Usagemodel_pcPackage.LOOP__BODY_BEHAVIOUR_LOOP, Loop.class, msgs);
         msgs = basicSetLoop_ScenarioBehaviour(newLoop_ScenarioBehaviour, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, newLoop_ScenarioBehaviour, newLoop_ScenarioBehaviour));
   }
   ...
   public EList<AbstractUserAction> getActions_ScenarioBehaviour() {
      if (actions_ScenarioBehaviour == null) {
         actions_ScenarioBehaviour = new EObjectContainmentWithInverseEList<AbstractUserAction>(AbstractUserAction.class, this, Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR, Usagemodel_pcPackage.ABSTRACT_USER_ACTION__SCENARIO_BEHAVIOUR_ABSTRACT_USER_ACTION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Usagemodel_pcValidator.SCENARIO_BEHAVIOUR__EXACTLYONESTART,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Usagemodel_pcValidator.DIAGNOSTIC_SOURCE,
                   Usagemodel_pcValidator.SCENARIO_BEHAVIOUR__EXACTLYONESTOP,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Usagemodel_pcValidator.DIAGNOSTIC_SOURCE,
                   Usagemodel_pcValidator.SCENARIO_BEHAVIOUR__EACHUSERACTIONEXCEPT_STARTAND_STOPMUSTHAVEAPREDECESSORANDSUCCESSOR,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetUsageScenario_SenarioBehaviour((UsageScenario)otherEnd, msgs);
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetBranchTransition_ScenarioBehaviour((BranchTransition)otherEnd, msgs);
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetLoop_ScenarioBehaviour((Loop)otherEnd, msgs);
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__ACTIONS_SCENARIO_BEHAVIOUR:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__USAGE_SCENARIO_SENARIO_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Usagemodel_pcPackage.USAGE_SCENARIO__SCENARIO_BEHAVIOUR_USAGE_SCENARIO, UsageScenario.class, msgs);
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__BRANCH_TRANSITION_SCENARIO_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Usagemodel_pcPackage.BRANCH_TRANSITION__BRANCHED_BEHAVIOUR_BRANCH_TRANSITION, BranchTransition.class, msgs);
         case Usagemodel_pcPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR:
            return eInternalContainer().eInverseRemove(this, Usagemodel_pcPackage.LOOP__BODY_BEHAVIOUR_LOOP, Loop.class, msgs);
      }
