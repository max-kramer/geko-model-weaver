 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.allocation_pc_av.impl.AllocationImpl#getTargetResourceEnvironment_Allocation <em>Target Resource Environment Allocation</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.allocation_pc_av.impl.AllocationImpl#getSystem_Allocation <em>System Allocation</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.allocation_pc_av.impl.AllocationImpl#getAllocationContexts_Allocation <em>Allocation Contexts Allocation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AllocationImpl extends EntityImpl implements Allocation {
    ...
    * @ordered
    */
   protected de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System system_Allocation;
   ...
   protected EClass eStaticClass() {
      return Allocation_pc_avPackage.Literals.ALLOCATION;
   }
      ...
      if (targetResourceEnvironment_Allocation != null && targetResourceEnvironment_Allocation.eIsProxy()) {
         ...
         if (targetResourceEnvironment_Allocation != oldTargetResourceEnvironment_Allocation) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Allocation_pc_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION, oldTargetResourceEnvironment_Allocation, targetResourceEnvironment_Allocation));
         }
      }
   ...
   public void setTargetResourceEnvironment_Allocation(ResourceEnvironment newTargetResourceEnvironment_Allocation) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Allocation_pc_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION, oldTargetResourceEnvironment_Allocation, targetResourceEnvironment_Allocation));
   }
    ...
    * @generated
    */
   public de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System getSystem_Allocation() {
      if (system_Allocation != null && system_Allocation.eIsProxy()) {
         ...
         system_Allocation = (de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)eResolveProxy(oldSystem_Allocation);
         if (system_Allocation != oldSystem_Allocation) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Allocation_pc_avPackage.ALLOCATION__SYSTEM_ALLOCATION, oldSystem_Allocation, system_Allocation));
         }
      }
    ...
    * @generated
    */
   public de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System basicGetSystem_Allocation() {
      return system_Allocation;
   }
    ...
    * @generated
    */
   public void setSystem_Allocation(de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System newSystem_Allocation) {
      de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System oldSystem_Allocation = system_Allocation;
      system_Allocation = newSystem_Allocation;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Allocation_pc_avPackage.ALLOCATION__SYSTEM_ALLOCATION, oldSystem_Allocation, system_Allocation));
   }
   ...
   public EList<AllocationContext> getAllocationContexts_Allocation() {
      if (allocationContexts_Allocation == null) {
         allocationContexts_Allocation = new EObjectContainmentWithInverseEList<AllocationContext>(AllocationContext.class, this, Allocation_pc_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION, Allocation_pc_avPackage.ALLOCATION_CONTEXT__ALLOCATION_ALLOCATION_CONTEXT);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Allocation_pc_avValidator.ALLOCATION__EACH_ASSEMBLY_CONTEXT_WITHIN_SYSTEM_HAS_TO_BE_ALLOCATED_EXACTLY_ONCE,
         ...
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Allocation_pc_avValidator.DIAGNOSTIC_SOURCE,
                   Allocation_pc_avValidator.ALLOCATION__COMMUNICATING_SERVERS_HAVE_TO_BE_CONNECTED_BY_LINKING_RESOURCE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Allocation_pc_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Allocation_pc_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
            if (resolve) return getTargetResourceEnvironment_Allocation();
            return basicGetTargetResourceEnvironment_Allocation();
         case Allocation_pc_avPackage.ALLOCATION__SYSTEM_ALLOCATION:
   ...
   public void eSet(int featureID, Object newValue) {
      switch (featureID) {
         case Allocation_pc_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
            ...
            return;
         case Allocation_pc_avPackage.ALLOCATION__SYSTEM_ALLOCATION:
            setSystem_Allocation((de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)newValue);
            return;
         case Allocation_pc_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
   ...
   public void eUnset(int featureID) {
      switch (featureID) {
         case Allocation_pc_avPackage.ALLOCATION__TARGET_RESOURCE_ENVIRONMENT_ALLOCATION:
            ...
            return;
         case Allocation_pc_avPackage.ALLOCATION__SYSTEM_ALLOCATION:
            setSystem_Allocation((de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)null);
            return;
         case Allocation_pc_avPackage.ALLOCATION__ALLOCATION_CONTEXTS_ALLOCATION:
            getAllocationContexts_Allocation().clear();
            return;
