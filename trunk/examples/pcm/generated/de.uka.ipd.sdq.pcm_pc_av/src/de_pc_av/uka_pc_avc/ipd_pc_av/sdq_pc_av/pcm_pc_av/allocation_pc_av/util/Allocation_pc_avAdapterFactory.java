 ...
 * @generated
 */
public class Allocation_pc_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Allocation_pc_avPackage modelPackage;
    ...
    * @generated
    */
   public Allocation_pc_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Allocation_pc_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Allocation_pc_avSwitch<Adapter> modelSwitch =
      new Allocation_pc_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.allocation_pc_av.AllocationContext <em>Allocation Context</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.allocation_pc_av.Allocation <em>Allocation</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Allocation_pc_avAdapterFactory
