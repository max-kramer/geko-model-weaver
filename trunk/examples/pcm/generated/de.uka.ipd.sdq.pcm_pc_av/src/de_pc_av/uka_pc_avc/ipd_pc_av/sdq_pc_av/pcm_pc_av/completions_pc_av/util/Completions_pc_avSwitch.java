 ...
 * @generated
 */
public class Completions_pc_avSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Completions_pc_avSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Completions_pc_avPackage.COMPLETION: {
         ...
         case Completions_pc_avPackage.COMPLETION_REPOSITORY: {
         ...
         case Completions_pc_avPackage.DELEGATING_EXTERNAL_CALL_ACTION: {
         ...
         case Completions_pc_avPackage.NETWORK_DEMAND_PARAMETRIC_RESOURCE_DEMAND: {
