...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.core_pc_av.entity_pc_av.Entity_pc_avFactory;
 ...
 * @generated
 */
public class Entity_pc_avPackageImpl extends EPackageImpl implements Entity_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.core_pc_av.entity_pc_av.Entity_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Entity_pc_avPackageImpl() {
      super(eNS_URI, Entity_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Entity_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Entity_pc_avPackage init() {
      if (isInited) return (Entity_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Entity_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Entity_pc_avPackageImpl theEntity_pc_avPackage = (Entity_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Entity_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Entity_pc_avPackageImpl());
         ...
         (theEntity_pc_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Entity_pc_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theEntity_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Entity_pc_avPackage.eNS_URI, theEntity_pc_avPackage);
      return theEntity_pc_avPackage;
   }
    ...
    * @generated
    */
   public Entity_pc_avFactory getEntity_pc_avFactory() {
      return (Entity_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      resourceProvidedRoleEClass.getESuperTypes().add(theRepository_pc_avPackage.getRole());
      ...
      resourceRequiredRoleEClass.getESuperTypes().add(theRepository_pc_avPackage.getRole());
      resourceInterfaceProvidingEntityEClass.getESuperTypes().add(this.getEntity());
      composedProvidingRequiringEntityEClass.getESuperTypes().add(theComposition_pc_avPackage.getComposedStructure());
      ...
      entityEClass.getESuperTypes().add(theIdentifier_pc_avPackage.getIdentifier());
      ...
      initEReference(getResourceProvidedRole_ProvidedResourceInterface__ResourceProvidedRole(), theResourcetype_pc_avPackage.getResourceInterface(), null, "providedResourceInterface__ResourceProvidedRole", null, 0, 1, ResourceProvidedRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity(), theRepository_pc_avPackage.getProvidedRole(), theRepository_pc_avPackage.getProvidedRole_ProvidingEntity_ProvidedRole(), "providedRoles_InterfaceProvidingEntity", null, 0, -1, InterfaceProvidingEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getInterfaceRequiringEntity_RequiredRoles_InterfaceRequiringEntity(), theRepository_pc_avPackage.getRequiredRole(), theRepository_pc_avPackage.getRequiredRole_RequiringEntity_RequiredRole(), "requiredRoles_InterfaceRequiringEntity", null, 0, -1, InterfaceRequiringEntity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
