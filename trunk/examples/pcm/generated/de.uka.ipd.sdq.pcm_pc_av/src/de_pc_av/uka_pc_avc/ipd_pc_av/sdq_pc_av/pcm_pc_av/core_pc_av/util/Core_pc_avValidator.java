 ...
 * @generated
 */
public class Core_pc_avValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Core_pc_avValidator INSTANCE = new Core_pc_avValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.core_pc_av";
   ...
   protected boolean validate(int classifierID, Object value, DiagnosticChain diagnostics, Map<Object, Object> context) {
      switch (classifierID) {
         case Core_pc_avPackage.PCM_RANDOM_VARIABLE:
