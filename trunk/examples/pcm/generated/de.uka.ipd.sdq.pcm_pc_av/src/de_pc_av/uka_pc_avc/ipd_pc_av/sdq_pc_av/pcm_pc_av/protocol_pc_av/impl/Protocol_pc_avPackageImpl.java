...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.protocol_pc_av.Protocol_pc_avFactory;
 ...
 * @generated
 */
public class Protocol_pc_avPackageImpl extends EPackageImpl implements Protocol_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.protocol_pc_av.Protocol_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Protocol_pc_avPackageImpl() {
      super(eNS_URI, Protocol_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Protocol_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Protocol_pc_avPackage init() {
      if (isInited) return (Protocol_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Protocol_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Protocol_pc_avPackageImpl theProtocol_pc_avPackage = (Protocol_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Protocol_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Protocol_pc_avPackageImpl());
      ...
      theProtocol_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Protocol_pc_avPackage.eNS_URI, theProtocol_pc_avPackage);
      return theProtocol_pc_avPackage;
   }
    ...
    * @generated
    */
   public Protocol_pc_avFactory getProtocol_pc_avFactory() {
      return (Protocol_pc_avFactory)getEFactoryInstance();
   }
