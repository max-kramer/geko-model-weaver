 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.qosannotations_pc_av.impl.QoSAnnotationsImpl#getSpecifiedOutputParameterAbstractions_QoSAnnotations <em>Specified Output Parameter Abstractions Qo SAnnotations</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.qosannotations_pc_av.impl.QoSAnnotationsImpl#getSystem_QoSAnnotations <em>System Qo SAnnotations</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.qosannotations_pc_av.impl.QoSAnnotationsImpl#getSpecifiedQoSAnnotations_QoSAnnotations <em>Specified Qo SAnnotations Qo SAnnotations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class QoSAnnotationsImpl extends EntityImpl implements QoSAnnotations {
   ...
   protected EClass eStaticClass() {
      return Qosannotations_pc_avPackage.Literals.QO_SANNOTATIONS;
   }
    ...
    * @generated
    */
   public de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System getSystem_QoSAnnotations() {
      if (eContainerFeatureID() != Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS) return null;
      return (de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)eInternalContainer();
   }
    ...
    * @generated
    */
   public NotificationChain basicSetSystem_QoSAnnotations(de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System newSystem_QoSAnnotations, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newSystem_QoSAnnotations, Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS, msgs);
      return msgs;
   }
    ...
    * @generated
    */
   public void setSystem_QoSAnnotations(de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System newSystem_QoSAnnotations) {
      if (newSystem_QoSAnnotations != eInternalContainer() || (eContainerFeatureID() != Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS && newSystem_QoSAnnotations != null)) {
         ...
         if (newSystem_QoSAnnotations != null)
            msgs = ((InternalEObject)newSystem_QoSAnnotations).eInverseAdd(this, System_pc_avPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM, de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System.class, msgs);
         msgs = basicSetSystem_QoSAnnotations(newSystem_QoSAnnotations, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS, newSystem_QoSAnnotations, newSystem_QoSAnnotations));
   }
   ...
   public EList<SpecifiedQoSAnnotation> getSpecifiedQoSAnnotations_QoSAnnotations() {
      if (specifiedQoSAnnotations_QoSAnnotations == null) {
         specifiedQoSAnnotations_QoSAnnotations = new EObjectContainmentWithInverseEList<SpecifiedQoSAnnotation>(SpecifiedQoSAnnotation.class, this, Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS, Qosannotations_pc_avPackage.SPECIFIED_QO_SANNOTATION__QOS_ANNOTATIONS_SPECIFIED_QO_SANNOTATION);
      }
      ...
      if (false) {
         if (diagnostics != null) {
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   Qosannotations_pc_avValidator.DIAGNOSTIC_SOURCE,
                   Qosannotations_pc_avValidator.QO_SANNOTATIONS__MULTIPLE_RELIABILITY_ANNOTATIONS_PER_EXTERNAL_CALL_NOT_ALLOWED,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS:
         ...
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetSystem_QoSAnnotations((de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)otherEnd, msgs);
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
            return eInternalContainer().eInverseRemove(this, System_pc_avPackage.SYSTEM__QOS_ANNOTATIONS_SYSTEM, de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System.class, msgs);
      }
   ...
   public void eSet(int featureID, Object newValue) {
      switch (featureID) {
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS:
            ...
            return;
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
            setSystem_QoSAnnotations((de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)newValue);
            return;
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
   ...
   public void eUnset(int featureID) {
      switch (featureID) {
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_OUTPUT_PARAMETER_ABSTRACTIONS_QO_SANNOTATIONS:
            ...
            return;
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SYSTEM_QO_SANNOTATIONS:
            setSystem_QoSAnnotations((de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System)null);
            return;
         case Qosannotations_pc_avPackage.QO_SANNOTATIONS__SPECIFIED_QO_SANNOTATIONS_QO_SANNOTATIONS:
            getSpecifiedQoSAnnotations_QoSAnnotations().clear();
            return;
