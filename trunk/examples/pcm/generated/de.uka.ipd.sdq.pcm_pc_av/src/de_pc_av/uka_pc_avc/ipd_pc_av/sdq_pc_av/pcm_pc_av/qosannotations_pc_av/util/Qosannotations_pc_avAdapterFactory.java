 ...
 * @generated
 */
public class Qosannotations_pc_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   public Qosannotations_pc_avAdapterFactory() {
    ...
    * @generated
    */
   protected Qosannotations_pc_avSwitch<Adapter> modelSwitch =
      new Qosannotations_pc_avSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.qosannotations_pc_av.QoSAnnotations <em>Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.qosannotations_pc_av.SpecifiedOutputParameterAbstraction <em>Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Qosannotations_pc_avAdapterFactory
