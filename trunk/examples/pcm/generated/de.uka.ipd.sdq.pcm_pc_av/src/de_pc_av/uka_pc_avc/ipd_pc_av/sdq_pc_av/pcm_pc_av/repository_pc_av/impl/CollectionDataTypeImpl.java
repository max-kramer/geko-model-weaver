 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.impl.CollectionDataTypeImpl#getRepository__DataType <em>Repository Data Type</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.impl.CollectionDataTypeImpl#getInnerType_CollectionDataType <em>Inner Type Collection Data Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CollectionDataTypeImpl extends EntityImpl implements CollectionDataType {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_avPackage.Literals.COLLECTION_DATA_TYPE;
   }
   ...
   public Repository getRepository__DataType() {
      if (eContainerFeatureID() != Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE) return null;
   ...
   public NotificationChain basicSetRepository__DataType(Repository newRepository__DataType, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newRepository__DataType, Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE, msgs);
      return msgs;
   }
   ...
   public void setRepository__DataType(Repository newRepository__DataType) {
      if (newRepository__DataType != eInternalContainer() || (eContainerFeatureID() != Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE && newRepository__DataType != null)) {
         ...
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE, newRepository__DataType, newRepository__DataType));
   }
      ...
      if (innerType_CollectionDataType != null && innerType_CollectionDataType.eIsProxy()) {
         ...
         if (innerType_CollectionDataType != oldInnerType_CollectionDataType) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_pc_avPackage.COLLECTION_DATA_TYPE__INNER_TYPE_COLLECTION_DATA_TYPE, oldInnerType_CollectionDataType, innerType_CollectionDataType));
         }
      }
   ...
   public void setInnerType_CollectionDataType(DataType newInnerType_CollectionDataType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_avPackage.COLLECTION_DATA_TYPE__INNER_TYPE_COLLECTION_DATA_TYPE, oldInnerType_CollectionDataType, innerType_CollectionDataType));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Repository_pc_avPackage.COLLECTION_DATA_TYPE__INNER_TYPE_COLLECTION_DATA_TYPE:
   ...
   public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (derivedFeatureID) {
            case Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_pc_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
   ...
   public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
      if (baseClass == DataType.class) {
         switch (baseFeatureID) {
            case Repository_pc_avPackage.DATA_TYPE__REPOSITORY_DATA_TYPE: return Repository_pc_avPackage.COLLECTION_DATA_TYPE__REPOSITORY_DATA_TYPE;
            default: return -1;
         }
      }
