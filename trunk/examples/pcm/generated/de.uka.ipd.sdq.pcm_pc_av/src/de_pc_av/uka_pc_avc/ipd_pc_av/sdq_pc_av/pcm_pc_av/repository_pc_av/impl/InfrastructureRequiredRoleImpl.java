 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.impl.InfrastructureRequiredRoleImpl#getRequiredInterface__InfrastructureRequiredRole <em>Required Interface Infrastructure Required Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InfrastructureRequiredRoleImpl extends RequiredRoleImpl implements InfrastructureRequiredRole {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_avPackage.Literals.INFRASTRUCTURE_REQUIRED_ROLE;
   }
      ...
      if (requiredInterface__InfrastructureRequiredRole != null && requiredInterface__InfrastructureRequiredRole.eIsProxy()) {
         ...
         if (requiredInterface__InfrastructureRequiredRole != oldRequiredInterface__InfrastructureRequiredRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_pc_avPackage.INFRASTRUCTURE_REQUIRED_ROLE__REQUIRED_INTERFACE_INFRASTRUCTURE_REQUIRED_ROLE, oldRequiredInterface__InfrastructureRequiredRole, requiredInterface__InfrastructureRequiredRole));
         }
      }
   ...
   public void setRequiredInterface__InfrastructureRequiredRole(InfrastructureInterface newRequiredInterface__InfrastructureRequiredRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_avPackage.INFRASTRUCTURE_REQUIRED_ROLE__REQUIRED_INTERFACE_INFRASTRUCTURE_REQUIRED_ROLE, oldRequiredInterface__InfrastructureRequiredRole, requiredInterface__InfrastructureRequiredRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pc_avPackage.INFRASTRUCTURE_REQUIRED_ROLE__REQUIRED_INTERFACE_INFRASTRUCTURE_REQUIRED_ROLE:
