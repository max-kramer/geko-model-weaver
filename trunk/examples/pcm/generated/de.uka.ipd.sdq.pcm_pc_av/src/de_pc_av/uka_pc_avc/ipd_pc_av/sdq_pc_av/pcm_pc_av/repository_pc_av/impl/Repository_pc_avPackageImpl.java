...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.CollectionDataType;
...
import de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.Repository_pc_avFactory;
 ...
 * @generated
 */
public class Repository_pc_avPackageImpl extends EPackageImpl implements Repository_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.repository_pc_av.Repository_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Repository_pc_avPackageImpl() {
      super(eNS_URI, Repository_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Repository_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Repository_pc_avPackage init() {
      if (isInited) return (Repository_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Repository_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      Repository_pc_avPackageImpl theRepository_pc_avPackage = (Repository_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Repository_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Repository_pc_avPackageImpl());
         ...
         (theRepository_pc_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return Repository_pc_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theRepository_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Repository_pc_avPackage.eNS_URI, theRepository_pc_avPackage);
      return theRepository_pc_avPackage;
   }
    ...
    * @generated
    */
   public Repository_pc_avFactory getRepository_pc_avFactory() {
      return (Repository_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      Protocol_pc_avPackage theProtocol_pc_avPackage = (Protocol_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(Protocol_pc_avPackage.eNS_URI);
      ...
      passiveResourceEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      ...
      repositoryComponentEClass.getESuperTypes().add(theEntity_pc_avPackage.getInterfaceProvidingRequiringEntity());
      providedRoleEClass.getESuperTypes().add(this.getRole());
      repositoryEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      interfaceEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      eventGroupEClass.getESuperTypes().add(this.getInterface());
      eventTypeEClass.getESuperTypes().add(this.getSignature());
      signatureEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      ...
      compositeComponentEClass.getESuperTypes().add(theEntity_pc_avPackage.getComposedProvidingRequiringEntity());
      ...
      collectionDataTypeEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      collectionDataTypeEClass.getESuperTypes().add(this.getDataType());
      compositeDataTypeEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      compositeDataTypeEClass.getESuperTypes().add(this.getDataType());
      innerDeclarationEClass.getESuperTypes().add(theEntity_pc_avPackage.getNamedElement());
      roleEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      ...
      initEReference(getPassiveResource_Capacity_PassiveResource(), theCore_pc_avPackage.getPCMRandomVariable(), theCore_pc_avPackage.getPCMRandomVariable_PassiveResource_capacity_PCMRandomVariable(), "capacity_PassiveResource", null, 0, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getPassiveResource_ResourceTimeoutFailureType__PassiveResource(), theReliability_pc_avPackage.getResourceTimeoutFailureType(), theReliability_pc_avPackage.getResourceTimeoutFailureType_PassiveResource__ResourceTimeoutFailureType(), "resourceTimeoutFailureType__PassiveResource", null, 0, 1, PassiveResource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);

      initEClass(basicComponentEClass, BasicComponent.class, "BasicComponent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getBasicComponent_ServiceEffectSpecifications__BasicComponent(), theSeff_pc_avPackage.getServiceEffectSpecification(), theSeff_pc_avPackage.getServiceEffectSpecification_BasicComponent_ServiceEffectSpecification(), "serviceEffectSpecifications__BasicComponent", null, 0, -1, BasicComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getProvidedRole_ProvidingEntity_ProvidedRole(), theEntity_pc_avPackage.getInterfaceProvidingEntity(), theEntity_pc_avPackage.getInterfaceProvidingEntity_ProvidedRoles_InterfaceProvidingEntity(), "providingEntity_ProvidedRole", null, 0, 1, ProvidedRole.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getParameter_ResourceSignature__Parameter(), theResourcetype_pc_avPackage.getResourceSignature(), theResourcetype_pc_avPackage.getResourceSignature_Parameter__ResourceSignature(), "resourceSignature__Parameter", null, 0, 1, Parameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getInterface_Protocols__Interface(), theProtocol_pc_avPackage.getProtocol(), null, "protocols__Interface", null, 0, -1, Interface.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEAttribute(getRequiredCharacterisation_Type(), theParameter_pc_avPackage.getVariableCharacterisationType(), "type", null, 1, 1, RequiredCharacterisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
      ...
      initEReference(getSignature_FailureType(), theReliability_pc_avPackage.getFailureType(), null, "failureType", null, 0, -1, Signature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
