 ...
 * @generated
 */
public class Resourcetype_pc_avSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourcetype_pc_avSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourcetype_pc_avPackage.RESOURCE_SIGNATURE: {
         ...
         case Resourcetype_pc_avPackage.PROCESSING_RESOURCE_TYPE: {
         ...
         case Resourcetype_pc_avPackage.RESOURCE_TYPE: {
         ...
         case Resourcetype_pc_avPackage.COMMUNICATION_LINK_RESOURCE_TYPE: {
         ...
         case Resourcetype_pc_avPackage.RESOURCE_INTERFACE: {
