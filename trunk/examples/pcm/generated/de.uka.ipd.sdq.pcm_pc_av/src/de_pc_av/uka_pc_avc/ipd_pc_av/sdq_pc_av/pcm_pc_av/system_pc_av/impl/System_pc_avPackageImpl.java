 ...
 * @generated
 */
public class System_pc_avPackageImpl extends EPackageImpl implements System_pc_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System_pc_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private System_pc_avPackageImpl() {
      super(eNS_URI, System_pc_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link System_pc_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static System_pc_avPackage init() {
      if (isInited) return (System_pc_avPackage)EPackage.Registry.INSTANCE.getEPackage(System_pc_avPackage.eNS_URI);

      // Obtain or create and register package
      System_pc_avPackageImpl theSystem_pc_avPackage = (System_pc_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof System_pc_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new System_pc_avPackageImpl());
      ...
      EValidator.Registry.INSTANCE.put
         (theSystem_pc_avPackage, 
          new EValidator.Descriptor() {
             public EValidator getEValidator() {
                return System_pc_avValidator.INSTANCE;
             }
          });

      // Mark meta-data to indicate it can't be changed
      theSystem_pc_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(System_pc_avPackage.eNS_URI, theSystem_pc_avPackage);
      return theSystem_pc_avPackage;
   }
    ...
    * @generated
    */
   public System_pc_avFactory getSystem_pc_avFactory() {
      return (System_pc_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      systemEClass.getESuperTypes().add(theEntity_pc_avPackage.getEntity());
      systemEClass.getESuperTypes().add(theEntity_pc_avPackage.getComposedProvidingRequiringEntity());

      // Initialize classes and features; add operations and parameters
      initEClass(systemEClass, de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
      initEReference(getSystem_QosAnnotations_System(), theQosannotations_pc_avPackage.getQoSAnnotations(), theQosannotations_pc_avPackage.getQoSAnnotations_System_QoSAnnotations(), "qosAnnotations_System", null, 0, -1, de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
