 ...
 * @generated
 */
public class System_pc_avAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static System_pc_avPackage modelPackage;
    ...
    * @generated
    */
   public System_pc_avAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = System_pc_avPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected System_pc_avSwitch<Adapter> modelSwitch =
      new System_pc_avSwitch<Adapter>() {
         @Override
         public Adapter caseSystem(de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System object) {
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.system_pc_av.System <em>System</em>}'.
    * <!-- begin-user-doc -->
