 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.impl.BranchImpl#getBranchTransitions_Branch <em>Branch Transitions Branch</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BranchImpl extends AbstractUserActionImpl implements Branch {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pc_avPackage.Literals.BRANCH;
   }
   ...
   public EList<BranchTransition> getBranchTransitions_Branch() {
      if (branchTransitions_Branch == null) {
         branchTransitions_Branch = new EObjectContainmentWithInverseEList<BranchTransition>(BranchTransition.class, this, Usagemodel_pc_avPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH, Usagemodel_pc_avPackage.BRANCH_TRANSITION__BRANCH_BRANCH_TRANSITION);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Usagemodel_pc_avValidator.BRANCH__ALL_BRANCH_PROBABILITIES_MUST_SUM_UP_TO1,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pc_avPackage.BRANCH__BRANCH_TRANSITIONS_BRANCH:
