 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.impl.LoopImpl#getLoopIteration_Loop <em>Loop Iteration Loop</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.impl.LoopImpl#getBodyBehaviour_Loop <em>Body Behaviour Loop</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LoopImpl extends AbstractUserActionImpl implements Loop {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pc_avPackage.Literals.LOOP;
   }
   ...
   public NotificationChain basicSetLoopIteration_Loop(PCMRandomVariable newLoopIteration_Loop, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Usagemodel_pc_avPackage.LOOP__LOOP_ITERATION_LOOP, oldLoopIteration_Loop, newLoopIteration_Loop);
   ...
   public void setLoopIteration_Loop(PCMRandomVariable newLoopIteration_Loop) {
      if (newLoopIteration_Loop != loopIteration_Loop) {
         ...
         if (loopIteration_Loop != null)
            msgs = ((InternalEObject)loopIteration_Loop).eInverseRemove(this, Core_pc_avPackage.PCM_RANDOM_VARIABLE__LOOP_LOOP_ITERATION, PCMRandomVariable.class, msgs);
         if (newLoopIteration_Loop != null)
            msgs = ((InternalEObject)newLoopIteration_Loop).eInverseAdd(this, Core_pc_avPackage.PCM_RANDOM_VARIABLE__LOOP_LOOP_ITERATION, PCMRandomVariable.class, msgs);
         msgs = basicSetLoopIteration_Loop(newLoopIteration_Loop, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pc_avPackage.LOOP__LOOP_ITERATION_LOOP, newLoopIteration_Loop, newLoopIteration_Loop));
   }
   ...
   public NotificationChain basicSetBodyBehaviour_Loop(ScenarioBehaviour newBodyBehaviour_Loop, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Usagemodel_pc_avPackage.LOOP__BODY_BEHAVIOUR_LOOP, oldBodyBehaviour_Loop, newBodyBehaviour_Loop);
         if (msgs == null) msgs = notification; else msgs.add(notification);
      }
      return msgs;
   }
   ...
   public void setBodyBehaviour_Loop(ScenarioBehaviour newBodyBehaviour_Loop) {
      if (newBodyBehaviour_Loop != bodyBehaviour_Loop) {
         ...
         if (bodyBehaviour_Loop != null)
            msgs = ((InternalEObject)bodyBehaviour_Loop).eInverseRemove(this, Usagemodel_pc_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
         if (newBodyBehaviour_Loop != null)
            msgs = ((InternalEObject)newBodyBehaviour_Loop).eInverseAdd(this, Usagemodel_pc_avPackage.SCENARIO_BEHAVIOUR__LOOP_SCENARIO_BEHAVIOUR, ScenarioBehaviour.class, msgs);
         msgs = basicSetBodyBehaviour_Loop(newBodyBehaviour_Loop, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pc_avPackage.LOOP__BODY_BEHAVIOUR_LOOP, newBodyBehaviour_Loop, newBodyBehaviour_Loop));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pc_avPackage.LOOP__LOOP_ITERATION_LOOP:
            if (loopIteration_Loop != null)
               msgs = ((InternalEObject)loopIteration_Loop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Usagemodel_pc_avPackage.LOOP__LOOP_ITERATION_LOOP, null, msgs);
            return basicSetLoopIteration_Loop((PCMRandomVariable)otherEnd, msgs);
         case Usagemodel_pc_avPackage.LOOP__BODY_BEHAVIOUR_LOOP:
            if (bodyBehaviour_Loop != null)
               msgs = ((InternalEObject)bodyBehaviour_Loop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Usagemodel_pc_avPackage.LOOP__BODY_BEHAVIOUR_LOOP, null, msgs);
