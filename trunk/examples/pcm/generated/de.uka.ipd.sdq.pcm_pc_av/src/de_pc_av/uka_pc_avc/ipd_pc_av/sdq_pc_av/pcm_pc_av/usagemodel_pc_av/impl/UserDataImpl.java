 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.impl.UserDataImpl#getAssemblyContext_userData <em>Assembly Context user Data</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.impl.UserDataImpl#getUsageModel_UserData <em>Usage Model User Data</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_avc.ipd_pc_av.sdq_pc_av.pcm_pc_av.usagemodel_pc_av.impl.UserDataImpl#getUserDataParameterUsages_UserData <em>User Data Parameter Usages User Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserDataImpl extends EObjectImpl implements UserData {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pc_avPackage.Literals.USER_DATA;
   }
      ...
      if (assemblyContext_userData != null && assemblyContext_userData.eIsProxy()) {
         ...
         if (assemblyContext_userData != oldAssemblyContext_userData) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Usagemodel_pc_avPackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA, oldAssemblyContext_userData, assemblyContext_userData));
         }
      }
   ...
   public void setAssemblyContext_userData(AssemblyContext newAssemblyContext_userData) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pc_avPackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA, oldAssemblyContext_userData, assemblyContext_userData));
   }
   ...
   public UsageModel getUsageModel_UserData() {
      if (eContainerFeatureID() != Usagemodel_pc_avPackage.USER_DATA__USAGE_MODEL_USER_DATA) return null;
   ...
   public NotificationChain basicSetUsageModel_UserData(UsageModel newUsageModel_UserData, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUsageModel_UserData, Usagemodel_pc_avPackage.USER_DATA__USAGE_MODEL_USER_DATA, msgs);
      return msgs;
   }
   ...
   public void setUsageModel_UserData(UsageModel newUsageModel_UserData) {
      if (newUsageModel_UserData != eInternalContainer() || (eContainerFeatureID() != Usagemodel_pc_avPackage.USER_DATA__USAGE_MODEL_USER_DATA && newUsageModel_UserData != null)) {
         ...
         if (newUsageModel_UserData != null)
            msgs = ((InternalEObject)newUsageModel_UserData).eInverseAdd(this, Usagemodel_pc_avPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, UsageModel.class, msgs);
         msgs = basicSetUsageModel_UserData(newUsageModel_UserData, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pc_avPackage.USER_DATA__USAGE_MODEL_USER_DATA, newUsageModel_UserData, newUsageModel_UserData));
   }
   ...
   public EList<VariableUsage> getUserDataParameterUsages_UserData() {
      if (userDataParameterUsages_UserData == null) {
         userDataParameterUsages_UserData = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Usagemodel_pc_avPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA, Parameter_pc_avPackage.VARIABLE_USAGE__USER_DATA_VARIABLE_USAGE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pc_avPackage.USER_DATA__USAGE_MODEL_USER_DATA:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetUsageModel_UserData((UsageModel)otherEnd, msgs);
         case Usagemodel_pc_avPackage.USER_DATA__USER_DATA_PARAMETER_USAGES_USER_DATA:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_pc_avPackage.USER_DATA__USAGE_MODEL_USER_DATA:
            return eInternalContainer().eInverseRemove(this, Usagemodel_pc_avPackage.USAGE_MODEL__USER_DATA_USAGE_MODEL, UsageModel.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Usagemodel_pc_avPackage.USER_DATA__ASSEMBLY_CONTEXT_USER_DATA:
