 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.completions_pc_pc.impl.CompletionRepositoryImpl#getCompletions_CompletionRepository <em>Completions Completion Repository</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompletionRepositoryImpl extends EObjectImpl implements CompletionRepository {
   ...
   protected EClass eStaticClass() {
      return Completions_pc_pcPackage.Literals.COMPLETION_REPOSITORY;
   }
   ...
   public EList<Completion> getCompletions_CompletionRepository() {
      if (completions_CompletionRepository == null) {
         completions_CompletionRepository = new EObjectContainmentEList<Completion>(Completion.class, this, Completions_pc_pcPackage.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY);
      }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Completions_pc_pcPackage.COMPLETION_REPOSITORY__COMPLETIONS_COMPLETION_REPOSITORY:
