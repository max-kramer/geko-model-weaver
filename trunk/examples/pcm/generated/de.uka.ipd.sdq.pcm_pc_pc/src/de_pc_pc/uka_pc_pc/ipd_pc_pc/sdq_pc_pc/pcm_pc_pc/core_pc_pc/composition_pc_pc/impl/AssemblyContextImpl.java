 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.core_pc_pc.composition_pc_pc.impl.AssemblyContextImpl#getParentStructure__AssemblyContext <em>Parent Structure Assembly Context</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.core_pc_pc.composition_pc_pc.impl.AssemblyContextImpl#getEncapsulatedComponent__AssemblyContext <em>Encapsulated Component Assembly Context</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.core_pc_pc.composition_pc_pc.impl.AssemblyContextImpl#getConfigParameterUsages__AssemblyContext <em>Config Parameter Usages Assembly Context</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AssemblyContextImpl extends EntityImpl implements AssemblyContext {
   ...
   protected EClass eStaticClass() {
      return Composition_pc_pcPackage.Literals.ASSEMBLY_CONTEXT;
   }
   ...
   public ComposedStructure getParentStructure__AssemblyContext() {
      if (eContainerFeatureID() != Composition_pc_pcPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT) return null;
   ...
   public NotificationChain basicSetParentStructure__AssemblyContext(ComposedStructure newParentStructure__AssemblyContext, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newParentStructure__AssemblyContext, Composition_pc_pcPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT, msgs);
      return msgs;
   }
   ...
   public void setParentStructure__AssemblyContext(ComposedStructure newParentStructure__AssemblyContext) {
      if (newParentStructure__AssemblyContext != eInternalContainer() || (eContainerFeatureID() != Composition_pc_pcPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT && newParentStructure__AssemblyContext != null)) {
         ...
         if (newParentStructure__AssemblyContext != null)
            msgs = ((InternalEObject)newParentStructure__AssemblyContext).eInverseAdd(this, Composition_pc_pcPackage.COMPOSED_STRUCTURE__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE, ComposedStructure.class, msgs);
         msgs = basicSetParentStructure__AssemblyContext(newParentStructure__AssemblyContext, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_pc_pcPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT, newParentStructure__AssemblyContext, newParentStructure__AssemblyContext));
   }
      ...
      if (encapsulatedComponent__AssemblyContext != null && encapsulatedComponent__AssemblyContext.eIsProxy()) {
         ...
         if (encapsulatedComponent__AssemblyContext != oldEncapsulatedComponent__AssemblyContext) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Composition_pc_pcPackage.ASSEMBLY_CONTEXT__ENCAPSULATED_COMPONENT_ASSEMBLY_CONTEXT, oldEncapsulatedComponent__AssemblyContext, encapsulatedComponent__AssemblyContext));
         }
      }
   ...
   public void setEncapsulatedComponent__AssemblyContext(RepositoryComponent newEncapsulatedComponent__AssemblyContext) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Composition_pc_pcPackage.ASSEMBLY_CONTEXT__ENCAPSULATED_COMPONENT_ASSEMBLY_CONTEXT, oldEncapsulatedComponent__AssemblyContext, encapsulatedComponent__AssemblyContext));
   }
   ...
   public EList<VariableUsage> getConfigParameterUsages__AssemblyContext() {
      if (configParameterUsages__AssemblyContext == null) {
         configParameterUsages__AssemblyContext = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Composition_pc_pcPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT, Parameter_pc_pcPackage.VARIABLE_USAGE__ASSEMBLY_CONTEXT_VARIABLE_USAGE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Composition_pc_pcPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
            return basicSetParentStructure__AssemblyContext((ComposedStructure)otherEnd, msgs);
         case Composition_pc_pcPackage.ASSEMBLY_CONTEXT__CONFIG_PARAMETER_USAGES_ASSEMBLY_CONTEXT:
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Composition_pc_pcPackage.ASSEMBLY_CONTEXT__PARENT_STRUCTURE_ASSEMBLY_CONTEXT:
            return eInternalContainer().eInverseRemove(this, Composition_pc_pcPackage.COMPOSED_STRUCTURE__ASSEMBLY_CONTEXTS_COMPOSED_STRUCTURE, ComposedStructure.class, msgs);
      }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Composition_pc_pcPackage.ASSEMBLY_CONTEXT__ENCAPSULATED_COMPONENT_ASSEMBLY_CONTEXT:
