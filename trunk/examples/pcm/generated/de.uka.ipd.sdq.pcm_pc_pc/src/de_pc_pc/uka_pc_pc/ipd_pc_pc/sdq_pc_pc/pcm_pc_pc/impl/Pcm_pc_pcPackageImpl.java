...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.DummyClass;
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.Pcm_pc_pcFactory;
...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.PointcutPointcut;
 ...
 * @generated
 */
public class Pcm_pc_pcPackageImpl extends EPackageImpl implements Pcm_pc_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.Pcm_pc_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Pcm_pc_pcPackageImpl() {
      super(eNS_URI, Pcm_pc_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Pcm_pc_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Pcm_pc_pcPackage init() {
      if (isInited) return (Pcm_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Pcm_pc_pcPackage.eNS_URI);

      // Obtain or create and register package
      Pcm_pc_pcPackageImpl thePcm_pc_pcPackage = (Pcm_pc_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Pcm_pc_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Pcm_pc_pcPackageImpl());
      ...
      thePcm_pc_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Pcm_pc_pcPackage.eNS_URI, thePcm_pc_pcPackage);
      return thePcm_pc_pcPackage;
   }
    ...
    * @generated
    */
   public Pcm_pc_pcFactory getPcm_pc_pcFactory() {
      return (Pcm_pc_pcFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      Allocation_pc_pcPackage theAllocation_pc_pcPackage = (Allocation_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Allocation_pc_pcPackage.eNS_URI);
      Subsystem_pc_pcPackage theSubsystem_pc_pcPackage = (Subsystem_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Subsystem_pc_pcPackage.eNS_URI);
      Completions_pc_pcPackage theCompletions_pc_pcPackage = (Completions_pc_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Completions_pc_pcPackage.eNS_URI);

      // Add subpackages
      getESubpackages().add(theCore_pc_pcPackage);
      getESubpackages().add(theUsagemodel_pc_pcPackage);
      getESubpackages().add(theRepository_pc_pcPackage);
      getESubpackages().add(theResourcetype_pc_pcPackage);
      getESubpackages().add(theProtocol_pc_pcPackage);
      getESubpackages().add(theParameter_pc_pcPackage);
      getESubpackages().add(theReliability_pc_pcPackage);
      getESubpackages().add(theSeff_pc_pcPackage);
      getESubpackages().add(theQosannotations_pc_pcPackage);
      getESubpackages().add(theSystem_pc_pcPackage);
      getESubpackages().add(theResourceenvironment_pc_pcPackage);
      getESubpackages().add(theAllocation_pc_pcPackage);
      getESubpackages().add(theSubsystem_pc_pcPackage);
      getESubpackages().add(theCompletions_pc_pcPackage);
