...
import de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.VariableImpl;
 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.parameter_pc_pc.impl.CharacterisedVariableImpl#getCharacterisationType <em>Characterisation Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CharacterisedVariableImpl extends VariableImpl implements CharacterisedVariable {
   ...
   protected EClass eStaticClass() {
      return Parameter_pc_pcPackage.Literals.CHARACTERISED_VARIABLE;
   }
   ...
   public void setCharacterisationType(VariableCharacterisationType newCharacterisationType) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Parameter_pc_pcPackage.CHARACTERISED_VARIABLE__CHARACTERISATION_TYPE, oldCharacterisationType, characterisationType));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Parameter_pc_pcPackage.CHARACTERISED_VARIABLE__CHARACTERISATION_TYPE:
