 ...
 * @generated
 */
public class Qosannotations_pc_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   protected static Qosannotations_pc_pcPackage modelPackage;
    ...
    * @generated
    */
   public Qosannotations_pc_pcAdapterFactory() {
      if (modelPackage == null) {
         modelPackage = Qosannotations_pc_pcPackage.eINSTANCE;
      }
   }
    ...
    * @generated
    */
   protected Qosannotations_pc_pcSwitch<Adapter> modelSwitch =
      new Qosannotations_pc_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.qosannotations_pc_pc.QoSAnnotations <em>Qo SAnnotations</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.qosannotations_pc_pc.SpecifiedOutputParameterAbstraction <em>Specified Output Parameter Abstraction</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Qosannotations_pc_pcAdapterFactory
