 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.OperationInterfaceImpl#getSignatures__OperationInterface <em>Signatures Operation Interface</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationInterfaceImpl extends InterfaceImpl implements OperationInterface {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_pcPackage.Literals.OPERATION_INTERFACE;
   }
   ...
   public EList<OperationSignature> getSignatures__OperationInterface() {
      if (signatures__OperationInterface == null) {
         signatures__OperationInterface = new EObjectContainmentWithInverseEList<OperationSignature>(OperationSignature.class, this, Repository_pc_pcPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE, Repository_pc_pcPackage.OPERATION_SIGNATURE__INTERFACE_OPERATION_SIGNATURE);
      }
            ...
            diagnostics.add
               (new BasicDiagnostic
                  (Diagnostic.ERROR,
                   ...
                   Repository_pc_pcValidator.OPERATION_INTERFACE__SIGNATURES_HAVE_TO_BE_UNIQUE_FOR_AN_INTERFACE,
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_pcPackage.OPERATION_INTERFACE__SIGNATURES_OPERATION_INTERFACE:
