 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.OperationProvidedRoleImpl#getProvidedInterface__OperationProvidedRole <em>Provided Interface Operation Provided Role</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationProvidedRoleImpl extends ProvidedRoleImpl implements OperationProvidedRole {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_pcPackage.Literals.OPERATION_PROVIDED_ROLE;
   }
      ...
      if (providedInterface__OperationProvidedRole != null && providedInterface__OperationProvidedRole.eIsProxy()) {
         ...
         if (providedInterface__OperationProvidedRole != oldProvidedInterface__OperationProvidedRole) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Repository_pc_pcPackage.OPERATION_PROVIDED_ROLE__PROVIDED_INTERFACE_OPERATION_PROVIDED_ROLE, oldProvidedInterface__OperationProvidedRole, providedInterface__OperationProvidedRole));
         }
      }
   ...
   public void setProvidedInterface__OperationProvidedRole(OperationInterface newProvidedInterface__OperationProvidedRole) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Repository_pc_pcPackage.OPERATION_PROVIDED_ROLE__PROVIDED_INTERFACE_OPERATION_PROVIDED_ROLE, oldProvidedInterface__OperationProvidedRole, providedInterface__OperationProvidedRole));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Repository_pc_pcPackage.OPERATION_PROVIDED_ROLE__PROVIDED_INTERFACE_OPERATION_PROVIDED_ROLE:
