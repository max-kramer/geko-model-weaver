 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.SignatureImpl#getExceptions__Signature <em>Exceptions Signature</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.repository_pc_pc.impl.SignatureImpl#getFailureType <em>Failure Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SignatureImpl extends EntityImpl implements Signature {
   ...
   protected EClass eStaticClass() {
      return Repository_pc_pcPackage.Literals.SIGNATURE;
   }
   ...
   public EList<ExceptionType> getExceptions__Signature() {
      if (exceptions__Signature == null) {
         exceptions__Signature = new EObjectContainmentEList<ExceptionType>(ExceptionType.class, this, Repository_pc_pcPackage.SIGNATURE__EXCEPTIONS_SIGNATURE);
      }
   ...
   public EList<FailureType> getFailureType() {
      if (failureType == null) {
         failureType = new EObjectResolvingEList<FailureType>(FailureType.class, this, Repository_pc_pcPackage.SIGNATURE__FAILURE_TYPE);
      }
      return failureType;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Repository_pc_pcPackage.SIGNATURE__EXCEPTIONS_SIGNATURE:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         ...
         case Repository_pc_pcPackage.SIGNATURE__FAILURE_TYPE:
