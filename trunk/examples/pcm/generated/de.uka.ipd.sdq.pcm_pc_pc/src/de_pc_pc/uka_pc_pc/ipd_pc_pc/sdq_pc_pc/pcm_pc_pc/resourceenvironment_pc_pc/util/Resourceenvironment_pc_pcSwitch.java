 ...
 * @generated
 */
public class Resourceenvironment_pc_pcSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourceenvironment_pc_pcSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourceenvironment_pc_pcPackage.RESOURCE_ENVIRONMENT: {
         ...
         case Resourceenvironment_pc_pcPackage.LINKING_RESOURCE: {
         ...
         case Resourceenvironment_pc_pcPackage.RESOURCE_CONTAINER: {
         ...
         case Resourceenvironment_pc_pcPackage.PROCESSING_RESOURCE_SPECIFICATION: {
         ...
         case Resourceenvironment_pc_pcPackage.COMMUNICATION_LINK_RESOURCE_SPECIFICATION: {
...
} //Resourceenvironment_pc_pcSwitch
