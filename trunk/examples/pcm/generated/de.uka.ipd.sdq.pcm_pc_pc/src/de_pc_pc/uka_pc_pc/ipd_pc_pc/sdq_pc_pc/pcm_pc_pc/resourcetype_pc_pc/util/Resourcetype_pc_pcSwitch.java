 ...
 * @generated
 */
public class Resourcetype_pc_pcSwitch<T> extends Switch<T> {
   /**
    ...
    * @generated
    */
   public Resourcetype_pc_pcSwitch() {
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Resourcetype_pc_pcPackage.RESOURCE_SIGNATURE: {
         ...
         case Resourcetype_pc_pcPackage.PROCESSING_RESOURCE_TYPE: {
         ...
         case Resourcetype_pc_pcPackage.RESOURCE_TYPE: {
         ...
         case Resourcetype_pc_pcPackage.COMMUNICATION_LINK_RESOURCE_TYPE: {
         ...
         case Resourcetype_pc_pcPackage.RESOURCE_INTERFACE: {
