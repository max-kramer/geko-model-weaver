 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.seff_pc_pc.impl.CallActionImpl#getInputVariableUsages__CallAction <em>Input Variable Usages Call Action</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CallActionImpl extends EObjectImpl implements CallAction {
   ...
   protected EClass eStaticClass() {
      return Seff_pc_pcPackage.Literals.CALL_ACTION;
   }
   ...
   public EList<VariableUsage> getInputVariableUsages__CallAction() {
      if (inputVariableUsages__CallAction == null) {
         inputVariableUsages__CallAction = new EObjectContainmentWithInverseEList<VariableUsage>(VariableUsage.class, this, Seff_pc_pcPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION, Parameter_pc_pcPackage.VARIABLE_USAGE__CALL_ACTION_VARIABLE_USAGE);
      }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Seff_pc_pcPackage.CALL_ACTION__INPUT_VARIABLE_USAGES_CALL_ACTION:
