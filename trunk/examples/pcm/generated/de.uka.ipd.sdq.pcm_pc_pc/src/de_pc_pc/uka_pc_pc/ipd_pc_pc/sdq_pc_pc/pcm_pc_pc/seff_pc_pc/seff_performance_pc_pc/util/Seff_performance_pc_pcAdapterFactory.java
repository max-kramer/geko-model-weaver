 ...
 * @generated
 */
public class Seff_performance_pc_pcAdapterFactory extends AdapterFactoryImpl {
   /**
    ...
    * @generated
    */
   public Seff_performance_pc_pcAdapterFactory() {
    ...
    * @generated
    */
   protected Seff_performance_pc_pcSwitch<Adapter> modelSwitch =
      new Seff_performance_pc_pcSwitch<Adapter>() {
         @Override
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.seff_pc_pc.seff_performance_pc_pc.InfrastructureCall <em>Infrastructure Call</em>}'.
    * <!-- begin-user-doc -->
   ...
   /**
    * Creates a new adapter for an object of class '{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.seff_pc_pc.seff_performance_pc_pc.ResourceCall <em>Resource Call</em>}'.
    * <!-- begin-user-doc -->
    * This default implementation returns null so that we can easily ignore cases;
    * it's useful to ignore a case when inheritance will catch all the cases anyway.
    * <!-- end-user-doc -->
...
} //Seff_performance_pc_pcAdapterFactory
