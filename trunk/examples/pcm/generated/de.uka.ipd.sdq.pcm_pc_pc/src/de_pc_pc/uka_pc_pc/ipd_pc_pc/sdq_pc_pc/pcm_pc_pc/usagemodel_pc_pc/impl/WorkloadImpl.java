 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.usagemodel_pc_pc.impl.WorkloadImpl#getUsageScenario_Workload <em>Usage Scenario Workload</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WorkloadImpl extends EObjectImpl implements Workload {
   ...
   protected EClass eStaticClass() {
      return Usagemodel_pc_pcPackage.Literals.WORKLOAD;
   }
   ...
   public UsageScenario getUsageScenario_Workload() {
      if (eContainerFeatureID() != Usagemodel_pc_pcPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD) return null;
   ...
   public NotificationChain basicSetUsageScenario_Workload(UsageScenario newUsageScenario_Workload, NotificationChain msgs) {
      msgs = eBasicSetContainer((InternalEObject)newUsageScenario_Workload, Usagemodel_pc_pcPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, msgs);
      return msgs;
   }
   ...
   public void setUsageScenario_Workload(UsageScenario newUsageScenario_Workload) {
      if (newUsageScenario_Workload != eInternalContainer() || (eContainerFeatureID() != Usagemodel_pc_pcPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD && newUsageScenario_Workload != null)) {
         ...
         if (newUsageScenario_Workload != null)
            msgs = ((InternalEObject)newUsageScenario_Workload).eInverseAdd(this, Usagemodel_pc_pcPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, UsageScenario.class, msgs);
         msgs = basicSetUsageScenario_Workload(newUsageScenario_Workload, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Usagemodel_pc_pcPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD, newUsageScenario_Workload, newUsageScenario_Workload));
   }
   ...
   public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Usagemodel_pc_pcPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD:
            if (eInternalContainer() != null)
               msgs = eBasicRemoveFromContainer(msgs);
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case Usagemodel_pc_pcPackage.WORKLOAD__USAGE_SCENARIO_WORKLOAD:
            return eInternalContainer().eInverseRemove(this, Usagemodel_pc_pcPackage.USAGE_SCENARIO__WORKLOAD_USAGE_SCENARIO, UsageScenario.class, msgs);
      }
