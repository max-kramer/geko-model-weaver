 ...
 * @generated
 */
public class Usagemodel_pc_pcValidator extends EObjectValidator {
   /**
    ...
    * @generated
    */
   public static final Usagemodel_pc_pcValidator INSTANCE = new Usagemodel_pc_pcValidator();
    ...
    * @generated
    */
   public static final String DIAGNOSTIC_SOURCE = "de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.pcm_pc_pc.usagemodel_pc_pc";
    ...
    * @generated
    */
   public Usagemodel_pc_pcValidator() {
      super();
   ...
   public boolean validateUsageScenario(UsageScenario usageScenario, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(usageScenario, diagnostics, context);
      return result;
   }
   ...
   public boolean validateEntryLevelSystemCall(EntryLevelSystemCall entryLevelSystemCall, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(entryLevelSystemCall, diagnostics, context);
   ...
   public boolean validateAbstractUserAction(AbstractUserAction abstractUserAction, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(abstractUserAction, diagnostics, context);
      return result;
   }
   ...
   public boolean validateScenarioBehaviour(ScenarioBehaviour scenarioBehaviour, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(scenarioBehaviour, diagnostics, context);
   ...
   public boolean validateBranch(Branch branch, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(branch, diagnostics, context);
   ...
   public boolean validateLoop(Loop loop, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(loop, diagnostics, context);
      return result;
   }
   ...
   public boolean validateStop(Stop stop, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(stop, diagnostics, context);
   ...
   public boolean validateStart(Start start, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(start, diagnostics, context);
   ...
   public boolean validateDelay(Delay delay, DiagnosticChain diagnostics, Map<Object, Object> context) {
      ...
      if (result || diagnostics != null) result &= identifier_pc_pcValidator.validateIdentifier_idHasToBeUnique(delay, diagnostics, context);
      return result;
   }
