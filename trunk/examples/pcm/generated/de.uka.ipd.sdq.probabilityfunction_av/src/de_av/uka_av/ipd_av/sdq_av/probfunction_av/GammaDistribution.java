 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.GammaDistribution#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.GammaDistribution#getTheta <em>Theta</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.probfunction_av.Probfunction_avPackage#getGammaDistribution()
 * @model
 * @generated
 */
public interface GammaDistribution extends ContinuousPDF {
    ...
    * @see #setAlpha(double)
    * @see de_av.uka_av.ipd_av.sdq_av.probfunction_av.Probfunction_avPackage#getGammaDistribution_Alpha()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.GammaDistribution#getAlpha <em>Alpha</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see #setTheta(double)
    * @see de_av.uka_av.ipd_av.sdq_av.probfunction_av.Probfunction_avPackage#getGammaDistribution_Theta()
    * @model required="true" ordered="false"
    * @generated
    */
   double getTheta();
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.GammaDistribution#getTheta <em>Theta</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
