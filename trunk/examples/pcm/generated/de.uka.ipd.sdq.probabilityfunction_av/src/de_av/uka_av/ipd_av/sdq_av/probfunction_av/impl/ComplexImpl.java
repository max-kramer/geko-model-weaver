 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.impl.ComplexImpl#getReal <em>Real</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.probfunction_av.impl.ComplexImpl#getImaginary <em>Imaginary</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexImpl extends EObjectImpl implements Complex {
   ...
   protected EClass eStaticClass() {
      return Probfunction_avPackage.Literals.COMPLEX;
   }
   ...
   public void setReal(double newReal) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_avPackage.COMPLEX__REAL, oldReal, real));
   }
   ...
   public void setImaginary(double newImaginary) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_avPackage.COMPLEX__IMAGINARY, oldImaginary, imaginary));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_avPackage.COMPLEX__REAL:
            return getReal();
         case Probfunction_avPackage.COMPLEX__IMAGINARY:
            return getImaginary();
      }
