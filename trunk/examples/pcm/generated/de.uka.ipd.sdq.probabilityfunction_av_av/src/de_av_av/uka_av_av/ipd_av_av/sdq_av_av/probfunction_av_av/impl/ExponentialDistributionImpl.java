 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.probfunction_av_av.impl.ExponentialDistributionImpl#getRate <em>Rate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExponentialDistributionImpl extends ContinuousPDFImpl implements ExponentialDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_avPackage.Literals.EXPONENTIAL_DISTRIBUTION;
   }
   ...
   public void setRate(double newRate) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_avPackage.EXPONENTIAL_DISTRIBUTION__RATE, oldRate, rate));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_avPackage.EXPONENTIAL_DISTRIBUTION__RATE:
            return getRate();
      }
