 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.probfunction_av_pc.impl.BoxedPDFImpl#getSamples <em>Samples</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BoxedPDFImpl extends ProbabilityDensityFunctionImpl implements BoxedPDF {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_pcPackage.Literals.BOXED_PDF;
   }
   ...
   public EList<ContinuousSample> getSamples() {
      if (samples == null) {
         samples = new EObjectContainmentEList<ContinuousSample>(ContinuousSample.class, this, Probfunction_av_pcPackage.BOXED_PDF__SAMPLES);
      }
      return samples;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Probfunction_av_pcPackage.BOXED_PDF__SAMPLES:
