 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.probfunction_av_pc.impl.ExponentialDistributionImpl#getRate <em>Rate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExponentialDistributionImpl extends ContinuousPDFImpl implements ExponentialDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_pcPackage.Literals.EXPONENTIAL_DISTRIBUTION;
   }
   ...
   public void setRate(double newRate) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_pcPackage.EXPONENTIAL_DISTRIBUTION__RATE, oldRate, rate));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_pcPackage.EXPONENTIAL_DISTRIBUTION__RATE:
            return getRate();
      }
