 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.probfunction_av_pc.impl.GammaDistributionImpl#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.probfunction_av_pc.impl.GammaDistributionImpl#getTheta <em>Theta</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GammaDistributionImpl extends ContinuousPDFImpl implements GammaDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_pcPackage.Literals.GAMMA_DISTRIBUTION;
   }
   ...
   public void setAlpha(double newAlpha) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_pcPackage.GAMMA_DISTRIBUTION__ALPHA, oldAlpha, alpha));
   }
   ...
   public void setTheta(double newTheta) {
      ...
      theta = newTheta;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_pcPackage.GAMMA_DISTRIBUTION__THETA, oldTheta, theta));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_pcPackage.GAMMA_DISTRIBUTION__ALPHA:
            return getAlpha();
         case Probfunction_av_pcPackage.GAMMA_DISTRIBUTION__THETA:
            return getTheta();
      }
