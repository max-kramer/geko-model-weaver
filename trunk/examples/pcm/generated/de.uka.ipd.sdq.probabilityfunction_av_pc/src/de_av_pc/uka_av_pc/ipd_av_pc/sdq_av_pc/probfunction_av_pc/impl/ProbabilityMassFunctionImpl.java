 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.probfunction_av_pc.impl.ProbabilityMassFunctionImpl#getSamples <em>Samples</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.probfunction_av_pc.impl.ProbabilityMassFunctionImpl#isOrderedDomain <em>Ordered Domain</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProbabilityMassFunctionImpl extends ProbabilityFunctionImpl implements ProbabilityMassFunction {
   ...
   protected EClass eStaticClass() {
      return Probfunction_av_pcPackage.Literals.PROBABILITY_MASS_FUNCTION;
   }
   ...
   public EList<Sample> getSamples() {
      if (samples == null) {
         samples = new EObjectContainmentEList<Sample>(Sample.class, this, Probfunction_av_pcPackage.PROBABILITY_MASS_FUNCTION__SAMPLES);
      }
      return samples;
   }
   ...
   public void setOrderedDomain(boolean newOrderedDomain) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_av_pcPackage.PROBABILITY_MASS_FUNCTION__ORDERED_DOMAIN, oldOrderedDomain, orderedDomain));
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Probfunction_av_pcPackage.PROBABILITY_MASS_FUNCTION__SAMPLES:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_av_pcPackage.PROBABILITY_MASS_FUNCTION__SAMPLES:
            return getSamples();
         case Probfunction_av_pcPackage.PROBABILITY_MASS_FUNCTION__ORDERED_DOMAIN:
