 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.GammaDistribution#getAlpha <em>Alpha</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.GammaDistribution#getTheta <em>Theta</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Probfunction_pcPackage#getGammaDistribution()
 * @model
 * @generated
 */
public interface GammaDistribution extends ContinuousPDF {
    ...
    * @see #setAlpha(double)
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Probfunction_pcPackage#getGammaDistribution_Alpha()
   ...
   /**
    * Sets the value of the '{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.GammaDistribution#getAlpha <em>Alpha</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    ...
    * @see #setTheta(double)
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.Probfunction_pcPackage#getGammaDistribution_Theta()
    * @model required="true" ordered="false"
    * @generated
    */
   double getTheta();
   ...
   /**
    * Sets the value of the '{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.GammaDistribution#getTheta <em>Theta</em>}' attribute.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
