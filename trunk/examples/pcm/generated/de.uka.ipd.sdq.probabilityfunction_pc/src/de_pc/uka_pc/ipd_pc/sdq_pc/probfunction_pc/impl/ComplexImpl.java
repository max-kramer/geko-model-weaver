 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.impl.ComplexImpl#getReal <em>Real</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.impl.ComplexImpl#getImaginary <em>Imaginary</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexImpl extends EObjectImpl implements Complex {
   ...
   protected EClass eStaticClass() {
      return Probfunction_pcPackage.Literals.COMPLEX;
   }
   ...
   public void setReal(double newReal) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pcPackage.COMPLEX__REAL, oldReal, real));
   }
   ...
   public void setImaginary(double newImaginary) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pcPackage.COMPLEX__IMAGINARY, oldImaginary, imaginary));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_pcPackage.COMPLEX__REAL:
            return getReal();
         case Probfunction_pcPackage.COMPLEX__IMAGINARY:
            return getImaginary();
      }
