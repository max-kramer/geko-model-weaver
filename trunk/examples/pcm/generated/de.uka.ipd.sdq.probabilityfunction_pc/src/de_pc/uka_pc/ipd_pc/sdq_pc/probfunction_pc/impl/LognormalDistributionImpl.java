 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.impl.LognormalDistributionImpl#getMu <em>Mu</em>}</li>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.probfunction_pc.impl.LognormalDistributionImpl#getSigma <em>Sigma</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LognormalDistributionImpl extends ContinuousPDFImpl implements LognormalDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_pcPackage.Literals.LOGNORMAL_DISTRIBUTION;
   }
   ...
   public void setMu(double newMu) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pcPackage.LOGNORMAL_DISTRIBUTION__MU, oldMu, mu));
   }
   ...
   public void setSigma(double newSigma) {
      ...
      sigma = newSigma;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pcPackage.LOGNORMAL_DISTRIBUTION__SIGMA, oldSigma, sigma));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_pcPackage.LOGNORMAL_DISTRIBUTION__MU:
            return getMu();
         case Probfunction_pcPackage.LOGNORMAL_DISTRIBUTION__SIGMA:
            return getSigma();
      }
