 ...
 * @generated
 */
public class Probfunction_pcSwitch<T1> extends Switch<T1> {
   /**
   ...
   protected T1 doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Probfunction_pcPackage.BOXED_PDF: {
         ...
         case Probfunction_pcPackage.PROBABILITY_DENSITY_FUNCTION: {
         ...
         case Probfunction_pcPackage.PROBABILITY_FUNCTION: {
         ...
         case Probfunction_pcPackage.SAMPLE: {
            Sample<?> sample = (Sample<?>)theEObject;
            T1 result = caseSample(sample);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_pcPackage.SAMPLE_PDF: {
         ...
         case Probfunction_pcPackage.COMPLEX: {
            Complex complex = (Complex)theEObject;
            T1 result = caseComplex(complex);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Probfunction_pcPackage.CONTINUOUS_PDF: {
         ...
         case Probfunction_pcPackage.EXPONENTIAL_DISTRIBUTION: {
         ...
         case Probfunction_pcPackage.NORMAL_DISTRIBUTION: {
         ...
         case Probfunction_pcPackage.LOGNORMAL_DISTRIBUTION: {
         ...
         case Probfunction_pcPackage.GAMMA_DISTRIBUTION: {
         ...
         case Probfunction_pcPackage.POINTCUT: {
