 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.impl.NormalDistributionImpl#getMu <em>Mu</em>}</li>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.probfunction_pc_pc.impl.NormalDistributionImpl#getSigma <em>Sigma</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NormalDistributionImpl extends ContinuousPDFImpl implements NormalDistribution {
   ...
   protected EClass eStaticClass() {
      return Probfunction_pc_pcPackage.Literals.NORMAL_DISTRIBUTION;
   }
   ...
   public void setMu(double newMu) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pc_pcPackage.NORMAL_DISTRIBUTION__MU, oldMu, mu));
   }
   ...
   public void setSigma(double newSigma) {
      ...
      sigma = newSigma;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Probfunction_pc_pcPackage.NORMAL_DISTRIBUTION__SIGMA, oldSigma, sigma));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Probfunction_pc_pcPackage.NORMAL_DISTRIBUTION__MU:
            return getMu();
         case Probfunction_pc_pcPackage.NORMAL_DISTRIBUTION__SIGMA:
            return getSigma();
      }
