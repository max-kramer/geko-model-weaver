 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.stoex_av.NegativeExpression#getInner <em>Inner</em>}</li>
 * </ul>
 * </p>
 *
 * @see de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avPackage#getNegativeExpression()
 * @model
 * @generated
 */
public interface NegativeExpression extends Unary {
    ...
    * @see #setInner(Unary)
    * @see de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avPackage#getNegativeExpression_Inner()
   ...
   /**
    * Sets the value of the '{@link de_av.uka_av.ipd_av.sdq_av.stoex_av.NegativeExpression#getInner <em>Inner</em>}' containment reference.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
