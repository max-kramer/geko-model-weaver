...
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Advice;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Atom;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.BoolLiteral;
...
import de_av.uka_av.ipd_av.sdq_av.stoex_av.CompareExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.CompareOperations;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Comparison;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.DoubleLiteral;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Expression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.FunctionLiteral;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.GlobalScope;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.IfElse;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.IfElseExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.IntLiteral;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.NamespaceReference;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.NegativeExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.NotExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.NumericLiteral;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Parenthesis;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.PerJoinPointScope;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Power;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.PowerExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.ProbabilityFunctionLiteral;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Product;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.ProductExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.ProductOperations;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.RandomVariable;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avFactory;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avPackage;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.StringLiteral;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Term;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.TermExpression;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.TermOperations;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Unary;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.Variable;
import de_av.uka_av.ipd_av.sdq_av.stoex_av.VariableReference;
 ...
 * @generated
 */
public class Stoex_avPackageImpl extends EPackageImpl implements Stoex_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.stoex_av.Stoex_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Stoex_avPackageImpl() {
      super(eNS_URI, Stoex_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Stoex_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Stoex_avPackage init() {
      if (isInited) return (Stoex_avPackage)EPackage.Registry.INSTANCE.getEPackage(Stoex_avPackage.eNS_URI);

      // Obtain or create and register package
      Stoex_avPackageImpl theStoex_avPackage = (Stoex_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Stoex_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Stoex_avPackageImpl());
      ...
      theStoex_avPackage.createPackageContents();

      // Initialize created meta-data
      theStoex_avPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theStoex_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Stoex_avPackage.eNS_URI, theStoex_avPackage);
      return theStoex_avPackage;
   }
    ...
    * @generated
    */
   public Stoex_avFactory getStoex_avFactory() {
      return (Stoex_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      Probfunction_avPackage theProbfunction_avPackage = (Probfunction_avPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_avPackage.eNS_URI);
      ...
      numericLiteralEClass.getESuperTypes().add(theUnits_avPackage.getUnitCarryingElement());
