 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.impl.AbstractNamedReferenceImpl#getReferenceName <em>Reference Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractNamedReferenceImpl extends EObjectImpl implements AbstractNamedReference {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_avPackage.Literals.ABSTRACT_NAMED_REFERENCE;
   }
   ...
   public void setReferenceName(String newReferenceName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_avPackage.ABSTRACT_NAMED_REFERENCE__REFERENCE_NAME, oldReferenceName, referenceName));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_avPackage.ABSTRACT_NAMED_REFERENCE__REFERENCE_NAME:
