 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.impl.FunctionLiteralImpl#getId <em>Id</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.impl.FunctionLiteralImpl#getParameters_FunctionLiteral <em>Parameters Function Literal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionLiteralImpl extends AtomImpl implements FunctionLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_avPackage.Literals.FUNCTION_LITERAL;
   }
   ...
   public void setId(String newId) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_avPackage.FUNCTION_LITERAL__ID, oldId, id));
   }
   ...
   public EList<Expression> getParameters_FunctionLiteral() {
      if (parameters_FunctionLiteral == null) {
         parameters_FunctionLiteral = new EObjectContainmentEList<Expression>(Expression.class, this, Stoex_av_avPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL);
      }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_av_avPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL:
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_avPackage.FUNCTION_LITERAL__ID:
            return getId();
         case Stoex_av_avPackage.FUNCTION_LITERAL__PARAMETERS_FUNCTION_LITERAL:
