 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.impl.RandomVariableImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.impl.RandomVariableImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RandomVariableImpl extends EObjectImpl implements RandomVariable {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_avPackage.Literals.RANDOM_VARIABLE;
   }
   ...
   public void setSpecification(String newSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_avPackage.RANDOM_VARIABLE__SPECIFICATION, oldSpecification, specification));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_avPackage.RANDOM_VARIABLE__SPECIFICATION:
            return getSpecification();
         case Stoex_av_avPackage.RANDOM_VARIABLE__EXPRESSION:
