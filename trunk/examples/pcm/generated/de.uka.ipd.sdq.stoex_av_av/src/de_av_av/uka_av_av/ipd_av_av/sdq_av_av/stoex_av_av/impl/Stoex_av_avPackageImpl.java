...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Advice;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.AdviceAdvice;
...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.BooleanOperations;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.BooleanOperatorExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.CompareExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.CompareOperations;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Comparison;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.DoubleLiteral;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Expression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.FunctionLiteral;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.GlobalScope;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.GlobalScopeGlobalScope;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.IfElse;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.IfElseExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.IntLiteral;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.NamespaceReference;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.NegativeExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.NotExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.NumericLiteral;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Parenthesis;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.PerJoinPointScope;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.PerJoinPointScopePerJoinPointScope;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Power;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.PowerExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.ProbabilityFunctionLiteral;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Product;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.ProductExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.ProductOperations;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.RandomVariable;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Stoex_av_avFactory;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Stoex_av_avPackage;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.StringLiteral;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Term;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.TermExpression;
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.TermOperations;
...
import de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.VariableReference;
 ...
 * @generated
 */
public class Stoex_av_avPackageImpl extends EPackageImpl implements Stoex_av_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av_av.uka_av_av.ipd_av_av.sdq_av_av.stoex_av_av.Stoex_av_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Stoex_av_avPackageImpl() {
      super(eNS_URI, Stoex_av_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Stoex_av_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Stoex_av_avPackage init() {
      if (isInited) return (Stoex_av_avPackage)EPackage.Registry.INSTANCE.getEPackage(Stoex_av_avPackage.eNS_URI);

      // Obtain or create and register package
      Stoex_av_avPackageImpl theStoex_av_avPackage = (Stoex_av_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Stoex_av_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Stoex_av_avPackageImpl());
      ...
      theStoex_av_avPackage.createPackageContents();

      // Initialize created meta-data
      theStoex_av_avPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theStoex_av_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Stoex_av_avPackage.eNS_URI, theStoex_av_avPackage);
      return theStoex_av_avPackage;
   }
    ...
    * @generated
    */
   public Stoex_av_avFactory getStoex_av_avFactory() {
      return (Stoex_av_avFactory)getEFactoryInstance();
   }
   ...
   public void initializePackageContents() {
      ...
      Probfunction_av_avPackage theProbfunction_av_avPackage = (Probfunction_av_avPackage)EPackage.Registry.INSTANCE.getEPackage(Probfunction_av_avPackage.eNS_URI);
      ...
      numericLiteralEClass.getESuperTypes().add(theUnits_av_avPackage.getUnitCarryingElement());
