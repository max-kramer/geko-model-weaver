 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.AbstractNamedReferenceImpl#getReferenceName <em>Reference Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractNamedReferenceImpl extends EObjectImpl implements AbstractNamedReference {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.ABSTRACT_NAMED_REFERENCE;
   }
   ...
   public void setReferenceName(String newReferenceName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.ABSTRACT_NAMED_REFERENCE__REFERENCE_NAME, oldReferenceName, referenceName));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_pcPackage.ABSTRACT_NAMED_REFERENCE__REFERENCE_NAME:
