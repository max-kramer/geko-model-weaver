 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleLiteralImpl extends NumericLiteralImpl implements DoubleLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.DOUBLE_LITERAL;
   }
   ...
   public void setValue(double newValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.DOUBLE_LITERAL__VALUE, oldValue, value));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_pcPackage.DOUBLE_LITERAL__VALUE:
            return getValue();
      }
