 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.NegativeExpressionImpl#getInner <em>Inner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NegativeExpressionImpl extends UnaryImpl implements NegativeExpression {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.NEGATIVE_EXPRESSION;
   }
   ...
   public NotificationChain basicSetInner(Unary newInner, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.NEGATIVE_EXPRESSION__INNER, oldInner, newInner);
   ...
   public void setInner(Unary newInner) {
      if (newInner != inner) {
         ...
         if (inner != null)
            msgs = ((InternalEObject)inner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Stoex_av_pcPackage.NEGATIVE_EXPRESSION__INNER, null, msgs);
         if (newInner != null)
            msgs = ((InternalEObject)newInner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Stoex_av_pcPackage.NEGATIVE_EXPRESSION__INNER, null, msgs);
         msgs = basicSetInner(newInner, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.NEGATIVE_EXPRESSION__INNER, newInner, newInner));
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_av_pcPackage.NEGATIVE_EXPRESSION__INNER:
