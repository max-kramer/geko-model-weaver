 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.RandomVariableImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.RandomVariableImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RandomVariableImpl extends EObjectImpl implements RandomVariable {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.RANDOM_VARIABLE;
   }
   ...
   public void setSpecification(String newSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.RANDOM_VARIABLE__SPECIFICATION, oldSpecification, specification));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_pcPackage.RANDOM_VARIABLE__SPECIFICATION:
            return getSpecification();
         case Stoex_av_pcPackage.RANDOM_VARIABLE__EXPRESSION:
