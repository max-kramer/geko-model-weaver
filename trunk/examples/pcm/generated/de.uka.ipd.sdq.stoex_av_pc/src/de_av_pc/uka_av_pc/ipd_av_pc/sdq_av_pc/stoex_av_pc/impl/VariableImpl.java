 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.stoex_av_pc.impl.VariableImpl#getId_Variable <em>Id Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends AtomImpl implements Variable {
   ...
   protected EClass eStaticClass() {
      return Stoex_av_pcPackage.Literals.VARIABLE;
   }
      ...
      if (id_Variable != null && id_Variable.eIsProxy()) {
         ...
         if (id_Variable != oldId_Variable) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Stoex_av_pcPackage.VARIABLE__ID_VARIABLE, oldId_Variable, id_Variable));
         }
      }
      return id_Variable;
   }
   ...
   public void setId_Variable(AbstractNamedReference newId_Variable) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_av_pcPackage.VARIABLE__ID_VARIABLE, oldId_Variable, id_Variable));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_av_pcPackage.VARIABLE__ID_VARIABLE:
