 ...
 * @generated
 */
public class Stoex_av_pcSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Stoex_av_pcPackage.VARIABLE_REFERENCE: {
         ...
         case Stoex_av_pcPackage.ABSTRACT_NAMED_REFERENCE: {
         ...
         case Stoex_av_pcPackage.NAMESPACE_REFERENCE: {
         ...
         case Stoex_av_pcPackage.VARIABLE: {
         ...
         case Stoex_av_pcPackage.PRODUCT: {
         ...
         case Stoex_av_pcPackage.COMPARISON: {
         ...
         case Stoex_av_pcPackage.BOOLEAN_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.IF_ELSE: {
         ...
         case Stoex_av_pcPackage.EXPRESSION: {
            Expression expression = (Expression)theEObject;
            T result = caseExpression(expression);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Stoex_av_pcPackage.TERM_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.PRODUCT_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.PROBABILITY_FUNCTION_LITERAL: {
         ...
         case Stoex_av_pcPackage.PARENTHESIS: {
         ...
         case Stoex_av_pcPackage.NUMERIC_LITERAL: {
         ...
         case Stoex_av_pcPackage.INT_LITERAL: {
         ...
         case Stoex_av_pcPackage.DOUBLE_LITERAL: {
         ...
         case Stoex_av_pcPackage.COMPARE_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.BOOL_LITERAL: {
         ...
         case Stoex_av_pcPackage.STRING_LITERAL: {
         ...
         case Stoex_av_pcPackage.POWER_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.BOOLEAN_OPERATOR_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.NOT_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.NEGATIVE_EXPRESSION: {
         ...
         case Stoex_av_pcPackage.FUNCTION_LITERAL: {
         ...
         case Stoex_av_pcPackage.IF_ELSE_EXPRESSION: {
