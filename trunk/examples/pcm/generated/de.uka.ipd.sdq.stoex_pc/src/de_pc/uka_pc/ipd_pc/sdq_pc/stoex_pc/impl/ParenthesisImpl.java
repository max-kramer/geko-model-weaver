 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.stoex_pc.impl.ParenthesisImpl#getInnerExpression <em>Inner Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParenthesisImpl extends AtomImpl implements Parenthesis {
   ...
   protected EClass eStaticClass() {
      return Stoex_pcPackage.Literals.PARENTHESIS;
   }
   ...
   public NotificationChain basicSetInnerExpression(Expression newInnerExpression, NotificationChain msgs) {
      ...
      if (eNotificationRequired()) {
         ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Stoex_pcPackage.PARENTHESIS__INNER_EXPRESSION, oldInnerExpression, newInnerExpression);
   ...
   public void setInnerExpression(Expression newInnerExpression) {
      if (newInnerExpression != innerExpression) {
         ...
         if (innerExpression != null)
            msgs = ((InternalEObject)innerExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Stoex_pcPackage.PARENTHESIS__INNER_EXPRESSION, null, msgs);
         if (newInnerExpression != null)
            msgs = ((InternalEObject)newInnerExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Stoex_pcPackage.PARENTHESIS__INNER_EXPRESSION, null, msgs);
         msgs = basicSetInnerExpression(newInnerExpression, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pcPackage.PARENTHESIS__INNER_EXPRESSION, newInnerExpression, newInnerExpression));
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_pcPackage.PARENTHESIS__INNER_EXPRESSION:
