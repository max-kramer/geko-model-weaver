 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.impl.RandomVariableImpl#getSpecification <em>Specification</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.impl.RandomVariableImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RandomVariableImpl extends EObjectImpl implements RandomVariable {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_avPackage.Literals.RANDOM_VARIABLE;
   }
   ...
   public void setSpecification(String newSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_avPackage.RANDOM_VARIABLE__SPECIFICATION, oldSpecification, specification));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_avPackage.RANDOM_VARIABLE__SPECIFICATION:
            return getSpecification();
         case Stoex_pc_avPackage.RANDOM_VARIABLE__EXPRESSION:
