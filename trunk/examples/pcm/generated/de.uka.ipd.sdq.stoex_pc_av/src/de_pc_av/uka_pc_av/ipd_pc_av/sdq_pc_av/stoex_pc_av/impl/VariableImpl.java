 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.stoex_pc_av.impl.VariableImpl#getId_Variable <em>Id Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableImpl extends AtomImpl implements Variable {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_avPackage.Literals.VARIABLE;
   }
      ...
      if (id_Variable != null && id_Variable.eIsProxy()) {
         ...
         if (id_Variable != oldId_Variable) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Stoex_pc_avPackage.VARIABLE__ID_VARIABLE, oldId_Variable, id_Variable));
         }
      }
      return id_Variable;
   }
   ...
   public void setId_Variable(AbstractNamedReference newId_Variable) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_avPackage.VARIABLE__ID_VARIABLE, oldId_Variable, id_Variable));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_avPackage.VARIABLE__ID_VARIABLE:
