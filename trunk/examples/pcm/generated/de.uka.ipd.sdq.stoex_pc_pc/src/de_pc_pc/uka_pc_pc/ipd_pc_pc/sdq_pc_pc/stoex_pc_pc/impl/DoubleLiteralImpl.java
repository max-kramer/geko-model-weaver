 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.DoubleLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoubleLiteralImpl extends NumericLiteralImpl implements DoubleLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_pcPackage.Literals.DOUBLE_LITERAL;
   }
   ...
   public void setValue(double newValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_pcPackage.DOUBLE_LITERAL__VALUE, oldValue, value));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_pcPackage.DOUBLE_LITERAL__VALUE:
            return getValue();
      }
