 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.PointcutPointcutImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PointcutPointcutImpl extends EObjectImpl implements PointcutPointcut {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_pcPackage.Literals.POINTCUT_POINTCUT;
   }
   ...
   public EList<EObject> getChildren() {
      if (children == null) {
         children = new EObjectContainmentEList<EObject>(EObject.class, this, Stoex_pc_pcPackage.POINTCUT_POINTCUT__CHILDREN);
      }
      return children;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Stoex_pc_pcPackage.POINTCUT_POINTCUT__CHILDREN:
