 ...
 * <ul>
 *   <li>{@link de_pc_pc.uka_pc_pc.ipd_pc_pc.sdq_pc_pc.stoex_pc_pc.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends AtomImpl implements StringLiteral {
   ...
   protected EClass eStaticClass() {
      return Stoex_pc_pcPackage.Literals.STRING_LITERAL;
   }
   ...
   public void setValue(String newValue) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Stoex_pc_pcPackage.STRING_LITERAL__VALUE, oldValue, value));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Stoex_pc_pcPackage.STRING_LITERAL__VALUE:
            return getValue();
      }
