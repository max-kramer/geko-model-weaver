 ...
 * @generated
 */
public class Stoex_pc_pcSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Stoex_pc_pcPackage.VARIABLE_REFERENCE: {
         ...
         case Stoex_pc_pcPackage.ABSTRACT_NAMED_REFERENCE: {
         ...
         case Stoex_pc_pcPackage.NAMESPACE_REFERENCE: {
         ...
         case Stoex_pc_pcPackage.VARIABLE: {
         ...
         case Stoex_pc_pcPackage.PRODUCT: {
         ...
         case Stoex_pc_pcPackage.COMPARISON: {
         ...
         case Stoex_pc_pcPackage.BOOLEAN_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.IF_ELSE: {
         ...
         case Stoex_pc_pcPackage.EXPRESSION: {
            Expression expression = (Expression)theEObject;
            T result = caseExpression(expression);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case Stoex_pc_pcPackage.TERM_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.PRODUCT_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.PROBABILITY_FUNCTION_LITERAL: {
         ...
         case Stoex_pc_pcPackage.PARENTHESIS: {
         ...
         case Stoex_pc_pcPackage.NUMERIC_LITERAL: {
         ...
         case Stoex_pc_pcPackage.INT_LITERAL: {
         ...
         case Stoex_pc_pcPackage.DOUBLE_LITERAL: {
         ...
         case Stoex_pc_pcPackage.COMPARE_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.BOOL_LITERAL: {
         ...
         case Stoex_pc_pcPackage.STRING_LITERAL: {
         ...
         case Stoex_pc_pcPackage.POWER_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.BOOLEAN_OPERATOR_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.NOT_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.NEGATIVE_EXPRESSION: {
         ...
         case Stoex_pc_pcPackage.FUNCTION_LITERAL: {
         ...
         case Stoex_pc_pcPackage.IF_ELSE_EXPRESSION: {
