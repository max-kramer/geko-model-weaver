 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.units_av.impl.UnitCarryingElementImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.units_av.impl.UnitCarryingElementImpl#getUnitSpecification <em>Unit Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitCarryingElementImpl extends EObjectImpl implements UnitCarryingElement {
   ...
   protected EClass eStaticClass() {
      return Units_avPackage.Literals.UNIT_CARRYING_ELEMENT;
   }
   ...
   public void setUnitSpecification(String newUnitSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_avPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION, oldUnitSpecification, unitSpecification));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_avPackage.UNIT_CARRYING_ELEMENT__UNIT:
            if (resolve) return getUnit();
            return basicGetUnit();
         case Units_avPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION:
