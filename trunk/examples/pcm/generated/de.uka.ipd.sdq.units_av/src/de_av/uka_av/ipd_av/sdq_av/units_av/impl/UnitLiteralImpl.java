 ...
 * <ul>
 *   <li>{@link de_av.uka_av.ipd_av.sdq_av.units_av.impl.UnitLiteralImpl#getBaseUnit <em>Base Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitLiteralImpl extends UnitImpl implements UnitLiteral {
   ...
   protected EClass eStaticClass() {
      return Units_avPackage.Literals.UNIT_LITERAL;
   }
      ...
      if (baseUnit != null && baseUnit.eIsProxy()) {
         ...
         if (baseUnit != oldBaseUnit) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Units_avPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit, baseUnit));
         }
      }
      return baseUnit;
   }
   ...
   public void setBaseUnit(BaseUnit newBaseUnit) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_avPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit, baseUnit));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_avPackage.UNIT_LITERAL__BASE_UNIT:
