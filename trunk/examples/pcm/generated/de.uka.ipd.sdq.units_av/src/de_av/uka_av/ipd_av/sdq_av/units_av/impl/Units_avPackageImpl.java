...
import de_av.uka_av.ipd_av.sdq_av.units_av.Advice;
import de_av.uka_av.ipd_av.sdq_av.units_av.BaseUnit;
import de_av.uka_av.ipd_av.sdq_av.units_av.GlobalScope;
import de_av.uka_av.ipd_av.sdq_av.units_av.PerJoinPointScope;
import de_av.uka_av.ipd_av.sdq_av.units_av.Unit;
import de_av.uka_av.ipd_av.sdq_av.units_av.UnitCarryingElement;
import de_av.uka_av.ipd_av.sdq_av.units_av.UnitLiteral;
import de_av.uka_av.ipd_av.sdq_av.units_av.UnitMultiplication;
import de_av.uka_av.ipd_av.sdq_av.units_av.UnitPower;
import de_av.uka_av.ipd_av.sdq_av.units_av.UnitRepository;
import de_av.uka_av.ipd_av.sdq_av.units_av.Units_avFactory;
 ...
 * @generated
 */
public class Units_avPackageImpl extends EPackageImpl implements Units_avPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_av.uka_av.ipd_av.sdq_av.units_av.Units_avPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Units_avPackageImpl() {
      super(eNS_URI, Units_avFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Units_avPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Units_avPackage init() {
      if (isInited) return (Units_avPackage)EPackage.Registry.INSTANCE.getEPackage(Units_avPackage.eNS_URI);

      // Obtain or create and register package
      Units_avPackageImpl theUnits_avPackage = (Units_avPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Units_avPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Units_avPackageImpl());

      isInited = true;

      // Create package meta-data objects
      theUnits_avPackage.createPackageContents();

      // Initialize created meta-data
      theUnits_avPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theUnits_avPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Units_avPackage.eNS_URI, theUnits_avPackage);
      return theUnits_avPackage;
   }
    ...
    * @generated
    */
   public Units_avFactory getUnits_avFactory() {
      return (Units_avFactory)getEFactoryInstance();
   }
