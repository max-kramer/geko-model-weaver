 ...
 * @generated
 */
public class Units_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Units_avPackage.UNIT_CARRYING_ELEMENT: {
         ...
         case Units_avPackage.UNIT_POWER: {
         ...
         case Units_avPackage.UNIT_LITERAL: {
