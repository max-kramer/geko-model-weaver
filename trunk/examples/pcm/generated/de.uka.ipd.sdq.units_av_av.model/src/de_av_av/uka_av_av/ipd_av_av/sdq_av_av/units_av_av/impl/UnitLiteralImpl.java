 ...
 * <ul>
 *   <li>{@link de_av_av.uka_av_av.ipd_av_av.sdq_av_av.units_av_av.impl.UnitLiteralImpl#getBaseUnit <em>Base Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitLiteralImpl extends UnitImpl implements UnitLiteral {
   ...
   protected EClass eStaticClass() {
      return Units_av_avPackage.Literals.UNIT_LITERAL;
   }
      ...
      if (baseUnit != null && baseUnit.eIsProxy()) {
         ...
         if (baseUnit != oldBaseUnit) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Units_av_avPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit, baseUnit));
         }
      }
      return baseUnit;
   }
   ...
   public void setBaseUnit(BaseUnit newBaseUnit) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_av_avPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit, baseUnit));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_av_avPackage.UNIT_LITERAL__BASE_UNIT:
