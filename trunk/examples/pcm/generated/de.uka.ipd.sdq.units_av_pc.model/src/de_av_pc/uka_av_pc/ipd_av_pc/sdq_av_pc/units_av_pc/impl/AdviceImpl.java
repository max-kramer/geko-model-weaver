 ...
 * <ul>
 *   <li>{@link de_av_pc.uka_av_pc.ipd_av_pc.sdq_av_pc.units_av_pc.impl.AdviceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdviceImpl extends EObjectImpl implements Advice {
   ...
   protected EClass eStaticClass() {
      return Units_av_pcPackage.Literals.ADVICE;
   }
   ...
   public EList<EObject> getChildren() {
      if (children == null) {
         children = new EObjectContainmentEList<EObject>(EObject.class, this, Units_av_pcPackage.ADVICE__CHILDREN);
      }
      return children;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_av_pcPackage.ADVICE__CHILDREN:
