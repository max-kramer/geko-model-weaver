 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.impl.UnitLiteralImpl#getBaseUnit <em>Base Unit</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitLiteralImpl extends UnitImpl implements UnitLiteral {
   ...
   protected EClass eStaticClass() {
      return Units_pcPackage.Literals.UNIT_LITERAL;
   }
      ...
      if (baseUnit != null && baseUnit.eIsProxy()) {
         ...
         if (baseUnit != oldBaseUnit) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, Units_pcPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit, baseUnit));
         }
      }
      return baseUnit;
   }
   ...
   public void setBaseUnit(BaseUnit newBaseUnit) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_pcPackage.UNIT_LITERAL__BASE_UNIT, oldBaseUnit, baseUnit));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_pcPackage.UNIT_LITERAL__BASE_UNIT:
