 ...
 * <ul>
 *   <li>{@link de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.impl.UnitMultiplicationImpl#getUnits <em>Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitMultiplicationImpl extends UnitImpl implements UnitMultiplication {
   ...
   protected EClass eStaticClass() {
      return Units_pcPackage.Literals.UNIT_MULTIPLICATION;
   }
   ...
   public EList<Unit> getUnits() {
      if (units == null) {
         units = new EObjectContainmentEList<Unit>(Unit.class, this, Units_pcPackage.UNIT_MULTIPLICATION__UNITS);
      }
      return units;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_pcPackage.UNIT_MULTIPLICATION__UNITS:
