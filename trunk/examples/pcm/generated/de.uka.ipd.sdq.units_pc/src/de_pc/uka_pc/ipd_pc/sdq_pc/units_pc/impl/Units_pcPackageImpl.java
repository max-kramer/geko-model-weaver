...
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.BaseUnit;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.Pointcut;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.Unit;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.UnitCarryingElement;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.UnitLiteral;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.UnitMultiplication;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.UnitPower;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.UnitRepository;
import de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.Units_pcFactory;
 ...
 * @generated
 */
public class Units_pcPackageImpl extends EPackageImpl implements Units_pcPackage {
   /**
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    ...
    * @see de_pc.uka_pc.ipd_pc.sdq_pc.units_pc.Units_pcPackage#eNS_URI
    * @see #init()
    * @generated
    */
   private Units_pcPackageImpl() {
      super(eNS_URI, Units_pcFactory.eINSTANCE);
   }
    ...
    * 
    * <p>This method is used to initialize {@link Units_pcPackage#eINSTANCE} when that field is accessed.
    ...
    * @generated
    */
   public static Units_pcPackage init() {
      if (isInited) return (Units_pcPackage)EPackage.Registry.INSTANCE.getEPackage(Units_pcPackage.eNS_URI);

      // Obtain or create and register package
      Units_pcPackageImpl theUnits_pcPackage = (Units_pcPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Units_pcPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Units_pcPackageImpl());

      isInited = true;

      // Create package meta-data objects
      theUnits_pcPackage.createPackageContents();

      // Initialize created meta-data
      theUnits_pcPackage.initializePackageContents();

      // Mark meta-data to indicate it can't be changed
      theUnits_pcPackage.freeze();

  
      // Update the registry and return the package
      EPackage.Registry.INSTANCE.put(Units_pcPackage.eNS_URI, theUnits_pcPackage);
      return theUnits_pcPackage;
   }
    ...
    * @generated
    */
   public Units_pcFactory getUnits_pcFactory() {
      return (Units_pcFactory)getEFactoryInstance();
   }
