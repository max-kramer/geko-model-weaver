 ...
 * @generated
 */
public class Units_pcSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Units_pcPackage.UNIT_CARRYING_ELEMENT: {
         ...
         case Units_pcPackage.UNIT_POWER: {
         ...
         case Units_pcPackage.UNIT_LITERAL: {
