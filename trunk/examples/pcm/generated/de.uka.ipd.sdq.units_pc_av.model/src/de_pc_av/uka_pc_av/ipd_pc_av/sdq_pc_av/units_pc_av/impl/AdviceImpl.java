 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.units_pc_av.impl.AdviceImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AdviceImpl extends EObjectImpl implements Advice {
   ...
   protected EClass eStaticClass() {
      return Units_pc_avPackage.Literals.ADVICE;
   }
   ...
   public EList<EObject> getChildren() {
      if (children == null) {
         children = new EObjectContainmentEList<EObject>(EObject.class, this, Units_pc_avPackage.ADVICE__CHILDREN);
      }
      return children;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_pc_avPackage.ADVICE__CHILDREN:
