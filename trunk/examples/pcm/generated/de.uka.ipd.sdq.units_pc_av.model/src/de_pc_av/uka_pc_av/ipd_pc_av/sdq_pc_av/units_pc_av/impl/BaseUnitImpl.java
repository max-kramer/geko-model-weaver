 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.units_pc_av.impl.BaseUnitImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BaseUnitImpl extends EObjectImpl implements BaseUnit {
   ...
   protected EClass eStaticClass() {
      return Units_pc_avPackage.Literals.BASE_UNIT;
   }
   ...
   public void setName(String newName) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_pc_avPackage.BASE_UNIT__NAME, oldName, name));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_pc_avPackage.BASE_UNIT__NAME:
            return getName();
      }
