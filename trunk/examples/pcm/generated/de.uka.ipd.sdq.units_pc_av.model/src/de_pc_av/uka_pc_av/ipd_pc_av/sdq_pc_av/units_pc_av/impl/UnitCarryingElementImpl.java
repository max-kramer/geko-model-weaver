 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.units_pc_av.impl.UnitCarryingElementImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.units_pc_av.impl.UnitCarryingElementImpl#getUnitSpecification <em>Unit Specification</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitCarryingElementImpl extends EObjectImpl implements UnitCarryingElement {
   ...
   protected EClass eStaticClass() {
      return Units_pc_avPackage.Literals.UNIT_CARRYING_ELEMENT;
   }
   ...
   public void setUnitSpecification(String newUnitSpecification) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, Units_pc_avPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION, oldUnitSpecification, unitSpecification));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case Units_pc_avPackage.UNIT_CARRYING_ELEMENT__UNIT:
            if (resolve) return getUnit();
            return basicGetUnit();
         case Units_pc_avPackage.UNIT_CARRYING_ELEMENT__UNIT_SPECIFICATION:
