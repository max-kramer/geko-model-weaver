 ...
 * <ul>
 *   <li>{@link de_pc_av.uka_pc_av.ipd_pc_av.sdq_pc_av.units_pc_av.impl.UnitMultiplicationImpl#getUnits <em>Units</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UnitMultiplicationImpl extends UnitImpl implements UnitMultiplication {
   ...
   protected EClass eStaticClass() {
      return Units_pc_avPackage.Literals.UNIT_MULTIPLICATION;
   }
   ...
   public EList<Unit> getUnits() {
      if (units == null) {
         units = new EObjectContainmentEList<Unit>(Unit.class, this, Units_pc_avPackage.UNIT_MULTIPLICATION__UNITS);
      }
      return units;
   }
   ...
   public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
      switch (featureID) {
         case Units_pc_avPackage.UNIT_MULTIPLICATION__UNITS:
