 ...
 * @generated
 */
public class Units_pc_avSwitch<T> extends Switch<T> {
   /**
   ...
   protected T doSwitch(int classifierID, EObject theEObject) {
      switch (classifierID) {
         case Units_pc_avPackage.UNIT_CARRYING_ELEMENT: {
         ...
         case Units_pc_avPackage.UNIT_POWER: {
         ...
         case Units_pc_avPackage.UNIT_LITERAL: {
